...
| Luminance Min | Single | Minimum grayscale value for tiles |
| Luminance Max | Single | Maximum grayscale value for tiles |
| Luminance Random | Single | Random luminance variation between min and max |
| Blend Mode | Single |  |
| Background | Single | Background grayscale value |
...
| Luminance Map | 2D | white | Controls the luminance map. |
...
| Luminance Map Influence | Range | 0 | Controls the luminance map influence. |
