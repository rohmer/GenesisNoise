...
> Generates clouds 1 procedural noise.

![Clouds 1](../_images/generators/pattern-clouds-1.png)
...
| Detail Amount | Range | 0.65 | Controls the detail amount. |
...
- [Back to Clouds 1](./generators-index.md)
