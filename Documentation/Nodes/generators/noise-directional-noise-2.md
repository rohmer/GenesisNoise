...
> Generates directional noise 2 procedural noise.

![Directional Noise 2](../_images/generators/noise-directional-noise-2.png)
...
|---------|------|---------|-------------|
| Scale | Vector2 | (7, 7, 0, 0) | Global UV scale |
| Offset | Vector2 | (0, 0, 0, 0) | Global UV offset |
| Angle | Range | 0.0 | Direction of the noise in radians |
| Anisotropy | Range | 12.0 | Stretch along the chosen direction |
| Frequency | Range | 8.0 | Base feature frequency |
| Detail Frequency | Range | 72.0 | Fine directional detail frequency |
| Detail Strength | Range | 0.65 | Amount of fine detail mixed into the result |
| Flow | Range | 0.9 | How much the direction meanders |
| Warp Strength | Range | 0.35 | Domain warp strength |
| Warp Scale | Range | 3.0 | Domain warp scale |
| Ridge Strength | Range | 0.55 | Ridge shaping amount |
| Cell Breakup | Range | 0.1 | Cellular directional breakup amount |
...
| Contrast | Range | 1.25 | Final contrast |
...
- [Back to Directional Noise 2](./generators-index.md)
