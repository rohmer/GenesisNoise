...
> Generates a weave complex pattern.

![Weave Complex](../_images/generators/shapes-weave-complex.png)
...
| Over Count | Range | 2 | Number of horizontal overs |
| Under Count | Range | 1 | Number of horizontal unders |
| Randomness | Range | 0.0 | Random variation amount |
| Seed | int | 52 | Random seed |

## See Also

- [Back to Weave Complex](./generators-index.md)
