...
> Generates cells 1 procedural noise.

![Cells 1](../_images/generators/pattern-cells-1.png)
...
| Pattern | Enum | 0 | Controls the pattern. |
| Pattern Size | Vector | (0.85,0.85,0,0) | Controls the pattern size. |
...
- [Back to Cells 1](./generators-index.md)
