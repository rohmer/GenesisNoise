...
> Generates a spiral splatter shape pattern.

![Spiral Splatter Shape](../_images/generators/shapes-spiral-splatter-shape.png)
...
| Count | Range | 64 | Number of shapes along spiral |
| Start Radius | Range | 0.05 | Base radius at start of spiral |
| Radius Step | Range | 0.01 | Radius growth per step |
| Angle Step | Range | 0.25 | Angular step per instance |
...
- [Back to Spiral Splatter Shape](./generators-index.md)
