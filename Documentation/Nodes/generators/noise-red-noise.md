...
> Generates red (low-frequency) spectral noise.

![Red Noise](../_images/generators/noise-red-noise.png)
...
| Base Frequency | Float | 1.5 | Controls the base frequency. |
| Octaves | Int Range | 8 | Controls the octaves. |
| Lacunarity | Float | 2 | Controls the lacunarity. |
| High Frequency Falloff | Range | 0.15 | Controls the high frequency falloff. |
...
- [Back to Red Noise](./generators-index.md)
