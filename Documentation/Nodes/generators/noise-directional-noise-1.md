...
> Generates directional noise 1 procedural noise.

![Directional Noise 1](../_images/generators/noise-directional-noise-1.png)
...
| Anisotropy | Range | 8.0 | Stretch along the chosen direction |
| Frequency | Range | 5.0 | Base feature frequency |
| Detail Frequency | Range | 36.0 | Fine directional detail frequency |
| Detail Strength | Range | 0.35 | Amount of fine detail mixed into the result |
| Flow | Range | 0.55 | How much the direction meanders |
| Warp Strength | Range | 0.25 | Domain warp strength |
| Warp Scale | Range | 2.0 | Domain warp scale |
| Ridge Strength | Range | 0.15 | Ridge shaping amount |
| Cell Breakup | Range | 0.0 | Cellular directional breakup amount |
| Octaves | Int Range | 4 | Number of fBm octaves |
| Lacunarity | Range | 2.0 | Frequency multiplier between octaves |
| Persistence | Range | 0.5 | Amplitude multiplier between octaves |
| Contrast | Range | 1.0 | Final contrast |
...
- [Back to Directional Noise 1](./generators-index.md)
