...
```cpp
class GradientMapNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Color/GradientMapNodeView.cs:13
...
| Name | Kind | Owner |
|------|------|-------|
| [`gradientMapNode`](#gradientmapnode-1) | `property` | Declared here |
| [`Enable`](#enable-110) | `function` | Declared here |
...
|--------|------|-------------|
| `GradientMapNode` | [`gradientMapNode`](#gradientmapnode-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Color/GradientMapNodeView.cs:15

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-110) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Color/GradientMapNodeView.cs:17
