{#terrainmoisturemapnode}

# TerrainMoistureMapNode

```cpp
class TerrainMoistureMapNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:16
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-601) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-84) | `property` | Declared here |
| [`hasPreview`](#haspreview-97) | `property` | Declared here |
| [`hasSettings`](#hassettings-28) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-213) | `property` | Declared here |
| [`previewTexture`](#previewtexture-59) | `property` | Declared here |
| [`TerrainInput`](#terraininput-2) | `variable` | Declared here |
| [`WindFlowMap`](#windflowmap) | `variable` | Declared here |
| [`CurvatureMap`](#curvaturemap-1) | `variable` | Declared here |
| [`SlopeMap`](#slopemap) | `variable` | Declared here |
| [`MoistureMap`](#moisturemap) | `variable` | Declared here |
| [`Enable`](#enable-194) | `function` | Declared here |
| [`ProcessNode`](#processnode-147) | `function` | Declared here |
| [`Disable`](#disable-81) | `function` | Declared here |
| [`preview`](#preview-19) | `variable` | Declared here |
| [`previewRequestVersion`](#previewrequestversion-6) | `variable` | Declared here |
| [`shader`](#shader-9) | `variable` | Declared here |
| [`kernel`](#kernel-3) | `variable` | Declared here |
| [`SanitizeParameters`](#sanitizeparameters-1) | `function` | Declared here |
| [`RequestPreview`](#requestpreview-7) | `function` | Declared here |
| [`ThreadGroupSize`](#threadgroupsize-6) | `variable` | Declared here |
| [`PreviewResolution`](#previewresolution-2) | `variable` | Declared here |
| [`ClearTexture`](#cleartexture-3) | `function` | Declared here |
| [`DestroyPreview`](#destroypreview-5) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-601)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-84)  |  |
| `override bool` | [`hasPreview`](#haspreview-97)  |  |
| `override bool` | [`hasSettings`](#hassettings-28)  |  |
| `override float` | [`nodeWidth`](#nodewidth-213)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-59)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:53

---

{#showdefaultinspector-84}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:54
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:55
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:56
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:57
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:58

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `HeightField` | [`TerrainInput`](#terraininput-2)  |  |
| `RenderTexture` | [`WindFlowMap`](#windflowmap)  |  |
| `RenderTexture` | [`CurvatureMap`](#curvaturemap-1)  |  |
| `RenderTexture` | [`SlopeMap`](#slopemap)  |  |
| `RenderTexture` | [`MoistureMap`](#moisturemap)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:22
...
```cpp
RenderTexture CurvatureMap
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:25
...
```cpp
RenderTexture SlopeMap
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:28
...
```cpp
RenderTexture MoistureMap
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:31

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-194) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-147) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-81) `virtual` `inline` | Called when the node is disabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:60
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:66
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:174
...
| Return | Name | Description |
|--------|------|-------------|
| `Texture2D` | [`preview`](#preview-19)  |  |
| `int` | [`previewRequestVersion`](#previewrequestversion-6)  |  |
| `ComputeShader` | [`shader`](#shader-9)  |  |
| `int` | [`kernel`](#kernel-3)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:45

---

{#previewrequestversion-6}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:46
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:47
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:48

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`SanitizeParameters`](#sanitizeparameters-1) `inline` |  |
| `void` | [`RequestPreview`](#requestpreview-7) `inline` |  |
...
```cpp
inline void SanitizeParameters()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:131
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:153

## Private Static Attributes

| Return | Name | Description |
|--------|------|-------------|
| `const int` | [`ThreadGroupSize`](#threadgroupsize-6) `static` |  |
| `const int` | [`PreviewResolution`](#previewresolution-2) `static` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:50
...
```cpp
const int PreviewResolution = 300
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:51

## Private Static Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`ClearTexture`](#cleartexture-3) `static` `inline` |  |
| `void` | [`DestroyPreview`](#destroypreview-5) `static` `inline` |  |
...
```cpp
static inline void ClearTexture(RenderTexture texture, Color color)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:145
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainMoistureMapNode.cs:183
