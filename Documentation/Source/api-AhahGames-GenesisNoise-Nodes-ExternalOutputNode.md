...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ExternalOutputNode.cs:21

> **Inherits:** [`AhahGames.GenesisNoise.Nodes.OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2)

## List of all members

| Name | Kind | Owner |
|------|------|-------|
| [`previewTexture`](#previewtexture-9) | `property` | Declared here |
| [`hasSettings`](#hassettings-7) | `property` | Declared here |
| [`canEditPreviewSRGB`](#caneditpreviewsrgb-1) | `property` | Declared here |
| [`defaultSettings`](#defaultsettings-7) | `property` | Declared here |
| [`name`](#name-181) | `variable` | Declared here |
| [`asset`](#asset) | `variable` | Declared here |
| [`externalOutputDimension`](#externaloutputdimension) | `variable` | Declared here |
| [`external2DOoutputType`](#external2dooutputtype) | `variable` | Declared here |
| [`externalFileType`](#externalfiletype-1) | `variable` | Declared here |
| [`external3DFormat`](#external3dformat) | `variable` | Declared here |
| [`exportAlpha`](#exportalpha) | `variable` | Declared here |
| [`Enable`](#enable-29) | `function` | Declared here |
| [`ProcessNode`](#processnode-44) | `function` | Declared here |
| [`ExternalOutputDimension`](#externaloutputdimension-1) | `enum` | Declared here |
| [`External2DOutputType`](#external2doutputtype-1) | `enum` | Declared here |
| [`ExternalFileType`](#externalfiletype-2) | `enum` | Declared here |
| [`mainOutput`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#mainoutput) | `property` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
| [`name`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#name-380) | `property` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
| [`previewTexture`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#previewtexture-34) | `property` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
| [`nodeWidth`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#nodewidth-135) | `property` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
| [`canEditPreviewSRGB`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#caneditpreviewsrgb-3) | `property` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
| [`defaultPreviewSRGB`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#defaultpreviewsrgb-1) | `property` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
| [`isOutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#isoutputnode-1) | `property` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
| [`selectedPreviewIndex`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#selectedpreviewindex) | `property` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
| [`defaultSettings`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#defaultsettings-23) | `property` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
| [`outputTextureSettings`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputtexturesettings) | `variable` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
| [`AddTextureOutput`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#addtextureoutput) | `function` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
| [`RemoveTextureOutput`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#removetextureoutput) | `function` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
| [`GetCustomRenderTextures`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#getcustomrendertextures-3) | `function` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
| [`uniqueMessages`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#uniquemessages) | `variable` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
| [`Enable`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#enable-62) | `function` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
| [`CanResetPort`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#canresetport-1) | `function` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
| [`Disable`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#disable-35) | `function` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
| [`ProcessNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#processnode-91) | `function` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
| [`ChangeOutputPortType`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#changeoutputporttype) | `function` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
| [`AssignSubTextures`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#assignsubtextures) | `function` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
| [`_selectedPreviewIndex`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#_selectedpreviewindex) | `variable` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
| [`CreateFinalCopyMaterial`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#createfinalcopymaterial) | `function` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
| [`UpdateMessages`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#updatemessages) | `function` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
| [`UpdateFinalCopyMaterial`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#updatefinalcopymaterial) | `function` | Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2) |
...
## Inherited from [`OutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputnode-2)

| Kind | Name | Description |
|------|------|-------------|
| `property` | [`mainOutput`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#mainoutput)  |  |
| `property` | [`name`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#name-380)  |  |
| `property` | [`previewTexture`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#previewtexture-34)  |  |
| `property` | [`nodeWidth`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#nodewidth-135)  |  |
| `property` | [`canEditPreviewSRGB`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#caneditpreviewsrgb-3)  |  |
| `property` | [`defaultPreviewSRGB`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#defaultpreviewsrgb-1)  |  |
| `property` | [`isOutputNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#isoutputnode-1)  |  |
| `property` | [`selectedPreviewIndex`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#selectedpreviewindex)  |  |
| `property` | [`defaultSettings`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#defaultsettings-23)  |  |
| `variable` | [`outputTextureSettings`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#outputtexturesettings)  |  |
| `function` | [`AddTextureOutput`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#addtextureoutput) `inline` |  |
| `function` | [`RemoveTextureOutput`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#removetextureoutput) `inline` |  |
| `function` | [`GetCustomRenderTextures`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#getcustomrendertextures-3) `inline` |  |
| `variable` | [`uniqueMessages`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#uniquemessages)  |  |
| `function` | [`Enable`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#enable-62) `virtual` `inline` | Called when the node is enabled. |
| `function` | [`CanResetPort`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#canresetport-1) `virtual` `inline` |  |
| `function` | [`Disable`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#disable-35) `virtual` `inline` | Called when the node is disabled. |
| `function` | [`ProcessNode`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#processnode-91) `virtual` `inline` |  |
| `function` | [`ChangeOutputPortType`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#changeoutputporttype) `inline` |  |
| `function` | [`AssignSubTextures`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#assignsubtextures) `inline` |  |
| `variable` | [`_selectedPreviewIndex`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#_selectedpreviewindex)  |  |
| `function` | [`CreateFinalCopyMaterial`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#createfinalcopymaterial) `inline` |  |
| `function` | [`UpdateMessages`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#updatemessages) `inline` |  |
| `function` | [`UpdateFinalCopyMaterial`](api-AhahGames-GenesisNoise-Nodes-OutputNode.md#updatefinalcopymaterial) `inline` |  |
...
|--------|------|-------------|
| `override Texture` | [`previewTexture`](#previewtexture-9)  |  |
| `override bool` | [`hasSettings`](#hassettings-7)  |  |
| `override bool` | [`canEditPreviewSRGB`](#caneditpreviewsrgb-1)  |  |
| `override GenesisNoiseSettings` | [`defaultSettings`](#defaultsettings-7)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ExternalOutputNode.cs:55
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ExternalOutputNode.cs:57

---

{#caneditpreviewsrgb-1}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ExternalOutputNode.cs:59
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ExternalOutputNode.cs:61

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `new string` | [`name`](#name-181)  |  |
| `Texture` | [`asset`](#asset)  |  |
| `ExternalOutputDimension` | [`externalOutputDimension`](#externaloutputdimension)  |  |
| `External2DOutputType` | [`external2DOoutputType`](#external2dooutputtype)  |  |
| `ExternalFileType` | [`externalFileType`](#externalfiletype-1)  |  |
| `ConversionFormat` | [`external3DFormat`](#external3dformat)  |  |
| `bool` | [`exportAlpha`](#exportalpha)  |  |
...
```cpp
new string name = "External Output"
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ExternalOutputNode.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ExternalOutputNode.cs:47
...
```cpp
ExternalOutputDimension externalOutputDimension = ExternalOutputDimension.Texture2D
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ExternalOutputNode.cs:49
...
```cpp
External2DOutputType external2DOoutputType = External2DOutputType.Color
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ExternalOutputNode.cs:50
...
```cpp
ExternalFileType externalFileType = ExternalFileType.PNG
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ExternalOutputNode.cs:51
...
```cpp
ConversionFormat external3DFormat = ConversionFormat.RGBA32
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ExternalOutputNode.cs:52
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ExternalOutputNode.cs:53

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-29) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-44) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ExternalOutputNode.cs:83
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ExternalOutputNode.cs:90
...
| Name | Description |
|------|-------------|
| [`ExternalOutputDimension`](#externaloutputdimension-1)  |  |
| [`External2DOutputType`](#external2doutputtype-1)  |  |
| [`ExternalFileType`](#externalfiletype-2)  |  |

---

{#externaloutputdimension-1}

### ExternalOutputDimension

```cpp
enum ExternalOutputDimension
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ExternalOutputNode.cs:25
...
{#external2doutputtype-1}

### External2DOutputType

```cpp
enum External2DOutputType
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ExternalOutputNode.cs:31
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ExternalOutputNode.cs:39
