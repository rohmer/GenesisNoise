{#terraingeneratornodeview}

# TerrainGeneratorNodeView

```cpp
class TerrainGeneratorNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainGeneratorNodeView.cs:13
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-63) | `property` | Declared here |
| [`Enable`](#enable-161) | `function` | Declared here |
| [`terrainHeight`](#terrainheight) | `variable` | Declared here |
| [`lakeDepth`](#lakedepth) | `variable` | Declared here |
| [`featherDistance`](#featherdistance) | `variable` | Declared here |
| [`featherRandomness`](#featherrandomness) | `variable` | Declared here |
| [`generateButton`](#generatebutton) | `variable` | Declared here |
| [`lakeMaterial`](#lakematerial) | `variable` | Declared here |
...
|--------|------|-------------|
| `TerrainGeneratorNode` | [`node`](#node-63)  |  |
...
```cpp
TerrainGeneratorNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainGeneratorNodeView.cs:15

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-161) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainGeneratorNodeView.cs:24
...
| Return | Name | Description |
|--------|------|-------------|
| `Slider` | [`terrainHeight`](#terrainheight)  |  |
| `Slider` | [`lakeDepth`](#lakedepth)  |  |
| `SliderInt` | [`featherDistance`](#featherdistance)  |  |
| `Slider` | [`featherRandomness`](#featherrandomness)  |  |
| `Button` | [`generateButton`](#generatebutton)  |  |
| `ObjectField` | [`lakeMaterial`](#lakematerial)  |  |
...
```cpp
Slider terrainHeight
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainGeneratorNodeView.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainGeneratorNodeView.cs:18
...
```cpp
SliderInt featherDistance
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainGeneratorNodeView.cs:19
...
```cpp
Slider featherRandomness
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainGeneratorNodeView.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainGeneratorNodeView.cs:21
...
```cpp
ObjectField lakeMaterial
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainGeneratorNodeView.cs:22
