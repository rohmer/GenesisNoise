...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/PowNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`addNode`](#addnode-5) | `property` | Declared here |
| [`Enable`](#enable-140) | `function` | Declared here |
| [`value`](#value-35) | `variable` | Declared here |
| [`PowNodeWiew_onPortDisconnected`](#pownodewiew_onportdisconnected) | `function` | Declared here |
| [`PowNodeWiew_onPortConnected`](#pownodewiew_onportconnected) | `function` | Declared here |
| [`UpdateLabel`](#updatelabel-10) | `function` | Declared here |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/PowNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-140) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/PowNodeView.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/PowNodeView.cs:13

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`PowNodeWiew_onPortDisconnected`](#pownodewiew_onportdisconnected) `inline` |  |
| `void` | [`PowNodeWiew_onPortConnected`](#pownodewiew_onportconnected) `inline` |  |
| `void` | [`UpdateLabel`](#updatelabel-10) `inline` |  |

---

{#pownodewiew_onportdisconnected}
...
```cpp
inline void PowNodeWiew_onPortDisconnected(PortView obj)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/PowNodeView.cs:35

---

{#pownodewiew_onportconnected}
...
```cpp
inline void PowNodeWiew_onPortConnected(PortView obj)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/PowNodeView.cs:40
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/PowNodeView.cs:47
