...
```cpp
class Vector2IntParameter
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/NodeGraphProcessor/Runtime/Elements/ExposedParameter.cs:270
...
| Name | Kind | Owner |
|------|------|-------|
| [`value`](#value-24) | `property` | Declared here |
| [`val`](#val-18) | `variable` | Declared here |
...
|--------|------|-------------|
| `override object` | [`value`](#value-24)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/NodeGraphProcessor/Runtime/Elements/ExposedParameter.cs:274

## Private Attributes

| Return | Name | Description |
|--------|------|-------------|
| `Vector2Int` | [`val`](#val-18)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/NodeGraphProcessor/Runtime/Elements/ExposedParameter.cs:272
