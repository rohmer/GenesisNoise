...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomIntNode.cs:14
...
| Name | Kind | Owner |
|------|------|-------|
| [`nodeWidth`](#nodewidth-145) | `property` | Declared here |
| [`name`](#name-410) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-379) | `property` | Declared here |
| [`output`](#output-68) | `variable` | Declared here |
| [`min`](#min-62) | `variable` | Declared here |
| [`max`](#max-62) | `variable` | Declared here |
| [`Process`](#process-9) | `function` | Declared here |
| [`ProcessNode`](#processnode-98) | `function` | Declared here |
...
|--------|------|-------------|
| `override float` | [`nodeWidth`](#nodewidth-145)  |  |
| `override string` | [`name`](#name-410)  |  |
| `override string` | [`NodeGroup`](#nodegroup-379)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomIntNode.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomIntNode.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomIntNode.cs:23

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `int` | [`output`](#output-68)  |  |
| `int` | [`min`](#min-62)  |  |
| `int` | [`max`](#max-62)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomIntNode.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomIntNode.cs:20
...
| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Process`](#process-9) `virtual` `inline` | Override this method to implement custom processing. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomIntNode.cs:24
...
| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-98) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomIntNode.cs:29
