...
```cpp
class EnumSwitchNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/EnumSwitchNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-16) | `property` | Declared here |
| [`Enable`](#enable-104) | `function` | Declared here |
| [`Disable`](#disable-56) | `function` | Declared here |
| [`caseCountField`](#casecountfield) | `variable` | Declared here |
| [`caseLabelsContainer`](#caselabelscontainer) | `variable` | Declared here |
| [`OnSelectionPortChanged`](#onselectionportchanged) | `function` | Declared here |
| [`OnCaseCountChanged`](#oncasecountchanged) | `function` | Declared here |
| [`RefreshCaseLabels`](#refreshcaselabels) | `function` | Declared here |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/EnumSwitchNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-104) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-56) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/EnumSwitchNodeView.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/EnumSwitchNodeView.cs:40
...
| Return | Name | Description |
|--------|------|-------------|
| `IntegerField` | [`caseCountField`](#casecountfield)  |  |
| `VisualElement` | [`caseLabelsContainer`](#caselabelscontainer)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/EnumSwitchNodeView.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/EnumSwitchNodeView.cs:15

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`OnSelectionPortChanged`](#onselectionportchanged) `inline` |  |
| `void` | [`OnCaseCountChanged`](#oncasecountchanged) `inline` |  |
| `void` | [`RefreshCaseLabels`](#refreshcaselabels) `inline` |  |

---

{#onselectionportchanged}
...
```cpp
inline void OnSelectionPortChanged(PortView port)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/EnumSwitchNodeView.cs:51
...
```cpp
inline void OnCaseCountChanged(ChangeEvent< int > evt)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/EnumSwitchNodeView.cs:68
...
```cpp
inline void RefreshCaseLabels()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/EnumSwitchNodeView.cs:87
