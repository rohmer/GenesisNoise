...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/GradientNode.cs:14
...
| Name | Kind | Owner |
|------|------|-------|
| [`hasSettings`](#hassettings-12) | `property` | Declared here |
| [`name`](#name-230) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-207) | `property` | Declared here |
| [`texture`](#texture-2) | `variable` | Declared here |
| [`gradient`](#gradient-2) | `variable` | Declared here |
| [`UpdateTexture`](#updatetexture-2) | `function` | Declared here |
| [`Enable`](#enable-33) | `function` | Declared here |
| [`ProcessNode`](#processnode-52) | `function` | Declared here |
| [`pixels`](#pixels-1) | `variable` | Declared here |
...
|--------|------|-------------|
| `override bool` | [`hasSettings`](#hassettings-12)  |  |
| `override string` | [`name`](#name-230)  |  |
| `override string` | [`NodeGroup`](#nodegroup-207)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/GradientNode.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/GradientNode.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/GradientNode.cs:25

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `Texture2D` | [`texture`](#texture-2)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/GradientNode.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/GradientNode.cs:19

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`UpdateTexture`](#updatetexture-2) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/GradientNode.cs:46

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-33) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-52) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/GradientNode.cs:26
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/GradientNode.cs:32
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/GradientNode.cs:44

## Private Static Attributes

| Return | Name | Description |
|--------|------|-------------|
| `const int` | [`SIZE`](#size-5) `static` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/GradientNode.cs:24
