{#nonuniformdirwarpnode}

# NonUniformDirWarpNode

```cpp
class NonUniformDirWarpNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/NonUniformDirWarpNode.cs:24
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-362) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-334) | `property` | Declared here |
| [`ShaderName`](#shadername-268) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-362)  |  |
| `override string` | [`NodeGroup`](#nodegroup-334)  |  |
| `override string` | [`ShaderName`](#shadername-268)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/NonUniformDirWarpNode.cs:26
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/NonUniformDirWarpNode.cs:27
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/NonUniformDirWarpNode.cs:28
