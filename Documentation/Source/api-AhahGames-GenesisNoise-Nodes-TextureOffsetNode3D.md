...
```cpp
class TextureOffsetNode3D
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/3DTextureOffsetNode.cs:11
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-518) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-477) | `property` | Declared here |
| [`ShaderName`](#shadername-377) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-518)  |  |
| `override string` | [`NodeGroup`](#nodegroup-477)  |  |
| `override string` | [`ShaderName`](#shadername-377)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/3DTextureOffsetNode.cs:13
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/3DTextureOffsetNode.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/3DTextureOffsetNode.cs:15
