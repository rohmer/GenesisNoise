...
```cpp
class FlowAccumulationNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/FlowAccumulationNode.cs:14

> **Inherits:** [`AhahGames.GenesisNoise.Nodes.FlowEffectNodeBase`](api-AhahGames-GenesisNoise-Nodes-FlowEffectNodeBase.md#floweffectnodebase)

## List of all members

| Name | Kind | Owner |
|------|------|-------|
| [`Mode`](#mode-11) | `property` | Declared here |
| [`name`](#name-201) | `property` | Declared here |
| [`ShaderName`](#shadername-150) | `property` | Declared here |
| [`Mode`](api-AhahGames-GenesisNoise-Nodes-FlowEffectNodeBase.md#mode-12) | `property` | Inherited from [`FlowEffectNodeBase`](api-AhahGames-GenesisNoise-Nodes-FlowEffectNodeBase.md#floweffectnodebase) |
| [`NodeGroup`](api-AhahGames-GenesisNoise-Nodes-FlowEffectNodeBase.md#nodegroup-179) | `property` | Inherited from [`FlowEffectNodeBase`](api-AhahGames-GenesisNoise-Nodes-FlowEffectNodeBase.md#floweffectnodebase) |
| [`filteredOutProperties`](api-AhahGames-GenesisNoise-Nodes-FlowEffectNodeBase.md#filteredoutproperties-55) | `property` | Inherited from [`FlowEffectNodeBase`](api-AhahGames-GenesisNoise-Nodes-FlowEffectNodeBase.md#floweffectnodebase) |
| [`ProcessNode`](api-AhahGames-GenesisNoise-Nodes-FlowEffectNodeBase.md#processnode-45) | `function` | Inherited from [`FlowEffectNodeBase`](api-AhahGames-GenesisNoise-Nodes-FlowEffectNodeBase.md#floweffectnodebase) |
...
## Inherited from [`FlowEffectNodeBase`](api-AhahGames-GenesisNoise-Nodes-FlowEffectNodeBase.md#floweffectnodebase)

| Kind | Name | Description |
|------|------|-------------|
| `property` | [`Mode`](api-AhahGames-GenesisNoise-Nodes-FlowEffectNodeBase.md#mode-12)  |  |
| `property` | [`NodeGroup`](api-AhahGames-GenesisNoise-Nodes-FlowEffectNodeBase.md#nodegroup-179)  |  |
| `property` | [`filteredOutProperties`](api-AhahGames-GenesisNoise-Nodes-FlowEffectNodeBase.md#filteredoutproperties-55)  |  |
| `function` | [`ProcessNode`](api-AhahGames-GenesisNoise-Nodes-FlowEffectNodeBase.md#processnode-45) `virtual` `inline` |  |
...
|--------|------|-------------|
| `override int` | [`Mode`](#mode-11)  |  |
| `override string` | [`name`](#name-201)  |  |
| `override string` | [`ShaderName`](#shadername-150)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/FlowAccumulationNode.cs:16
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/FlowAccumulationNode.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/FlowAccumulationNode.cs:19
