{#directionalnoise3node}

# DirectionalNoise3Node

```cpp
class DirectionalNoise3Node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/DirectionalNoise3Node.cs:17
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-145) | `property` | Declared here |
| [`ShaderName`](#shadername-102) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-126) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-145)  |  |
| `override string` | [`ShaderName`](#shadername-102)  |  |
| `override string` | [`NodeGroup`](#nodegroup-126)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/DirectionalNoise3Node.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/DirectionalNoise3Node.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/DirectionalNoise3Node.cs:21
