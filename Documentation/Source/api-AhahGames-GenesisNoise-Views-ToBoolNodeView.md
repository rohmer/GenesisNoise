...
```cpp
class ToBoolNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Cast/ToBoolNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`boolNode`](#boolnode-2) | `property` | Declared here |
| [`Enable`](#enable-170) | `function` | Declared here |
| [`toggle`](#toggle-1) | `variable` | Declared here |
| [`UpdateLabel`](#updatelabel-15) | `function` | Declared here |
...
|--------|------|-------------|
| `ToBoolNode` | [`boolNode`](#boolnode-2)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Cast/ToBoolNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-170) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Cast/ToBoolNodeView.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Cast/ToBoolNodeView.cs:13

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`UpdateLabel`](#updatelabel-15) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Cast/ToBoolNodeView.cs:34
