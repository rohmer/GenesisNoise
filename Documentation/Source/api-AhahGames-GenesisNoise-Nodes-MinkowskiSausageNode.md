{#minkowskisausagenode}

# MinkowskiSausageNode

```cpp
class MinkowskiSausageNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Shape/MinkowskiSausageNode.cs:17
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-339) | `property` | Declared here |
| [`ShaderName`](#shadername-253) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-311) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-339)  |  |
| `override string` | [`ShaderName`](#shadername-253)  |  |
| `override string` | [`NodeGroup`](#nodegroup-311)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Shape/MinkowskiSausageNode.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Shape/MinkowskiSausageNode.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Shape/MinkowskiSausageNode.cs:21
