{#urpcomplexlitmaterialnodeview}

# URPComplexLitMaterialNodeView

```cpp
class URPComplexLitMaterialNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/URP/URPComplexLitMaterialNodeView.cs:14
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-82) | `property` | Declared here |
| [`Enable`](#enable-182) | `function` | Declared here |
...
|--------|------|-------------|
| `URPComplexLitMaterial` | [`node`](#node-82)  |  |
...
```cpp
URPComplexLitMaterial node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/URP/URPComplexLitMaterialNodeView.cs:16

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-182) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/URP/URPComplexLitMaterialNodeView.cs:18
