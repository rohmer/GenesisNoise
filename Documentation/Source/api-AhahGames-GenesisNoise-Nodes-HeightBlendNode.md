...
```cpp
class HeightBlendNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Operations/HeightBlendNode.cs:27
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-255) | `property` | Declared here |
| [`ShaderName`](#shadername-192) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-231) | `property` | Declared here |
| [`DisplayMaterialInspector`](#displaymaterialinspector-72) | `property` | Declared here |
| [`filteredOutProperties`](#filteredoutproperties-76) | `property` | Declared here |
| [`maskOutput`](#maskoutput) | `variable` | Declared here |
| [`GetCustomRenderTextures`](#getcustomrendertextures) | `function` | Declared here |
| [`ProcessNode`](#processnode-55) | `function` | Declared here |
| [`Disable`](#disable-19) | `function` | Declared here |
| [`maskMaterial`](#maskmaterial) | `variable` | Declared here |
| [`EnsureMaskMaterial`](#ensuremaskmaterial) | `function` | Declared here |
| [`OutputModeProperty`](#outputmodeproperty) | `variable` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-255)  |  |
| `override string` | [`ShaderName`](#shadername-192)  |  |
| `override string` | [`NodeGroup`](#nodegroup-231)  |  |
| `override bool` | [`DisplayMaterialInspector`](#displaymaterialinspector-72)  |  |
| `override IEnumerable< string >` | [`filteredOutProperties`](#filteredoutproperties-76)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Operations/HeightBlendNode.cs:29
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Operations/HeightBlendNode.cs:30
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Operations/HeightBlendNode.cs:31

---

{#displaymaterialinspector-72}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Operations/HeightBlendNode.cs:32

---

{#filteredoutproperties-76}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Operations/HeightBlendNode.cs:41

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `CustomRenderTexture` | [`maskOutput`](#maskoutput)  |  |
...
```cpp
CustomRenderTexture maskOutput
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Operations/HeightBlendNode.cs:37

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override IEnumerable< CustomRenderTexture >` | [`GetCustomRenderTextures`](#getcustomrendertextures) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Operations/HeightBlendNode.cs:63
...
| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-55) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-19) `virtual` `inline` | Called when the node is disabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Operations/HeightBlendNode.cs:44
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Operations/HeightBlendNode.cs:72
...
| Return | Name | Description |
|--------|------|-------------|
| `Material` | [`maskMaterial`](#maskmaterial)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Operations/HeightBlendNode.cs:39

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`EnsureMaskMaterial`](#ensuremaskmaterial) `inline` |  |
...
```cpp
inline void EnsureMaskMaterial()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Operations/HeightBlendNode.cs:81

## Private Static Attributes

| Return | Name | Description |
|--------|------|-------------|
| `const string` | [`OutputModeProperty`](#outputmodeproperty) `static` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Operations/HeightBlendNode.cs:34
