...
```cpp
class DivideNodeWiew
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/DivideNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`divideNode`](#dividenode-1) | `property` | Declared here |
| [`Enable`](#enable-103) | `function` | Declared here |
| [`value`](#value-33) | `variable` | Declared here |
| [`DivideNodeWiew_onPortDisconnected`](#dividenodewiew_onportdisconnected) | `function` | Declared here |
| [`DivideNodeWiew_onPortConnected`](#dividenodewiew_onportconnected) | `function` | Declared here |
| [`Process`](#process-28) | `function` | Declared here |
| [`UpdateLabel`](#updatelabel-6) | `function` | Declared here |
...
|--------|------|-------------|
| `DivideNode` | [`divideNode`](#dividenode-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/DivideNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-103) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/DivideNodeView.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/DivideNodeView.cs:13

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`DivideNodeWiew_onPortDisconnected`](#dividenodewiew_onportdisconnected) `inline` |  |
| `void` | [`DivideNodeWiew_onPortConnected`](#dividenodewiew_onportconnected) `inline` |  |
| `void` | [`Process`](#process-28) `inline` |  |
| `void` | [`UpdateLabel`](#updatelabel-6) `inline` |  |

---

{#dividenodewiew_onportdisconnected}
...
```cpp
inline void DivideNodeWiew_onPortDisconnected(PortView obj)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/DivideNodeView.cs:35

---

{#dividenodewiew_onportconnected}
...
```cpp
inline void DivideNodeWiew_onPortConnected(PortView obj)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/DivideNodeView.cs:40
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/DivideNodeView.cs:48
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/DivideNodeView.cs:59
