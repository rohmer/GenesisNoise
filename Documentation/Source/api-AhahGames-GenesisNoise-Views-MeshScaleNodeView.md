...
```cpp
class MeshScaleNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshScaleNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-35) | `property` | Declared here |
| [`Enable`](#enable-130) | `function` | Declared here |
| [`scaleX`](#scalex-1) | `variable` | Declared here |
| [`scaleY`](#scaley-1) | `variable` | Declared here |
| [`scaleZ`](#scalez-1) | `variable` | Declared here |
| [`CreateScaleField`](#createscalefield) | `function` | Declared here |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshScaleNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-130) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshScaleNodeView.cs:18

## Private Attributes

| Return | Name | Description |
|--------|------|-------------|
| `FloatField` | [`scaleX`](#scalex-1)  |  |
| `FloatField` | [`scaleY`](#scaley-1)  |  |
| `FloatField` | [`scaleZ`](#scalez-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshScaleNodeView.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshScaleNodeView.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshScaleNodeView.cs:16

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `FloatField` | [`CreateScaleField`](#createscalefield) `inline` |  |
...
```cpp
inline FloatField CreateScaleField(string label, float value, System.Action< float > setValue)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshScaleNodeView.cs:32
