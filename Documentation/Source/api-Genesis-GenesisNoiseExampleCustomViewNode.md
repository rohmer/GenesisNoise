{#genesisnoiseexamplecustomviewnode}

# GenesisNoiseExampleCustomViewNode

```cpp
class GenesisNoiseExampleCustomViewNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Examples/Nodes/Shader Node - Custom View/GenesisNoiseExampleCustomView.cs:11
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name) | `property` | Declared here |
| [`ShaderName`](#shadername) | `property` | Declared here |
| [`DisplayMaterialInspector`](#displaymaterialinspector) | `property` | Declared here |
| [`filteredOutProperties`](#filteredoutproperties) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name)  | The name of the node, which will be displayed in the node graph. You can change this to whatever you want. |
| `override string` | [`ShaderName`](#shadername)  | The name of the shader, this will be the same as the first line of your shader file. For example: Shader "Hidden/Genesis/MyCustomShader". |
| `override bool` | [`DisplayMaterialInspector`](#displaymaterialinspector)  | If true, the node will display the material inspector for the shader. If false, the node will not display the material inspector. You may want to not show the default if you are planning on writing a custom view for this node. |
| `override IEnumerable< string >` | [`filteredOutProperties`](#filteredoutproperties)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Examples/Nodes/Shader Node - Custom View/GenesisNoiseExampleCustomView.cs:16
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Examples/Nodes/Shader Node - Custom View/GenesisNoiseExampleCustomView.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Examples/Nodes/Shader Node - Custom View/GenesisNoiseExampleCustomView.cs:29
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Examples/Nodes/Shader Node - Custom View/GenesisNoiseExampleCustomView.cs:32
