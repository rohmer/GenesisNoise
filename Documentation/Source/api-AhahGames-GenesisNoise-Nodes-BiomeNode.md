...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeNode.cs:17
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-53) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-10) | `property` | Declared here |
| [`hasPreview`](#haspreview-13) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-19) | `property` | Declared here |
| [`Enable`](#enable-19) | `function` | Declared here |
| [`ProcessNode`](#processnode-18) | `function` | Declared here |
| [`PullInputs`](#pullinputs-1) | `function` | Declared here |
| [`PullDecorations`](#pulldecorations) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-53)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-10)  |  |
| `override bool` | [`hasPreview`](#haspreview-13)  |  |
| `override float` | [`nodeWidth`](#nodewidth-19)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeNode.cs:29

---

{#showdefaultinspector-10}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeNode.cs:30
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeNode.cs:31
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeNode.cs:32

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-19) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-18) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeNode.cs:34
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeNode.cs:64
...
| Return | Name | Description |
|--------|------|-------------|
| `void` | [`PullInputs`](#pullinputs-1) `inline` |  |
| `void` | [`PullDecorations`](#pulldecorations) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeNode.cs:42
...
```cpp
inline void PullDecorations(List< SerializableEdge > inputEdges)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeNode.cs:52
