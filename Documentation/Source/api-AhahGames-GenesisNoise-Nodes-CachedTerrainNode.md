...
```cpp
class CachedTerrainNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/CachedTerrainNode.cs:6

> **Inherits:** [`AhahGames.GenesisNoise.Nodes.GenesisNode`](api-AhahGames-GenesisNoise-Nodes-GenesisNode.md#genesisnode)
> **Subclassed by:** [`AhahGames.GenesisNoise.Assets.Packages.com.ahahgames.genesisnoise.Runtime.Nodes.Terrain.Height.DistanceNoiseHeightNode`](api-AhahGames-GenesisNoise-Assets-Packages-com-ahahgames-genesisnoise-Runtime-Nodes-Terrain-Height-DistanceNoiseHeightNode.md#distancenoiseheightnode), [`AhahGames.GenesisNoise.GNTerrain.Nodes.HydraulicErosionNode`](api-AhahGames-GenesisNoise-GNTerrain-Nodes-HydraulicErosionNode.md#hydraulicerosionnode), [`AhahGames.GenesisNoise.GNTerrain.Nodes.TerrainCurvatureNode`](api-AhahGames-GenesisNoise-GNTerrain-Nodes-TerrainCurvatureNode.md#terraincurvaturenode), [`AhahGames.GenesisNoise.GNTerrain.Nodes.TerrainMoistureMapNode`](api-AhahGames-GenesisNoise-GNTerrain-Nodes-TerrainMoistureMapNode.md#terrainmoisturemapnode), [`AhahGames.GenesisNoise.GNTerrain.Nodes.TerrainSlopeNode`](api-AhahGames-GenesisNoise-GNTerrain-Nodes-TerrainSlopeNode.md#terrainslopenode), [`AhahGames.GenesisNoise.GNTerrain.Nodes.TerrainThermalErosionNode`](api-AhahGames-GenesisNoise-GNTerrain-Nodes-TerrainThermalErosionNode.md#terrainthermalerosionnode), [`AhahGames.GenesisNoise.GNTerrain.Nodes.TerrainWindErosionNode`](api-AhahGames-GenesisNoise-GNTerrain-Nodes-TerrainWindErosionNode.md#terrainwinderosionnode), [`AhahGames.GenesisNoise.GNTerrain.Nodes.TerrainWindFlowMapNode`](api-AhahGames-GenesisNoise-GNTerrain-Nodes-TerrainWindFlowMapNode.md#terrainwindflowmapnode), [`AhahGames.GenesisNoise.Nodes.BiomeDecorationNode`](api-AhahGames-GenesisNoise-Nodes-BiomeDecorationNode.md#biomedecorationnode), [`AhahGames.GenesisNoise.Nodes.BiomeManagerNode`](api-AhahGames-GenesisNoise-Nodes-BiomeManagerNode.md#biomemanagernode), [`AhahGames.GenesisNoise.Nodes.BiomeNode`](api-AhahGames-GenesisNoise-Nodes-BiomeNode.md#biomenode), [`AhahGames.GenesisNoise.Nodes.DistanceHeightNode`](api-AhahGames-GenesisNoise-Nodes-DistanceHeightNode.md#distanceheightnode), [`AhahGames.GenesisNoise.Nodes.IslandGeneratorNode`](api-AhahGames-GenesisNoise-Nodes-IslandGeneratorNode.md#islandgeneratornode), [`AhahGames.GenesisNoise.Nodes.OceanSettingsNode`](api-AhahGames-GenesisNoise-Nodes-OceanSettingsNode.md#oceansettingsnode), [`AhahGames.GenesisNoise.Nodes.TerrainBiomeDecorationNode`](api-AhahGames-GenesisNoise-Nodes-TerrainBiomeDecorationNode.md#terrainbiomedecorationnode), [`AhahGames.GenesisNoise.Nodes.TerrainGaussianBlurNode`](api-AhahGames-GenesisNoise-Nodes-TerrainGaussianBlurNode.md#terraingaussianblurnode), [`AhahGames.GenesisNoise.Nodes.TerrainGeneratorNode`](api-AhahGames-GenesisNoise-Nodes-TerrainGeneratorNode.md#terraingeneratornode), [`AhahGames.GenesisNoise.Nodes.TerrainTextureNode`](api-AhahGames-GenesisNoise-Nodes-TerrainTextureNode.md#terraintexturenode)

## List of all members

| Name | Kind | Owner |
|------|------|-------|
| [`preserveUpstreamCacheOnForceReprocess`](#preserveupstreamcacheonforcereprocess) | `property` | Declared here |
...
|--------|------|-------------|
| `override bool` | [`preserveUpstreamCacheOnForceReprocess`](#preserveupstreamcacheonforcereprocess)  |  |
...
```cpp
override bool preserveUpstreamCacheOnForceReprocess
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/CachedTerrainNode.cs:8
