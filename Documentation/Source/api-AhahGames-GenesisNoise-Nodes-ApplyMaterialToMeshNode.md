{#applymaterialtomeshnode}

# ApplyMaterialToMeshNode

```cpp
class ApplyMaterialToMeshNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/ApplyMaterialToMeshNode.cs:17
...
| Name | Kind | Owner |
|------|------|-------|
| [`hasPreview`](#haspreview-4) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-20) | `property` | Declared here |
| [`name`](#name-32) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-4) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-9) | `property` | Declared here |
| [`previewTexture`](#previewtexture) | `property` | Declared here |
| [`loopInput`](#loopinput) | `variable` | Declared here |
| [`loopOutput`](#loopoutput) | `variable` | Declared here |
| [`input`](#input-6) | `variable` | Declared here |
| [`output`](#output-10) | `variable` | Declared here |
| [`inputMaterial`](#inputmaterial) | `variable` | Declared here |
| [`materialInputs`](#materialinputs) | `variable` | Declared here |
| [`InitializeNodeFromObject`](#initializenodefromobject-1) | `function` | Declared here |
| [`ListMaterialProperties`](#listmaterialproperties) | `function` | Declared here |
| [`SetMaterial`](#setmaterial) | `function` | Declared here |
| [`Enable`](#enable-12) | `function` | Declared here |
| [`GetMaterialInputs`](#getmaterialinputs) | `function` | Declared here |
| [`ProcessNode`](#processnode-9) | `function` | Declared here |
| [`UpdatePreview`](#updatepreview) | `function` | Declared here |
| [`GetMaterialForPorts`](#getmaterialforports) | `function` | Declared here |
| [`EnsureRenderer`](#ensurerenderer) | `function` | Declared here |
| [`IsColorOrTextureProperty`](#iscolorortextureproperty) | `function` | Declared here |
...
|--------|------|-------------|
| `override bool` | [`hasPreview`](#haspreview-4)  |  |
| `override string` | [`NodeGroup`](#nodegroup-20)  |  |
| `override string` | [`name`](#name-32)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-4)  |  |
| `override float` | [`nodeWidth`](#nodewidth-9)  |  |
| `override Texture` | [`previewTexture`](#previewtexture)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/ApplyMaterialToMeshNode.cs:43
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/ApplyMaterialToMeshNode.cs:44
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/ApplyMaterialToMeshNode.cs:45

---

{#showdefaultinspector-4}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/ApplyMaterialToMeshNode.cs:46
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/ApplyMaterialToMeshNode.cs:47
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/ApplyMaterialToMeshNode.cs:50

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `object` | [`loopInput`](#loopinput)  |  |
| `object` | [`loopOutput`](#loopoutput)  |  |
| `GameObject` | [`input`](#input-6)  |  |
| `GameObject` | [`output`](#output-10)  |  |
| `Material` | [`inputMaterial`](#inputmaterial)  |  |
| `List< object >` | [`materialInputs`](#materialinputs)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/ApplyMaterialToMeshNode.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/ApplyMaterialToMeshNode.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/ApplyMaterialToMeshNode.cs:26
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/ApplyMaterialToMeshNode.cs:29
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/ApplyMaterialToMeshNode.cs:32
...
```cpp
List< object > materialInputs = new()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/ApplyMaterialToMeshNode.cs:35

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `bool` | [`InitializeNodeFromObject`](#initializenodefromobject-1) `inline` |  |
| `IEnumerable< PortData >` | [`ListMaterialProperties`](#listmaterialproperties) `inline` |  |
| `void` | [`SetMaterial`](#setmaterial) `inline` |  |

---

{#initializenodefromobject-1}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/ApplyMaterialToMeshNode.cs:59
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/ApplyMaterialToMeshNode.cs:66
...
```cpp
inline void SetMaterial(Material newMaterial, bool refreshPorts = true)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/ApplyMaterialToMeshNode.cs:93

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-12) `virtual` `inline` | Called when the node is enabled. |
| `void` | [`GetMaterialInputs`](#getmaterialinputs) `inline` |  |
| `override bool` | [`ProcessNode`](#processnode-9) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/ApplyMaterialToMeshNode.cs:52
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/ApplyMaterialToMeshNode.cs:77
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/ApplyMaterialToMeshNode.cs:84
...
| Return | Name | Description |
|--------|------|-------------|
| `void` | [`UpdatePreview`](#updatepreview) `inline` |  |
| `Material` | [`GetMaterialForPorts`](#getmaterialforports) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/ApplyMaterialToMeshNode.cs:178
...
```cpp
inline Material GetMaterialForPorts()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/ApplyMaterialToMeshNode.cs:193

## Private Static Methods

| Return | Name | Description |
|--------|------|-------------|
| `Renderer` | [`EnsureRenderer`](#ensurerenderer) `static` `inline` |  |
| `bool` | [`IsColorOrTextureProperty`](#iscolorortextureproperty) `static` `inline` |  |
...
```cpp
static inline Renderer EnsureRenderer(GameObject target)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/ApplyMaterialToMeshNode.cs:148

---

{#iscolorortextureproperty}
...
```cpp
static inline bool IsColorOrTextureProperty(Material targetMaterial, string propertyName)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/ApplyMaterialToMeshNode.cs:195
