...
```cpp
class SubtractTextureNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/SubtractTexture.cs:15

> **Inherits:** [`AhahGames.GenesisNoise.Nodes.TextureMathNode`](api-AhahGames-GenesisNoise-Nodes-TextureMathNode.md#texturemathnode)

## List of all members

| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-497) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-462) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-66) | `property` | Declared here |
| [`hasPreview`](#haspreview-77) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-171) | `property` | Declared here |
| [`Enable`](#enable-74) | `function` | Declared here |
| [`ProcessNode`](#processnode-122) | `function` | Declared here |
| [`inputA`](api-AhahGames-GenesisNoise-Nodes-TextureMathNode.md#inputa-36) | `variable` | Inherited from [`TextureMathNode`](api-AhahGames-GenesisNoise-Nodes-TextureMathNode.md#texturemathnode) |
| [`inputB`](api-AhahGames-GenesisNoise-Nodes-TextureMathNode.md#inputb-10) | `variable` | Inherited from [`TextureMathNode`](api-AhahGames-GenesisNoise-Nodes-TextureMathNode.md#texturemathnode) |
| [`output`](api-AhahGames-GenesisNoise-Nodes-TextureMathNode.md#output-95) | `variable` | Inherited from [`TextureMathNode`](api-AhahGames-GenesisNoise-Nodes-TextureMathNode.md#texturemathnode) |
...
## Inherited from [`TextureMathNode`](api-AhahGames-GenesisNoise-Nodes-TextureMathNode.md#texturemathnode)

| Kind | Name | Description |
|------|------|-------------|
| `variable` | [`inputA`](api-AhahGames-GenesisNoise-Nodes-TextureMathNode.md#inputa-36)  |  |
| `variable` | [`inputB`](api-AhahGames-GenesisNoise-Nodes-TextureMathNode.md#inputb-10)  |  |
| `variable` | [`output`](api-AhahGames-GenesisNoise-Nodes-TextureMathNode.md#output-95)  |  |
...
|--------|------|-------------|
| `override string` | [`name`](#name-497)  |  |
| `override string` | [`NodeGroup`](#nodegroup-462)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-66)  |  |
| `override bool` | [`hasPreview`](#haspreview-77)  |  |
| `override float` | [`nodeWidth`](#nodewidth-171)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/SubtractTexture.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/SubtractTexture.cs:18

---

{#showdefaultinspector-66}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/SubtractTexture.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/SubtractTexture.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/SubtractTexture.cs:22

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-74) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-122) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/SubtractTexture.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/SubtractTexture.cs:29
