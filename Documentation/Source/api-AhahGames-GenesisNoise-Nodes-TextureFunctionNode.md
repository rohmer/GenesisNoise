...
```cpp
class TextureFunctionNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/TextureMathNode.cs:9

> **Inherits:** [`AhahGames.GenesisNoise.Nodes.GenesisNode`](api-AhahGames-GenesisNoise-Nodes-GenesisNode.md#genesisnode)
> **Subclassed by:** [`AhahGames.GenesisNoise.Nodes.ABSTextureNode`](api-AhahGames-GenesisNoise-Nodes-ABSTextureNode.md#abstexturenode), [`AhahGames.GenesisNoise.Nodes.ACosTextureNode`](api-AhahGames-GenesisNoise-Nodes-ACosTextureNode.md#acostexturenode), [`AhahGames.GenesisNoise.Nodes.ASinTextureNode`](api-AhahGames-GenesisNoise-Nodes-ASinTextureNode.md#asintexturenode), [`AhahGames.GenesisNoise.Nodes.ATanTextureNode`](api-AhahGames-GenesisNoise-Nodes-ATanTextureNode.md#atantexturenode), [`AhahGames.GenesisNoise.Nodes.CosHTextureNode`](api-AhahGames-GenesisNoise-Nodes-CosHTextureNode.md#coshtexturenode), [`AhahGames.GenesisNoise.Nodes.ExpTextureNode`](api-AhahGames-GenesisNoise-Nodes-ExpTextureNode.md#exptexturenode), [`AhahGames.GenesisNoise.Nodes.InvertTextureNode`](api-AhahGames-GenesisNoise-Nodes-InvertTextureNode.md#inverttexturenode), [`AhahGames.GenesisNoise.Nodes.Log2ATextureNode`](api-AhahGames-GenesisNoise-Nodes-Log2ATextureNode.md#log2atexturenode), [`AhahGames.GenesisNoise.Nodes.LogATextureNode`](api-AhahGames-GenesisNoise-Nodes-LogATextureNode.md#logatexturenode), [`AhahGames.GenesisNoise.Nodes.RoundTextureNode`](api-AhahGames-GenesisNoise-Nodes-RoundTextureNode.md#roundtexturenode), [`AhahGames.GenesisNoise.Nodes.SinHTextureNode`](api-AhahGames-GenesisNoise-Nodes-SinHTextureNode.md#sinhtexturenode), [`AhahGames.GenesisNoise.Nodes.SmoothStepTexture`](api-AhahGames-GenesisNoise-Nodes-SmoothStepTexture.md#smoothsteptexture), [`AhahGames.GenesisNoise.Nodes.SqrtTextureNode`](api-AhahGames-GenesisNoise-Nodes-SqrtTextureNode.md#sqrttexturenode), [`AhahGames.GenesisNoise.Nodes.TanHTextureNode`](api-AhahGames-GenesisNoise-Nodes-TanHTextureNode.md#tanhtexturenode), [`AhahGames.GenesisNoise.Nodes.TextureMathNode`](api-AhahGames-GenesisNoise-Nodes-TextureMathNode.md#texturemathnode)

## List of all members

| Name | Kind | Owner |
|------|------|-------|
| [`previewTexture`](#previewtexture-47) | `property` | Declared here |
| [`shader`](#shader-4) | `variable` | Declared here |
| [`kernel`](#kernel-1) | `variable` | Declared here |
| [`EnsureOutput`](#ensureoutput-3) | `function` | Declared here |
| [`LoadFunctionShader`](#loadfunctionshader) | `function` | Declared here |
| [`GetKernel`](#getkernel) | `function` | Declared here |
| [`Dispatch2D`](#dispatch2d) | `function` | Declared here |
| [`Disable`](#disable-47) | `function` | Declared here |
| [`managedOutput`](#managedoutput) | `variable` | Declared here |
...
|--------|------|-------------|
| `override Texture` | [`previewTexture`](#previewtexture-47)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/TextureMathNode.cs:16

## Protected Attributes

| Return | Name | Description |
|--------|------|-------------|
| `ComputeShader` | [`shader`](#shader-4)  |  |
| `int` | [`kernel`](#kernel-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/TextureMathNode.cs:11
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/TextureMathNode.cs:12

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`EnsureOutput`](#ensureoutput-3) `inline` |  |
| `ComputeShader` | [`LoadFunctionShader`](#loadfunctionshader) `inline` |  |
| `int` | [`GetKernel`](#getkernel) `inline` |  |
| `void` | [`Dispatch2D`](#dispatch2d) `inline` |  |
| `override void` | [`Disable`](#disable-47) `virtual` `inline` | Called when the node is disabled. |
...
```cpp
inline void EnsureOutput(ref RenderTexture output, int width, int height)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/TextureMathNode.cs:18
...
```cpp
inline ComputeShader LoadFunctionShader(string resourcePath)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/TextureMathNode.cs:47
...
```cpp
inline int GetKernel(string kernelName = "CSMain")
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/TextureMathNode.cs:58
...
```cpp
inline void Dispatch2D(int width, int height)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/TextureMathNode.cs:66
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/TextureMathNode.cs:76
...
| Return | Name | Description |
|--------|------|-------------|
| `RenderTexture` | [`managedOutput`](#managedoutput)  |  |
...
```cpp
RenderTexture managedOutput
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/TextureMathNode.cs:14
