{#randomvector2nodeview}

# RandomVector2NodeView

```cpp
class RandomVector2NodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomVector2NodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-54) | `property` | Declared here |
| [`Enable`](#enable-151) | `function` | Declared here |
| [`Disable`](#disable-73) | `function` | Declared here |
| [`xMinField`](#xminfield) | `variable` | Declared here |
| [`xMaxField`](#xmaxfield) | `variable` | Declared here |
| [`yMinField`](#yminfield) | `variable` | Declared here |
| [`yMaxField`](#ymaxfield) | `variable` | Declared here |
| [`RefreshOutputs`](#refreshoutputs-16) | `function` | Declared here |
...
|--------|------|-------------|
| `RandomVector2Node` | [`node`](#node-54)  |  |
...
```cpp
RandomVector2Node node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomVector2NodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-151) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-73) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomVector2NodeView.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomVector2NodeView.cs:67
...
| Return | Name | Description |
|--------|------|-------------|
| `FloatField` | [`xMinField`](#xminfield)  |  |
| `FloatField` | [`xMaxField`](#xmaxfield)  |  |
| `FloatField` | [`yMinField`](#yminfield)  |  |
| `FloatField` | [`yMaxField`](#ymaxfield)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomVector2NodeView.cs:13
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomVector2NodeView.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomVector2NodeView.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomVector2NodeView.cs:16

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RefreshOutputs`](#refreshoutputs-16) `inline` |  |
...
```cpp
inline void RefreshOutputs()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomVector2NodeView.cs:73
