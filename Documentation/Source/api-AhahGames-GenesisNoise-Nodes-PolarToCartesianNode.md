{#polartocartesiannode}

# PolarToCartesianNode

```cpp
class PolarToCartesianNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/PolarToCartesianNode.cs:17
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-396) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-365) | `property` | Declared here |
| [`ShaderName`](#shadername-298) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-396)  |  |
| `override string` | [`NodeGroup`](#nodegroup-365)  |  |
| `override string` | [`ShaderName`](#shadername-298)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/PolarToCartesianNode.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/PolarToCartesianNode.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/PolarToCartesianNode.cs:21
