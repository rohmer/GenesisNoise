...
```cpp
class StringNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Constant/StringNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-58) | `property` | Declared here |
| [`Enable`](#enable-156) | `function` | Declared here |
| [`editorField`](#editorfield-3) | `variable` | Declared here |
| [`UpdateLabel`](#updatelabel-13) | `function` | Declared here |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Constant/StringNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-156) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Constant/StringNodeView.cs:15
...
| Return | Name | Description |
|--------|------|-------------|
| `TextField` | [`editorField`](#editorfield-3)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Constant/StringNodeView.cs:13

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`UpdateLabel`](#updatelabel-13) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Constant/StringNodeView.cs:32
