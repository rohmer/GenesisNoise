...
```cpp
class ToVector3IntNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToVector3IntNode.cs:13
...
| Name | Kind | Owner |
|------|------|-------|
| [`nodeWidth`](#nodewidth-192) | `property` | Declared here |
| [`name`](#name-539) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-495) | `property` | Declared here |
| [`output`](#output-105) | `variable` | Declared here |
| [`Process`](#process-25) | `function` | Declared here |
| [`X`](#x-26) | `variable` | Declared here |
| [`Y`](#y-23) | `variable` | Declared here |
| [`Z`](#z-12) | `variable` | Declared here |
...
|--------|------|-------------|
| `override float` | [`nodeWidth`](#nodewidth-192)  |  |
| `override string` | [`name`](#name-539)  |  |
| `override string` | [`NodeGroup`](#nodegroup-495)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToVector3IntNode.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToVector3IntNode.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToVector3IntNode.cs:21

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `Vector3Int` | [`output`](#output-105)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToVector3IntNode.cs:18

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Process`](#process-25) `virtual` `inline` | Override this method to implement custom processing. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToVector3IntNode.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToVector3IntNode.cs:15
