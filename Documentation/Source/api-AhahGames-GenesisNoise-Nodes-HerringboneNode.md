...
```cpp
class HerringboneNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Shape/HerringboneNode.cs:23

> **Inherits:** [`FixedNoiseNode`](api-FixedNoiseNode.md#fixednoisenode)

## List of all members

| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-261) | `property` | Declared here |
| [`ShaderName`](#shadername-198) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-237) | `property` | Declared here |
| [`filteredOutProperties`](#filteredoutproperties-80) | `property` | Declared here |
| [`horizontalMask`](#horizontalmask) | `variable` | Declared here |
| [`verticalMask`](#verticalmask) | `variable` | Declared here |
| [`GetCustomRenderTextures`](#getcustomrendertextures-1) | `function` | Declared here |
| [`ProcessNode`](#processnode-56) | `function` | Declared here |
| [`Disable`](#disable-20) | `function` | Declared here |
| [`horizontalMaskMaterial`](#horizontalmaskmaterial) | `variable` | Declared here |
| [`verticalMaskMaterial`](#verticalmaskmaterial) | `variable` | Declared here |
| [`EnsureMaskMaterials`](#ensuremaskmaterials) | `function` | Declared here |
| [`CopyMaterialProperties`](#copymaterialproperties) | `function` | Declared here |
| [`OutputModeProperty`](#outputmodeproperty-1) | `variable` | Declared here |
| [`DisplayMaterialInspector`](api-FixedNoiseNode.md#displaymaterialinspector-3) | `property` | Inherited from [`FixedNoiseNode`](api-FixedNoiseNode.md#fixednoisenode) |
| [`NodeGroup`](api-FixedNoiseNode.md#nodegroup-1) | `property` | Inherited from [`FixedNoiseNode`](api-FixedNoiseNode.md#fixednoisenode) |
| [`defaultPreviewChannels`](api-FixedNoiseNode.md#defaultpreviewchannels) | `property` | Inherited from [`FixedNoiseNode`](api-FixedNoiseNode.md#fixednoisenode) |
| [`filteredOutProperties`](api-FixedNoiseNode.md#filteredoutproperties-3) | `property` | Inherited from [`FixedNoiseNode`](api-FixedNoiseNode.md#fixednoisenode) |
| [`ProcessNode`](api-FixedNoiseNode.md#processnode) | `function` | Inherited from [`FixedNoiseNode`](api-FixedNoiseNode.md#fixednoisenode) |
...
## Inherited from [`FixedNoiseNode`](api-FixedNoiseNode.md#fixednoisenode)

| Kind | Name | Description |
|------|------|-------------|
| `property` | [`DisplayMaterialInspector`](api-FixedNoiseNode.md#displaymaterialinspector-3)  |  |
| `property` | [`NodeGroup`](api-FixedNoiseNode.md#nodegroup-1)  |  |
| `property` | [`defaultPreviewChannels`](api-FixedNoiseNode.md#defaultpreviewchannels)  |  |
| `property` | [`filteredOutProperties`](api-FixedNoiseNode.md#filteredoutproperties-3)  |  |
| `function` | [`ProcessNode`](api-FixedNoiseNode.md#processnode) `virtual` `inline` |  |
...
|--------|------|-------------|
| `override string` | [`name`](#name-261)  |  |
| `override string` | [`ShaderName`](#shadername-198)  |  |
| `override string` | [`NodeGroup`](#nodegroup-237)  |  |
| `override IEnumerable< string >` | [`filteredOutProperties`](#filteredoutproperties-80)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Shape/HerringboneNode.cs:36
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Shape/HerringboneNode.cs:37
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Shape/HerringboneNode.cs:38

---

{#filteredoutproperties-80}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Shape/HerringboneNode.cs:40

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `CustomRenderTexture` | [`horizontalMask`](#horizontalmask)  |  |
| `CustomRenderTexture` | [`verticalMask`](#verticalmask)  |  |
...
```cpp
CustomRenderTexture horizontalMask
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Shape/HerringboneNode.cs:26
...
```cpp
CustomRenderTexture verticalMask
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Shape/HerringboneNode.cs:29

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override IEnumerable< CustomRenderTexture >` | [`GetCustomRenderTextures`](#getcustomrendertextures-1) `virtual` `inline` |  |

---

{#getcustomrendertextures-1}
...
```cpp
virtual inline override IEnumerable< CustomRenderTexture > GetCustomRenderTextures()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Shape/HerringboneNode.cs:65
...
| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-56) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-20) `virtual` `inline` | Called when the node is disabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Shape/HerringboneNode.cs:42
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Shape/HerringboneNode.cs:77
...
| Return | Name | Description |
|--------|------|-------------|
| `Material` | [`horizontalMaskMaterial`](#horizontalmaskmaterial)  |  |
| `Material` | [`verticalMaskMaterial`](#verticalmaskmaterial)  |  |

---

{#horizontalmaskmaterial}

### horizontalMaskMaterial

```cpp
Material horizontalMaskMaterial
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Shape/HerringboneNode.cs:33

---

{#verticalmaskmaterial}

### verticalMaskMaterial

```cpp
Material verticalMaskMaterial
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Shape/HerringboneNode.cs:34

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`EnsureMaskMaterials`](#ensuremaskmaterials) `inline` |  |
| `void` | [`CopyMaterialProperties`](#copymaterialproperties) `inline` |  |
...
```cpp
inline void EnsureMaskMaterials()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Shape/HerringboneNode.cs:90
...
```cpp
inline void CopyMaterialProperties(Material source, Material destination)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Shape/HerringboneNode.cs:109

## Private Static Attributes

| Return | Name | Description |
|--------|------|-------------|
| `const string` | [`OutputModeProperty`](#outputmodeproperty-1) `static` |  |

---

{#outputmodeproperty-1}
...
```cpp
const string OutputModeProperty = "_OutputMode"
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Shape/HerringboneNode.cs:31
