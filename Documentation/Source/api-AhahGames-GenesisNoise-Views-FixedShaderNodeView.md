...
```cpp
class FixedShaderNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/FixedShaderNodeView.cs:17
...
> **Subclassed by:** [`AhahGames.GenesisNoise.Views.CurveNodeView`](api-AhahGames-GenesisNoise-Views-CurveNodeView.md#curvenodeview), [`AhahGames.GenesisNoise.Views.GradientMapNodeView`](api-AhahGames-GenesisNoise-Views-GradientMapNodeView.md#gradientmapnodeview), [`AhahGames.GenesisNoise.Views.TileGeneratorColorNodeView`](api-AhahGames-GenesisNoise-Views-TileGeneratorColorNodeView.md#tilegeneratorcolornodeview), [`AhahGames.GenesisNoise.Views.TileGeneratorGrayscaleNodeView`](api-AhahGames-GenesisNoise-Views-TileGeneratorGrayscaleNodeView.md#tilegeneratorgrayscalenodeview)

## List of all members

| Name | Kind | Owner |
|------|------|-------|
| [`fixedShaderNode`](#fixedshadernode-1) | `property` | Declared here |
| [`Enable`](#enable-106) | `function` | Declared here |
| [`BuildContextualMenu`](#buildcontextualmenu-6) | `function` | Declared here |
| [`OnRemoved`](#onremoved-4) | `function` | Declared here |
| [`MaterialGUI`](#materialgui-2) | `function` | Declared here |
| [`materialHash`](#materialhash-2) | `variable` | Declared here |
| [`debugCustomRenderTextureField`](#debugcustomrendertexturefield-1) | `variable` | Declared here |
| [`debugShaderField`](#debugshaderfield-1) | `variable` | Declared here |
| [`debugMaterialField`](#debugmaterialfield-1) | `variable` | Declared here |
| [`lastModified`](#lastmodified-1) | `variable` | Declared here |
| [`DetectShaderChanges`](#detectshaderchanges-1) | `function` | Declared here |
| [`InitializeDebug`](#initializedebug-2) | `function` | Declared here |
| [`ResetMaterialPropertyToDefault`](#resetmaterialpropertytodefault-3) | `function` | Declared here |
...
|--------|------|-------------|
| `FixedShaderNode` | [`fixedShaderNode`](#fixedshadernode-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/FixedShaderNodeView.cs:19

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-106) `virtual` `inline` |  |
| `override void` | [`BuildContextualMenu`](#buildcontextualmenu-6) `inline` |  |
| `override void` | [`OnRemoved`](#onremoved-4) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/FixedShaderNodeView.cs:28
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/FixedShaderNodeView.cs:153
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/FixedShaderNodeView.cs:166
...
| Return | Name | Description |
|--------|------|-------------|
| `void` | [`MaterialGUI`](#materialgui-2) `virtual` `inline` |  |
...
```cpp
virtual inline void MaterialGUI(bool fromInspector)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/FixedShaderNodeView.cs:123

#### Reimplemented by

- [`MaterialGUI`](api-AhahGames-GenesisNoise-Views-TileGeneratorColorNodeView.md#materialgui-4)
- [`MaterialGUI`](api-AhahGames-GenesisNoise-Views-TileGeneratorGrayscaleNodeView.md#materialgui-5)

## Private Attributes

| Return | Name | Description |
|--------|------|-------------|
| `int` | [`materialHash`](#materialhash-2)  |  |
| `ObjectField` | [`debugCustomRenderTextureField`](#debugcustomrendertexturefield-1)  |  |
| `ObjectField` | [`debugShaderField`](#debugshaderfield-1)  |  |
| `ObjectField` | [`debugMaterialField`](#debugmaterialfield-1)  |  |
| `DateTime` | [`lastModified`](#lastmodified-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/FixedShaderNodeView.cs:20

---

{#debugcustomrendertexturefield-1}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/FixedShaderNodeView.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/FixedShaderNodeView.cs:23

---

{#debugmaterialfield-1}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/FixedShaderNodeView.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/FixedShaderNodeView.cs:26

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`DetectShaderChanges`](#detectshaderchanges-1) `inline` |  |
| `void` | [`InitializeDebug`](#initializedebug-2) `inline` |  |
| `void` | [`ResetMaterialPropertyToDefault`](#resetmaterialpropertytodefault-3) `inline` |  |

---

{#detectshaderchanges-1}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/FixedShaderNodeView.cs:76
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/FixedShaderNodeView.cs:100

---

{#resetmaterialpropertytodefault-3}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/FixedShaderNodeView.cs:144
