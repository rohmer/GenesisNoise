{#symmetricnearestneighbornode}

# SymmetricNearestNeighborNode

```cpp
class SymmetricNearestNeighborNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Enhance/SymmetricNearestNeighborNode.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-502) | `property` | Declared here |
| [`ShaderName`](#shadername-373) | `property` | Declared here |
| [`DisplayMaterialInspector`](#displaymaterialinspector-167) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-502)  |  |
| `override string` | [`ShaderName`](#shadername-373)  |  |
| `override bool` | [`DisplayMaterialInspector`](#displaymaterialinspector-167)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Enhance/SymmetricNearestNeighborNode.cs:12
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Enhance/SymmetricNearestNeighborNode.cs:14

---

{#displaymaterialinspector-167}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Enhance/SymmetricNearestNeighborNode.cs:16
