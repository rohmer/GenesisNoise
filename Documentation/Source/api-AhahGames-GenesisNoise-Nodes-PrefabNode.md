...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrefabNode.cs:15
...
| Name | Kind | Owner |
|------|------|-------|
| [`hasPreview`](#haspreview-64) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-370) | `property` | Declared here |
| [`name`](#name-401) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-55) | `property` | Declared here |
| [`hasSettings`](#hassettings-16) | `property` | Declared here |
| [`isRenamable`](#isrenamable-4) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-139) | `property` | Declared here |
| [`previewTexture`](#previewtexture-37) | `property` | Declared here |
| [`output`](#output-64) | `variable` | Declared here |
| [`InitializeNodeFromObject`](#initializenodefromobject-4) | `function` | Declared here |
| [`Enable`](#enable-63) | `function` | Declared here |
| [`ProcessNode`](#processnode-95) | `function` | Declared here |
| [`preview`](#preview-9) | `variable` | Declared here |
| [`PushPrefabToConnectedDecorationNodes`](#pushprefabtoconnecteddecorationnodes) | `function` | Declared here |
| [`GetConnectedDecorationNodes`](#getconnecteddecorationnodes) | `function` | Declared here |
...
|--------|------|-------------|
| `override bool` | [`hasPreview`](#haspreview-64)  |  |
| `override string` | [`NodeGroup`](#nodegroup-370)  |  |
| `override string` | [`name`](#name-401)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-55)  |  |
| `override bool` | [`hasSettings`](#hassettings-16)  |  |
| `override bool` | [`isRenamable`](#isrenamable-4)  |  |
| `override float` | [`nodeWidth`](#nodewidth-139)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-37)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrefabNode.cs:26
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrefabNode.cs:27
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrefabNode.cs:28

---

{#showdefaultinspector-55}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrefabNode.cs:29
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrefabNode.cs:30
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrefabNode.cs:31
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrefabNode.cs:32
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrefabNode.cs:33

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `GameObject` | [`output`](#output-64)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrefabNode.cs:21

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `bool` | [`InitializeNodeFromObject`](#initializenodefromobject-4) `inline` |  |

---

{#initializenodefromobject-4}
...
```cpp
inline bool InitializeNodeFromObject(GameObject value)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrefabNode.cs:88

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-63) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-95) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrefabNode.cs:35
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrefabNode.cs:41
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrefabNode.cs:24

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`PushPrefabToConnectedDecorationNodes`](#pushprefabtoconnecteddecorationnodes) `inline` |  |
| `IEnumerable< BiomeDecorationNode >` | [`GetConnectedDecorationNodes`](#getconnecteddecorationnodes) `inline` |  |

---

{#pushprefabtoconnecteddecorationnodes}
...
```cpp
inline void PushPrefabToConnectedDecorationNodes()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrefabNode.cs:67

---

{#getconnecteddecorationnodes}
...
```cpp
inline IEnumerable< BiomeDecorationNode > GetConnectedDecorationNodes()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrefabNode.cs:73
