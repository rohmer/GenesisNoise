{#heightnormalcurvatureblendnode}

# HeightNormalCurvatureBlendNode

```cpp
class HeightNormalCurvatureBlendNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Normals/HeightNormalCurvatureBlenderNode.cs:22
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-260) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-236) | `property` | Declared here |
| [`ShaderName`](#shadername-197) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-260)  |  |
| `override string` | [`NodeGroup`](#nodegroup-236)  |  |
| `override string` | [`ShaderName`](#shadername-197)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Normals/HeightNormalCurvatureBlenderNode.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Normals/HeightNormalCurvatureBlenderNode.cs:25
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Normals/HeightNormalCurvatureBlenderNode.cs:26
