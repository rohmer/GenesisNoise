{#tovector3intnodeview}

# ToVector3IntNodeView

```cpp
class ToVector3IntNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Cast/ToVector3IntNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-78) | `property` | Declared here |
| [`Enable`](#enable-178) | `function` | Declared here |
| [`field`](#field-7) | `variable` | Declared here |
| [`UpdateLabel`](#updatelabel-23) | `function` | Declared here |
...
```cpp
ToVector3IntNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Cast/ToVector3IntNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-178) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Cast/ToVector3IntNodeView.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Cast/ToVector3IntNodeView.cs:13

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`UpdateLabel`](#updatelabel-23) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Cast/ToVector3IntNodeView.cs:32
