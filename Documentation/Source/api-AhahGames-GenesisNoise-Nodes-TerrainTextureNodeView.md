{#terraintexturenodeview}

# TerrainTextureNodeView

```cpp
class TerrainTextureNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainTextureNodeView.cs:13
...
| Name | Kind | Owner |
|------|------|-------|
| [`textureNode`](#texturenode) | `property` | Declared here |
| [`Enable`](#enable-80) | `function` | Declared here |
| [`diffuse`](#diffuse) | `variable` | Declared here |
| [`normal`](#normal-6) | `variable` | Declared here |
| [`metallic`](#metallic) | `variable` | Declared here |
| [`ao`](#ao) | `variable` | Declared here |
| [`height`](#height-8) | `variable` | Declared here |
| [`smoothness`](#smoothness) | `variable` | Declared here |
| [`difTint`](#diftint) | `variable` | Declared here |
| [`normalScale`](#normalscale) | `variable` | Declared here |
| [`invertSmoothness`](#invertsmoothness) | `variable` | Declared here |
| [`size`](#size-9) | `variable` | Declared here |
| [`offset`](#offset) | `variable` | Declared here |
| [`nodeControls`](#nodecontrols) | `variable` | Declared here |
| [`CreateTextureField`](#createtexturefield) | `function` | Declared here |
| [`SetTexture`](#settexture) | `function` | Declared here |
| [`SetValue`](#setvalue-2) | `function` | Declared here |
| [`SynchronizeNodeControls`](#synchronizenodecontrols-1) | `function` | Declared here |
...
|--------|------|-------------|
| `TerrainTextureNode` | [`textureNode`](#texturenode)  |  |
...
```cpp
TerrainTextureNode textureNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainTextureNodeView.cs:15

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-80) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainTextureNodeView.cs:25
...
| Return | Name | Description |
|--------|------|-------------|
| `ObjectField` | [`diffuse`](#diffuse)  |  |
| `ObjectField` | [`normal`](#normal-6)  |  |
| `ObjectField` | [`metallic`](#metallic)  |  |
| `ObjectField` | [`ao`](#ao)  |  |
| `ObjectField` | [`height`](#height-8)  |  |
| `ObjectField` | [`smoothness`](#smoothness)  |  |
| `ColorField` | [`difTint`](#diftint)  |  |
| `Slider` | [`normalScale`](#normalscale)  |  |
| `Toggle` | [`invertSmoothness`](#invertsmoothness)  |  |
| `Vector2Field` | [`size`](#size-9)  |  |
| `Vector2Field` | [`offset`](#offset)  |  |
| `TextureControls` | [`nodeControls`](#nodecontrols)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainTextureNodeView.cs:16
...
```cpp
ObjectField metallic
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainTextureNodeView.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainTextureNodeView.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainTextureNodeView.cs:19
...
```cpp
Toggle invertSmoothness
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainTextureNodeView.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainTextureNodeView.cs:22
...
```cpp
TextureControls nodeControls
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainTextureNodeView.cs:23

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `ObjectField` | [`CreateTextureField`](#createtexturefield) `inline` |  |
| `void` | [`SetTexture`](#settexture) `inline` |  |
| `void` | [`SetValue`](#setvalue-2) `inline` |  |
| `void` | [`SynchronizeNodeControls`](#synchronizenodecontrols-1) `inline` |  |
...
```cpp
inline ObjectField CreateTextureField(string label, Texture2D value)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainTextureNodeView.cs:136
...
```cpp
inline void SetTexture(string undoName, System.Action< Texture2D > setter, Object value)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainTextureNodeView.cs:146
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainTextureNodeView.cs:151

---

{#synchronizenodecontrols-1}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainTextureNodeView.cs:159
