{#curvaturesmoothfromnormalnode}

# CurvatureSmoothFromNormalNode

```cpp
class CurvatureSmoothFromNormalNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Normals/CurvatureSmoothFromNormalNode.cs:14
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-128) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-109) | `property` | Declared here |
| [`ShaderName`](#shadername-86) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-128)  |  |
| `override string` | [`NodeGroup`](#nodegroup-109)  |  |
| `override string` | [`ShaderName`](#shadername-86)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Normals/CurvatureSmoothFromNormalNode.cs:16
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Normals/CurvatureSmoothFromNormalNode.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Normals/CurvatureSmoothFromNormalNode.cs:18
