{#fractalbrownianmotionnoisenode}

# FractalBrownianMotionNoiseNode

```cpp
class FractalBrownianMotionNoiseNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/FractalBrownianMotionNoiseNode.cs:17
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-205) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-182) | `property` | Declared here |
| [`ShaderName`](#shadername-151) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-205)  |  |
| `override string` | [`NodeGroup`](#nodegroup-182)  |  |
| `override string` | [`ShaderName`](#shadername-151)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/FractalBrownianMotionNoiseNode.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/FractalBrownianMotionNoiseNode.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/FractalBrownianMotionNoiseNode.cs:21
