{#distanceheightnodeview}

# DistanceHeightNodeView

```cpp
class DistanceHeightNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/DistanceHeightNodeView.cs:15
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-15) | `property` | Declared here |
| [`Enable`](#enable-102) | `function` | Declared here |
| [`iterations`](#iterations) | `variable` | Declared here |
| [`maxHeight`](#maxheight-2) | `variable` | Declared here |
| [`coastHeight`](#coastheight) | `variable` | Declared here |
| [`falloffPower`](#falloffpower) | `variable` | Declared here |
| [`oceanDepthFalloffPower`](#oceandepthfalloffpower) | `variable` | Declared here |
| [`lakeDepthFalloffPower`](#lakedepthfalloffpower) | `variable` | Declared here |
| [`button`](#button) | `variable` | Declared here |
...
|--------|------|-------------|
| `DistanceHeightNode` | [`node`](#node-15)  |  |
...
```cpp
DistanceHeightNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/DistanceHeightNodeView.cs:17

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-102) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/DistanceHeightNodeView.cs:26
...
| Return | Name | Description |
|--------|------|-------------|
| `SliderInt` | [`iterations`](#iterations)  |  |
| `Slider` | [`maxHeight`](#maxheight-2)  |  |
| `Slider` | [`coastHeight`](#coastheight)  |  |
| `Slider` | [`falloffPower`](#falloffpower)  |  |
| `Slider` | [`oceanDepthFalloffPower`](#oceandepthfalloffpower)  |  |
| `Slider` | [`lakeDepthFalloffPower`](#lakedepthfalloffpower)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/DistanceHeightNodeView.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/DistanceHeightNodeView.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/DistanceHeightNodeView.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/DistanceHeightNodeView.cs:21

---

{#oceandepthfalloffpower}

### oceanDepthFalloffPower

```cpp
Slider oceanDepthFalloffPower
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/DistanceHeightNodeView.cs:22

---

{#lakedepthfalloffpower}

### lakeDepthFalloffPower

```cpp
Slider lakeDepthFalloffPower
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/DistanceHeightNodeView.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/DistanceHeightNodeView.cs:24
