{#meshoptimizationnodeview}

# MeshOptimizationNodeView

```cpp
class MeshOptimizationNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshOptimizationNodeView.cs:11
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-33) | `property` | Declared here |
| [`Enable`](#enable-128) | `function` | Declared here |
| [`Disable`](#disable-61) | `function` | Declared here |
| [`targetTriangles`](#targettriangles) | `variable` | Declared here |
| [`recalculateNormals`](#recalculatenormals-2) | `variable` | Declared here |
| [`triangleCounts`](#trianglecounts) | `variable` | Declared here |
| [`QueueRefreshTriangleCounts`](#queuerefreshtrianglecounts) | `function` | Declared here |
| [`RefreshTriangleCounts`](#refreshtrianglecounts) | `function` | Declared here |
...
|--------|------|-------------|
| `MeshOptimizationNode` | [`node`](#node-33)  |  |
...
```cpp
MeshOptimizationNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshOptimizationNodeView.cs:13

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-128) `inline` |  |
| `override void` | [`Disable`](#disable-61) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshOptimizationNodeView.cs:19
...
```cpp
inline override void Disable()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshOptimizationNodeView.cs:61

## Private Attributes

| Return | Name | Description |
|--------|------|-------------|
| `SliderInt` | [`targetTriangles`](#targettriangles)  |  |
| `Toggle` | [`recalculateNormals`](#recalculatenormals-2)  |  |
| `Label` | [`triangleCounts`](#trianglecounts)  |  |
...
```cpp
SliderInt targetTriangles
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshOptimizationNodeView.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshOptimizationNodeView.cs:16
...
```cpp
Label triangleCounts
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshOptimizationNodeView.cs:17

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`QueueRefreshTriangleCounts`](#queuerefreshtrianglecounts) `inline` |  |
| `void` | [`RefreshTriangleCounts`](#refreshtrianglecounts) `inline` |  |

---

{#queuerefreshtrianglecounts}
...
```cpp
inline void QueueRefreshTriangleCounts()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshOptimizationNodeView.cs:67

---

{#refreshtrianglecounts}
...
```cpp
inline void RefreshTriangleCounts()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshOptimizationNodeView.cs:78
