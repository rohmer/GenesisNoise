{#terraingaussianblurnodeview}

# TerrainGaussianBlurNodeView

```cpp
class TerrainGaussianBlurNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainGaussianBlurNodeView.cs:16
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-62) | `property` | Declared here |
| [`Enable`](#enable-160) | `function` | Declared here |
| [`slider`](#slider) | `variable` | Declared here |
...
|--------|------|-------------|
| `TerrainGaussianBlurNode` | [`node`](#node-62)  |  |
...
```cpp
TerrainGaussianBlurNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainGaussianBlurNodeView.cs:18

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-160) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainGaussianBlurNodeView.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainGaussianBlurNodeView.cs:19
