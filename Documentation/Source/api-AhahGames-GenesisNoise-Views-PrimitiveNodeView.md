...
```cpp
class PrimitiveNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/PrimitiveNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-45) | `property` | Declared here |
| [`Enable`](#enable-142) | `function` | Declared here |
| [`RefreshOutputs`](#refreshoutputs-8) | `function` | Declared here |
| [`primitiveType`](#primitivetype-12) | `variable` | Declared here |
| [`primitiveName`](#primitivename-1) | `variable` | Declared here |
| [`markMeshStatic`](#markmeshstatic) | `variable` | Declared here |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/PrimitiveNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-142) `virtual` `inline` |  |
| `void` | [`RefreshOutputs`](#refreshoutputs-8) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/PrimitiveNodeView.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/PrimitiveNodeView.cs:58

## Private Attributes

| Return | Name | Description |
|--------|------|-------------|
| `EnumField` | [`primitiveType`](#primitivetype-12)  |  |
| `TextField` | [`primitiveName`](#primitivename-1)  |  |
| `Toggle` | [`markMeshStatic`](#markmeshstatic)  |  |
...
```cpp
EnumField primitiveType
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/PrimitiveNodeView.cs:14
...
```cpp
TextField primitiveName
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/PrimitiveNodeView.cs:15
...
```cpp
Toggle markMeshStatic
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/PrimitiveNodeView.cs:16
