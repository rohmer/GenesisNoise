...
```cpp
class IslandGeneratorNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Shape/IslandGeneratorNode.cs:32
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-292) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-30) | `property` | Declared here |
| [`hasPreview`](#haspreview-46) | `property` | Declared here |
| [`hasSettings`](#hassettings-13) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-108) | `property` | Declared here |
| [`previewTexture`](#previewtexture-19) | `property` | Declared here |
| [`points`](#points-4) | `variable` | Declared here |
| [`NoiseFunction`](#noisefunction) | `variable` | Declared here |
| [`islandShape`](#islandshape-1) | `variable` | Declared here |
| [`TerrainSize`](#terrainsize) | `variable` | Declared here |
| [`useCoasts`](#usecoasts) | `variable` | Declared here |
| [`forceEdgeOcean`](#forceedgeocean) | `variable` | Declared here |
| [`heightCurve`](#heightcurve) | `variable` | Declared here |
| [`noiseInfluence`](#noiseinfluence) | `variable` | Declared here |
| [`allowLakes`](#allowlakes) | `variable` | Declared here |
| [`Generate`](#generate-2) | `function` | Declared here |
| [`Enable`](#enable-41) | `function` | Declared here |
| [`ProcessNode`](#processnode-61) | `function` | Declared here |
| [`Disable`](#disable-21) | `function` | Declared here |
| [`GetSize`](#getsize) | `function` | Declared here |
| [`DestroyTexture`](#destroytexture) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-292)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-30)  |  |
| `override bool` | [`hasPreview`](#haspreview-46)  |  |
| `override bool` | [`hasSettings`](#hassettings-13)  |  |
| `override float` | [`nodeWidth`](#nodewidth-108)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-19)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Shape/IslandGeneratorNode.cs:53

---

{#showdefaultinspector-30}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Shape/IslandGeneratorNode.cs:54
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Shape/IslandGeneratorNode.cs:55
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Shape/IslandGeneratorNode.cs:56
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Shape/IslandGeneratorNode.cs:57
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Shape/IslandGeneratorNode.cs:60

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `List< Vector2 >` | [`points`](#points-4)  |  |
| `CustomRenderTexture` | [`NoiseFunction`](#noisefunction)  |  |
| `IslandShape` | [`islandShape`](#islandshape-1)  |  |
| `eTerrainSize` | [`TerrainSize`](#terrainsize)  |  |
| `bool` | [`useCoasts`](#usecoasts)  |  |
| `bool` | [`forceEdgeOcean`](#forceedgeocean)  |  |
| `AnimationCurve` | [`heightCurve`](#heightcurve)  |  |
| `float` | [`noiseInfluence`](#noiseinfluence)  |  |
| `bool` | [`allowLakes`](#allowlakes)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Shape/IslandGeneratorNode.cs:35
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Shape/IslandGeneratorNode.cs:37
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Shape/IslandGeneratorNode.cs:39
...
```cpp
eTerrainSize TerrainSize = eTerrainSize.x4096
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Shape/IslandGeneratorNode.cs:41
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Shape/IslandGeneratorNode.cs:43
...
```cpp
bool forceEdgeOcean = true
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Shape/IslandGeneratorNode.cs:45
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Shape/IslandGeneratorNode.cs:47
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Shape/IslandGeneratorNode.cs:49
...
```cpp
bool allowLakes = true
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Shape/IslandGeneratorNode.cs:51

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`Generate`](#generate-2) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Shape/IslandGeneratorNode.cs:103

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-41) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-61) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-21) `virtual` `inline` | Called when the node is disabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Shape/IslandGeneratorNode.cs:64
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Shape/IslandGeneratorNode.cs:74
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Shape/IslandGeneratorNode.cs:203
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Shape/IslandGeneratorNode.cs:81

## Private Static Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`DestroyTexture`](#destroytexture) `static` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Shape/IslandGeneratorNode.cs:211
