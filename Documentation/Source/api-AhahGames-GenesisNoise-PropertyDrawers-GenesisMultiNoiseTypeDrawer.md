{#genesismultinoisetypedrawer}

# GenesisMultiNoiseTypeDrawer

```cpp
class GenesisMultiNoiseTypeDrawer
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisMultiNoiseTypeDrawer.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`DrawerGUI`](#drawergui-12) | `function` | Declared here |
| [`NoiseType`](#noisetype) | `enum` | Declared here |
...
|--------|------|-------------|
| `override void` | [`DrawerGUI`](#drawergui-12) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisMultiNoiseTypeDrawer.cs:33
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisMultiNoiseTypeDrawer.cs:12
