...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToIntNode.cs:13
...
| Name | Kind | Owner |
|------|------|-------|
| [`nodeWidth`](#nodewidth-187) | `property` | Declared here |
| [`name`](#name-532) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-488) | `property` | Declared here |
| [`input`](#input-27) | `variable` | Declared here |
| [`output`](#output-100) | `variable` | Declared here |
| [`Process`](#process-20) | `function` | Declared here |
...
|--------|------|-------------|
| `override float` | [`nodeWidth`](#nodewidth-187)  |  |
| `override string` | [`name`](#name-532)  |  |
| `override string` | [`NodeGroup`](#nodegroup-488)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToIntNode.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToIntNode.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToIntNode.cs:22

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `object` | [`input`](#input-27)  |  |
| `int` | [`output`](#output-100)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToIntNode.cs:16
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToIntNode.cs:19

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Process`](#process-20) `virtual` `inline` | Override this method to implement custom processing. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToIntNode.cs:23
