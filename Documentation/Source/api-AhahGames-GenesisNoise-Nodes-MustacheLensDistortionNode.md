{#mustachelensdistortionnode}

# MustacheLensDistortionNode

```cpp
class MustacheLensDistortionNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/MustacheLensDistortionNode.cs:12
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-355) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-327) | `property` | Declared here |
| [`ShaderName`](#shadername-263) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-355)  |  |
| `override string` | [`NodeGroup`](#nodegroup-327)  |  |
| `override string` | [`ShaderName`](#shadername-263)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/MustacheLensDistortionNode.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/MustacheLensDistortionNode.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/MustacheLensDistortionNode.cs:16
