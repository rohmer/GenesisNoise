...
```cpp
class ShaderNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ShaderNodeView.cs:17
...
| Name | Kind | Owner |
|------|------|-------|
| [`shaderNode`](#shadernode-1) | `property` | Declared here |
| [`header`](#header-3) | `property` | Declared here |
| [`Enable`](#enable-154) | `function` | Declared here |
| [`BuildContextualMenu`](#buildcontextualmenu-10) | `function` | Declared here |
| [`OnRemoved`](#onremoved-5) | `function` | Declared here |
| [`shaderSettings`](#shadersettings) | `variable` | Declared here |
| [`CreateNewShader`](#createnewshader) | `function` | Declared here |
| [`SetShader`](#setshader) | `function` | Declared here |
| [`materialEditorUI`](#materialeditorui) | `variable` | Declared here |
| [`debugCustomRenderTextureField`](#debugcustomrendertexturefield-2) | `variable` | Declared here |
| [`materialHash`](#materialhash-3) | `variable` | Declared here |
| [`lastModified`](#lastmodified-2) | `variable` | Declared here |
| [`shaderPath`](#shaderpath) | `variable` | Declared here |
| [`DetectShaderChanges`](#detectshaderchanges-2) | `function` | Declared here |
| [`InitializeDebug`](#initializedebug-4) | `function` | Declared here |
| [`UpdateShaderCreationUI`](#updateshadercreationui) | `function` | Declared here |
| [`ResetMaterialPropertyToDefault`](#resetmaterialpropertytodefault-4) | `function` | Declared here |
| [`MaterialGUI`](#materialgui-3) | `function` | Declared here |
...
|--------|------|-------------|
| `ShaderNode` | [`shaderNode`](#shadernode-1)  |  |
| `override string` | [`header`](#header-3)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ShaderNodeView.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ShaderNodeView.cs:30

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-154) `virtual` `inline` |  |
| `override void` | [`BuildContextualMenu`](#buildcontextualmenu-10) `inline` |  |
| `override void` | [`OnRemoved`](#onremoved-5) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ShaderNodeView.cs:32
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ShaderNodeView.cs:217
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ShaderNodeView.cs:230
...
| Return | Name | Description |
|--------|------|-------------|
| `VisualElement` | [`shaderSettings`](#shadersettings)  |  |
...
```cpp
VisualElement shaderSettings
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ShaderNodeView.cs:28

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`CreateNewShader`](#createnewshader) `virtual` `inline` |  |
| `void` | [`SetShader`](#setshader) `inline` |  |
...
```cpp
virtual inline void CreateNewShader(VisualElement shaderCreationUI, ObjectField shaderField)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ShaderNodeView.cs:157
...
```cpp
inline void SetShader(Shader newShader, VisualElement shaderCreationUI, ObjectField shaderField)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ShaderNodeView.cs:181

## Private Attributes

| Return | Name | Description |
|--------|------|-------------|
| `VisualElement` | [`materialEditorUI`](#materialeditorui)  |  |
| `ObjectField` | [`debugCustomRenderTextureField`](#debugcustomrendertexturefield-2)  |  |
| `int` | [`materialHash`](#materialhash-3)  |  |
| `DateTime` | [`lastModified`](#lastmodified-2)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ShaderNodeView.cs:19

---

{#debugcustomrendertexturefield-2}

### debugCustomRenderTextureField

```cpp
ObjectField debugCustomRenderTextureField
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ShaderNodeView.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ShaderNodeView.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ShaderNodeView.cs:25
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ShaderNodeView.cs:26

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`DetectShaderChanges`](#detectshaderchanges-2) `inline` |  |
| `void` | [`InitializeDebug`](#initializedebug-4) `inline` |  |
| `void` | [`UpdateShaderCreationUI`](#updateshadercreationui) `inline` |  |
| `void` | [`ResetMaterialPropertyToDefault`](#resetmaterialpropertytodefault-4) `inline` |  |
| `void` | [`MaterialGUI`](#materialgui-3) `inline` |  |

---

{#detectshaderchanges-2}
...
```cpp
inline void DetectShaderChanges()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ShaderNodeView.cs:87
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ShaderNodeView.cs:117
...
```cpp
inline void UpdateShaderCreationUI(VisualElement shaderCreationUI, ObjectField shaderField)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ShaderNodeView.cs:132

---

{#resetmaterialpropertytodefault-4}
...
```cpp
inline void ResetMaterialPropertyToDefault(PortView pv)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ShaderNodeView.cs:172
...
```cpp
inline void MaterialGUI(bool fromInspector, VisualElement shaderCreationUI, ObjectField shaderField)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ShaderNodeView.cs:197
