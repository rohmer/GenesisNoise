{#smartupsamplercurvatureawarenode}

# SmartUpsamplerCurvatureAwareNode

```cpp
class SmartUpsamplerCurvatureAwareNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/SmartUpsamplerCurvatureAwareNode.cs:17
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-470) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-436) | `property` | Declared here |
| [`ShaderName`](#shadername-349) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-470)  |  |
| `override string` | [`NodeGroup`](#nodegroup-436)  |  |
| `override string` | [`ShaderName`](#shadername-349)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/SmartUpsamplerCurvatureAwareNode.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/SmartUpsamplerCurvatureAwareNode.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/SmartUpsamplerCurvatureAwareNode.cs:21
