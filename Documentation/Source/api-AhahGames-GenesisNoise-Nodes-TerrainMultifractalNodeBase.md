{#terrainmultifractalnodebase}

# TerrainMultifractalNodeBase

```cpp
class TerrainMultifractalNodeBase
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/TerrainMultifractalNodes.cs:11

> **Inherits:** [`FixedNoiseNode`](api-FixedNoiseNode.md#fixednoisenode)
> **Subclassed by:** [`AhahGames.GenesisNoise.Nodes.HeteroTerrainNode`](api-AhahGames-GenesisNoise-Nodes-HeteroTerrainNode.md#heteroterrainnode), [`AhahGames.GenesisNoise.Nodes.HybridMultifractalNode`](api-AhahGames-GenesisNoise-Nodes-HybridMultifractalNode.md#hybridmultifractalnode), [`AhahGames.GenesisNoise.Nodes.PingPongMultifractalNode`](api-AhahGames-GenesisNoise-Nodes-PingPongMultifractalNode.md#pingpongmultifractalnode), [`AhahGames.GenesisNoise.Nodes.RidgedMultifractalNode`](api-AhahGames-GenesisNoise-Nodes-RidgedMultifractalNode.md#ridgedmultifractalnode)

## List of all members

| Name | Kind | Owner |
|------|------|-------|
| [`Mode`](#mode-26) | `property` | Declared here |
| [`filteredOutProperties`](#filteredoutproperties-126) | `property` | Declared here |
| [`ProcessNode`](#processnode-131) | `function` | Declared here |
...
|--------|------|-------------|
| `int` | [`Mode`](#mode-26)  |  |
| `override IEnumerable< string >` | [`filteredOutProperties`](#filteredoutproperties-126)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/TerrainMultifractalNodes.cs:13

---

{#filteredoutproperties-126}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/TerrainMultifractalNodes.cs:15

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-131) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/TerrainMultifractalNodes.cs:17
