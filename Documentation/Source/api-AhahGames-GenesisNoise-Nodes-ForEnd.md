...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:20

> **Inherits:** [`AhahGames.GenesisNoise.Nodes.GenesisNode`](api-AhahGames-GenesisNoise-Nodes-GenesisNode.md#genesisnode), [`AhahGames.GenesisNoise.Nodes.ILoopEnd`](api-AhahGames-GenesisNoise-Nodes-ILoopEnd.md#iloopend)
> **Subclassed by:** [`AhahGames.GenesisNoise.Nodes.WhileEnd`](api-AhahGames-GenesisNoise-Nodes-WhileEnd.md#whileend)

## List of all members

| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-203) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-181) | `property` | Declared here |
| [`hasPreview`](#haspreview-29) | `property` | Declared here |
| [`hasSettings`](#hassettings-9) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-25) | `property` | Declared here |
| [`input`](#input-12) | `variable` | Declared here |
| [`output`](#output-36) | `variable` | Declared here |
| [`mode`](#mode-13) | `variable` | Declared here |
| [`InputPortType`](#inputporttype-4) | `function` | Declared here |
| [`OutputPortType`](#outputporttype-6) | `function` | Declared here |
| [`PrepareNewIteration`](#preparenewiteration) | `function` | Declared here |
| [`PrepareLoopEnd`](#prepareloopend-1) | `function` | Declared here |
| [`FinalIteration`](#finaliteration-1) | `function` | Declared here |
| [`Enable`](#enable-31) | `function` | Declared here |
| [`ProcessNode`](#processnode-47) | `function` | Declared here |
| [`Disable`](#disable-15) | `function` | Declared here |
| [`AggregationMode`](#aggregationmode) | `enum` | Declared here |
| [`loopStart`](#loopstart) | `variable` | Declared here |
| [`loopStartGUID`](#loopstartguid-1) | `variable` | Declared here |
| [`doubleBufferForEnd`](#doublebufferforend) | `variable` | Declared here |
| [`inputMeshes`](#inputmeshes) | `variable` | Declared here |
| [`RegisterLoopStart`](#registerloopstart-1) | `function` | Declared here |
| [`UnregisterLoopStart`](#unregisterloopstart-1) | `function` | Declared here |
| [`EdgeConnectionCallback`](#edgeconnectioncallback-1) | `function` | Declared here |
| [`FeedbackInputToStartNode`](#feedbackinputtostartnode) | `function` | Declared here |
| [`RemoveTransientGeneratedObjects`](#removetransientgeneratedobjects) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-203)  |  |
| `override string` | [`NodeGroup`](#nodegroup-181)  |  |
| `override bool` | [`hasPreview`](#haspreview-29)  |  |
| `override bool` | [`hasSettings`](#hassettings-9)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-25)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:35
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:36
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:38
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:39

---

{#showdefaultinspector-25}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:40

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `object` | [`input`](#input-12)  |  |
| `object` | [`output`](#output-36)  |  |
| `AggregationMode` | [`mode`](#mode-13)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:30
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:33
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:42

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `IEnumerable< PortData >` | [`InputPortType`](#inputporttype-4) `inline` |  |
| `IEnumerable< PortData >` | [`OutputPortType`](#outputporttype-6) `inline` |  |
| `void` | [`PrepareNewIteration`](#preparenewiteration) `inline` |  |
| `void` | [`PrepareLoopEnd`](#prepareloopend-1) `inline` | Function executed the first time a Loop end is encountered. I.e. at the end of the first loop iteration. |
| `void` | [`FinalIteration`](#finaliteration-1) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:106
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:120
...
```cpp
inline void PrepareNewIteration(BaseNode startNode)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:198
...
```cpp
inline void PrepareLoopEnd(ILoopStart loopStartNode)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:204

Function executed the first time a Loop end is encountered. I.e. at the end of the first loop iteration.

#### Reimplements

- [`PrepareLoopEnd`](api-AhahGames-GenesisNoise-Nodes.md#prepareloopend-2)
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:216

#### Reimplements

- [`FinalIteration`](api-AhahGames-GenesisNoise-Nodes.md#finaliteration-2)

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-31) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-47) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-15) `virtual` `inline` | Called when the node is disabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:50
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:133
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:251
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:22
...
| Return | Name | Description |
|--------|------|-------------|
| `ForStart` | [`loopStart`](#loopstart)  |  |
| `string` | [`loopStartGUID`](#loopstartguid-1)  |  |
| `RenderTexture` | [`doubleBufferForEnd`](#doublebufferforend)  |  |
| `List< GenesisMesh >` | [`inputMeshes`](#inputmeshes)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:45
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:48
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:155
...
```cpp
List< GenesisMesh > inputMeshes = new()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:215

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RegisterLoopStart`](#registerloopstart-1) `inline` |  |
| `void` | [`UnregisterLoopStart`](#unregisterloopstart-1) `inline` |  |
| `void` | [`EdgeConnectionCallback`](#edgeconnectioncallback-1) `inline` |  |
| `void` | [`FeedbackInputToStartNode`](#feedbackinputtostartnode) `inline` |  |
| `void` | [`RemoveTransientGeneratedObjects`](#removetransientgeneratedobjects) `inline` |  |
...
```cpp
inline void RegisterLoopStart()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:58

---

{#unregisterloopstart-1}
...
```cpp
inline void UnregisterLoopStart()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:69

---

{#edgeconnectioncallback-1}

### EdgeConnectionCallback

`inline`

```cpp
inline void EdgeConnectionCallback(SerializableEdge edge)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:78

---

{#feedbackinputtostartnode}
...
```cpp
inline void FeedbackInputToStartNode(CommandBuffer cmd)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:157
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForEnd.cs:226
