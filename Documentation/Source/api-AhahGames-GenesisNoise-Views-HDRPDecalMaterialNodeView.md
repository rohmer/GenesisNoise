{#hdrpdecalmaterialnodeview}

# HDRPDecalMaterialNodeView

```cpp
class HDRPDecalMaterialNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/HDRP/HDRPDecalMaterialNodeView.cs:14
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-20) | `property` | Declared here |
| [`Enable`](#enable-113) | `function` | Declared here |
...
|--------|------|-------------|
| `HDRPDecalMaterial` | [`node`](#node-20)  |  |
...
```cpp
HDRPDecalMaterial node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/HDRP/HDRPDecalMaterialNodeView.cs:16

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-113) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/HDRP/HDRPDecalMaterialNodeView.cs:18
