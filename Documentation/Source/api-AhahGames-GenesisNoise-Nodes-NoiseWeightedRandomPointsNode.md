{#noiseweightedrandompointsnode}

# NoiseWeightedRandomPointsNode

```cpp
class NoiseWeightedRandomPointsNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:31
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-359) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-331) | `property` | Declared here |
| [`previewTexture`](#previewtexture-33) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-52) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-133) | `property` | Declared here |
| [`defaultPreviewChannels`](#defaultpreviewchannels-7) | `property` | Declared here |
| [`supportedDimensions`](#supporteddimensions-17) | `property` | Declared here |
| [`defaultSettings`](#defaultsettings-17) | `property` | Declared here |
| [`noiseInput`](#noiseinput-1) | `variable` | Declared here |
| [`seed`](#seed-5) | `variable` | Declared here |
| [`numberOfPoints`](#numberofpoints-3) | `variable` | Declared here |
| [`pointRadiusPixels`](#pointradiuspixels-5) | `variable` | Declared here |
| [`backgroundColor`](#backgroundcolor-7) | `variable` | Declared here |
| [`pointColor`](#pointcolor-5) | `variable` | Declared here |
| [`output`](#output-60) | `variable` | Declared here |
| [`points`](#points-7) | `variable` | Declared here |
| [`pointCount`](#pointcount-5) | `variable` | Declared here |
| [`GetCoordinatesText`](#getcoordinatestext-5) | `function` | Declared here |
| [`ProcessNode`](#processnode-88) | `function` | Declared here |
| [`Disable`](#disable-34) | `function` | Declared here |
| [`lastWidth`](#lastwidth-5) | `variable` | Declared here |
| [`lastHeight`](#lastheight-5) | `variable` | Declared here |
| [`lastSeed`](#lastseed-5) | `variable` | Declared here |
| [`lastNumberOfPoints`](#lastnumberofpoints-3) | `variable` | Declared here |
| [`lastPointRadiusPixels`](#lastpointradiuspixels-5) | `variable` | Declared here |
| [`lastBackgroundColor`](#lastbackgroundcolor-5) | `variable` | Declared here |
| [`lastPointColor`](#lastpointcolor-5) | `variable` | Declared here |
| [`readableNoise`](#readablenoise-1) | `variable` | Declared here |
| [`pixelBuffer`](#pixelbuffer-5) | `variable` | Declared here |
| [`cumulativeWeights`](#cumulativeweights-2) | `variable` | Declared here |
| [`GeneratePoints`](#generatepoints-5) | `function` | Declared here |
| [`GenerateWeightedPoints`](#generateweightedpoints) | `function` | Declared here |
| [`GenerateUniformPoints`](#generateuniformpoints) | `function` | Declared here |
| [`UpdateReadableNoise`](#updatereadablenoise-1) | `function` | Declared here |
| [`TryBuildCumulativeWeights`](#trybuildcumulativeweights-2) | `function` | Declared here |
| [`BuildTexture`](#buildtexture-5) | `function` | Declared here |
| [`EnsureOutputTexture`](#ensureoutputtexture-5) | `function` | Declared here |
| [`NeedsRebuild`](#needsrebuild-5) | `function` | Declared here |
| [`CacheSettings`](#cachesettings-5) | `function` | Declared here |
| [`epsilon`](#epsilon-7) | `variable` | Declared here |
| [`NextFloat`](#nextfloat-5) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-359)  |  |
| `override string` | [`NodeGroup`](#nodegroup-331)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-33)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-52)  |  |
| `override float` | [`nodeWidth`](#nodewidth-133)  |  |
| `override PreviewChannels` | [`defaultPreviewChannels`](#defaultpreviewchannels-7)  |  |
| `override List< OutputDimension >` | [`supportedDimensions`](#supporteddimensions-17)  |  |
| `override GenesisNoiseSettings` | [`defaultSettings`](#defaultsettings-17)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:87
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:88
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:89

---

{#showdefaultinspector-52}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:90
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:91

---

{#defaultpreviewchannels-7}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:92

---

{#supporteddimensions-17}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:93
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:94

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `Texture` | [`noiseInput`](#noiseinput-1)  |  |
| `int` | [`seed`](#seed-5)  |  |
| `int` | [`numberOfPoints`](#numberofpoints-3)  |  |
| `int` | [`pointRadiusPixels`](#pointradiuspixels-5)  |  |
| `Color` | [`backgroundColor`](#backgroundcolor-7)  |  |
| `Color` | [`pointColor`](#pointcolor-5)  |  |
| `Texture2D` | [`output`](#output-60)  |  |
| `List< Vector2 >` | [`points`](#points-7)  |  |
| `int` | [`pointCount`](#pointcount-5)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:36
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:39
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:42
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:45
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:48
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:51
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:54
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:57
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:60

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `string` | [`GetCoordinatesText`](#getcoordinatestext-5) `inline` |  |

---

{#getcoordinatestext-5}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:111

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-88) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-34) `virtual` `inline` | Called when the node is disabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:96
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:345
...
| Return | Name | Description |
|--------|------|-------------|
| `int` | [`lastWidth`](#lastwidth-5)  |  |
| `int` | [`lastHeight`](#lastheight-5)  |  |
| `int` | [`lastSeed`](#lastseed-5)  |  |
| `int` | [`lastNumberOfPoints`](#lastnumberofpoints-3)  |  |
| `int` | [`lastPointRadiusPixels`](#lastpointradiuspixels-5)  |  |
| `Color` | [`lastBackgroundColor`](#lastbackgroundcolor-5)  |  |
| `Color` | [`lastPointColor`](#lastpointcolor-5)  |  |
| `Texture2D` | [`readableNoise`](#readablenoise-1)  |  |
| `Color32[]` | [`pixelBuffer`](#pixelbuffer-5)  |  |
| `float[]` | [`cumulativeWeights`](#cumulativeweights-2)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:63
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:66
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:69

---

{#lastnumberofpoints-3}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:72

---

{#lastpointradiuspixels-5}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:75

---

{#lastbackgroundcolor-5}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:78
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:81
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:83
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:84
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:85

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`GeneratePoints`](#generatepoints-5) `inline` |  |
| `void` | [`GenerateWeightedPoints`](#generateweightedpoints) `inline` |  |
| `void` | [`GenerateUniformPoints`](#generateuniformpoints) `inline` |  |
| `bool` | [`UpdateReadableNoise`](#updatereadablenoise-1) `inline` |  |
| `bool` | [`TryBuildCumulativeWeights`](#trybuildcumulativeweights-2) `inline` |  |
| `void` | [`BuildTexture`](#buildtexture-5) `inline` |  |
| `void` | [`EnsureOutputTexture`](#ensureoutputtexture-5) `inline` |  |
| `bool` | [`NeedsRebuild`](#needsrebuild-5) `inline` |  |
| `void` | [`CacheSettings`](#cachesettings-5) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:134

---

{#generateweightedpoints}
...
```cpp
inline void GenerateWeightedPoints(System.Random random, int pointTarget, float totalWeight)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:154
...
```cpp
inline void GenerateUniformPoints(System.Random random, int pointTarget)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:178

---

{#updatereadablenoise-1}
...
```cpp
inline bool UpdateReadableNoise(Texture source)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:184

---

{#trybuildcumulativeweights-2}
...
```cpp
inline bool TryBuildCumulativeWeights(out float totalWeight)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:221
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:237

---

{#ensureoutputtexture-5}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:284
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:305
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:329

## Private Static Attributes

| Return | Name | Description |
|--------|------|-------------|
| `const float` | [`epsilon`](#epsilon-7) `static` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:33

## Private Static Methods

| Return | Name | Description |
|--------|------|-------------|
| `float` | [`NextFloat`](#nextfloat-5) `static` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/NoiseWeightedRandomPointsNode.cs:340
