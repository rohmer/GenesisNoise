{#terraincurvaturenodeview}

# TerrainCurvatureNodeView

```cpp
class TerrainCurvatureNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainCurvatureNodeView.cs:12
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-61) | `property` | Declared here |
| [`Enable`](#enable-159) | `function` | Declared here |
| [`heightScale`](#heightscale-1) | `variable` | Declared here |
| [`curvatureScale`](#curvaturescale) | `variable` | Declared here |
| [`sampleRadius`](#sampleradius) | `variable` | Declared here |
| [`absoluteCurvature`](#absolutecurvature) | `variable` | Declared here |
| [`localNormalization`](#localnormalization) | `variable` | Declared here |
...
|--------|------|-------------|
| `TerrainCurvatureNode` | [`node`](#node-61)  |  |
...
```cpp
TerrainCurvatureNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainCurvatureNodeView.cs:14

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-159) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainCurvatureNodeView.cs:22
...
| Return | Name | Description |
|--------|------|-------------|
| `Slider` | [`heightScale`](#heightscale-1)  |  |
| `Slider` | [`curvatureScale`](#curvaturescale)  |  |
| `SliderInt` | [`sampleRadius`](#sampleradius)  |  |
| `Toggle` | [`absoluteCurvature`](#absolutecurvature)  |  |
| `Toggle` | [`localNormalization`](#localnormalization)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainCurvatureNodeView.cs:16
...
```cpp
Slider curvatureScale
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainCurvatureNodeView.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainCurvatureNodeView.cs:18
...
```cpp
Toggle absoluteCurvature
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainCurvatureNodeView.cs:19
...
```cpp
Toggle localNormalization
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainCurvatureNodeView.cs:20
