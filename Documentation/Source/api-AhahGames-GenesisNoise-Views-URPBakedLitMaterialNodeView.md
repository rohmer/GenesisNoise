{#urpbakedlitmaterialnodeview}

# URPBakedLitMaterialNodeView

```cpp
class URPBakedLitMaterialNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/URP/URPBakedLitMaterialNodeView.cs:14
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-81) | `property` | Declared here |
| [`Enable`](#enable-181) | `function` | Declared here |
...
|--------|------|-------------|
| `URPBakedLitMaterial` | [`node`](#node-81)  |  |
...
```cpp
URPBakedLitMaterial node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/URP/URPBakedLitMaterialNodeView.cs:16

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-181) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/URP/URPBakedLitMaterialNodeView.cs:18
