{#genesisvector3drawer}

# GenesisVector3Drawer

```cpp
class GenesisVector3Drawer
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisVector3Drawer.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`DrawerGUI`](#drawergui-28) | `function` | Declared here |
...
|--------|------|-------------|
| `override void` | [`DrawerGUI`](#drawergui-28) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisVector3Drawer.cs:12
