...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/ConstantNode.cs:9

> **Inherits:** [`AhahGames.GenesisNoise.Nodes.GenesisNode`](api-AhahGames-GenesisNoise-Nodes-GenesisNode.md#genesisnode)
> **Subclassed by:** [`AhahGames.GenesisNoise.Nodes.AbsNode`](api-AhahGames-GenesisNoise-Nodes-AbsNode.md#absnode), [`AhahGames.GenesisNoise.Nodes.AcosNode`](api-AhahGames-GenesisNoise-Nodes-AcosNode.md#acosnode), [`AhahGames.GenesisNoise.Nodes.AddNode`](api-AhahGames-GenesisNoise-Nodes-AddNode.md#addnode-2), [`AhahGames.GenesisNoise.Nodes.AnimationCurveNode`](api-AhahGames-GenesisNoise-Nodes-AnimationCurveNode.md#animationcurvenode), [`AhahGames.GenesisNoise.Nodes.AsinNode`](api-AhahGames-GenesisNoise-Nodes-AsinNode.md#asinnode), [`AhahGames.GenesisNoise.Nodes.Atan2Node`](api-AhahGames-GenesisNoise-Nodes-Atan2Node.md#atan2node), [`AhahGames.GenesisNoise.Nodes.AtanNode`](api-AhahGames-GenesisNoise-Nodes-AtanNode.md#atannode), [`AhahGames.GenesisNoise.Nodes.BoolNode`](api-AhahGames-GenesisNoise-Nodes-BoolNode.md#boolnode), [`AhahGames.GenesisNoise.Nodes.ClampNode`](api-AhahGames-GenesisNoise-Nodes-ClampNode.md#clampnode), [`AhahGames.GenesisNoise.Nodes.ColorNode`](api-AhahGames-GenesisNoise-Nodes-ColorNode.md#colornode), [`AhahGames.GenesisNoise.Nodes.CosNode`](api-AhahGames-GenesisNoise-Nodes-CosNode.md#cosnode), [`AhahGames.GenesisNoise.Nodes.CoshNode`](api-AhahGames-GenesisNoise-Nodes-CoshNode.md#coshnode), [`AhahGames.GenesisNoise.Nodes.DivideNode`](api-AhahGames-GenesisNoise-Nodes-DivideNode.md#dividenode), [`AhahGames.GenesisNoise.Nodes.ExpNode`](api-AhahGames-GenesisNoise-Nodes-ExpNode.md#expnode), [`AhahGames.GenesisNoise.Nodes.FloatNode`](api-AhahGames-GenesisNoise-Nodes-FloatNode.md#floatnode), [`AhahGames.GenesisNoise.Nodes.GradientNode`](api-AhahGames-GenesisNoise-Nodes-GradientNode.md#gradientnode), [`AhahGames.GenesisNoise.Nodes.IntNode`](api-AhahGames-GenesisNoise-Nodes-IntNode.md#intnode), [`AhahGames.GenesisNoise.Nodes.LogNode`](api-AhahGames-GenesisNoise-Nodes-LogNode.md#lognode), [`AhahGames.GenesisNoise.Nodes.MaxNode`](api-AhahGames-GenesisNoise-Nodes-MaxNode.md#maxnode), [`AhahGames.GenesisNoise.Nodes.MinNode`](api-AhahGames-GenesisNoise-Nodes-MinNode.md#minnode), [`AhahGames.GenesisNoise.Nodes.ModNode`](api-AhahGames-GenesisNoise-Nodes-ModNode.md#modnode), [`AhahGames.GenesisNoise.Nodes.MultiplyNode`](api-AhahGames-GenesisNoise-Nodes-MultiplyNode.md#multiplynode), [`AhahGames.GenesisNoise.Nodes.PowNode`](api-AhahGames-GenesisNoise-Nodes-PowNode.md#pownode), [`AhahGames.GenesisNoise.Nodes.QuaternionNode`](api-AhahGames-GenesisNoise-Nodes-QuaternionNode.md#quaternionnode), [`AhahGames.GenesisNoise.Nodes.RandomFloatNode`](api-AhahGames-GenesisNoise-Nodes-RandomFloatNode.md#randomfloatnode), [`AhahGames.GenesisNoise.Nodes.RandomIntNode`](api-AhahGames-GenesisNoise-Nodes-RandomIntNode.md#randomintnode), [`AhahGames.GenesisNoise.Nodes.RandomPointInBoxNode`](api-AhahGames-GenesisNoise-Nodes-RandomPointInBoxNode.md#randompointinboxnode), [`AhahGames.GenesisNoise.Nodes.RandomPointInCircleNode`](api-AhahGames-GenesisNoise-Nodes-RandomPointInCircleNode.md#randompointincirclenode), [`AhahGames.GenesisNoise.Nodes.RandomPointInCubeNode`](api-AhahGames-GenesisNoise-Nodes-RandomPointInCubeNode.md#randompointincubenode), [`AhahGames.GenesisNoise.Nodes.RandomPointInSphereNode`](api-AhahGames-GenesisNoise-Nodes-RandomPointInSphereNode.md#randompointinspherenode), [`AhahGames.GenesisNoise.Nodes.RandomVector2Node`](api-AhahGames-GenesisNoise-Nodes-RandomVector2Node.md#randomvector2node), [`AhahGames.GenesisNoise.Nodes.RandomVector3Node`](api-AhahGames-GenesisNoise-Nodes-RandomVector3Node.md#randomvector3node), [`AhahGames.GenesisNoise.Nodes.RandomVector4Node`](api-AhahGames-GenesisNoise-Nodes-RandomVector4Node.md#randomvector4node), [`AhahGames.GenesisNoise.Nodes.RoundNode`](api-AhahGames-GenesisNoise-Nodes-RoundNode.md#roundnode), [`AhahGames.GenesisNoise.Nodes.SinNode`](api-AhahGames-GenesisNoise-Nodes-SinNode.md#sinnode), [`AhahGames.GenesisNoise.Nodes.SinhNode`](api-AhahGames-GenesisNoise-Nodes-SinhNode.md#sinhnode), [`AhahGames.GenesisNoise.Nodes.SqrtNode`](api-AhahGames-GenesisNoise-Nodes-SqrtNode.md#sqrtnode), [`AhahGames.GenesisNoise.Nodes.StringNode`](api-AhahGames-GenesisNoise-Nodes-StringNode.md#stringnode), [`AhahGames.GenesisNoise.Nodes.SubtractNode`](api-AhahGames-GenesisNoise-Nodes-SubtractNode.md#subtractnode-1), [`AhahGames.GenesisNoise.Nodes.TanNode`](api-AhahGames-GenesisNoise-Nodes-TanNode.md#tannode), [`AhahGames.GenesisNoise.Nodes.TanhNode`](api-AhahGames-GenesisNoise-Nodes-TanhNode.md#tanhnode), [`AhahGames.GenesisNoise.Nodes.Texture2DNode`](api-AhahGames-GenesisNoise-Nodes-Texture2DNode.md#texture2dnode), [`AhahGames.GenesisNoise.Nodes.ToBoolNode`](api-AhahGames-GenesisNoise-Nodes-ToBoolNode.md#toboolnode), [`AhahGames.GenesisNoise.Nodes.ToColorNode`](api-AhahGames-GenesisNoise-Nodes-ToColorNode.md#tocolornode), [`AhahGames.GenesisNoise.Nodes.ToFloatNode`](api-AhahGames-GenesisNoise-Nodes-ToFloatNode.md#tofloatnode), [`AhahGames.GenesisNoise.Nodes.ToIntNode`](api-AhahGames-GenesisNoise-Nodes-ToIntNode.md#tointnode), [`AhahGames.GenesisNoise.Nodes.ToQuaternionNode`](api-AhahGames-GenesisNoise-Nodes-ToQuaternionNode.md#toquaternionnode), [`AhahGames.GenesisNoise.Nodes.ToStringNode`](api-AhahGames-GenesisNoise-Nodes-ToStringNode.md#tostringnode), [`AhahGames.GenesisNoise.Nodes.ToVector2IntNode`](api-AhahGames-GenesisNoise-Nodes-ToVector2IntNode.md#tovector2intnode), [`AhahGames.GenesisNoise.Nodes.ToVector2Node`](api-AhahGames-GenesisNoise-Nodes-ToVector2Node.md#tovector2node), [`AhahGames.GenesisNoise.Nodes.ToVector3IntNode`](api-AhahGames-GenesisNoise-Nodes-ToVector3IntNode.md#tovector3intnode), [`AhahGames.GenesisNoise.Nodes.ToVector3Node`](api-AhahGames-GenesisNoise-Nodes-ToVector3Node.md#tovector3node), [`AhahGames.GenesisNoise.Nodes.ToVector4Node`](api-AhahGames-GenesisNoise-Nodes-ToVector4Node.md#tovector4node), [`AhahGames.GenesisNoise.Nodes.Vector2IntNode`](api-AhahGames-GenesisNoise-Nodes-Vector2IntNode.md#vector2intnode), [`AhahGames.GenesisNoise.Nodes.Vector2Node`](api-AhahGames-GenesisNoise-Nodes-Vector2Node.md#vector2node), [`AhahGames.GenesisNoise.Nodes.Vector3IntNode`](api-AhahGames-GenesisNoise-Nodes-Vector3IntNode.md#vector3intnode), [`AhahGames.GenesisNoise.Nodes.Vector3Node`](api-AhahGames-GenesisNoise-Nodes-Vector3Node.md#vector3node), [`AhahGames.GenesisNoise.Nodes.Vector4Node`](api-AhahGames-GenesisNoise-Nodes-Vector4Node.md#vector4node)
...
| Name | Kind | Owner |
|------|------|-------|
| [`NodeGroup`](#nodegroup-93) | `property` | Declared here |
| [`processingTime`](#processingtime) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-48) | `property` | Declared here |
| [`hasSettings`](#hassettings-4) | `property` | Declared here |
| [`canUseUpstreamCaching`](#canuseupstreamcaching-1) | `property` | Declared here |
| [`ProcessNode`](#processnode-29) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`NodeGroup`](#nodegroup-93)  |  |
| `override float` | [`processingTime`](#processingtime)  | Gets the width of the node. |
| `override float` | [`nodeWidth`](#nodewidth-48)  |  |
| `override bool` | [`hasSettings`](#hassettings-4)  |  |
| `override bool` | [`canUseUpstreamCaching`](#canuseupstreamcaching-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/ConstantNode.cs:11
...
```cpp
override float processingTime
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/ConstantNode.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/ConstantNode.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/ConstantNode.cs:20

---

{#canuseupstreamcaching-1}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/ConstantNode.cs:21

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-29) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/ConstantNode.cs:23
