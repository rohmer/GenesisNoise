{#materialbasenodeview}

# MaterialBaseNodeView

```cpp
class MaterialBaseNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/MaterialBaseNodeView.cs:20
