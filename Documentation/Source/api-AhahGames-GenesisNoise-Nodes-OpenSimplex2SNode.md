...
```cpp
class OpenSimplex2SNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/OpenSimplexNodes.cs:56

> **Inherits:** [`AhahGames.GenesisNoise.Nodes.OpenSimplexNodeBase`](api-AhahGames-GenesisNoise-Nodes-OpenSimplexNodeBase.md#opensimplexnodebase)

## List of all members

| Name | Kind | Owner |
|------|------|-------|
| [`Variant`](#variant-1) | `property` | Declared here |
| [`name`](#name-378) | `property` | Declared here |
| [`ShaderName`](#shadername-284) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-350) | `property` | Declared here |
| [`Variant`](api-AhahGames-GenesisNoise-Nodes-OpenSimplexNodeBase.md#variant-2) | `property` | Inherited from [`OpenSimplexNodeBase`](api-AhahGames-GenesisNoise-Nodes-OpenSimplexNodeBase.md#opensimplexnodebase) |
| [`filteredOutProperties`](api-AhahGames-GenesisNoise-Nodes-OpenSimplexNodeBase.md#filteredoutproperties-97) | `property` | Inherited from [`OpenSimplexNodeBase`](api-AhahGames-GenesisNoise-Nodes-OpenSimplexNodeBase.md#opensimplexnodebase) |
| [`ProcessNode`](api-AhahGames-GenesisNoise-Nodes-OpenSimplexNodeBase.md#processnode-90) | `function` | Inherited from [`OpenSimplexNodeBase`](api-AhahGames-GenesisNoise-Nodes-OpenSimplexNodeBase.md#opensimplexnodebase) |
...
## Inherited from [`OpenSimplexNodeBase`](api-AhahGames-GenesisNoise-Nodes-OpenSimplexNodeBase.md#opensimplexnodebase)

| Kind | Name | Description |
|------|------|-------------|
| `property` | [`Variant`](api-AhahGames-GenesisNoise-Nodes-OpenSimplexNodeBase.md#variant-2)  |  |
| `property` | [`filteredOutProperties`](api-AhahGames-GenesisNoise-Nodes-OpenSimplexNodeBase.md#filteredoutproperties-97)  |  |
| `function` | [`ProcessNode`](api-AhahGames-GenesisNoise-Nodes-OpenSimplexNodeBase.md#processnode-90) `virtual` `inline` |  |
...
|--------|------|-------------|
| `override int` | [`Variant`](#variant-1)  |  |
| `override string` | [`name`](#name-378)  |  |
| `override string` | [`ShaderName`](#shadername-284)  |  |
| `override string` | [`NodeGroup`](#nodegroup-350)  |  |
...
```cpp
override int Variant
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/OpenSimplexNodes.cs:58
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/OpenSimplexNodes.cs:60
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/OpenSimplexNodes.cs:61
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/OpenSimplexNodes.cs:62
