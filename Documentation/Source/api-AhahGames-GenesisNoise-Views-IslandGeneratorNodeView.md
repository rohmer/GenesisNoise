{#islandgeneratornodeview}

# IslandGeneratorNodeView

```cpp
class IslandGeneratorNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/IslandGeneratorNodeView.cs:13
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-28) | `property` | Declared here |
| [`Enable`](#enable-121) | `function` | Declared here |
| [`forceEdge`](#forceedge) | `variable` | Declared here |
| [`useCoasts`](#usecoasts-1) | `variable` | Declared here |
| [`forceEdgeOcean`](#forceedgeocean-1) | `variable` | Declared here |
| [`allowLakes`](#allowlakes-1) | `variable` | Declared here |
| [`noiseInfluence`](#noiseinfluence-1) | `variable` | Declared here |
| [`heightCurve`](#heightcurve-1) | `variable` | Declared here |
| [`terrainSize`](#terrainsize-1) | `variable` | Declared here |
...
|--------|------|-------------|
| `IslandGeneratorNode` | [`node`](#node-28)  |  |
...
```cpp
IslandGeneratorNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/IslandGeneratorNodeView.cs:15

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-121) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/IslandGeneratorNodeView.cs:22
...
| Return | Name | Description |
|--------|------|-------------|
| `Toggle` | [`forceEdge`](#forceedge)  |  |
| `Toggle` | [`useCoasts`](#usecoasts-1)  |  |
| `Toggle` | [`forceEdgeOcean`](#forceedgeocean-1)  |  |
| `Toggle` | [`allowLakes`](#allowlakes-1)  |  |
| `Slider` | [`noiseInfluence`](#noiseinfluence-1)  |  |
| `CurveField` | [`heightCurve`](#heightcurve-1)  |  |
| `EnumField` | [`terrainSize`](#terrainsize-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/IslandGeneratorNodeView.cs:16
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/IslandGeneratorNodeView.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/IslandGeneratorNodeView.cs:19
...
```cpp
EnumField terrainSize
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/IslandGeneratorNodeView.cs:20
