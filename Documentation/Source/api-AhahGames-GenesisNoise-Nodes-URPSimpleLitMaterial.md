{#urpsimplelitmaterial}

# URPSimpleLitMaterial

```cpp
class URPSimpleLitMaterial
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPSimpleLitMaterial.cs:11
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-553) | `property` | Declared here |
| [`hasPreview`](#haspreview-90) | `property` | Declared here |
| [`previewTexture`](#previewtexture-53) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-508) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-199) | `property` | Declared here |
| [`MaterialOutput`](#materialoutput-9) | `property` | Declared here |
| [`asset`](#asset-11) | `variable` | Declared here |
| [`primitiveType`](#primitivetype-10) | `variable` | Declared here |
| [`baseColor`](#basecolor-7) | `variable` | Declared here |
| [`specularColor`](#specularcolor-1) | `variable` | Declared here |
| [`smoothnessAmount`](#smoothnessamount-6) | `variable` | Declared here |
| [`Render`](#render-9) | `function` | Declared here |
| [`Enable`](#enable-87) | `function` | Declared here |
| [`baseMap`](#basemap-7) | `variable` | Declared here |
| [`specularMap`](#specularmap-1) | `variable` | Declared here |
| [`normalMap`](#normalmap-7) | `variable` | Declared here |
| [`OutputMaterial`](#outputmaterial-9) | `variable` | Declared here |
| [`preview`](#preview-15) | `variable` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-553)  |  |
| `override bool` | [`hasPreview`](#haspreview-90)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-53)  |  |
| `override string` | [`NodeGroup`](#nodegroup-508)  |  |
| `override float` | [`nodeWidth`](#nodewidth-199)  |  |
| `Material` | [`MaterialOutput`](#materialoutput-9)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPSimpleLitMaterial.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPSimpleLitMaterial.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPSimpleLitMaterial.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPSimpleLitMaterial.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPSimpleLitMaterial.cs:25
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPSimpleLitMaterial.cs:28

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `Material` | [`asset`](#asset-11)  |  |
| `PrimitiveType` | [`primitiveType`](#primitivetype-10)  |  |
| `Color` | [`baseColor`](#basecolor-7)  |  |
| `Color` | [`specularColor`](#specularcolor-1)  |  |
| `float` | [`smoothnessAmount`](#smoothnessamount-6)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPSimpleLitMaterial.cs:27
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPSimpleLitMaterial.cs:30
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPSimpleLitMaterial.cs:31
...
```cpp
Color specularColor = new Color(0.5f, 0.5f, 0.5f, 0.5f)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPSimpleLitMaterial.cs:32
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPSimpleLitMaterial.cs:33

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`Render`](#render-9) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPSimpleLitMaterial.cs:42

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-87) `virtual` `inline` | Called when the node is enabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPSimpleLitMaterial.cs:35
...
| Return | Name | Description |
|--------|------|-------------|
| `Texture` | [`baseMap`](#basemap-7)  |  |
| `Texture` | [`specularMap`](#specularmap-1)  |  |
| `Texture` | [`normalMap`](#normalmap-7)  |  |
| `Material` | [`OutputMaterial`](#outputmaterial-9)  |  |
| `Texture2D` | [`preview`](#preview-15)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPSimpleLitMaterial.cs:13
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPSimpleLitMaterial.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPSimpleLitMaterial.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPSimpleLitMaterial.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPSimpleLitMaterial.cs:20
