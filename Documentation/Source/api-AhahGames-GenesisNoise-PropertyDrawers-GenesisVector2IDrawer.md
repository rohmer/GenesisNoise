{#genesisvector2idrawer}

# GenesisVector2IDrawer

```cpp
class GenesisVector2IDrawer
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisVector2IDrawer.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`DrawerGUI`](#drawergui-27) | `function` | Declared here |
...
|--------|------|-------------|
| `override void` | [`DrawerGUI`](#drawergui-27) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisVector2IDrawer.cs:12
