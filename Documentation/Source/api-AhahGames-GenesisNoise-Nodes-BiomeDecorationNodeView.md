{#biomedecorationnodeview}

# BiomeDecorationNodeView

```cpp
class BiomeDecorationNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeDecorationNodeView.cs:15

> **Inherits:** [`AhahGames.GenesisNoise.Views.GenesisNodeView`](api-AhahGames-GenesisNoise-Views-GenesisNodeView.md#genesisnodeview)

## List of all members

| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-7) | `property` | Declared here |
| [`Enable`](#enable-17) | `function` | Declared here |
| [`Disable`](#disable-5) | `function` | Declared here |
| [`controlSets`](#controlsets) | `variable` | Declared here |
| [`prefabListContainer`](#prefablistcontainer) | `variable` | Declared here |
| [`OnPrefabPortConnected`](#onprefabportconnected) | `function` | Declared here |
| [`OnPrefabPortDisconnected`](#onprefabportdisconnected) | `function` | Declared here |
| [`OnNodeEdgeDisconnected`](#onnodeedgedisconnected) | `function` | Declared here |
| [`IsPrefabPort`](#isprefabport) | `function` | Declared here |
| [`RefreshConnectedPrefabs`](#refreshconnectedprefabs) | `function` | Declared here |
| [`CreateSection`](#createsection) | `function` | Declared here |
| [`CreateIndentedContainer`](#createindentedcontainer) | `function` | Declared here |
| [`CreateObjectField`](#createobjectfield) | `function` | Declared here |
| [`CreateSlider`](#createslider) | `function` | Declared here |
| [`CreateFloatField`](#createfloatfield) | `function` | Declared here |
| [`CreateToggle`](#createtoggle) | `function` | Declared here |
| [`CreateAxisToggle`](#createaxistoggle) | `function` | Declared here |
| [`StyleControl`](#stylecontrol) | `function` | Declared here |
| [`SetDecorationValue`](#setdecorationvalue) | `function` | Declared here |
| [`SynchronizeNodeControls`](#synchronizenodecontrols) | `function` | Declared here |
| [`RebuildPrefabList`](#rebuildprefablist) | `function` | Declared here |
| [`UpdateConditionalVisibility`](#updateconditionalvisibility) | `function` | Declared here |
...
|--------|------|-------------|
| `BiomeDecorationNode` | [`node`](#node-7)  |  |
...
```cpp
BiomeDecorationNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeDecorationNodeView.cs:17

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-17) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-5) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeDecorationNodeView.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeDecorationNodeView.cs:126
...
| Return | Name | Description |
|--------|------|-------------|
| `readonly List< DecorationControls >` | [`controlSets`](#controlsets)  |  |
| `VisualElement` | [`prefabListContainer`](#prefablistcontainer)  |  |
...
```cpp
readonly List< DecorationControls > controlSets = new()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeDecorationNodeView.cs:18
...
```cpp
VisualElement prefabListContainer
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeDecorationNodeView.cs:19

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`OnPrefabPortConnected`](#onprefabportconnected) `inline` |  |
| `void` | [`OnPrefabPortDisconnected`](#onprefabportdisconnected) `inline` |  |
| `void` | [`OnNodeEdgeDisconnected`](#onnodeedgedisconnected) `inline` |  |
| `bool` | [`IsPrefabPort`](#isprefabport) `inline` |  |
| `void` | [`RefreshConnectedPrefabs`](#refreshconnectedprefabs) `inline` |  |
| `Foldout` | [`CreateSection`](#createsection) `inline` |  |
| `VisualElement` | [`CreateIndentedContainer`](#createindentedcontainer) `inline` |  |
| `ObjectField` | [`CreateObjectField`](#createobjectfield) `inline` |  |
| `Slider` | [`CreateSlider`](#createslider) `inline` |  |
| `FloatField` | [`CreateFloatField`](#createfloatfield) `inline` |  |
| `Toggle` | [`CreateToggle`](#createtoggle) `inline` |  |
| `Toggle` | [`CreateAxisToggle`](#createaxistoggle) `inline` |  |
| `void` | [`StyleControl`](#stylecontrol) `inline` |  |
| `void` | [`SetDecorationValue`](#setdecorationvalue) `inline` |  |
| `void` | [`SynchronizeNodeControls`](#synchronizenodecontrols) `inline` |  |
| `void` | [`RebuildPrefabList`](#rebuildprefablist) `inline` |  |
| `void` | [`UpdateConditionalVisibility`](#updateconditionalvisibility) `inline` |  |

---

{#onprefabportconnected}
...
```cpp
inline void OnPrefabPortConnected(PortView port)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeDecorationNodeView.cs:135

---

{#onprefabportdisconnected}
...
```cpp
inline void OnPrefabPortDisconnected(PortView port)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeDecorationNodeView.cs:141

---

{#onnodeedgedisconnected}
...
```cpp
inline void OnNodeEdgeDisconnected(SerializableEdge edge)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeDecorationNodeView.cs:147
...
```cpp
inline bool IsPrefabPort(PortView port)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeDecorationNodeView.cs:158

---

{#refreshconnectedprefabs}
...
```cpp
inline void RefreshConnectedPrefabs()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeDecorationNodeView.cs:163
...
```cpp
inline Foldout CreateSection(string title)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeDecorationNodeView.cs:173

---

{#createindentedcontainer}
...
```cpp
inline VisualElement CreateIndentedContainer()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeDecorationNodeView.cs:187
...
```cpp
inline ObjectField CreateObjectField(string label, System.Type objectType, Object value)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeDecorationNodeView.cs:196
...
```cpp
inline Slider CreateSlider(string label, float value, float lowValue, float highValue)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeDecorationNodeView.cs:208
...
```cpp
inline FloatField CreateFloatField(string label, float value)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeDecorationNodeView.cs:219
...
```cpp
inline Toggle CreateToggle(string label, bool value, System.Action< bool > assign, string undoName)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeDecorationNodeView.cs:229
...
```cpp
inline Toggle CreateAxisToggle(string label, bool value, System.Action< bool > assign)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeDecorationNodeView.cs:243
...
```cpp
inline void StyleControl(VisualElement element)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeDecorationNodeView.cs:257
...
```cpp
inline void SetDecorationValue(string undoName, System.Action setter)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeDecorationNodeView.cs:263

---

{#synchronizenodecontrols}
...
```cpp
inline void SynchronizeNodeControls()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeDecorationNodeView.cs:272
...
```cpp
inline void RebuildPrefabList()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeDecorationNodeView.cs:295
...
```cpp
inline void UpdateConditionalVisibility(DecorationControls controls)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeDecorationNodeView.cs:342
