{#urpcomplexlitmaterial}

# URPComplexLitMaterial

```cpp
class URPComplexLitMaterial
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPComplexLitMaterial.cs:11
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-551) | `property` | Declared here |
| [`hasPreview`](#haspreview-88) | `property` | Declared here |
| [`previewTexture`](#previewtexture-51) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-506) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-197) | `property` | Declared here |
| [`MaterialOutput`](#materialoutput-7) | `property` | Declared here |
| [`asset`](#asset-9) | `variable` | Declared here |
| [`primitiveType`](#primitivetype-8) | `variable` | Declared here |
| [`baseColor`](#basecolor-5) | `variable` | Declared here |
| [`specularColor`](#specularcolor) | `variable` | Declared here |
| [`metallicAmount`](#metallicamount-4) | `variable` | Declared here |
| [`smoothnessAmount`](#smoothnessamount-4) | `variable` | Declared here |
| [`Render`](#render-7) | `function` | Declared here |
| [`Enable`](#enable-85) | `function` | Declared here |
| [`baseMap`](#basemap-5) | `variable` | Declared here |
| [`specularMap`](#specularmap) | `variable` | Declared here |
| [`normalMap`](#normalmap-5) | `variable` | Declared here |
| [`OutputMaterial`](#outputmaterial-7) | `variable` | Declared here |
| [`preview`](#preview-13) | `variable` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-551)  |  |
| `override bool` | [`hasPreview`](#haspreview-88)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-51)  |  |
| `override string` | [`NodeGroup`](#nodegroup-506)  |  |
| `override float` | [`nodeWidth`](#nodewidth-197)  |  |
| `Material` | [`MaterialOutput`](#materialoutput-7)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPComplexLitMaterial.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPComplexLitMaterial.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPComplexLitMaterial.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPComplexLitMaterial.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPComplexLitMaterial.cs:25
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPComplexLitMaterial.cs:28

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `Material` | [`asset`](#asset-9)  |  |
| `PrimitiveType` | [`primitiveType`](#primitivetype-8)  |  |
| `Color` | [`baseColor`](#basecolor-5)  |  |
| `Color` | [`specularColor`](#specularcolor)  |  |
| `float` | [`metallicAmount`](#metallicamount-4)  |  |
| `float` | [`smoothnessAmount`](#smoothnessamount-4)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPComplexLitMaterial.cs:27
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPComplexLitMaterial.cs:30
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPComplexLitMaterial.cs:31
...
```cpp
Color specularColor = new Color(0.2f, 0.2f, 0.2f, 1f)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPComplexLitMaterial.cs:32
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPComplexLitMaterial.cs:33
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPComplexLitMaterial.cs:34

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`Render`](#render-7) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPComplexLitMaterial.cs:43

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-85) `virtual` `inline` | Called when the node is enabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPComplexLitMaterial.cs:36
...
| Return | Name | Description |
|--------|------|-------------|
| `Texture` | [`baseMap`](#basemap-5)  |  |
| `Texture` | [`specularMap`](#specularmap)  |  |
| `Texture` | [`normalMap`](#normalmap-5)  |  |
| `Material` | [`OutputMaterial`](#outputmaterial-7)  |  |
| `Texture2D` | [`preview`](#preview-13)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPComplexLitMaterial.cs:13
...
```cpp
Texture specularMap = default
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPComplexLitMaterial.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPComplexLitMaterial.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPComplexLitMaterial.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/URP/URPComplexLitMaterial.cs:20
