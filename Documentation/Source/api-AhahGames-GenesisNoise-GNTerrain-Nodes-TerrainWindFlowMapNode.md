{#terrainwindflowmapnode}

# TerrainWindFlowMapNode

```cpp
class TerrainWindFlowMapNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainWindFlowMapNode.cs:16
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-605) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-88) | `property` | Declared here |
| [`hasPreview`](#haspreview-101) | `property` | Declared here |
| [`hasSettings`](#hassettings-32) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-217) | `property` | Declared here |
| [`previewTexture`](#previewtexture-63) | `property` | Declared here |
| [`TerrainInput`](#terraininput-6) | `variable` | Declared here |
| [`FlowMap`](#flowmap) | `variable` | Declared here |
| [`Enable`](#enable-198) | `function` | Declared here |
| [`ProcessNode`](#processnode-151) | `function` | Declared here |
| [`Disable`](#disable-85) | `function` | Declared here |
| [`preview`](#preview-23) | `variable` | Declared here |
| [`previewRequestVersion`](#previewrequestversion-10) | `variable` | Declared here |
| [`shader`](#shader-13) | `variable` | Declared here |
| [`kernel`](#kernel-5) | `variable` | Declared here |
| [`RequestPreview`](#requestpreview-10) | `function` | Declared here |
| [`ThreadGroupSize`](#threadgroupsize-10) | `variable` | Declared here |
| [`EncodeWindColor`](#encodewindcolor) | `function` | Declared here |
| [`ClearTexture`](#cleartexture-5) | `function` | Declared here |
| [`DestroyPreview`](#destroypreview-9) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-605)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-88)  |  |
| `override bool` | [`hasPreview`](#haspreview-101)  |  |
| `override bool` | [`hasSettings`](#hassettings-32)  |  |
| `override float` | [`nodeWidth`](#nodewidth-217)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-63)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainWindFlowMapNode.cs:43

---

{#showdefaultinspector-88}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainWindFlowMapNode.cs:44
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainWindFlowMapNode.cs:45
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainWindFlowMapNode.cs:46
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainWindFlowMapNode.cs:47
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainWindFlowMapNode.cs:48

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `HeightField` | [`TerrainInput`](#terraininput-6)  |  |
| `RenderTexture` | [`FlowMap`](#flowmap)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainWindFlowMapNode.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainWindFlowMapNode.cs:22

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-198) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-151) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-85) `virtual` `inline` | Called when the node is disabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainWindFlowMapNode.cs:50
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainWindFlowMapNode.cs:56
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainWindFlowMapNode.cs:149
...
| Return | Name | Description |
|--------|------|-------------|
| `Texture2D` | [`preview`](#preview-23)  |  |
| `int` | [`previewRequestVersion`](#previewrequestversion-10)  |  |
| `ComputeShader` | [`shader`](#shader-13)  |  |
| `int` | [`kernel`](#kernel-5)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainWindFlowMapNode.cs:36

---

{#previewrequestversion-10}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainWindFlowMapNode.cs:37
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainWindFlowMapNode.cs:38
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainWindFlowMapNode.cs:39

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RequestPreview`](#requestpreview-10) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainWindFlowMapNode.cs:128

## Private Static Attributes

| Return | Name | Description |
|--------|------|-------------|
| `const int` | [`ThreadGroupSize`](#threadgroupsize-10) `static` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainWindFlowMapNode.cs:41

## Private Static Methods

| Return | Name | Description |
|--------|------|-------------|
| `Color` | [`EncodeWindColor`](#encodewindcolor) `static` `inline` |  |
| `void` | [`ClearTexture`](#cleartexture-5) `static` `inline` |  |
| `void` | [`DestroyPreview`](#destroypreview-9) `static` `inline` |  |
...
```cpp
static inline Color EncodeWindColor(Vector2 windDirection, float strength)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainWindFlowMapNode.cs:114
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainWindFlowMapNode.cs:120
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainWindFlowMapNode.cs:158
