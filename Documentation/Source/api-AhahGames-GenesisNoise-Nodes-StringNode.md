...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/StringNode.cs:11
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-491) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-457) | `property` | Declared here |
| [`output`](#output-87) | `variable` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-491)  |  |
| `override string` | [`NodeGroup`](#nodegroup-457)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/StringNode.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/StringNode.cs:16

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `string` | [`output`](#output-87)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/StringNode.cs:14
