{#heightnormalblendnode}

# HeightNormalBlendNode

```cpp
class HeightNormalBlendNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Normals/HeightNormalBlendNode.cs:16
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-259) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-235) | `property` | Declared here |
| [`ShaderName`](#shadername-196) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-259)  |  |
| `override string` | [`NodeGroup`](#nodegroup-235)  |  |
| `override string` | [`ShaderName`](#shadername-196)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Normals/HeightNormalBlendNode.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Normals/HeightNormalBlendNode.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Normals/HeightNormalBlendNode.cs:20
