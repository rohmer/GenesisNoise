{#meshnoisedisplacementnode}

# MeshNoiseDisplacementNode

```cpp
class MeshNoiseDisplacementNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:18
...
| Name | Kind | Owner |
|------|------|-------|
| [`hasPreview`](#haspreview-55) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-302) | `property` | Declared here |
| [`name`](#name-329) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-40) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-121) | `property` | Declared here |
| [`previewTexture`](#previewtexture-24) | `property` | Declared here |
| [`loopInput`](#loopinput-3) | `variable` | Declared here |
| [`loopOutput`](#loopoutput-3) | `variable` | Declared here |
| [`input`](#input-17) | `variable` | Declared here |
| [`noise`](#noise) | `variable` | Declared here |
| [`origin`](#origin-1) | `variable` | Declared here |
| [`output`](#output-49) | `variable` | Declared here |
| [`PrepareNewLoopRun`](#preparenewlooprun-3) | `function` | Declared here |
| [`Enable`](#enable-50) | `function` | Declared here |
| [`ProcessNode`](#processnode-73) | `function` | Declared here |
| [`Disable`](#disable-27) | `function` | Declared here |
| [`meshStates`](#meshstates-1) | `variable` | Declared here |
| [`TryGetInputMesh`](#trygetinputmesh-1) | `function` | Declared here |
| [`ResolveCurrentInputMesh`](#resolvecurrentinputmesh-1) | `function` | Declared here |
| [`ClearGeneratedMeshes`](#cleargeneratedmeshes-2) | `function` | Declared here |
| [`IsLoopMode`](#isloopmode-2) | `function` | Declared here |
| [`ReadMeshData`](#readmeshdata-1) | `function` | Declared here |
| [`RefreshCollider`](#refreshcollider-1) | `function` | Declared here |
| [`ReadNoiseData`](#readnoisedata) | `function` | Declared here |
| [`DisplaceMeshData`](#displacemeshdata) | `function` | Declared here |
| [`CloseCoincidentVertexSeams`](#closecoincidentvertexseams) | `function` | Declared here |
| [`GetBounds`](#getbounds-1) | `function` | Declared here |
| [`RegeneratePlanarUVs`](#regenerateplanaruvs-1) | `function` | Declared here |
| [`GetPlanarUV`](#getplanaruv-1) | `function` | Declared here |
| [`OffsetUVByOrigin`](#offsetuvbyorigin) | `function` | Declared here |
| [`SampleNoise`](#samplenoise) | `function` | Declared here |
| [`BuildOrUpdateUnityMesh`](#buildorupdateunitymesh) | `function` | Declared here |
| [`Luminance`](#luminance) | `function` | Declared here |
| [`Lerp`](#lerp-24) | `function` | Declared here |
| [`Clamp01`](#clamp01) | `function` | Declared here |
| [`Repeat01PreserveOne`](#repeat01preserveone) | `function` | Declared here |
...
|--------|------|-------------|
| `override bool` | [`hasPreview`](#haspreview-55)  |  |
| `override string` | [`NodeGroup`](#nodegroup-302)  |  |
| `override string` | [`name`](#name-329)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-40)  |  |
| `override float` | [`nodeWidth`](#nodewidth-121)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-24)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:44
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:45
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:46

---

{#showdefaultinspector-40}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:47
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:48
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:52

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `object` | [`loopInput`](#loopinput-3)  |  |
| `object` | [`loopOutput`](#loopoutput-3)  |  |
| `GameObject` | [`input`](#input-17)  |  |
| `CustomRenderTexture` | [`noise`](#noise)  |  |
| `Vector2` | [`origin`](#origin-1)  |  |
| `GameObject` | [`output`](#output-49)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:27
...
```cpp
CustomRenderTexture noise
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:30
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:33
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:36

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`PrepareNewLoopRun`](#preparenewlooprun-3) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:75
...
| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-50) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-73) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-27) `virtual` `inline` | Called when the node is disabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:54
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:60
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:69
...
| Return | Name | Description |
|--------|------|-------------|
| `readonly Dictionary< GameObject, MeshState >` | [`meshStates`](#meshstates-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:42

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `bool` | [`TryGetInputMesh`](#trygetinputmesh-1) `inline` |  |
| `Mesh` | [`ResolveCurrentInputMesh`](#resolvecurrentinputmesh-1) `inline` |  |
| `void` | [`ClearGeneratedMeshes`](#cleargeneratedmeshes-2) `inline` |  |
| `bool` | [`IsLoopMode`](#isloopmode-2) `inline` |  |
| `MeshBuildData` | [`ReadMeshData`](#readmeshdata-1) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:154

---

{#resolvecurrentinputmesh-1}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:194

---

{#cleargeneratedmeshes-2}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:220
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:231
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:273

## Private Static Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RefreshCollider`](#refreshcollider-1) `static` `inline` |  |
| `NoiseData` | [`ReadNoiseData`](#readnoisedata) `static` `inline` |  |
| `MeshBuildData` | [`DisplaceMeshData`](#displacemeshdata) `static` `inline` |  |
| `void` | [`CloseCoincidentVertexSeams`](#closecoincidentvertexseams) `static` `inline` |  |
| `void` | [`GetBounds`](#getbounds-1) `static` `inline` |  |
| `Vector2[]` | [`RegeneratePlanarUVs`](#regenerateplanaruvs-1) `static` `inline` |  |
| `Vector2` | [`GetPlanarUV`](#getplanaruv-1) `static` `inline` |  |
| `Vector2` | [`OffsetUVByOrigin`](#offsetuvbyorigin) `static` `inline` |  |
| `float` | [`SampleNoise`](#samplenoise) `static` `inline` |  |
| `Mesh` | [`BuildOrUpdateUnityMesh`](#buildorupdateunitymesh) `static` `inline` |  |
| `float` | [`Luminance`](#luminance) `static` `inline` |  |
| `float` | [`Lerp`](#lerp-24) `static` `inline` |  |
| `float` | [`Clamp01`](#clamp01) `static` `inline` |  |
| `float` | [`Repeat01PreserveOne`](#repeat01preserveone) `static` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:237
...
```cpp
static inline NoiseData ReadNoiseData(RenderTexture source)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:299
...
```cpp
static inline MeshBuildData DisplaceMeshData(MeshBuildData sourceData, NoiseData noiseData, float strength, bool alongNormals, bool centeredNoise, Vector2 origin)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:334
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:372
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:427

---

{#regenerateplanaruvs-1}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:449
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:458
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:465
...
```cpp
static inline float SampleNoise(NoiseData noiseData, float u, float v)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:472
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:496
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:534
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:535
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:536
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshNoiseDisplacementNode.cs:537
