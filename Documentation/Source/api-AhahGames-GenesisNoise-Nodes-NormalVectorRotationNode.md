{#normalvectorrotationnode}

# NormalVectorRotationNode

```cpp
class NormalVectorRotationNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Normals/NormalVectorRotationNode.cs:18
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-373) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-345) | `property` | Declared here |
| [`ShaderName`](#shadername-279) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-373)  |  |
| `override string` | [`NodeGroup`](#nodegroup-345)  |  |
| `override string` | [`ShaderName`](#shadername-279)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Normals/NormalVectorRotationNode.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Normals/NormalVectorRotationNode.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Normals/NormalVectorRotationNode.cs:22
