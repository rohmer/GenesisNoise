...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Utility/DebugNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-14) | `property` | Declared here |
| [`Enable`](#enable-101) | `function` | Declared here |
| [`debugValue`](#debugvalue) | `variable` | Declared here |
| [`NodeTarget_onProcessed`](#nodetarget_onprocessed-3) | `function` | Declared here |
| [`DebugNodeView_onPortDisconnected`](#debugnodeview_onportdisconnected) | `function` | Declared here |
| [`DebugNodeView_onPortConnected`](#debugnodeview_onportconnected) | `function` | Declared here |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Utility/DebugNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-101) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Utility/DebugNodeView.cs:15
...
| Return | Name | Description |
|--------|------|-------------|
| `TextField` | [`debugValue`](#debugvalue)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Utility/DebugNodeView.cs:13

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`NodeTarget_onProcessed`](#nodetarget_onprocessed-3) `inline` |  |
| `void` | [`DebugNodeView_onPortDisconnected`](#debugnodeview_onportdisconnected) `inline` |  |
| `void` | [`DebugNodeView_onPortConnected`](#debugnodeview_onportconnected) `inline` |  |

---

{#nodetarget_onprocessed-3}

### NodeTarget_onProcessed

`inline`

```cpp
inline void NodeTarget_onProcessed()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Utility/DebugNodeView.cs:31

---

{#debugnodeview_onportdisconnected}
...
```cpp
inline void DebugNodeView_onPortDisconnected(PortView obj)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Utility/DebugNodeView.cs:38

---

{#debugnodeview_onportconnected}
...
```cpp
inline void DebugNodeView_onPortConnected(PortView obj)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Utility/DebugNodeView.cs:45
