...
```cpp
class GradientNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Constant/GradientNodeView.cs:13
...
| Name | Kind | Owner |
|------|------|-------|
| [`Enable`](#enable-111) | `function` | Declared here |
| [`gradientNode`](#gradientnode-1) | `variable` | Declared here |
...
|--------|------|-------------|
| `override void` | [`Enable`](#enable-111) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Constant/GradientNodeView.cs:17
...
| Return | Name | Description |
|--------|------|-------------|
| `GradientNode` | [`gradientNode`](#gradientnode-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Constant/GradientNodeView.cs:15
