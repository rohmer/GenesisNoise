{#vector2parameterdrawer}

# Vector2ParameterDrawer

```cpp
class Vector2ParameterDrawer
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Utils/ExposedParameterDrawer.cs:124
...
| Name | Kind | Owner |
|------|------|-------|
| [`CreatePropertyGUI`](#createpropertygui-13) | `function` | Declared here |
...
|--------|------|-------------|
| `override VisualElement` | [`CreatePropertyGUI`](#createpropertygui-13) `inline` |  |

---

{#createpropertygui-13}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Utils/ExposedParameterDrawer.cs:126
