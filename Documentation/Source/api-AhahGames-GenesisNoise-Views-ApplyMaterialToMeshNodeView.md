{#applymaterialtomeshnodeview}

# ApplyMaterialToMeshNodeView

```cpp
class ApplyMaterialToMeshNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/ApplyMaterialToMeshNodeView.cs:14
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-11) | `property` | Declared here |
| [`Enable`](#enable-92) | `function` | Declared here |
| [`materialField`](#materialfield) | `variable` | Declared here |
| [`regenUVs`](#regenuvs) | `variable` | Declared here |
| [`materialHash`](#materialhash) | `variable` | Declared here |
| [`MaterialGUI`](#materialgui) | `function` | Declared here |
| [`ResetMaterialPropertyToDefault`](#resetmaterialpropertytodefault-1) | `function` | Declared here |
...
|--------|------|-------------|
| `ApplyMaterialToMeshNode` | [`node`](#node-11)  |  |
...
```cpp
ApplyMaterialToMeshNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/ApplyMaterialToMeshNodeView.cs:16

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-92) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/ApplyMaterialToMeshNodeView.cs:23

## Private Attributes

| Return | Name | Description |
|--------|------|-------------|
| `ObjectField` | [`materialField`](#materialfield)  |  |
| `Toggle` | [`regenUVs`](#regenuvs)  |  |
| `int` | [`materialHash`](#materialhash)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/ApplyMaterialToMeshNodeView.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/ApplyMaterialToMeshNodeView.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/ApplyMaterialToMeshNodeView.cs:21

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`MaterialGUI`](#materialgui) `inline` |  |
| `void` | [`ResetMaterialPropertyToDefault`](#resetmaterialpropertytodefault-1) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/ApplyMaterialToMeshNodeView.cs:66

---

{#resetmaterialpropertytodefault-1}
...
```cpp
inline void ResetMaterialPropertyToDefault(PortView portView)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/ApplyMaterialToMeshNodeView.cs:90
