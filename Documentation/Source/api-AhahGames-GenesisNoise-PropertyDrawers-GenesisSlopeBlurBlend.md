{#genesisslopeblurblend}

# GenesisSlopeBlurBlend

```cpp
class GenesisSlopeBlurBlend
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisSlopeBlurBlend.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`DrawerGUI`](#drawergui-22) | `function` | Declared here |
| [`BlendMode`](#blendmode) | `enum` | Declared here |
...
|--------|------|-------------|
| `override void` | [`DrawerGUI`](#drawergui-22) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisSlopeBlurBlend.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisSlopeBlurBlend.cs:12
