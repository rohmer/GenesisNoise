{#hdrplayeredlittessellationmaterialnodeview}

# HDRPLayeredLitTessellationMaterialNodeView

```cpp
class HDRPLayeredLitTessellationMaterialNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/HDRP/HDRPLayeredLitTessellationMaterialNodeView.cs:14
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-22) | `property` | Declared here |
| [`Enable`](#enable-115) | `function` | Declared here |
...
|--------|------|-------------|
| `HDRPLayeredLitTessellationMaterial` | [`node`](#node-22)  |  |
...
```cpp
HDRPLayeredLitTessellationMaterial node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/HDRP/HDRPLayeredLitTessellationMaterialNodeView.cs:16

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-115) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/HDRP/HDRPLayeredLitTessellationMaterialNodeView.cs:18
