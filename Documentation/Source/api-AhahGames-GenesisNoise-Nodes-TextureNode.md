...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/TextureNode.cs:20
...
| Name | Kind | Owner |
|------|------|-------|
| [`NodeGroup`](#nodegroup-476) | `property` | Declared here |
| [`canEditPreviewSRGB`](#caneditpreviewsrgb-4) | `property` | Declared here |
| [`hasSettings`](#hassettings-21) | `property` | Declared here |
| [`name`](#name-517) | `property` | Declared here |
| [`previewTexture`](#previewtexture-48) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-75) | `property` | Declared here |
| [`isRenamable`](#isrenamable-8) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-180) | `property` | Declared here |
| [`textureAsset`](#textureasset) | `variable` | Declared here |
| [`outputTexture`](#outputtexture) | `variable` | Declared here |
| [`POTMode`](#potmode) | `variable` | Declared here |
| [`IsPowerOf2`](#ispowerof2) | `function` | Declared here |
| [`InitializeNodeFromObject`](#initializenodefromobject-9) | `function` | Declared here |
| [`ProcessNode`](#processnode-135) | `function` | Declared here |
| [`PowerOf2Mode`](#powerof2mode) | `enum` | Declared here |
| [`normalMap`](#normalmap-3) | `variable` | Declared here |
| [`postProcessedTexture`](#postprocessedtexture) | `variable` | Declared here |
| [`OutputTextureType`](#outputtexturetype) | `function` | Declared here |
| [`IsInputImportedTexture`](#isinputimportedtexture) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`NodeGroup`](#nodegroup-476)  |  |
| `override bool` | [`canEditPreviewSRGB`](#caneditpreviewsrgb-4)  |  |
| `override bool` | [`hasSettings`](#hassettings-21)  |  |
| `override string` | [`name`](#name-517)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-48)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-75)  |  |
| `override bool` | [`isRenamable`](#isrenamable-8)  |  |
| `override float` | [`nodeWidth`](#nodewidth-180)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/TextureNode.cs:33

---

{#caneditpreviewsrgb-4}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/TextureNode.cs:34
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/TextureNode.cs:36
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/TextureNode.cs:37
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/TextureNode.cs:38

---

{#showdefaultinspector-75}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/TextureNode.cs:39
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/TextureNode.cs:40
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/TextureNode.cs:41
...
| `Texture` | [`outputTexture`](#outputtexture)  |  |
| `PowerOf2Mode` | [`POTMode`](#potmode)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/TextureNode.cs:30
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/TextureNode.cs:32
...
```cpp
PowerOf2Mode POTMode = PowerOf2Mode.None
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/TextureNode.cs:42

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `bool` | [`IsPowerOf2`](#ispowerof2) `inline` |  |
| `bool` | [`InitializeNodeFromObject`](#initializenodefromobject-9) `inline` |  |
...
```cpp
inline bool IsPowerOf2(Texture t)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/TextureNode.cs:63

---

{#initializenodefromobject-9}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/TextureNode.cs:185

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-135) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/TextureNode.cs:81
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/TextureNode.cs:22
...
| Return | Name | Description |
|--------|------|-------------|
| `bool` | [`normalMap`](#normalmap-3)  |  |
| `RenderTexture` | [`postProcessedTexture`](#postprocessedtexture)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/TextureNode.cs:45
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/TextureNode.cs:48

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `IEnumerable< PortData >` | [`OutputTextureType`](#outputtexturetype) `inline` |  |
| `bool` | [`IsInputImportedTexture`](#isinputimportedtexture) `inline` |  |
...
```cpp
inline IEnumerable< PortData > OutputTextureType(List< SerializableEdge > edges)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/TextureNode.cs:51

---

{#isinputimportedtexture}
...
```cpp
inline bool IsInputImportedTexture()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/TextureNode.cs:175
