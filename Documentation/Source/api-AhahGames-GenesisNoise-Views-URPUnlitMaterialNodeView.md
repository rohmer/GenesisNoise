{#urpunlitmaterialnodeview}

# URPUnlitMaterialNodeView

```cpp
class URPUnlitMaterialNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/URP/URPUnlitMaterialNodeView.cs:14
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-85) | `property` | Declared here |
| [`Enable`](#enable-185) | `function` | Declared here |
...
```cpp
URPUnlitMaterial node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/URP/URPUnlitMaterialNodeView.cs:16

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-185) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/URP/URPUnlitMaterialNodeView.cs:18
