...
```cpp
class DifferenceOfGaussiansNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Edge Detect/DifferenceOfGaussiansNode.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-139) | `property` | Declared here |
| [`ShaderName`](#shadername-96) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-120) | `property` | Declared here |
| [`DisplayMaterialInspector`](#displaymaterialinspector-46) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-139)  |  |
| `override string` | [`ShaderName`](#shadername-96)  |  |
| `override string` | [`NodeGroup`](#nodegroup-120)  |  |
| `override bool` | [`DisplayMaterialInspector`](#displaymaterialinspector-46)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Edge Detect/DifferenceOfGaussiansNode.cs:12
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Edge Detect/DifferenceOfGaussiansNode.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Edge Detect/DifferenceOfGaussiansNode.cs:15

---

{#displaymaterialinspector-46}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Edge Detect/DifferenceOfGaussiansNode.cs:16
