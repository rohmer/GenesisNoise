{#meshprefabsavenodeview}

# MeshPrefabSaveNodeView

```cpp
class MeshPrefabSaveNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshPrefabSaveNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-34) | `property` | Declared here |
| [`Enable`](#enable-129) | `function` | Declared here |
| [`folderPath`](#folderpath) | `variable` | Declared here |
| [`prefabName`](#prefabname) | `variable` | Declared here |
| [`saveOnProcess`](#saveonprocess) | `variable` | Declared here |
| [`includeInactiveChildren`](#includeinactivechildren) | `variable` | Declared here |
| [`saveButton`](#savebutton) | `variable` | Declared here |
...
|--------|------|-------------|
| `MeshPrefabSaveNode` | [`node`](#node-34)  |  |
...
```cpp
MeshPrefabSaveNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshPrefabSaveNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-129) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshPrefabSaveNodeView.cs:20

## Private Attributes

| Return | Name | Description |
|--------|------|-------------|
| `TextField` | [`folderPath`](#folderpath)  |  |
| `TextField` | [`prefabName`](#prefabname)  |  |
| `Toggle` | [`saveOnProcess`](#saveonprocess)  |  |
| `Toggle` | [`includeInactiveChildren`](#includeinactivechildren)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshPrefabSaveNodeView.cs:14
...
```cpp
TextField prefabName
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshPrefabSaveNodeView.cs:15
...
```cpp
Toggle saveOnProcess
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshPrefabSaveNodeView.cs:16
...
```cpp
Toggle includeInactiveChildren
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshPrefabSaveNodeView.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshPrefabSaveNodeView.cs:18

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`SetValue`](#setvalue-4) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshPrefabSaveNodeView.cs:52
