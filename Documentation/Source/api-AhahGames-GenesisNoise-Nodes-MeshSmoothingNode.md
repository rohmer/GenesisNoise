...
```cpp
class MeshSmoothingNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:18
...
| Name | Kind | Owner |
|------|------|-------|
| [`hasPreview`](#haspreview-59) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-307) | `property` | Declared here |
| [`name`](#name-334) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-45) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-126) | `property` | Declared here |
| [`previewTexture`](#previewtexture-29) | `property` | Declared here |
| [`loopInput`](#loopinput-7) | `variable` | Declared here |
| [`loopOutput`](#loopoutput-7) | `variable` | Declared here |
| [`input`](#input-22) | `variable` | Declared here |
| [`output`](#output-54) | `variable` | Declared here |
| [`PrepareNewLoopRun`](#preparenewlooprun-5) | `function` | Declared here |
| [`Enable`](#enable-55) | `function` | Declared here |
| [`Disable`](#disable-30) | `function` | Declared here |
| [`ProcessNode`](#processnode-78) | `function` | Declared here |
| [`meshStates`](#meshstates-3) | `variable` | Declared here |
| [`TryGetInputMesh`](#trygetinputmesh-3) | `function` | Declared here |
| [`ResolveCurrentInputMesh`](#resolvecurrentinputmesh-3) | `function` | Declared here |
| [`RestoreOriginalMesh`](#restoreoriginalmesh-1) | `function` | Declared here |
| [`UpdatePreview`](#updatepreview-2) | `function` | Declared here |
| [`ApplyOutputMesh`](#applyoutputmesh-1) | `function` | Declared here |
| [`ClearGeneratedMeshes`](#cleargeneratedmeshes-4) | `function` | Declared here |
| [`IsLoopMode`](#isloopmode-4) | `function` | Declared here |
| [`ReadMeshData`](#readmeshdata-3) | `function` | Declared here |
| [`RefreshCollider`](#refreshcollider-2) | `function` | Declared here |
| [`SmoothMeshData`](#smoothmeshdata) | `function` | Declared here |
| [`RemovePointedVertices`](#removepointedvertices) | `function` | Declared here |
| [`BuildAdjacency`](#buildadjacency-1) | `function` | Declared here |
| [`AddNeighbor`](#addneighbor-1) | `function` | Declared here |
| [`CountEdge`](#countedge-1) | `function` | Declared here |
| [`BuildUnityMesh`](#buildunitymesh-2) | `function` | Declared here |
...
|--------|------|-------------|
| `override bool` | [`hasPreview`](#haspreview-59)  |  |
| `override string` | [`NodeGroup`](#nodegroup-307)  |  |
| `override string` | [`name`](#name-334)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-45)  |  |
| `override float` | [`nodeWidth`](#nodewidth-126)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-29)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:41
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:42
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:43

---

{#showdefaultinspector-45}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:44
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:45
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:48

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `object` | [`loopInput`](#loopinput-7)  |  |
| `object` | [`loopOutput`](#loopoutput-7)  |  |
| `GameObject` | [`input`](#input-22)  |  |
| `GameObject` | [`output`](#output-54)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:27
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:30

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`PrepareNewLoopRun`](#preparenewlooprun-5) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:62
...
| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-55) `virtual` `inline` | Called when the node is enabled. |
| `override void` | [`Disable`](#disable-30) `virtual` `inline` | Called when the node is disabled. |
| `override bool` | [`ProcessNode`](#processnode-78) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:50
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:56
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:68
...
| Return | Name | Description |
|--------|------|-------------|
| `readonly Dictionary< GameObject, MeshState >` | [`meshStates`](#meshstates-3)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:39

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `bool` | [`TryGetInputMesh`](#trygetinputmesh-3) `inline` |  |
| `Mesh` | [`ResolveCurrentInputMesh`](#resolvecurrentinputmesh-3) `inline` |  |
| `void` | [`RestoreOriginalMesh`](#restoreoriginalmesh-1) `inline` |  |
| `void` | [`UpdatePreview`](#updatepreview-2) `inline` |  |
| `void` | [`ApplyOutputMesh`](#applyoutputmesh-1) `inline` |  |
| `void` | [`ClearGeneratedMeshes`](#cleargeneratedmeshes-4) `inline` |  |
| `bool` | [`IsLoopMode`](#isloopmode-4) `inline` |  |
| `MeshBuildData` | [`ReadMeshData`](#readmeshdata-3) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:166

---

{#resolvecurrentinputmesh-3}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:204

---

{#restoreoriginalmesh-1}
...
```cpp
inline void RestoreOriginalMesh(MeshState meshState)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:230
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:248
...
```cpp
inline void ApplyOutputMesh(Mesh mesh)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:254

---

{#cleargeneratedmeshes-4}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:271
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:282
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:324

## Private Static Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RefreshCollider`](#refreshcollider-2) `static` `inline` |  |
| `MeshBuildData` | [`SmoothMeshData`](#smoothmeshdata) `static` `inline` |  |
| `void` | [`RemovePointedVertices`](#removepointedvertices) `static` `inline` |  |
| `List< int >[]` | [`BuildAdjacency`](#buildadjacency-1) `static` `inline` |  |
| `void` | [`AddNeighbor`](#addneighbor-1) `static` `inline` |  |
| `void` | [`CountEdge`](#countedge-1) `static` `inline` |  |
| `Mesh` | [`BuildUnityMesh`](#buildunitymesh-2) `static` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:288
...
```cpp
static inline MeshBuildData SmoothMeshData(MeshBuildData sourceData, int iterations, float strength, bool preserveBorders, bool removePointedVertices, float pointedVertexThreshold)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:348

---

{#removepointedvertices}
...
```cpp
static inline void RemovePointedVertices(Vector3[] vertices, List< int >[] adjacency, bool[] isBoundaryVertex, bool preserveBorders, float threshold)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:394
...
```cpp
static inline List< int >[] BuildAdjacency(int[] triangles, int vertexCount, out bool[] isBoundaryVertex)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:431
...
```cpp
static inline void AddNeighbor(List< int >[] adjacency, int vertexIndex, int neighborIndex)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:469
...
```cpp
static inline void CountEdge(Dictionary< ulong, int > edgeUseCount, int a, int b)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:482
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshSmoothingNode.cs:492
