{#urplitmaterialnodeview}

# URPLitMaterialNodeView

```cpp
class URPLitMaterialNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/URP/URPLitMaterialNodeView.cs:18
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-83) | `property` | Declared here |
| [`Enable`](#enable-183) | `function` | Declared here |
| [`workflow`](#workflow-1) | `variable` | Declared here |
| [`surfaceType`](#surfacetype-2) | `variable` | Declared here |
| [`shadows`](#shadows-1) | `variable` | Declared here |
| [`clipping`](#clipping-1) | `variable` | Declared here |
| [`eColor`](#ecolor-1) | `variable` | Declared here |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/URP/URPLitMaterialNodeView.cs:20

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-183) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/URP/URPLitMaterialNodeView.cs:26
...
| Return | Name | Description |
|--------|------|-------------|
| `EnumField` | [`workflow`](#workflow-1)  |  |
| `EnumField` | [`surfaceType`](#surfacetype-2)  |  |
| `Toggle` | [`shadows`](#shadows-1)  |  |
| `Toggle` | [`clipping`](#clipping-1)  |  |
| `ColorField` | [`eColor`](#ecolor-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/URP/URPLitMaterialNodeView.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/URP/URPLitMaterialNodeView.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/URP/URPLitMaterialNodeView.cs:24
