...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/ClampNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`clampNode`](#clampnode-1) | `property` | Declared here |
| [`Enable`](#enable-97) | `function` | Declared here |
| [`displayValue`](#displayvalue-3) | `variable` | Declared here |
| [`AddNodeWiew_onPortDisconnected`](#addnodewiew_onportdisconnected-1) | `function` | Declared here |
| [`AddNodeWiew_onPortConnected`](#addnodewiew_onportconnected-1) | `function` | Declared here |
| [`UpdateLabel`](#updatelabel-4) | `function` | Declared here |
...
|--------|------|-------------|
| `ClampNode` | [`clampNode`](#clampnode-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/ClampNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-97) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/ClampNodeView.cs:14
...
| Return | Name | Description |
|--------|------|-------------|
| `DisplayValue` | [`displayValue`](#displayvalue-3)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/ClampNodeView.cs:13

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`AddNodeWiew_onPortDisconnected`](#addnodewiew_onportdisconnected-1) `inline` |  |
| `void` | [`AddNodeWiew_onPortConnected`](#addnodewiew_onportconnected-1) `inline` |  |
| `void` | [`UpdateLabel`](#updatelabel-4) `inline` |  |

---

{#addnodewiew_onportdisconnected-1}

### AddNodeWiew_onPortDisconnected

`inline`

```cpp
inline void AddNodeWiew_onPortDisconnected(PortView obj)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/ClampNodeView.cs:46

---

{#addnodewiew_onportconnected-1}

### AddNodeWiew_onPortConnected

`inline`

```cpp
inline void AddNodeWiew_onPortConnected(PortView obj)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/ClampNodeView.cs:51
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/ClampNodeView.cs:56
