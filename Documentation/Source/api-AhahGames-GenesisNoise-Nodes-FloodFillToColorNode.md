{#floodfilltocolornode}

# FloodFillToColorNode

```cpp
class FloodFillToColorNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/FloodFillToColorNode.cs:16
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-194) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-172) | `property` | Declared here |
| [`ShaderName`](#shadername-143) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-194)  |  |
| `override string` | [`NodeGroup`](#nodegroup-172)  |  |
| `override string` | [`ShaderName`](#shadername-143)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/FloodFillToColorNode.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/FloodFillToColorNode.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/FloodFillToColorNode.cs:20
