{#terrainmoisturemapnodeview}

# TerrainMoistureMapNodeView

```cpp
class TerrainMoistureMapNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainMoistureMapNodeView.cs:13
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-64) | `property` | Declared here |
| [`Enable`](#enable-162) | `function` | Declared here |
| [`heightScale`](#heightscale-2) | `variable` | Declared here |
| [`baseMoisture`](#basemoisture) | `variable` | Declared here |
| [`lowHeightWeight`](#lowheightweight) | `variable` | Declared here |
| [`slopeDrying`](#slopedrying) | `variable` | Declared here |
| [`curvatureWeight`](#curvatureweight) | `variable` | Declared here |
| [`flowAccumulationWeight`](#flowaccumulationweight) | `variable` | Declared here |
| [`flowStrengthWeight`](#flowstrengthweight) | `variable` | Declared here |
| [`evaporation`](#evaporation-1) | `variable` | Declared here |
| [`contrast`](#contrast) | `variable` | Declared here |
| [`smoothingRadius`](#smoothingradius) | `variable` | Declared here |
| [`curvatureIsSigned`](#curvatureissigned) | `variable` | Declared here |
| [`AddIntField`](#addintfield) | `function` | Declared here |
| [`AddSlider`](#addslider) | `function` | Declared here |
...
|--------|------|-------------|
| `TerrainMoistureMapNode` | [`node`](#node-64)  |  |
...
```cpp
TerrainMoistureMapNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainMoistureMapNodeView.cs:15

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-162) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainMoistureMapNodeView.cs:29
...
| Return | Name | Description |
|--------|------|-------------|
| `Slider` | [`heightScale`](#heightscale-2)  |  |
| `Slider` | [`baseMoisture`](#basemoisture)  |  |
| `Slider` | [`lowHeightWeight`](#lowheightweight)  |  |
| `Slider` | [`slopeDrying`](#slopedrying)  |  |
| `Slider` | [`curvatureWeight`](#curvatureweight)  |  |
| `Slider` | [`flowAccumulationWeight`](#flowaccumulationweight)  |  |
| `Slider` | [`flowStrengthWeight`](#flowstrengthweight)  |  |
| `Slider` | [`evaporation`](#evaporation-1)  |  |
| `Slider` | [`contrast`](#contrast)  |  |
| `IntegerField` | [`smoothingRadius`](#smoothingradius)  |  |
| `Toggle` | [`curvatureIsSigned`](#curvatureissigned)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainMoistureMapNodeView.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainMoistureMapNodeView.cs:18
...
```cpp
Slider lowHeightWeight
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainMoistureMapNodeView.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainMoistureMapNodeView.cs:20
...
```cpp
Slider curvatureWeight
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainMoistureMapNodeView.cs:21

---

{#flowaccumulationweight}

### flowAccumulationWeight

```cpp
Slider flowAccumulationWeight
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainMoistureMapNodeView.cs:22
...
```cpp
Slider flowStrengthWeight
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainMoistureMapNodeView.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainMoistureMapNodeView.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainMoistureMapNodeView.cs:25
...
```cpp
IntegerField smoothingRadius
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainMoistureMapNodeView.cs:26
...
```cpp
Toggle curvatureIsSigned
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainMoistureMapNodeView.cs:27

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `IntegerField` | [`AddIntField`](#addintfield) `inline` |  |
| `Slider` | [`AddSlider`](#addslider) `inline` |  |
...
```cpp
inline IntegerField AddIntField(string label, int value, System.Action< int > setter)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainMoistureMapNodeView.cs:56
...
```cpp
inline Slider AddSlider(string label, float min, float max, float value, System.Action< float > setter)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainMoistureMapNodeView.cs:73
