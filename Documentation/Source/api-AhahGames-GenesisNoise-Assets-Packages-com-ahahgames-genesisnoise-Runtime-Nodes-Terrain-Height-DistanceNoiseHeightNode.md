{#distancenoiseheightnode}

# DistanceNoiseHeightNode

```cpp
class DistanceNoiseHeightNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:21
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-606) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-89) | `property` | Declared here |
| [`hasPreview`](#haspreview-102) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-218) | `property` | Declared here |
| [`previewTexture`](#previewtexture-64) | `property` | Declared here |
| [`islandShape`](#islandshape-4) | `variable` | Declared here |
| [`NoiseFunction`](#noisefunction-1) | `variable` | Declared here |
| [`heightMap`](#heightmap-4) | `variable` | Declared here |
| [`heightmapRT`](#heightmaprt-1) | `variable` | Declared here |
| [`previewRT`](#previewrt-1) | `variable` | Declared here |
| [`preview300`](#preview300-1) | `variable` | Declared here |
| [`ProcessHeightField`](#processheightfield-1) | `function` | Declared here |
| [`ProcessNode`](#processnode-152) | `function` | Declared here |
| [`Disable`](#disable-86) | `function` | Declared here |
| [`seedA`](#seeda-1) | `variable` | Declared here |
| [`seedB`](#seedb-1) | `variable` | Declared here |
| [`terrainTypeRT`](#terraintypert-1) | `variable` | Declared here |
| [`previewRequestVersion`](#previewrequestversion-11) | `variable` | Declared here |
| [`compute`](#compute-2) | `variable` | Declared here |
| [`GetNormalizationDistance`](#getnormalizationdistance) | `function` | Declared here |
| [`RequestPreview`](#requestpreview-11) | `function` | Declared here |
| [`ReleaseWorkingTextures`](#releaseworkingtextures-4) | `function` | Declared here |
| [`DestroyPreview`](#destroypreview-10) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-606)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-89)  |  |
| `override bool` | [`hasPreview`](#haspreview-102)  |  |
| `override float` | [`nodeWidth`](#nodewidth-218)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-64)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:46

---

{#showdefaultinspector-89}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:47
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:48
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:49
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:51

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `IslandShape` | [`islandShape`](#islandshape-4)  |  |
| `CustomRenderTexture` | [`NoiseFunction`](#noisefunction-1)  |  |
| `Height.HeightField` | [`heightMap`](#heightmap-4)  |  |
| `RenderTexture` | [`heightmapRT`](#heightmaprt-1)  |  |
| `RenderTexture` | [`previewRT`](#previewrt-1)  |  |
| `Texture2D` | [`preview300`](#preview300-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:24
...
```cpp
CustomRenderTexture NoiseFunction
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:27
...
```cpp
Height.HeightField heightMap
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:30
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:52
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:57
...
```cpp
Texture2D preview300
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:58

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`ProcessHeightField`](#processheightfield-1) `inline` |  |

---

{#processheightfield-1}
...
```cpp
inline void ProcessHeightField()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:88

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-152) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-86) `virtual` `inline` | Called when the node is disabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:62
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:213
...
| Return | Name | Description |
|--------|------|-------------|
| `RenderTexture` | [`seedA`](#seeda-1)  |  |
| `RenderTexture` | [`seedB`](#seedb-1)  |  |
| `RenderTexture` | [`terrainTypeRT`](#terraintypert-1)  |  |
| `int` | [`previewRequestVersion`](#previewrequestversion-11)  |  |
| `ComputeShader` | [`compute`](#compute-2)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:53
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:54
...
```cpp
RenderTexture terrainTypeRT
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:55

---

{#previewrequestversion-11}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:56
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:60

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `float` | [`GetNormalizationDistance`](#getnormalizationdistance) `inline` |  |
| `void` | [`RequestPreview`](#requestpreview-11) `inline` |  |
| `void` | [`ReleaseWorkingTextures`](#releaseworkingtextures-4) `inline` |  |

---

{#getnormalizationdistance}
...
```cpp
inline float GetNormalizationDistance(int size)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:167
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:185

---

{#releaseworkingtextures-4}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:206

## Private Static Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`DestroyPreview`](#destroypreview-10) `static` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Height/DistanceNoiseHeightNode.cs:225
