{#exposedcolorsettingsdrawer}

# ExposedColorSettingsDrawer

```cpp
class ExposedColorSettingsDrawer
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Utils/ExposedParameterDrawer.cs:368
...
| Name | Kind | Owner |
|------|------|-------|
| [`CreatePropertyGUI`](#createpropertygui-3) | `function` | Declared here |
...
|--------|------|-------------|
| `override VisualElement` | [`CreatePropertyGUI`](#createpropertygui-3) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Utils/ExposedParameterDrawer.cs:370
