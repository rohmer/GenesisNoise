{#urpsimplelitmaterialnodeview}

# URPSimpleLitMaterialNodeView

```cpp
class URPSimpleLitMaterialNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/URP/URPSimpleLitMaterialNodeView.cs:14
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-84) | `property` | Declared here |
| [`Enable`](#enable-184) | `function` | Declared here |
...
|--------|------|-------------|
| `URPSimpleLitMaterial` | [`node`](#node-84)  |  |
...
```cpp
URPSimpleLitMaterial node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/URP/URPSimpleLitMaterialNodeView.cs:16

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-184) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/URP/URPSimpleLitMaterialNodeView.cs:18
