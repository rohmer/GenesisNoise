{#noisescaledpoissondiskpointsnodeview}

# NoiseScaledPoissonDiskPointsNodeView

```cpp
class NoiseScaledPoissonDiskPointsNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/NoiseScaledPoissonDiskPointsNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-39) | `property` | Declared here |
| [`Enable`](#enable-135) | `function` | Declared here |
| [`Disable`](#disable-62) | `function` | Declared here |
| [`countField`](#countfield-5) | `variable` | Declared here |
| [`coordinatesField`](#coordinatesfield-4) | `variable` | Declared here |
| [`RefreshOutputs`](#refreshoutputs-4) | `function` | Declared here |
...
|--------|------|-------------|
| `NoiseScaledPoissonDiskPointsNode` | [`node`](#node-39)  |  |
...
```cpp
NoiseScaledPoissonDiskPointsNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/NoiseScaledPoissonDiskPointsNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-135) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-62) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/NoiseScaledPoissonDiskPointsNodeView.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/NoiseScaledPoissonDiskPointsNodeView.cs:38
...
| Return | Name | Description |
|--------|------|-------------|
| `IntegerField` | [`countField`](#countfield-5)  |  |
| `TextField` | [`coordinatesField`](#coordinatesfield-4)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/NoiseScaledPoissonDiskPointsNodeView.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/NoiseScaledPoissonDiskPointsNodeView.cs:15

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RefreshOutputs`](#refreshoutputs-4) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/NoiseScaledPoissonDiskPointsNodeView.cs:44
