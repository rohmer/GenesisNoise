{#floodfilltoboundingboxnode}

# FloodFillToBoundingBoxNode

```cpp
class FloodFillToBoundingBoxNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/FloodFillToBoundingBoxNode.cs:18
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-193) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-171) | `property` | Declared here |
| [`ShaderName`](#shadername-142) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-193)  |  |
| `override string` | [`NodeGroup`](#nodegroup-171)  |  |
| `override string` | [`ShaderName`](#shadername-142)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/FloodFillToBoundingBoxNode.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/FloodFillToBoundingBoxNode.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/FloodFillToBoundingBoxNode.cs:22
