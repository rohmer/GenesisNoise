{#directionalnoise1node}

# DirectionalNoise1Node

```cpp
class DirectionalNoise1Node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/DirectionalNoise1Node.cs:17
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-143) | `property` | Declared here |
| [`ShaderName`](#shadername-100) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-124) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-143)  |  |
| `override string` | [`ShaderName`](#shadername-100)  |  |
| `override string` | [`NodeGroup`](#nodegroup-124)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/DirectionalNoise1Node.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/DirectionalNoise1Node.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/DirectionalNoise1Node.cs:21
