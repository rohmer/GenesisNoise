...
```cpp
class Vector3IntParameter
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/NodeGraphProcessor/Runtime/Elements/ExposedParameter.cs:278
...
| Name | Kind | Owner |
|------|------|-------|
| [`value`](#value-26) | `property` | Declared here |
| [`val`](#val-20) | `variable` | Declared here |
...
|--------|------|-------------|
| `override object` | [`value`](#value-26)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/NodeGraphProcessor/Runtime/Elements/ExposedParameter.cs:282

## Private Attributes

| Return | Name | Description |
|--------|------|-------------|
| `Vector3Int` | [`val`](#val-20)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/NodeGraphProcessor/Runtime/Elements/ExposedParameter.cs:280
