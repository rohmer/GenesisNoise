...
```cpp
class GradientDynamicNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/GradientDynamicNode.cs:21
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-227) | `property` | Declared here |
| [`ShaderName`](#shadername-172) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-204) | `property` | Declared here |
| [`DisplayMaterialInspector`](#displaymaterialinspector-65) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-74) | `property` | Declared here |
| [`filteredOutProperties`](#filteredoutproperties-61) | `property` | Declared here |
| [`defaultSettings`](#defaultsettings-10) | `property` | Declared here |
| [`supportedDimensions`](#supporteddimensions-11) | `property` | Declared here |
| [`ProcessNode`](#processnode-50) | `function` | Declared here |
| [`PreviewRampProperty`](#previewrampproperty) | `variable` | Declared here |
| [`SourceProperty`](#sourceproperty) | `variable` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-227)  |  |
| `override string` | [`ShaderName`](#shadername-172)  |  |
| `override string` | [`NodeGroup`](#nodegroup-204)  |  |
| `override bool` | [`DisplayMaterialInspector`](#displaymaterialinspector-65)  |  |
| `override float` | [`nodeWidth`](#nodewidth-74)  |  |
| `override IEnumerable< string >` | [`filteredOutProperties`](#filteredoutproperties-61)  |  |
| `override GenesisNoiseSettings` | [`defaultSettings`](#defaultsettings-10)  |  |
| `override List< OutputDimension >` | [`supportedDimensions`](#supporteddimensions-11)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/GradientDynamicNode.cs:26
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/GradientDynamicNode.cs:27
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/GradientDynamicNode.cs:28

---

{#displaymaterialinspector-65}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/GradientDynamicNode.cs:29
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/GradientDynamicNode.cs:30

---

{#filteredoutproperties-61}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/GradientDynamicNode.cs:32
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/GradientDynamicNode.cs:34

---

{#supporteddimensions-11}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/GradientDynamicNode.cs:36

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-50) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/GradientDynamicNode.cs:41
...
| Return | Name | Description |
|--------|------|-------------|
| `const string` | [`PreviewRampProperty`](#previewrampproperty) `static` |  |
| `const string` | [`SourceProperty`](#sourceproperty) `static` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/GradientDynamicNode.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/GradientDynamicNode.cs:24
