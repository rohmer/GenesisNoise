...
```cpp
class SmoothStepTexture
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/SmoothStepTexture.cs:15
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-473) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-439) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-63) | `property` | Declared here |
| [`hasPreview`](#haspreview-74) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-166) | `property` | Declared here |
| [`inputA`](#inputa-29) | `variable` | Declared here |
| [`output`](#output-84) | `variable` | Declared here |
| [`LowerBound`](#lowerbound) | `variable` | Declared here |
| [`UpperBound`](#upperbound) | `variable` | Declared here |
| [`Enable`](#enable-71) | `function` | Declared here |
| [`ProcessNode`](#processnode-117) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-473)  |  |
| `override string` | [`NodeGroup`](#nodegroup-439)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-63)  |  |
| `override bool` | [`hasPreview`](#haspreview-74)  |  |
| `override float` | [`nodeWidth`](#nodewidth-166)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/SmoothStepTexture.cs:28
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/SmoothStepTexture.cs:29

---

{#showdefaultinspector-63}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/SmoothStepTexture.cs:31
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/SmoothStepTexture.cs:32
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/SmoothStepTexture.cs:33

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `RenderTexture` | [`inputA`](#inputa-29)  |  |
| `RenderTexture` | [`output`](#output-84)  |  |
...
```cpp
RenderTexture inputA
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/SmoothStepTexture.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/SmoothStepTexture.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/SmoothStepTexture.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/SmoothStepTexture.cs:27

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-71) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-117) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/SmoothStepTexture.cs:34
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/SmoothStepTexture.cs:40
