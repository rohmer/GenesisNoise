{#heightnormalambientocclusionnode}

# HeightNormalAmbientOcclusionNode

```cpp
class HeightNormalAmbientOcclusionNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/HeightNormalAmbientOcclusionNode.cs:14
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-258) | `property` | Declared here |
| [`ShaderName`](#shadername-195) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-234) | `property` | Declared here |
| [`DisplayMaterialInspector`](#displaymaterialinspector-74) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-97) | `property` | Declared here |
| [`filteredOutProperties`](#filteredoutproperties-79) | `property` | Declared here |
| [`defaultSettings`](#defaultsettings-13) | `property` | Declared here |
| [`supportedDimensions`](#supporteddimensions-14) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-258)  |  |
| `override string` | [`ShaderName`](#shadername-195)  |  |
| `override string` | [`NodeGroup`](#nodegroup-234)  |  |
| `override bool` | [`DisplayMaterialInspector`](#displaymaterialinspector-74)  |  |
| `override float` | [`nodeWidth`](#nodewidth-97)  |  |
| `override IEnumerable< string >` | [`filteredOutProperties`](#filteredoutproperties-79)  |  |
| `override GenesisNoiseSettings` | [`defaultSettings`](#defaultsettings-13)  |  |
| `override List< OutputDimension >` | [`supportedDimensions`](#supporteddimensions-14)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/HeightNormalAmbientOcclusionNode.cs:16
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/HeightNormalAmbientOcclusionNode.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/HeightNormalAmbientOcclusionNode.cs:18

---

{#displaymaterialinspector-74}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/HeightNormalAmbientOcclusionNode.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/HeightNormalAmbientOcclusionNode.cs:20

---

{#filteredoutproperties-79}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/HeightNormalAmbientOcclusionNode.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/HeightNormalAmbientOcclusionNode.cs:24

---

{#supporteddimensions-14}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/HeightNormalAmbientOcclusionNode.cs:26
