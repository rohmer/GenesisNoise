{#genesisswizzledrawer}

# GenesisSwizzleDrawer

```cpp
class GenesisSwizzleDrawer
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisSwizzleDrawer.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`DrawerGUI`](#drawergui-23) | `function` | Declared here |
| [`displayedOptions`](#displayedoptions-3) | `variable` | Declared here |
| [`optionValues`](#optionvalues-2) | `variable` | Declared here |
...
|--------|------|-------------|
| `override void` | [`DrawerGUI`](#drawergui-23) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisSwizzleDrawer.cs:12
...
| Return | Name | Description |
|--------|------|-------------|
| `string[]` | [`displayedOptions`](#displayedoptions-3) `static` |  |
| `int[]` | [`optionValues`](#optionvalues-2) `static` |  |
...
```cpp
string[] displayedOptions = { "Input.Red", "Input.Green", "Input.Blue", "Input.Alpha", "Black", "Gray", "White", "Custom" }
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisSwizzleDrawer.cs:22
...
```cpp
int[] optionValues = { 0, 1, 2, 3, 4, 5, 6, 7 }
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisSwizzleDrawer.cs:23
