...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/Branch.cs:15
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-62) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-45) | `property` | Declared here |
| [`hasPreview`](#haspreview-14) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-13) | `property` | Declared here |
| [`inputTrue`](#inputtrue) | `variable` | Declared here |
| [`inputFalse`](#inputfalse) | `variable` | Declared here |
| [`condition`](#condition) | `variable` | Declared here |
| [`output`](#output-19) | `variable` | Declared here |
| [`InputPortTypeTrue`](#inputporttypetrue) | `function` | Declared here |
| [`InputPortTypeFalse`](#inputporttypefalse) | `function` | Declared here |
| [`OutputTruePortType`](#outputtrueporttype) | `function` | Declared here |
| [`ProcessNode`](#processnode-22) | `function` | Declared here |
| [`inputType`](#inputtype-3) | `variable` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-62)  |  |
| `override string` | [`NodeGroup`](#nodegroup-45)  |  |
| `override bool` | [`hasPreview`](#haspreview-14)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-13)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/Branch.cs:32
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/Branch.cs:34
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/Branch.cs:35

---

{#showdefaultinspector-13}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/Branch.cs:36

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `object` | [`inputTrue`](#inputtrue)  |  |
| `object` | [`inputFalse`](#inputfalse)  |  |
| `bool` | [`condition`](#condition)  |  |
| `object` | [`output`](#output-19)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/Branch.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/Branch.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/Branch.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/Branch.cs:27

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `IEnumerable< PortData >` | [`InputPortTypeTrue`](#inputporttypetrue) `inline` |  |
| `IEnumerable< PortData >` | [`InputPortTypeFalse`](#inputporttypefalse) `inline` |  |
| `IEnumerable< PortData >` | [`OutputTruePortType`](#outputtrueporttype) `inline` |  |
...
```cpp
inline IEnumerable< PortData > InputPortTypeTrue(List< SerializableEdge > edges)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/Branch.cs:39
...
```cpp
inline IEnumerable< PortData > InputPortTypeFalse(List< SerializableEdge > edges)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/Branch.cs:45
...
```cpp
inline IEnumerable< PortData > OutputTruePortType(List< SerializableEdge > edges)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/Branch.cs:51

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-22) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/Branch.cs:62
...
| Return | Name | Description |
|--------|------|-------------|
| `SerializableType` | [`inputType`](#inputtype-3)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/Branch.cs:30
