{#browniannoisepointsnodeview}

# BrownianNoisePointsNodeView

```cpp
class BrownianNoisePointsNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BrownianNoisePointsNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-13) | `property` | Declared here |
| [`Enable`](#enable-96) | `function` | Declared here |
| [`Disable`](#disable-54) | `function` | Declared here |
| [`countField`](#countfield-1) | `variable` | Declared here |
| [`coordinatesField`](#coordinatesfield-1) | `variable` | Declared here |
| [`RefreshOutputs`](#refreshoutputs-1) | `function` | Declared here |
...
|--------|------|-------------|
| `BrownianNoisePointsNode` | [`node`](#node-13)  |  |
...
```cpp
BrownianNoisePointsNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BrownianNoisePointsNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-96) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-54) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BrownianNoisePointsNodeView.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BrownianNoisePointsNodeView.cs:38
...
| Return | Name | Description |
|--------|------|-------------|
| `IntegerField` | [`countField`](#countfield-1)  |  |
| `TextField` | [`coordinatesField`](#coordinatesfield-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BrownianNoisePointsNodeView.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BrownianNoisePointsNodeView.cs:15

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RefreshOutputs`](#refreshoutputs-1) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BrownianNoisePointsNodeView.cs:44
