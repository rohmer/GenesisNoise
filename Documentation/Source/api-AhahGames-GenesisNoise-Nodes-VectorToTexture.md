...
```cpp
class VectorToTexture
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Operations/VectorToTexture.cs:17
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-564) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-77) | `property` | Declared here |
| [`previewTexture`](#previewtexture-55) | `property` | Declared here |
| [`input`](#input-29) | `variable` | Declared here |
| [`output`](#output-113) | `variable` | Declared here |
| [`ProcessNode`](#processnode-140) | `function` | Declared here |
| [`Disable`](#disable-49) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-564)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-77)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-55)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Operations/VectorToTexture.cs:25

---

{#showdefaultinspector-77}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Operations/VectorToTexture.cs:26
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Operations/VectorToTexture.cs:27

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `Vector4` | [`input`](#input-29)  |  |
| `RenderTexture` | [`output`](#output-113)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Operations/VectorToTexture.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Operations/VectorToTexture.cs:23

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-140) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-49) `virtual` `inline` | Called when the node is disabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Operations/VectorToTexture.cs:29
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Operations/VectorToTexture.cs:43
