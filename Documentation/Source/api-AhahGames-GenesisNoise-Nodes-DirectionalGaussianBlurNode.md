{#directionalgaussianblurnode}

# DirectionalGaussianBlurNode

```cpp
class DirectionalGaussianBlurNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Blur/DirectionalGaussianBlurNode.cs:12
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-142) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-123) | `property` | Declared here |
| [`ShaderName`](#shadername-99) | `property` | Declared here |
| [`DisplayMaterialInspector`](#displaymaterialinspector-48) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-142)  |  |
| `override string` | [`NodeGroup`](#nodegroup-123)  |  |
| `override string` | [`ShaderName`](#shadername-99)  |  |
| `override bool` | [`DisplayMaterialInspector`](#displaymaterialinspector-48)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Blur/DirectionalGaussianBlurNode.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Blur/DirectionalGaussianBlurNode.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Blur/DirectionalGaussianBlurNode.cs:16

---

{#displaymaterialinspector-48}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Blur/DirectionalGaussianBlurNode.cs:18
