...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshScaleNode.cs:18
...
| Name | Kind | Owner |
|------|------|-------|
| [`hasPreview`](#haspreview-58) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-306) | `property` | Declared here |
| [`name`](#name-333) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-44) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-125) | `property` | Declared here |
| [`previewTexture`](#previewtexture-28) | `property` | Declared here |
| [`loopInput`](#loopinput-6) | `variable` | Declared here |
| [`loopOutput`](#loopoutput-6) | `variable` | Declared here |
| [`input`](#input-21) | `variable` | Declared here |
| [`output`](#output-53) | `variable` | Declared here |
| [`scaleX`](#scalex) | `variable` | Declared here |
| [`scaleY`](#scaley) | `variable` | Declared here |
| [`scaleZ`](#scalez) | `variable` | Declared here |
| [`SetScale`](#setscale) | `function` | Declared here |
| [`Enable`](#enable-54) | `function` | Declared here |
| [`ProcessNode`](#processnode-77) | `function` | Declared here |
| [`Scale`](#scale-2) | `variable` | Declared here |
| [`migratedScaleAxes`](#migratedscaleaxes) | `variable` | Declared here |
| [`MigrateLegacyScale`](#migratelegacyscale) | `function` | Declared here |
...
|--------|------|-------------|
| `override bool` | [`hasPreview`](#haspreview-58)  |  |
| `override string` | [`NodeGroup`](#nodegroup-306)  |  |
| `override string` | [`name`](#name-333)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-44)  |  |
| `override float` | [`nodeWidth`](#nodewidth-125)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-28)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshScaleNode.cs:47
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshScaleNode.cs:48
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshScaleNode.cs:49

---

{#showdefaultinspector-44}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshScaleNode.cs:50
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshScaleNode.cs:51
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshScaleNode.cs:54

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `object` | [`loopInput`](#loopinput-6)  |  |
| `object` | [`loopOutput`](#loopoutput-6)  |  |
| `GameObject` | [`input`](#input-21)  |  |
| `GameObject` | [`output`](#output-53)  |  |
| `float` | [`scaleX`](#scalex)  |  |
| `float` | [`scaleY`](#scaley)  |  |
| `float` | [`scaleZ`](#scalez)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshScaleNode.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshScaleNode.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshScaleNode.cs:27
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshScaleNode.cs:30
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshScaleNode.cs:39
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshScaleNode.cs:42
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshScaleNode.cs:45
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshScaleNode.cs:62

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-54) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-77) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshScaleNode.cs:55
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshScaleNode.cs:70
...
| `bool` | [`migratedScaleAxes`](#migratedscaleaxes)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshScaleNode.cs:33
...
```cpp
bool migratedScaleAxes
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshScaleNode.cs:36

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`MigrateLegacyScale`](#migratelegacyscale) `inline` |  |
...
```cpp
inline void MigrateLegacyScale()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshScaleNode.cs:91
