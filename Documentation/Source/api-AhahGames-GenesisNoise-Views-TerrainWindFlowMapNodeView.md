{#terrainwindflowmapnodeview}

# TerrainWindFlowMapNodeView

```cpp
class TerrainWindFlowMapNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindFlowMapNodeView.cs:13
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-68) | `property` | Declared here |
| [`Enable`](#enable-166) | `function` | Declared here |
| [`windAngle`](#windangle-1) | `variable` | Declared here |
| [`windInfluence`](#windinfluence) | `variable` | Declared here |
| [`flowStrength`](#flowstrength) | `variable` | Declared here |
| [`slopeStrength`](#slopestrength) | `variable` | Declared here |
| [`windwardLiftStrength`](#windwardliftstrength) | `variable` | Declared here |
| [`rainShadowStrength`](#rainshadowstrength) | `variable` | Declared here |
| [`heightScale`](#heightscale-4) | `variable` | Declared here |
| [`cellSize`](#cellsize-2) | `variable` | Declared here |
| [`minSlope`](#minslope-2) | `variable` | Declared here |
| [`sampleRadius`](#sampleradius-3) | `variable` | Declared here |
| [`orographicSampleCount`](#orographicsamplecount) | `variable` | Declared here |
...
|--------|------|-------------|
| `TerrainWindFlowMapNode` | [`node`](#node-68)  |  |
...
```cpp
TerrainWindFlowMapNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindFlowMapNodeView.cs:15

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-166) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindFlowMapNodeView.cs:29
...
| Return | Name | Description |
|--------|------|-------------|
| `Slider` | [`windAngle`](#windangle-1)  |  |
| `Slider` | [`windInfluence`](#windinfluence)  |  |
| `Slider` | [`flowStrength`](#flowstrength)  |  |
| `Slider` | [`slopeStrength`](#slopestrength)  |  |
| `Slider` | [`windwardLiftStrength`](#windwardliftstrength)  |  |
| `Slider` | [`rainShadowStrength`](#rainshadowstrength)  |  |
| `Slider` | [`heightScale`](#heightscale-4)  |  |
| `Slider` | [`cellSize`](#cellsize-2)  |  |
| `Slider` | [`minSlope`](#minslope-2)  |  |
| `SliderInt` | [`sampleRadius`](#sampleradius-3)  |  |
| `SliderInt` | [`orographicSampleCount`](#orographicsamplecount)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindFlowMapNodeView.cs:17
...
```cpp
Slider windInfluence
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindFlowMapNodeView.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindFlowMapNodeView.cs:19
...
```cpp
Slider slopeStrength
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindFlowMapNodeView.cs:20

---

{#windwardliftstrength}

### windwardLiftStrength

```cpp
Slider windwardLiftStrength
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindFlowMapNodeView.cs:21
...
```cpp
Slider rainShadowStrength
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindFlowMapNodeView.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindFlowMapNodeView.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindFlowMapNodeView.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindFlowMapNodeView.cs:25
...
```cpp
SliderInt sampleRadius
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindFlowMapNodeView.cs:26

---

{#orographicsamplecount}

### orographicSampleCount

```cpp
SliderInt orographicSampleCount
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindFlowMapNodeView.cs:27
