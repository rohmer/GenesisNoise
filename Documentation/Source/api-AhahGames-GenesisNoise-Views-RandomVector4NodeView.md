{#randomvector4nodeview}

# RandomVector4NodeView

```cpp
class RandomVector4NodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomVector4NodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-56) | `property` | Declared here |
| [`Enable`](#enable-153) | `function` | Declared here |
| [`Disable`](#disable-75) | `function` | Declared here |
| [`AddFloatField`](#addfloatfield) | `function` | Declared here |
| [`RefreshOutputs`](#refreshoutputs-18) | `function` | Declared here |
...
|--------|------|-------------|
| `RandomVector4Node` | [`node`](#node-56)  |  |
...
```cpp
RandomVector4Node node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomVector4NodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-153) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-75) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomVector4NodeView.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomVector4NodeView.cs:32
...
| Return | Name | Description |
|--------|------|-------------|
| `void` | [`AddFloatField`](#addfloatfield) `inline` |  |
| `void` | [`RefreshOutputs`](#refreshoutputs-18) `inline` |  |
...
```cpp
inline void AddFloatField(string label, float value, System.Action< float > setValue)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomVector4NodeView.cs:38
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomVector4NodeView.cs:51
