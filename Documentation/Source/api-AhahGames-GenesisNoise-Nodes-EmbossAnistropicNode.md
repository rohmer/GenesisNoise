{#embossanistropicnode}

# EmbossAnistropicNode

```cpp
class EmbossAnistropicNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Distort/EmbossAnisotropicNode.cs:15
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-173) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-152) | `property` | Declared here |
| [`ShaderName`](#shadername-126) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-173)  |  |
| `override string` | [`NodeGroup`](#nodegroup-152)  |  |
| `override string` | [`ShaderName`](#shadername-126)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Distort/EmbossAnisotropicNode.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Distort/EmbossAnisotropicNode.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Distort/EmbossAnisotropicNode.cs:19
