...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToFloatNode.cs:13
...
| Name | Kind | Owner |
|------|------|-------|
| [`nodeWidth`](#nodewidth-186) | `property` | Declared here |
| [`name`](#name-531) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-487) | `property` | Declared here |
| [`input`](#input-26) | `variable` | Declared here |
| [`output`](#output-99) | `variable` | Declared here |
| [`Process`](#process-19) | `function` | Declared here |
...
|--------|------|-------------|
| `override float` | [`nodeWidth`](#nodewidth-186)  |  |
| `override string` | [`name`](#name-531)  |  |
| `override string` | [`NodeGroup`](#nodegroup-487)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToFloatNode.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToFloatNode.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToFloatNode.cs:22

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `object` | [`input`](#input-26)  |  |
| `float` | [`output`](#output-99)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToFloatNode.cs:16
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToFloatNode.cs:19

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Process`](#process-19) `virtual` `inline` | Override this method to implement custom processing. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToFloatNode.cs:23
