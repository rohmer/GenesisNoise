...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/UVMapperNode.cs:13
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-555) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-510) | `property` | Declared here |
| [`ShaderName`](#shadername-397) | `property` | Declared here |
| [`DisplayMaterialInspector`](#displaymaterialinspector-185) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-201) | `property` | Declared here |
| [`filteredOutProperties`](#filteredoutproperties-134) | `property` | Declared here |
| [`defaultSettings`](#defaultsettings-36) | `property` | Declared here |
| [`supportedDimensions`](#supporteddimensions-35) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-555)  |  |
| `override string` | [`NodeGroup`](#nodegroup-510)  |  |
| `override string` | [`ShaderName`](#shadername-397)  |  |
| `override bool` | [`DisplayMaterialInspector`](#displaymaterialinspector-185)  |  |
| `override float` | [`nodeWidth`](#nodewidth-201)  |  |
| `override IEnumerable< string >` | [`filteredOutProperties`](#filteredoutproperties-134)  |  |
| `override GenesisNoiseSettings` | [`defaultSettings`](#defaultsettings-36)  |  |
| `override List< OutputDimension >` | [`supportedDimensions`](#supporteddimensions-35)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/UVMapperNode.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/UVMapperNode.cs:16
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/UVMapperNode.cs:17

---

{#displaymaterialinspector-185}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/UVMapperNode.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/UVMapperNode.cs:19

---

{#filteredoutproperties-134}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/UVMapperNode.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/UVMapperNode.cs:23

---

{#supporteddimensions-35}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/UVMapperNode.cs:25
