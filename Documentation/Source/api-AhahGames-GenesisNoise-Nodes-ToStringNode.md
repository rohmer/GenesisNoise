...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToStringNode.cs:13
...
| Name | Kind | Owner |
|------|------|-------|
| [`nodeWidth`](#nodewidth-189) | `property` | Declared here |
| [`name`](#name-536) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-492) | `property` | Declared here |
| [`input`](#input-28) | `variable` | Declared here |
| [`output`](#output-102) | `variable` | Declared here |
| [`Process`](#process-22) | `function` | Declared here |
...
|--------|------|-------------|
| `override float` | [`nodeWidth`](#nodewidth-189)  |  |
| `override string` | [`name`](#name-536)  |  |
| `override string` | [`NodeGroup`](#nodegroup-492)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToStringNode.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToStringNode.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToStringNode.cs:22

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `object` | [`input`](#input-28)  |  |
| `string` | [`output`](#output-102)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToStringNode.cs:16
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToStringNode.cs:19

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Process`](#process-22) `virtual` `inline` | Override this method to implement custom processing. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToStringNode.cs:23
