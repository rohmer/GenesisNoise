...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/FloatNode.cs:11
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-189) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-167) | `property` | Declared here |
| [`output`](#output-34) | `variable` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-189)  |  |
| `override string` | [`NodeGroup`](#nodegroup-167)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/FloatNode.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/FloatNode.cs:16

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `float` | [`output`](#output-34)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Constants/FloatNode.cs:14
