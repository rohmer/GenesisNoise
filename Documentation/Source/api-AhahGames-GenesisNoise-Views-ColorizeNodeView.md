...
```cpp
class ColorizeNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ColorizeNodeView.cs:17
...
| Name | Kind | Owner |
|------|------|-------|
| [`colorizeNode`](#colorizenode-1) | `property` | Declared here |
| [`Enable`](#enable-98) | `function` | Declared here |
| [`BuildContextualMenu`](#buildcontextualmenu-5) | `function` | Declared here |
| [`OnRemoved`](#onremoved-2) | `function` | Declared here |
| [`materialHash`](#materialhash-1) | `variable` | Declared here |
| [`debugCustomRenderTextureField`](#debugcustomrendertexturefield) | `variable` | Declared here |
| [`debugShaderField`](#debugshaderfield) | `variable` | Declared here |
| [`debugMaterialField`](#debugmaterialfield) | `variable` | Declared here |
| [`lastModified`](#lastmodified) | `variable` | Declared here |
| [`DetectShaderChanges`](#detectshaderchanges) | `function` | Declared here |
| [`InitializeDebug`](#initializedebug-1) | `function` | Declared here |
| [`MaterialGUI`](#materialgui-1) | `function` | Declared here |
| [`ResetMaterialPropertyToDefault`](#resetmaterialpropertytodefault-2) | `function` | Declared here |
...
|--------|------|-------------|
| `ColorizeNode` | [`colorizeNode`](#colorizenode-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ColorizeNodeView.cs:19

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-98) `virtual` `inline` |  |
| `override void` | [`BuildContextualMenu`](#buildcontextualmenu-5) `inline` |  |
| `override void` | [`OnRemoved`](#onremoved-2) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ColorizeNodeView.cs:28
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ColorizeNodeView.cs:170
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ColorizeNodeView.cs:183
...
| Return | Name | Description |
|--------|------|-------------|
| `int` | [`materialHash`](#materialhash-1)  |  |
| `ObjectField` | [`debugCustomRenderTextureField`](#debugcustomrendertexturefield)  |  |
| `ObjectField` | [`debugShaderField`](#debugshaderfield)  |  |
| `ObjectField` | [`debugMaterialField`](#debugmaterialfield)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ColorizeNodeView.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ColorizeNodeView.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ColorizeNodeView.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ColorizeNodeView.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ColorizeNodeView.cs:26

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`DetectShaderChanges`](#detectshaderchanges) `inline` |  |
| `void` | [`InitializeDebug`](#initializedebug-1) `inline` |  |
| `void` | [`MaterialGUI`](#materialgui-1) `inline` |  |
| `void` | [`ResetMaterialPropertyToDefault`](#resetmaterialpropertytodefault-2) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ColorizeNodeView.cs:93
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ColorizeNodeView.cs:117
...
```cpp
inline void MaterialGUI(bool fromInspector)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ColorizeNodeView.cs:140

---

{#resetmaterialpropertytodefault-2}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ColorizeNodeView.cs:161
