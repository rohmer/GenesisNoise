...
```cpp
class RandomIntNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomIntNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-48) | `property` | Declared here |
| [`Enable`](#enable-145) | `function` | Declared here |
| [`Disable`](#disable-67) | `function` | Declared here |
| [`min`](#min-64) | `variable` | Declared here |
| [`max`](#max-64) | `variable` | Declared here |
| [`RefreshOutputs`](#refreshoutputs-10) | `function` | Declared here |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomIntNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-145) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-67) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomIntNodeView.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomIntNodeView.cs:44
...
| Return | Name | Description |
|--------|------|-------------|
| `IntegerField` | [`min`](#min-64)  |  |
| `IntegerField` | [`max`](#max-64)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomIntNodeView.cs:13
...
| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RefreshOutputs`](#refreshoutputs-10) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomIntNodeView.cs:50
