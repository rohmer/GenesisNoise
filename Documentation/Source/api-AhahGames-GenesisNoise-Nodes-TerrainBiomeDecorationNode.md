{#terrainbiomedecorationnode}

# TerrainBiomeDecorationNode

```cpp
class TerrainBiomeDecorationNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:17
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-510) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-70) | `property` | Declared here |
| [`hasPreview`](#haspreview-81) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-174) | `property` | Declared here |
| [`ProcessNode`](#processnode-128) | `function` | Declared here |
| [`ApplyBiomeDecorations`](#applybiomedecorations) | `function` | Declared here |
| [`CollectBiomeDecorationPlacements`](#collectbiomedecorationplacements) | `function` | Declared here |
| [`PlaceDecorationInstances`](#placedecorationinstances) | `function` | Declared here |
| [`ShouldPlace`](#shouldplace) | `function` | Declared here |
| [`GetTerrainSurfacePosition`](#getterrainsurfaceposition) | `function` | Declared here |
| [`GetPlacementResolution`](#getplacementresolution) | `function` | Declared here |
| [`EnsureDecorationRoot`](#ensuredecorationroot) | `function` | Declared here |
| [`ClearGeneratedDecorations`](#cleargenerateddecorations) | `function` | Declared here |
| [`generatedRootName`](#generatedrootname) | `variable` | Declared here |
| [`maxPlacementResolution`](#maxplacementresolution) | `variable` | Declared here |
| [`SelectPrefab`](#selectprefab) | `function` | Declared here |
| [`GetRandomRotation`](#getrandomrotation) | `function` | Declared here |
| [`GetRandomScale`](#getrandomscale) | `function` | Declared here |
| [`InstantiatePrefab`](#instantiateprefab) | `function` | Declared here |
| [`GetReadableRenderTexture`](#getreadablerendertexture) | `function` | Declared here |
| [`GetReadableRenderTexture`](#getreadablerendertexture-1) | `function` | Declared here |
| [`ReadRenderTexture`](#readrendertexture) | `function` | Declared here |
| [`SampleTextureChannel`](#sampletexturechannel) | `function` | Declared here |
| [`Hash01`](#hash01-3) | `function` | Declared here |
| [`DestroyObject`](#destroyobject) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-510)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-70)  |  |
| `override bool` | [`hasPreview`](#haspreview-81)  |  |
| `override float` | [`nodeWidth`](#nodewidth-174)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:31

---

{#showdefaultinspector-70}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:32
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:33
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:34

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-128) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:36
...
| Return | Name | Description |
|--------|------|-------------|
| `void` | [`ApplyBiomeDecorations`](#applybiomedecorations) `inline` |  |
| `List< DecorationPlacement >` | [`CollectBiomeDecorationPlacements`](#collectbiomedecorationplacements) `inline` |  |
| `void` | [`PlaceDecorationInstances`](#placedecorationinstances) `inline` |  |
| `bool` | [`ShouldPlace`](#shouldplace) `inline` |  |
| `Vector3` | [`GetTerrainSurfacePosition`](#getterrainsurfaceposition) `inline` |  |
| `int` | [`GetPlacementResolution`](#getplacementresolution) `inline` |  |
| `Transform` | [`EnsureDecorationRoot`](#ensuredecorationroot) `inline` |  |
| `void` | [`ClearGeneratedDecorations`](#cleargenerateddecorations) `inline` |  |

---

{#applybiomedecorations}
...
```cpp
inline void ApplyBiomeDecorations(TerrainData terrainData)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:56

---

{#collectbiomedecorationplacements}
...
```cpp
inline List< DecorationPlacement > CollectBiomeDecorationPlacements()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:96

---

{#placedecorationinstances}
...
```cpp
inline void PlaceDecorationInstances(TerrainData terrainData, Transform decorationRoot, DecorationPlacement placement, Texture2D biomeMap, Texture2D noiseMap, int resolution, int placementIndex)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:128
...
```cpp
inline bool ShouldPlace(BiomeDecoration decoration, Texture2D noiseMap, float u, float v, float coverage, float biomeAlpha, int placementIndex, int x, int y)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:174

---

{#getterrainsurfaceposition}
...
```cpp
inline Vector3 GetTerrainSurfacePosition(TerrainData terrainData, Vector3 terrainPosition, Vector3 terrainSize, float u, float v)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:206

---

{#getplacementresolution}
...
```cpp
inline int GetPlacementResolution()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:236
...
```cpp
inline Transform EnsureDecorationRoot()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:244
...
```cpp
inline void ClearGeneratedDecorations()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:261

## Private Static Attributes

| Return | Name | Description |
|--------|------|-------------|
| `const string` | [`generatedRootName`](#generatedrootname) `static` |  |
| `const int` | [`maxPlacementResolution`](#maxplacementresolution) `static` |  |
...
```cpp
const string generatedRootName = "Genesis Generated  Decorations"
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:19

---

{#maxplacementresolution}
...
```cpp
const int maxPlacementResolution = 512
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:20

## Private Static Methods

| Return | Name | Description |
|--------|------|-------------|
| `GameObject` | [`SelectPrefab`](#selectprefab) `static` `inline` |  |
| `Quaternion` | [`GetRandomRotation`](#getrandomrotation) `static` `inline` |  |
| `float` | [`GetRandomScale`](#getrandomscale) `static` `inline` |  |
| `GameObject` | [`InstantiatePrefab`](#instantiateprefab) `static` `inline` |  |
| `Texture2D` | [`GetReadableRenderTexture`](#getreadablerendertexture) `static` `inline` |  |
| `Texture2D` | [`GetReadableRenderTexture`](#getreadablerendertexture-1) `static` `inline` |  |
| `Texture2D` | [`ReadRenderTexture`](#readrendertexture) `static` `inline` |  |
| `float` | [`SampleTextureChannel`](#sampletexturechannel) `static` `inline` |  |
| `float` | [`Hash01`](#hash01-3) `static` `inline` |  |
| `void` | [`DestroyObject`](#destroyobject) `static` `inline` |  |
...
```cpp
static inline GameObject SelectPrefab(IReadOnlyList< GameObject > prefabs, int placementIndex, int x, int y)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:187
...
```cpp
static inline Quaternion GetRandomRotation(BiomeDecoration decoration, int placementIndex, int x, int y)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:215
...
```cpp
static inline float GetRandomScale(BiomeDecoration decoration, int placementIndex, int x, int y)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:226
...
```cpp
static inline GameObject InstantiatePrefab(GameObject prefab, Transform parent)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:271
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:285

---

{#getreadablerendertexture-1}
...
```cpp
static inline Texture2D GetReadableRenderTexture(RenderTexture renderTexture, Dictionary< RenderTexture, Texture2D > cache)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:298
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:311
...
```cpp
static inline float SampleTextureChannel(Texture2D texture, int channel, float u, float v)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:334
...
```cpp
static inline float Hash01(int a, int b, int c, int salt)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:352
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Generator/TerrainBiomeDecorationNode.cs:365
