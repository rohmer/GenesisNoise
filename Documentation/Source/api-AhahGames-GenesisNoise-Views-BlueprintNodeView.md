...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueprintNodeView.cs:18
...
| Name | Kind | Owner |
|------|------|-------|
| [`blueprintNode`](#blueprintnode-1) | `property` | Declared here |
| [`header`](#header-1) | `property` | Declared here |
| [`Enable`](#enable-94) | `function` | Declared here |
| [`Disable`](#disable-53) | `function` | Declared here |
| [`graphField`](#graphfield) | `variable` | Declared here |
| [`outputField`](#outputfield) | `variable` | Declared here |
| [`outputChoices`](#outputchoices) | `variable` | Declared here |
| [`outputOptions`](#outputoptions) | `variable` | Declared here |
| [`subscribedBlueprintGraph`](#subscribedblueprintgraph) | `variable` | Declared here |
| [`DeleteNodeFromFocusedControl`](#deletenodefromfocusedcontrol) | `function` | Declared here |
| [`SubscribeBlueprintGraph`](#subscribeblueprintgraph) | `function` | Declared here |
| [`UnsubscribeBlueprintGraph`](#unsubscribeblueprintgraph) | `function` | Declared here |
| [`OnBlueprintPreviewUpdated`](#onblueprintpreviewupdated) | `function` | Declared here |
| [`OnBlueprintParameterModified`](#onblueprintparametermodified) | `function` | Declared here |
| [`OnBlueprintParametersChanged`](#onblueprintparameterschanged) | `function` | Declared here |
| [`RefreshOutputField`](#refreshoutputfield) | `function` | Declared here |
| [`SelectOutput`](#selectoutput) | `function` | Declared here |
| [`RefreshBlueprintNode`](#refreshblueprintnode) | `function` | Declared here |
...
|--------|------|-------------|
| `BlueprintNode` | [`blueprintNode`](#blueprintnode-1)  |  |
| `override string` | [`header`](#header-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueprintNodeView.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueprintNodeView.cs:27

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-94) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-53) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueprintNodeView.cs:29
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueprintNodeView.cs:70
...
| Return | Name | Description |
|--------|------|-------------|
| `ObjectField` | [`graphField`](#graphfield)  |  |
| `PopupField< string >` | [`outputField`](#outputfield)  |  |
| `readonly List< string >` | [`outputChoices`](#outputchoices)  |  |
| `List< BlueprintOutputOption >` | [`outputOptions`](#outputoptions)  |  |
| `GenesisGraph` | [`subscribedBlueprintGraph`](#subscribedblueprintgraph)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueprintNodeView.cs:21
...
```cpp
PopupField< string > outputField
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueprintNodeView.cs:22
...
```cpp
readonly List< string > outputChoices = new()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueprintNodeView.cs:23
...
```cpp
List< BlueprintOutputOption > outputOptions = new()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueprintNodeView.cs:24

---

{#subscribedblueprintgraph}

### subscribedBlueprintGraph

```cpp
GenesisGraph subscribedBlueprintGraph
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueprintNodeView.cs:25

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`DeleteNodeFromFocusedControl`](#deletenodefromfocusedcontrol) `inline` |  |
| `void` | [`SubscribeBlueprintGraph`](#subscribeblueprintgraph) `inline` |  |
| `void` | [`UnsubscribeBlueprintGraph`](#unsubscribeblueprintgraph) `inline` |  |
| `void` | [`OnBlueprintPreviewUpdated`](#onblueprintpreviewupdated) `inline` |  |
| `void` | [`OnBlueprintParameterModified`](#onblueprintparametermodified) `inline` |  |
| `void` | [`OnBlueprintParametersChanged`](#onblueprintparameterschanged) `inline` |  |
| `void` | [`RefreshOutputField`](#refreshoutputfield) `inline` |  |
| `void` | [`SelectOutput`](#selectoutput) `inline` |  |
| `void` | [`RefreshBlueprintNode`](#refreshblueprintnode) `inline` |  |

---

{#deletenodefromfocusedcontrol}
...
```cpp
inline void DeleteNodeFromFocusedControl(KeyDownEvent evt)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueprintNodeView.cs:75

---

{#subscribeblueprintgraph}
...
```cpp
inline void SubscribeBlueprintGraph()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueprintNodeView.cs:87

---

{#unsubscribeblueprintgraph}
...
```cpp
inline void UnsubscribeBlueprintGraph()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueprintNodeView.cs:102
...
```cpp
inline void OnBlueprintPreviewUpdated()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueprintNodeView.cs:112

---

{#onblueprintparametermodified}
...
```cpp
inline void OnBlueprintParameterModified(ExposedParameter parameter)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueprintNodeView.cs:121

---

{#onblueprintparameterschanged}
...
```cpp
inline void OnBlueprintParametersChanged()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueprintNodeView.cs:126
...
```cpp
inline void RefreshOutputField()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueprintNodeView.cs:134
...
```cpp
inline void SelectOutput(string displayName)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueprintNodeView.cs:164

---

{#refreshblueprintnode}
...
```cpp
inline void RefreshBlueprintNode()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueprintNodeView.cs:174
