{#randompointinboxnodeview}

# RandomPointInBoxNodeView

```cpp
class RandomPointInBoxNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomPointInBoxNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-49) | `property` | Declared here |
| [`Enable`](#enable-146) | `function` | Declared here |
| [`Disable`](#disable-68) | `function` | Declared here |
| [`p1`](#p1) | `variable` | Declared here |
| [`p2`](#p2) | `variable` | Declared here |
| [`RefreshOutputs`](#refreshoutputs-11) | `function` | Declared here |
...
|--------|------|-------------|
| `RandomPointInBoxNode` | [`node`](#node-49)  |  |
...
```cpp
RandomPointInBoxNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomPointInBoxNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-146) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-68) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomPointInBoxNodeView.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomPointInBoxNodeView.cs:46
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomPointInBoxNodeView.cs:13
...
| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RefreshOutputs`](#refreshoutputs-11) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomPointInBoxNodeView.cs:52
