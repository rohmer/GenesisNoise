...
```cpp
class OceanSettingsNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/Ocean/OceanSettingsNode.cs:12
...
| Name | Kind | Owner |
|------|------|-------|
| [`ProcessNode`](#processnode-89) | `function` | Declared here |
...
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-89) `inline` |  |
...
```cpp
inline override bool ProcessNode(CommandBuffer cmd)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/Ocean/OceanSettingsNode.cs:18
