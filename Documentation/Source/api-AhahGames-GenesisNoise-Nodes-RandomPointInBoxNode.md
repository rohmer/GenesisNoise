...
```cpp
class RandomPointInBoxNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInBoxNode.cs:14
...
| Name | Kind | Owner |
|------|------|-------|
| [`nodeWidth`](#nodewidth-146) | `property` | Declared here |
| [`name`](#name-412) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-381) | `property` | Declared here |
| [`output`](#output-69) | `variable` | Declared here |
| [`pt1`](#pt1) | `variable` | Declared here |
| [`pt2`](#pt2) | `variable` | Declared here |
| [`Process`](#process-10) | `function` | Declared here |
| [`ProcessNode`](#processnode-99) | `function` | Declared here |
...
|--------|------|-------------|
| `override float` | [`nodeWidth`](#nodewidth-146)  |  |
| `override string` | [`name`](#name-412)  |  |
| `override string` | [`NodeGroup`](#nodegroup-381)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInBoxNode.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInBoxNode.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInBoxNode.cs:25

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `Vector2` | [`output`](#output-69)  |  |
| `Vector2` | [`pt1`](#pt1)  |  |
| `Vector2` | [`pt2`](#pt2)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInBoxNode.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInBoxNode.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInBoxNode.cs:22

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Process`](#process-10) `virtual` `inline` | Override this method to implement custom processing. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInBoxNode.cs:26
...
| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-99) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInBoxNode.cs:38
