{#bluenoisepointsnodeview}

# BlueNoisePointsNodeView

```cpp
class BlueNoisePointsNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueNoisePointsNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-12) | `property` | Declared here |
| [`Enable`](#enable-93) | `function` | Declared here |
| [`Disable`](#disable-52) | `function` | Declared here |
| [`countField`](#countfield) | `variable` | Declared here |
| [`coordinatesField`](#coordinatesfield) | `variable` | Declared here |
| [`RefreshOutputs`](#refreshoutputs) | `function` | Declared here |
...
|--------|------|-------------|
| `BlueNoisePointsNode` | [`node`](#node-12)  |  |
...
```cpp
BlueNoisePointsNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueNoisePointsNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-93) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-52) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueNoisePointsNodeView.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueNoisePointsNodeView.cs:38
...
| Return | Name | Description |
|--------|------|-------------|
| `IntegerField` | [`countField`](#countfield)  |  |
| `TextField` | [`coordinatesField`](#coordinatesfield)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueNoisePointsNodeView.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueNoisePointsNodeView.cs:15

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RefreshOutputs`](#refreshoutputs) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/BlueNoisePointsNodeView.cs:44
