{#genesisnoisevaluereturndrawer}

# GenesisNoiseValueReturnDrawer

```cpp
class GenesisNoiseValueReturnDrawer
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisNoiseValueReturnDrawer.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`DrawerGUI`](#drawergui-14) | `function` | Declared here |
| [`NoiseValueReturn`](#noisevaluereturn) | `enum` | Declared here |
...
|--------|------|-------------|
| `override void` | [`DrawerGUI`](#drawergui-14) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisNoiseValueReturnDrawer.cs:28
...
| Name | Description |
|------|-------------|
| [`NoiseValueReturn`](#noisevaluereturn)  |  |
...
```cpp
enum NoiseValueReturn
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisNoiseValueReturnDrawer.cs:12
