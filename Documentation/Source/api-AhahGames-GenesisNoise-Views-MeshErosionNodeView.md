...
```cpp
class MeshErosionNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshErosionNodeView.cs:11
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-30) | `property` | Declared here |
| [`Enable`](#enable-125) | `function` | Declared here |
| [`iterations`](#iterations-2) | `variable` | Declared here |
| [`erosionStrength`](#erosionstrength) | `variable` | Declared here |
| [`depositionStrength`](#depositionstrength) | `variable` | Declared here |
| [`talusHeight`](#talusheight) | `variable` | Declared here |
| [`preserveBorders`](#preserveborders) | `variable` | Declared here |
| [`recalculateNormals`](#recalculatenormals) | `variable` | Declared here |
...
```cpp
MeshErosionNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshErosionNodeView.cs:13

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-125) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshErosionNodeView.cs:22

## Private Attributes

| Return | Name | Description |
|--------|------|-------------|
| `SliderInt` | [`iterations`](#iterations-2)  |  |
| `Slider` | [`erosionStrength`](#erosionstrength)  |  |
| `Slider` | [`depositionStrength`](#depositionstrength)  |  |
| `Slider` | [`talusHeight`](#talusheight)  |  |
| `Toggle` | [`preserveBorders`](#preserveborders)  |  |
| `Toggle` | [`recalculateNormals`](#recalculatenormals)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshErosionNodeView.cs:15
...
```cpp
Slider erosionStrength
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshErosionNodeView.cs:16
...
```cpp
Slider depositionStrength
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshErosionNodeView.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshErosionNodeView.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshErosionNodeView.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshErosionNodeView.cs:20
