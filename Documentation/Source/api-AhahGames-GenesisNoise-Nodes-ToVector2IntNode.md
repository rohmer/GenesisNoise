...
```cpp
class ToVector2IntNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToVector2IntNode.cs:13
...
| Name | Kind | Owner |
|------|------|-------|
| [`nodeWidth`](#nodewidth-190) | `property` | Declared here |
| [`name`](#name-537) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-493) | `property` | Declared here |
| [`X`](#x-24) | `variable` | Declared here |
| [`Y`](#y-21) | `variable` | Declared here |
| [`output`](#output-103) | `variable` | Declared here |
| [`Process`](#process-23) | `function` | Declared here |
...
|--------|------|-------------|
| `override float` | [`nodeWidth`](#nodewidth-190)  |  |
| `override string` | [`name`](#name-537)  |  |
| `override string` | [`NodeGroup`](#nodegroup-493)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToVector2IntNode.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToVector2IntNode.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToVector2IntNode.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToVector2IntNode.cs:16
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToVector2IntNode.cs:19

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Process`](#process-23) `virtual` `inline` | Override this method to implement custom processing. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Cast/ToVector2IntNode.cs:23
