{#genesisremapmodedrawer}

# GenesisRemapModeDrawer

```cpp
class GenesisRemapModeDrawer
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisRemapModeDrawer.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`DrawerGUI`](#drawergui-19) | `function` | Declared here |
| [`displayedOptions`](#displayedoptions-1) | `variable` | Declared here |
| [`optionValues`](#optionvalues) | `variable` | Declared here |
...
|--------|------|-------------|
| `override void` | [`DrawerGUI`](#drawergui-19) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisRemapModeDrawer.cs:12
...
| Return | Name | Description |
|--------|------|-------------|
| `string[]` | [`displayedOptions`](#displayedoptions-1) `static` |  |
| `int[]` | [`optionValues`](#optionvalues) `static` |  |
...
```cpp
string[] displayedOptions = { "Brightness (Gradient)", "Red Channel (Curve)", "Green Channel (Curve)", "Blue Channel (Curve)", "Alpha Channel (Curve)", "All Channels (4 Curves)", "Brightness (Curve)", "Saturation (Curve)", "Hue (Curve)" }
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisRemapModeDrawer.cs:20
...
```cpp
int[] optionValues = { 0, 5, 6, 7, 1, 8, 2, 3, 4 }
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisRemapModeDrawer.cs:21
