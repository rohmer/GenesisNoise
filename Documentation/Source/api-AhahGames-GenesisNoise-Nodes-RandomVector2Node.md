...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector2Node.cs:12
...
| Name | Kind | Owner |
|------|------|-------|
| [`nodeWidth`](#nodewidth-151) | `property` | Declared here |
| [`name`](#name-417) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-386) | `property` | Declared here |
| [`output`](#output-74) | `variable` | Declared here |
| [`XMin`](#xmin) | `variable` | Declared here |
| [`XMax`](#xmax) | `variable` | Declared here |
| [`YMin`](#ymin) | `variable` | Declared here |
| [`YMax`](#ymax) | `variable` | Declared here |
| [`Process`](#process-14) | `function` | Declared here |
| [`ProcessNode`](#processnode-104) | `function` | Declared here |
...
|--------|------|-------------|
| `override float` | [`nodeWidth`](#nodewidth-151)  |  |
| `override string` | [`name`](#name-417)  |  |
| `override string` | [`NodeGroup`](#nodegroup-386)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector2Node.cs:26
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector2Node.cs:27
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector2Node.cs:28

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `Vector2` | [`output`](#output-74)  |  |
| `float` | [`XMin`](#xmin)  |  |
| `float` | [`XMax`](#xmax)  |  |
| `float` | [`YMin`](#ymin)  |  |
| `float` | [`YMax`](#ymax)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector2Node.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector2Node.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector2Node.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector2Node.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector2Node.cs:24

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Process`](#process-14) `virtual` `inline` | Override this method to implement custom processing. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector2Node.cs:30
...
| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-104) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector2Node.cs:37
