{#texturechannelnodeview}

# TextureChannelNodeView

```cpp
class TextureChannelNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Texture/TextureChannelNodeView.cs:14
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-70) | `property` | Declared here |
| [`Enable`](#enable-169) | `function` | Declared here |
| [`Disable`](#disable-77) | `function` | Declared here |
| [`textureField`](#texturefield) | `variable` | Declared here |
| [`OnPortConnectionChanged`](#onportconnectionchanged) | `function` | Declared here |
| [`UpdateTextureFieldVisibility`](#updatetexturefieldvisibility) | `function` | Declared here |
| [`IsTextureInputConnected`](#istextureinputconnected-1) | `function` | Declared here |
...
|--------|------|-------------|
| `TextureChannelNode` | [`node`](#node-70)  |  |
...
```cpp
TextureChannelNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Texture/TextureChannelNodeView.cs:16

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-169) `inline` |  |
| `override void` | [`Disable`](#disable-77) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Texture/TextureChannelNodeView.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Texture/TextureChannelNodeView.cs:43

## Private Attributes

| Return | Name | Description |
|--------|------|-------------|
| `ObjectField` | [`textureField`](#texturefield)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Texture/TextureChannelNodeView.cs:18

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`OnPortConnectionChanged`](#onportconnectionchanged) `inline` |  |
| `void` | [`UpdateTextureFieldVisibility`](#updatetexturefieldvisibility) `inline` |  |
| `bool` | [`IsTextureInputConnected`](#istextureinputconnected-1) `inline` |  |
...
```cpp
inline void OnPortConnectionChanged(PortView port)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Texture/TextureChannelNodeView.cs:50

---

{#updatetexturefieldvisibility}
...
```cpp
inline void UpdateTextureFieldVisibility()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Texture/TextureChannelNodeView.cs:58

---

{#istextureinputconnected-1}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Texture/TextureChannelNodeView.cs:66
