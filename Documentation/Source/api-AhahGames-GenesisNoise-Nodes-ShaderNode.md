...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:19

> **Inherits:** [`AhahGames.GenesisNoise.Nodes.GenesisNode`](api-AhahGames-GenesisNoise-Nodes-GenesisNode.md#genesisnode), [`AhahGames.GenesisNoise.Nodes.IUseCustomRenderTextureProcessing`](api-AhahGames-GenesisNoise-Nodes-IUseCustomRenderTextureProcessing.md#iusecustomrendertextureprocessing), [`GraphProcessor.ICreateNodeFrom< T >`](api-GraphProcessor-ICreateNodeFrom-1-g.md#icreatenodefrom-1-g), [`GraphProcessor.ICreateNodeFrom< T >`](api-GraphProcessor-ICreateNodeFrom-1-g.md#icreatenodefrom-1-g)
> **Subclassed by:** [`AhahGames.GenesisNoise.Nodes.FixedShaderNode`](api-AhahGames-GenesisNoise-Nodes-FixedShaderNode.md#fixedshadernode)

## List of all members

| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-446) | `property` | Declared here |
| [`isRenamable`](#isrenamable-6) | `property` | Declared here |
| [`hasMips`](#hasmips) | `property` | Declared here |
| [`filteredOutProperties`](#filteredoutproperties-112) | `property` | Declared here |
| [`previewTexture`](#previewtexture-41) | `property` | Declared here |
| [`rawProcessingTime`](#rawprocessingtime-1) | `property` | Declared here |
| [`defaultSettings`](#defaultsettings-31) | `property` | Declared here |
| [`canProcess`](#canprocess-3) | `property` | Declared here |
| [`materialInputs`](#materialinputs-1) | `variable` | Declared here |
| [`output`](#output-80) | `variable` | Declared here |
| [`shader`](#shader-2) | `variable` | Declared here |
| [`material`](#material) | `variable` | Declared here |
| [`InitializeNodeFromObject`](#initializenodefromobject-6) | `function` | Declared here |
| [`InitializeNodeFromObject`](#initializenodefromobject-7) | `function` | Declared here |
| [`ListMaterialProperties`](#listmaterialproperties-1) | `function` | Declared here |
| [`GetCustomRenderTextures`](#getcustomrendertextures-4) | `function` | Declared here |
| [`DefaultShaderName`](#defaultshadername) | `variable` | Declared here |
| [`Enable`](#enable-68) | `function` | Declared here |
| [`Disable`](#disable-41) | `function` | Declared here |
| [`GetMaterialInputs`](#getmaterialinputs-1) | `function` | Declared here |
| [`ProcessNode`](#processnode-111) | `function` | Declared here |
| [`exposedProperties`](#exposedproperties) | `variable` | Declared here |
| [`shaderGUID`](#shaderguid) | `variable` | Declared here |
| [`defaultShader`](#defaultshader) | `variable` | Declared here |
| [`UpdateShader`](#updateshader) | `function` | Declared here |
| [`BeforeProcessSetup`](#beforeprocesssetup) | `function` | Declared here |
...
| `property` | [`rawProcessingTime`](api-AhahGames-GenesisNoise-Nodes-GenesisNode.md#rawprocessingtime)  | Raw GPU processing time measured by the profiler sampler. Subclasses (e.g. [ShaderNode](#shadernode)) override this to source the time from a different sampler, while the skip/caching behaviour is handled by processingTime. |
...
|--------|------|-------------|
| `override string` | [`name`](#name-446)  |  |
| `override bool` | [`isRenamable`](#isrenamable-6)  |  |
| `bool` | [`hasMips`](#hasmips)  |  |
| `IEnumerable< string >` | [`filteredOutProperties`](#filteredoutproperties-112)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-41)  |  |
| `override float` | [`rawProcessingTime`](#rawprocessingtime-1)  |  |
| `override GenesisNoiseSettings` | [`defaultSettings`](#defaultsettings-31)  |  |
| `override bool` | [`canProcess`](#canprocess-3)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:32
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:33
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:54

---

{#filteredoutproperties-112}

### filteredOutProperties

```cpp
IEnumerable< string > filteredOutProperties
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:56
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:57
...
```cpp
override float rawProcessingTime
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:64
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:75
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:203

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `List< object >` | [`materialInputs`](#materialinputs-1)  |  |
| `CustomRenderTexture` | [`output`](#output-80)  |  |
...
```cpp
List< object > materialInputs
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:36
...
```cpp
CustomRenderTexture output = null
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:39
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:42
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:44

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `bool` | [`InitializeNodeFromObject`](#initializenodefromobject-6) `inline` |  |
| `bool` | [`InitializeNodeFromObject`](#initializenodefromobject-7) `inline` |  |
| `IEnumerable< PortData >` | [`ListMaterialProperties`](#listmaterialproperties-1) `inline` |  |
| `IEnumerable< CustomRenderTexture >` | [`GetCustomRenderTextures`](#getcustomrendertextures-4) `virtual` `inline` |  |

---

{#initializenodefromobject-6}
...
```cpp
inline bool InitializeNodeFromObject(Shader value)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:118

---

{#initializenodefromobject-7}
...
```cpp
inline bool InitializeNodeFromObject(Material value)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:124

---

{#listmaterialproperties-1}
...
```cpp
inline IEnumerable< PortData > ListMaterialProperties(List< SerializableEdge > edges)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:133

---

{#getcustomrendertextures-4}
...
```cpp
virtual inline IEnumerable< CustomRenderTexture > GetCustomRenderTextures()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:298

#### Reimplements

- [`GetCustomRenderTextures`](api-AhahGames-GenesisNoise-Nodes.md#getcustomrendertextures-2)
...
| Return | Name | Description |
|--------|------|-------------|
| `readonly string` | [`DefaultShaderName`](#defaultshadername) `static` |  |
...
```cpp
readonly string DefaultShaderName = "Hidden//ShaderNodeDefault"
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:30

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-68) `virtual` `inline` | Called when the node is enabled. |
| `override void` | [`Disable`](#disable-41) `virtual` `inline` | Called when the node is disabled. |
| `void` | [`GetMaterialInputs`](#getmaterialinputs-1) `inline` |  |
| `override bool` | [`ProcessNode`](#processnode-111) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:87
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:112
...
```cpp
inline void GetMaterialInputs(List< SerializableEdge > edges)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:160
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:255
...
| Return | Name | Description |
|--------|------|-------------|
| `List< ShaderProperty >` | [`exposedProperties`](#exposedproperties)  |  |
| `string` | [`shaderGUID`](#shaderguid)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:49
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:52
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:85

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`UpdateShader`](#updateshader) `inline` |  |
| `void` | [`BeforeProcessSetup`](#beforeprocesssetup) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:174
...
```cpp
inline void BeforeProcessSetup()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ShaderNode.cs:197
