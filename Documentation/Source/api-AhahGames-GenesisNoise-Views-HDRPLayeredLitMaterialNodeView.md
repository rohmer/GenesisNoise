{#hdrplayeredlitmaterialnodeview}

# HDRPLayeredLitMaterialNodeView

```cpp
class HDRPLayeredLitMaterialNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/HDRP/HDRPLayeredLitMaterialNodeView.cs:14
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-21) | `property` | Declared here |
| [`Enable`](#enable-114) | `function` | Declared here |
...
|--------|------|-------------|
| `HDRPLayeredLitMaterial` | [`node`](#node-21)  |  |
...
```cpp
HDRPLayeredLitMaterial node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/HDRP/HDRPLayeredLitMaterialNodeView.cs:16

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-114) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/HDRP/HDRPLayeredLitMaterialNodeView.cs:18
