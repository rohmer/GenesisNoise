...
```cpp
class ParameterNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Views/ParameterNodeView.cs:6
...
| Name | Kind | Owner |
|------|------|-------|
| [`Enable`](#enable-3) | `function` | Declared here |
| [`parameterNode`](#parameternode) | `variable` | Declared here |
| [`UpdateView`](#updateview) | `function` | Declared here |
| [`UpdatePort`](#updateport) | `function` | Declared here |
...
|--------|------|-------------|
| `override void` | [`Enable`](#enable-3) `virtual` `inline` |  |
...
```cpp
virtual inline override void Enable(bool fromInspector = false)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Views/ParameterNodeView.cs:10
...
| Return | Name | Description |
|--------|------|-------------|
| `ParameterNode` | [`parameterNode`](#parameternode)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Views/ParameterNodeView.cs:8

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`UpdateView`](#updateview) `inline` |  |
| `void` | [`UpdatePort`](#updateport) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Views/ParameterNodeView.cs:38
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Views/ParameterNodeView.cs:43
