...
```cpp
class LevelsNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Color/LevelsNodeView.cs:16
...
| Name | Kind | Owner |
|------|------|-------|
| [`Enable`](#enable-122) | `function` | Declared here |
| [`histogramContainer`](#histogramcontainer-1) | `variable` | Declared here |
| [`levelsNode`](#levelsnode) | `variable` | Declared here |
| [`sliders`](#sliders) | `variable` | Declared here |
...
|--------|------|-------------|
| `override void` | [`Enable`](#enable-122) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Color/LevelsNodeView.cs:54
...
| Return | Name | Description |
|--------|------|-------------|
| `VisualElement` | [`histogramContainer`](#histogramcontainer-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Color/LevelsNodeView.cs:23

## Private Attributes

| Return | Name | Description |
|--------|------|-------------|
| `Levels` | [`levelsNode`](#levelsnode)  |  |
| `List< MinMaxSlider >` | [`sliders`](#sliders)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Color/LevelsNodeView.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Color/LevelsNodeView.cs:22
