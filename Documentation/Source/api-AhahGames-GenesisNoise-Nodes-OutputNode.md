...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:16

> **Inherits:** [`AhahGames.GenesisNoise.Nodes.GenesisNode`](api-AhahGames-GenesisNoise-Nodes-GenesisNode.md#genesisnode), [`AhahGames.GenesisNoise.Nodes.IUseCustomRenderTextureProcessing`](api-AhahGames-GenesisNoise-Nodes-IUseCustomRenderTextureProcessing.md#iusecustomrendertextureprocessing)
> **Subclassed by:** [`AhahGames.GenesisNoise.Nodes.ExternalOutputNode`](api-AhahGames-GenesisNoise-Nodes-ExternalOutputNode.md#externaloutputnode)

## List of all members

| Name | Kind | Owner |
|------|------|-------|
| [`mainOutput`](#mainoutput) | `property` | Declared here |
| [`name`](#name-380) | `property` | Declared here |
| [`previewTexture`](#previewtexture-34) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-135) | `property` | Declared here |
| [`canEditPreviewSRGB`](#caneditpreviewsrgb-3) | `property` | Declared here |
| [`defaultPreviewSRGB`](#defaultpreviewsrgb-1) | `property` | Declared here |
| [`isOutputNode`](#isoutputnode-1) | `property` | Declared here |
| [`selectedPreviewIndex`](#selectedpreviewindex) | `property` | Declared here |
| [`defaultSettings`](#defaultsettings-23) | `property` | Declared here |
| [`outputTextureSettings`](#outputtexturesettings) | `variable` | Declared here |
| [`AddTextureOutput`](#addtextureoutput) | `function` | Declared here |
| [`RemoveTextureOutput`](#removetextureoutput) | `function` | Declared here |
| [`GetCustomRenderTextures`](#getcustomrendertextures-3) | `function` | Declared here |
| [`uniqueMessages`](#uniquemessages) | `variable` | Declared here |
| [`Enable`](#enable-62) | `function` | Declared here |
| [`CanResetPort`](#canresetport-1) | `function` | Declared here |
| [`Disable`](#disable-35) | `function` | Declared here |
| [`ProcessNode`](#processnode-91) | `function` | Declared here |
| [`ChangeOutputPortType`](#changeoutputporttype) | `function` | Declared here |
| [`AssignSubTextures`](#assignsubtextures) | `function` | Declared here |
| [`_selectedPreviewIndex`](#_selectedpreviewindex) | `variable` | Declared here |
| [`CreateFinalCopyMaterial`](#createfinalcopymaterial) | `function` | Declared here |
| [`UpdateMessages`](#updatemessages) | `function` | Declared here |
| [`UpdateFinalCopyMaterial`](#updatefinalcopymaterial) | `function` | Declared here |
...
|--------|------|-------------|
| `OutputTextureSettings` | [`mainOutput`](#mainoutput)  |  |
| `override string` | [`name`](#name-380)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-34)  |  |
| `override float` | [`nodeWidth`](#nodewidth-135)  |  |
| `override bool` | [`canEditPreviewSRGB`](#caneditpreviewsrgb-3)  |  |
| `override bool` | [`defaultPreviewSRGB`](#defaultpreviewsrgb-1)  |  |
| `override bool` | [`isOutputNode`](#isoutputnode-1)  |  |
| `int` | [`selectedPreviewIndex`](#selectedpreviewindex)  |  |
| `override GenesisNoiseSettings` | [`defaultSettings`](#defaultsettings-23)  |  |
...
```cpp
OutputTextureSettings mainOutput
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:25
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:26
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:27

---

{#caneditpreviewsrgb-3}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:29

---

{#defaultpreviewsrgb-1}

### defaultPreviewSRGB

```cpp
override bool defaultPreviewSRGB
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:30
...
```cpp
override bool isOutputNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:34
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:38
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:48

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `List< OutputTextureSettings >` | [`outputTextureSettings`](#outputtexturesettings)  |  |
...
```cpp
List< OutputTextureSettings > outputTextureSettings = new()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:19

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `OutputTextureSettings` | [`AddTextureOutput`](#addtextureoutput) `inline` |  |
| `void` | [`RemoveTextureOutput`](#removetextureoutput) `inline` |  |
| `IEnumerable< CustomRenderTexture >` | [`GetCustomRenderTextures`](#getcustomrendertextures-3) `inline` |  |
...
```cpp
inline OutputTextureSettings AddTextureOutput(OutputTextureSettings.Preset preset)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:78
...
```cpp
inline void RemoveTextureOutput(OutputTextureSettings settings)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:111

---

{#getcustomrendertextures-3}
...
```cpp
inline IEnumerable< CustomRenderTexture > GetCustomRenderTextures()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:263
...
| Return | Name | Description |
|--------|------|-------------|
| `HashSet< string >` | [`uniqueMessages`](#uniquemessages)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:46

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-62) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`CanResetPort`](#canresetport-1) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-35) `virtual` `inline` | Called when the node is disabled. |
| `override bool` | [`ProcessNode`](#processnode-91) `virtual` `inline` |  |
| `IEnumerable< PortData >` | [`ChangeOutputPortType`](#changeoutputporttype) `inline` |  |
| `void` | [`AssignSubTextures`](#assignsubtextures) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:60
...
```cpp
virtual inline override bool CanResetPort(NodePort port)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:76

#### Reimplements

- [`CanResetPort`](api-GraphProcessor-BaseNode.md#canresetport)
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:129
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:135
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:233
...
```cpp
inline void AssignSubTextures(List< SerializableEdge > edges)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:249

## Private Attributes

| Return | Name | Description |
|--------|------|-------------|
| `int` | [`_selectedPreviewIndex`](#_selectedpreviewindex)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:37

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `Material` | [`CreateFinalCopyMaterial`](#createfinalcopymaterial) `inline` |  |
| `void` | [`UpdateMessages`](#updatemessages) `inline` |  |
| `bool` | [`UpdateFinalCopyMaterial`](#updatefinalcopymaterial) `inline` |  |

---

{#createfinalcopymaterial}
...
```cpp
inline Material CreateFinalCopyMaterial()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:116
...
```cpp
inline void UpdateMessages()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:177

---

{#updatefinalcopymaterial}
...
```cpp
inline bool UpdateFinalCopyMaterial(OutputTextureSettings targetOutput)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/OutputNode.cs:191
