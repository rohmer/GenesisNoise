...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:18
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-335) | `property` | Declared here |
| [`computeShaderResourcePath`](#computeshaderresourcepath-3) | `property` | Declared here |
| [`previewTexture`](#previewtexture-30) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-46) | `property` | Declared here |
| [`defaultSettings`](#defaultsettings-15) | `property` | Declared here |
| [`loopInput`](#loopinput-8) | `variable` | Declared here |
| [`loopOutput`](#loopoutput-8) | `variable` | Declared here |
| [`inputMesh`](#inputmesh) | `variable` | Declared here |
| [`outputVolume`](#outputvolume) | `variable` | Declared here |
| [`mode`](#mode-18) | `variable` | Declared here |
| [`conservativeRaster`](#conservativeraster) | `variable` | Declared here |
| [`Enable`](#enable-56) | `function` | Declared here |
| [`Disable`](#disable-31) | `function` | Declared here |
| [`ProcessNode`](#processnode-79) | `function` | Declared here |
| [`Mode`](#mode-19) | `enum` | Declared here |
| [`rayMapBuffer`](#raymapbuffer) | `variable` | Declared here |
| [`props`](#props) | `variable` | Declared here |
| [`clearUnsignedKernel`](#clearunsignedkernel) | `variable` | Declared here |
| [`clearSignedKernel`](#clearsignedkernel) | `variable` | Declared here |
| [`fillUVUnsignedKernel`](#filluvunsignedkernel) | `variable` | Declared here |
| [`fillUVSignedKernel`](#filluvsignedkernel) | `variable` | Declared here |
| [`jumpFloodingUnsignedKernel`](#jumpfloodingunsignedkernel) | `variable` | Declared here |
| [`jumpFloodingSignedKernel`](#jumpfloodingsignedkernel) | `variable` | Declared here |
| [`finalPassUnsignedKernel`](#finalpassunsignedkernel) | `variable` | Declared here |
| [`finalPassSignedKernel`](#finalpasssignedkernel) | `variable` | Declared here |
| [`JumpFlooding`](#jumpflooding) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-335)  |  |
| `override string` | [`computeShaderResourcePath`](#computeshaderresourcepath-3)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-30)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-46)  |  |
| `override GenesisNoiseSettings` | [`defaultSettings`](#defaultsettings-15)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:44

---

{#computeshaderresourcepath-3}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:45
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:47

---

{#showdefaultinspector-46}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:48
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:49

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `object` | [`loopInput`](#loopinput-8)  |  |
| `object` | [`loopOutput`](#loopoutput-8)  |  |
| `GenesisMesh` | [`inputMesh`](#inputmesh)  |  |
| `CustomRenderTexture` | [`outputVolume`](#outputvolume)  |  |
| `Mode` | [`mode`](#mode-18)  |  |
| `bool` | [`conservativeRaster`](#conservativeraster)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:27
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:30
...
```cpp
GenesisMesh inputMesh = new()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:33
...
```cpp
CustomRenderTexture outputVolume
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:36
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:39
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:42

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-56) `virtual` `inline` | Called when the node is enabled. |
| `override void` | [`Disable`](#disable-31) `virtual` `inline` | Called when the node is disabled. |
| `override bool` | [`ProcessNode`](#processnode-79) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:63
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:85
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:92
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:20
...
| Return | Name | Description |
|--------|------|-------------|
| `CustomRenderTexture` | [`rayMapBuffer`](#raymapbuffer)  |  |
| `MaterialPropertyBlock` | [`props`](#props)  |  |
| `int` | [`clearUnsignedKernel`](#clearunsignedkernel)  |  |
| `int` | [`clearSignedKernel`](#clearsignedkernel)  |  |
| `int` | [`fillUVUnsignedKernel`](#filluvunsignedkernel)  |  |
| `int` | [`fillUVSignedKernel`](#filluvsignedkernel)  |  |
| `int` | [`jumpFloodingUnsignedKernel`](#jumpfloodingunsignedkernel)  |  |
| `int` | [`jumpFloodingSignedKernel`](#jumpfloodingsignedkernel)  |  |
| `int` | [`finalPassUnsignedKernel`](#finalpassunsignedkernel)  |  |
| `int` | [`finalPassSignedKernel`](#finalpasssignedkernel)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:51
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:53
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:54
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:55

---

{#filluvunsignedkernel}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:56
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:57

---

{#jumpfloodingunsignedkernel}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:58

---

{#jumpfloodingsignedkernel}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:59

---

{#finalpassunsignedkernel}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:60

---

{#finalpasssignedkernel}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:61

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`JumpFlooding`](#jumpflooding) `inline` |  |
...
```cpp
inline void JumpFlooding(CommandBuffer cmd)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshToVolumeNode.cs:120
