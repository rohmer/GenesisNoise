{#meshxyznoisedisplacementnode}

# MeshXYZNoiseDisplacementNode

```cpp
class MeshXYZNoiseDisplacementNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:18
...
| Name | Kind | Owner |
|------|------|-------|
| [`hasPreview`](#haspreview-60) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-308) | `property` | Declared here |
| [`name`](#name-336) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-47) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-127) | `property` | Declared here |
| [`previewTexture`](#previewtexture-31) | `property` | Declared here |
| [`loopInput`](#loopinput-9) | `variable` | Declared here |
| [`loopOutput`](#loopoutput-9) | `variable` | Declared here |
| [`input`](#input-23) | `variable` | Declared here |
| [`xNoise`](#xnoise) | `variable` | Declared here |
| [`yNoise`](#ynoise) | `variable` | Declared here |
| [`zNoise`](#znoise) | `variable` | Declared here |
| [`origin`](#origin-2) | `variable` | Declared here |
| [`output`](#output-55) | `variable` | Declared here |
| [`xStrength`](#xstrength) | `variable` | Declared here |
| [`yStrength`](#ystrength) | `variable` | Declared here |
| [`zStrength`](#zstrength) | `variable` | Declared here |
| [`PrepareNewLoopRun`](#preparenewlooprun-6) | `function` | Declared here |
| [`SetStrengths`](#setstrengths) | `function` | Declared here |
| [`Enable`](#enable-57) | `function` | Declared here |
| [`ProcessNode`](#processnode-80) | `function` | Declared here |
| [`Disable`](#disable-32) | `function` | Declared here |
| [`migratedAxisStrengths`](#migratedaxisstrengths) | `variable` | Declared here |
| [`meshStates`](#meshstates-4) | `variable` | Declared here |
| [`PullXTextureInput`](#pullxtextureinput) | `function` | Declared here |
| [`PullXRenderTextureInput`](#pullxrendertextureinput) | `function` | Declared here |
| [`PullYTextureInput`](#pullytextureinput) | `function` | Declared here |
| [`PullYRenderTextureInput`](#pullyrendertextureinput) | `function` | Declared here |
| [`PullZTextureInput`](#pullztextureinput) | `function` | Declared here |
| [`PullZRenderTextureInput`](#pullzrendertextureinput) | `function` | Declared here |
| [`MigrateLegacyStrength`](#migratelegacystrength) | `function` | Declared here |
| [`TryGetInputMesh`](#trygetinputmesh-4) | `function` | Declared here |
| [`ResolveCurrentInputMesh`](#resolvecurrentinputmesh-4) | `function` | Declared here |
| [`ClearGeneratedMeshes`](#cleargeneratedmeshes-5) | `function` | Declared here |
| [`IsLoopMode`](#isloopmode-5) | `function` | Declared here |
| [`ReadMeshData`](#readmeshdata-4) | `function` | Declared here |
| [`PullConnectedTexture`](#pullconnectedtexture-2) | `function` | Declared here |
| [`RefreshCollider`](#refreshcollider-3) | `function` | Declared here |
| [`ReadNoiseData`](#readnoisedata-1) | `function` | Declared here |
| [`DisplaceMeshData`](#displacemeshdata-1) | `function` | Declared here |
| [`CloseCoincidentVertexSeams`](#closecoincidentvertexseams-1) | `function` | Declared here |
| [`GetBounds`](#getbounds-2) | `function` | Declared here |
| [`RegeneratePlanarUVs`](#regenerateplanaruvs-2) | `function` | Declared here |
| [`GetPlanarUV`](#getplanaruv-2) | `function` | Declared here |
| [`OffsetUVByOrigin`](#offsetuvbyorigin-1) | `function` | Declared here |
| [`SampleNoise`](#samplenoise-1) | `function` | Declared here |
| [`BuildUnityMesh`](#buildunitymesh-3) | `function` | Declared here |
| [`Luminance`](#luminance-1) | `function` | Declared here |
| [`Lerp`](#lerp-25) | `function` | Declared here |
| [`Clamp01`](#clamp01-1) | `function` | Declared here |
| [`Repeat01PreserveOne`](#repeat01preserveone-1) | `function` | Declared here |
...
|--------|------|-------------|
| `override bool` | [`hasPreview`](#haspreview-60)  |  |
| `override string` | [`NodeGroup`](#nodegroup-308)  |  |
| `override string` | [`name`](#name-336)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-47)  |  |
| `override float` | [`nodeWidth`](#nodewidth-127)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-31)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:62
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:63
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:64

---

{#showdefaultinspector-47}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:65
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:66
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:70

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `object` | [`loopInput`](#loopinput-9)  |  |
| `object` | [`loopOutput`](#loopoutput-9)  |  |
| `GameObject` | [`input`](#input-23)  |  |
| `Texture` | [`xNoise`](#xnoise)  |  |
| `Texture` | [`yNoise`](#ynoise)  |  |
| `Texture` | [`zNoise`](#znoise)  |  |
| `Vector2` | [`origin`](#origin-2)  |  |
| `GameObject` | [`output`](#output-55)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:27
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:30
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:33
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:36
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:39
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:44
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:50
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:53
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:56

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`PrepareNewLoopRun`](#preparenewlooprun-6) `inline` |  |
| `void` | [`SetStrengths`](#setstrengths) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:146
...
```cpp
inline void SetStrengths(float x, float y, float z)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:227

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-57) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-80) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-32) `virtual` `inline` | Called when the node is disabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:124
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:131
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:140
...
| Return | Name | Description |
|--------|------|-------------|
| `bool` | [`migratedAxisStrengths`](#migratedaxisstrengths)  |  |
| `readonly Dictionary< GameObject, MeshState >` | [`meshStates`](#meshstates-4)  |  |

---

{#migratedaxisstrengths}

### migratedAxisStrengths

```cpp
bool migratedAxisStrengths
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:47
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:60

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`PullXTextureInput`](#pullxtextureinput) `inline` |  |
| `void` | [`PullXRenderTextureInput`](#pullxrendertextureinput) `inline` |  |
| `void` | [`PullYTextureInput`](#pullytextureinput) `inline` |  |
| `void` | [`PullYRenderTextureInput`](#pullyrendertextureinput) `inline` |  |
| `void` | [`PullZTextureInput`](#pullztextureinput) `inline` |  |
| `void` | [`PullZRenderTextureInput`](#pullzrendertextureinput) `inline` |  |
| `void` | [`MigrateLegacyStrength`](#migratelegacystrength) `inline` |  |
| `bool` | [`TryGetInputMesh`](#trygetinputmesh-4) `inline` |  |
| `Mesh` | [`ResolveCurrentInputMesh`](#resolvecurrentinputmesh-4) `inline` |  |
| `void` | [`ClearGeneratedMeshes`](#cleargeneratedmeshes-5) `inline` |  |
| `bool` | [`IsLoopMode`](#isloopmode-5) `inline` |  |
| `MeshBuildData` | [`ReadMeshData`](#readmeshdata-4) `inline` |  |
...
```cpp
inline void PullXTextureInput(List< SerializableEdge > edges)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:72

---

{#pullxrendertextureinput}
...
```cpp
inline void PullXRenderTextureInput(List< SerializableEdge > edges)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:78
...
```cpp
inline void PullYTextureInput(List< SerializableEdge > edges)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:84

---

{#pullyrendertextureinput}
...
```cpp
inline void PullYRenderTextureInput(List< SerializableEdge > edges)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:90
...
```cpp
inline void PullZTextureInput(List< SerializableEdge > edges)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:96

---

{#pullzrendertextureinput}
...
```cpp
inline void PullZRenderTextureInput(List< SerializableEdge > edges)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:102

---

{#migratelegacystrength}
...
```cpp
inline void MigrateLegacyStrength()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:235
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:246

---

{#resolvecurrentinputmesh-4}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:282

---

{#cleargeneratedmeshes-5}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:308
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:319
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:361

## Private Static Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`PullConnectedTexture`](#pullconnectedtexture-2) `static` `inline` |  |
| `void` | [`RefreshCollider`](#refreshcollider-3) `static` `inline` |  |
| `NoiseData` | [`ReadNoiseData`](#readnoisedata-1) `static` `inline` |  |
| `MeshBuildData` | [`DisplaceMeshData`](#displacemeshdata-1) `static` `inline` |  |
| `void` | [`CloseCoincidentVertexSeams`](#closecoincidentvertexseams-1) `static` `inline` |  |
| `void` | [`GetBounds`](#getbounds-2) `static` `inline` |  |
| `Vector2[]` | [`RegeneratePlanarUVs`](#regenerateplanaruvs-2) `static` `inline` |  |
| `Vector2` | [`GetPlanarUV`](#getplanaruv-2) `static` `inline` |  |
| `Vector2` | [`OffsetUVByOrigin`](#offsetuvbyorigin-1) `static` `inline` |  |
| `float` | [`SampleNoise`](#samplenoise-1) `static` `inline` |  |
| `Mesh` | [`BuildUnityMesh`](#buildunitymesh-3) `static` `inline` |  |
| `float` | [`Luminance`](#luminance-1) `static` `inline` |  |
| `float` | [`Lerp`](#lerp-25) `static` `inline` |  |
| `float` | [`Clamp01`](#clamp01-1) `static` `inline` |  |
| `float` | [`Repeat01PreserveOne`](#repeat01preserveone-1) `static` `inline` |  |

---

{#pullconnectedtexture-2}

### PullConnectedTexture

`static` `inline`

```cpp
static inline void PullConnectedTexture(List< SerializableEdge > edges, Action< Texture > setter)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:107
...
```cpp
static inline void RefreshCollider(GameObject target, Mesh mesh)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:325
...
```cpp
static inline NoiseData ReadNoiseData(Texture source)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:386
...
```cpp
static inline MeshBuildData DisplaceMeshData(MeshBuildData sourceData, NoiseData xNoiseData, NoiseData yNoiseData, NoiseData zNoiseData, float xStrength, float yStrength, float zStrength, bool centeredNoise, Vector2 origin)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:433

---

{#closecoincidentvertexseams-1}

### CloseCoincidentVertexSeams

`static` `inline`

```cpp
static inline void CloseCoincidentVertexSeams(Vector3[] sourceVertices, Vector3[] displacedVertices, Vector3 boundsSize)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:468
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:523

---

{#regenerateplanaruvs-2}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:545
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:554
...
```cpp
static inline Vector2 OffsetUVByOrigin(Vector2 uv, Vector2 origin, Vector3 boundsSize)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:561
...
```cpp
static inline float SampleNoise(NoiseData noiseData, float u, float v, bool centeredNoise)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:568
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:596
...
```cpp
static inline float Luminance(Color color)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:619
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:620
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:621

---

{#repeat01preserveone-1}
...
```cpp
static inline float Repeat01PreserveOne(float value)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshXYZNoiseDisplacementNode.cs:622
