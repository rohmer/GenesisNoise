{#tovector2intnodeview}

# ToVector2IntNodeView

```cpp
class ToVector2IntNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Cast/ToVector2IntNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-76) | `property` | Declared here |
| [`Enable`](#enable-176) | `function` | Declared here |
| [`field`](#field-5) | `variable` | Declared here |
| [`UpdateLabel`](#updatelabel-21) | `function` | Declared here |
...
```cpp
ToVector2IntNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Cast/ToVector2IntNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-176) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Cast/ToVector2IntNodeView.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Cast/ToVector2IntNodeView.cs:13

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`UpdateLabel`](#updatelabel-21) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Cast/ToVector2IntNodeView.cs:32
