{#gradientparameterdrawer}

# GradientParameterDrawer

```cpp
class GradientParameterDrawer
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Utils/ExposedParameterDrawer.cs:159
...
| Name | Kind | Owner |
|------|------|-------|
| [`CreatePropertyGUI`](#createpropertygui-8) | `function` | Declared here |
...
|--------|------|-------------|
| `override VisualElement` | [`CreatePropertyGUI`](#createpropertygui-8) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Utils/ExposedParameterDrawer.cs:161
