{#meshxyznoisedisplacementnodeview}

# MeshXYZNoiseDisplacementNodeView

```cpp
class MeshXYZNoiseDisplacementNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshXYZNoiseDisplacementNodeView.cs:11
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-37) | `property` | Declared here |
| [`Enable`](#enable-132) | `function` | Declared here |
| [`xStrength`](#xstrength-1) | `variable` | Declared here |
| [`yStrength`](#ystrength-1) | `variable` | Declared here |
| [`zStrength`](#zstrength-1) | `variable` | Declared here |
| [`centerNoise`](#centernoise-1) | `variable` | Declared here |
| [`CreateStrengthSlider`](#createstrengthslider) | `function` | Declared here |
...
|--------|------|-------------|
| `MeshXYZNoiseDisplacementNode` | [`node`](#node-37)  |  |
...
```cpp
MeshXYZNoiseDisplacementNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshXYZNoiseDisplacementNodeView.cs:13

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-132) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshXYZNoiseDisplacementNodeView.cs:20

## Private Attributes

| Return | Name | Description |
|--------|------|-------------|
| `Slider` | [`xStrength`](#xstrength-1)  |  |
| `Slider` | [`yStrength`](#ystrength-1)  |  |
| `Slider` | [`zStrength`](#zstrength-1)  |  |
| `Toggle` | [`centerNoise`](#centernoise-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshXYZNoiseDisplacementNodeView.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshXYZNoiseDisplacementNodeView.cs:16
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshXYZNoiseDisplacementNodeView.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshXYZNoiseDisplacementNodeView.cs:18

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `Slider` | [`CreateStrengthSlider`](#createstrengthslider) `inline` |  |

---

{#createstrengthslider}
...
```cpp
inline Slider CreateStrengthSlider(string label, float value, System.Action< float > setValue)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshXYZNoiseDisplacementNodeView.cs:47
