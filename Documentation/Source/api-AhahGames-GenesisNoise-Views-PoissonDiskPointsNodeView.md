{#poissondiskpointsnodeview}

# PoissonDiskPointsNodeView

```cpp
class PoissonDiskPointsNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/PoissonDiskPointsNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-43) | `property` | Declared here |
| [`Enable`](#enable-139) | `function` | Declared here |
| [`Disable`](#disable-65) | `function` | Declared here |
| [`countField`](#countfield-8) | `variable` | Declared here |
| [`coordinatesField`](#coordinatesfield-7) | `variable` | Declared here |
| [`RefreshOutputs`](#refreshoutputs-7) | `function` | Declared here |
...
|--------|------|-------------|
| `PoissonDiskPointsNode` | [`node`](#node-43)  |  |
...
```cpp
PoissonDiskPointsNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/PoissonDiskPointsNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-139) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-65) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/PoissonDiskPointsNodeView.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/PoissonDiskPointsNodeView.cs:38
...
| Return | Name | Description |
|--------|------|-------------|
| `IntegerField` | [`countField`](#countfield-8)  |  |
| `TextField` | [`coordinatesField`](#coordinatesfield-7)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/PoissonDiskPointsNodeView.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/PoissonDiskPointsNodeView.cs:15

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RefreshOutputs`](#refreshoutputs-7) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/PoissonDiskPointsNodeView.cs:44
