...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Filters/CurveNodeView.cs:15
...
| Name | Kind | Owner |
|------|------|-------|
| [`curveNode`](#curvenode-1) | `property` | Declared here |
| [`Enable`](#enable-100) | `function` | Declared here |
| [`Disable`](#disable-55) | `function` | Declared here |
| [`curveField`](#curvefield-2) | `variable` | Declared here |
| [`histogramData`](#histogramdata-2) | `variable` | Declared here |
| [`histogramContainer`](#histogramcontainer) | `variable` | Declared here |
| [`syncingCurve`](#syncingcurve) | `variable` | Declared here |
| [`SyncCurveField`](#synccurvefield) | `function` | Declared here |
| [`ApplyCurve`](#applycurve) | `function` | Declared here |
| [`UpdateHistogram`](#updatehistogram) | `function` | Declared here |
...
|--------|------|-------------|
| `CurveNode` | [`curveNode`](#curvenode-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Filters/CurveNodeView.cs:17

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-100) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-55) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Filters/CurveNodeView.cs:55
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Filters/CurveNodeView.cs:76
...
| Return | Name | Description |
|--------|------|-------------|
| `CurveField` | [`curveField`](#curvefield-2)  |  |
| `HistogramData` | [`histogramData`](#histogramdata-2)  |  |
| `VisualElement` | [`histogramContainer`](#histogramcontainer)  |  |
| `bool` | [`syncingCurve`](#syncingcurve)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Filters/CurveNodeView.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Filters/CurveNodeView.cs:19
...
```cpp
VisualElement histogramContainer
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Filters/CurveNodeView.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Filters/CurveNodeView.cs:21

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`SyncCurveField`](#synccurvefield) `inline` |  |
| `void` | [`ApplyCurve`](#applycurve) `inline` |  |
| `void` | [`UpdateHistogram`](#updatehistogram) `inline` |  |
...
```cpp
inline void SyncCurveField()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Filters/CurveNodeView.cs:91
...
```cpp
inline void ApplyCurve(AnimationCurve curve)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Filters/CurveNodeView.cs:101
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Filters/CurveNodeView.cs:111
