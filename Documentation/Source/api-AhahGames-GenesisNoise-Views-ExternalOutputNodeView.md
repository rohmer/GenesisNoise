{#externaloutputnodeview}

# ExternalOutputNodeView

```cpp
class ExternalOutputNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ExternalOutputNodeView.cs:17

> **Inherits:** [`AhahGames.GenesisNoise.Views.OutputNodeView`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#outputnodeview)

## List of all members

| Name | Kind | Owner |
|------|------|-------|
| [`showPreviewTextureEnum`](#showpreviewtextureenum) | `property` | Declared here |
| [`Enable`](#enable-105) | `function` | Declared here |
| [`BuildOutputNodeSettings`](#buildoutputnodesettings) | `function` | Declared here |
| [`OnRemoved`](#onremoved-3) | `function` | Declared here |
| [`buttons`](#buttons) | `variable` | Declared here |
| [`UpdateButtons`](#updatebuttons) | `function` | Declared here |
| [`SaveExternal`](#saveexternal) | `function` | Declared here |
| [`UpdateExternal`](#updateexternal) | `function` | Declared here |
| [`showPreviewTextureEnum`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#showpreviewtextureenum-1) | `property` | Inherited from [`OutputNodeView`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#outputnodeview) |
| [`Enable`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#enable-137) | `function` | Inherited from [`OutputNodeView`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#outputnodeview) |
| [`RefreshPorts`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#refreshports-1) | `function` | Inherited from [`OutputNodeView`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#outputnodeview) |
| [`BuildOutputNodeSettings`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#buildoutputnodesettings-1) | `function` | Inherited from [`OutputNodeView`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#outputnodeview) |
| [`BuildContextualMenu`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#buildcontextualmenu-9) | `function` | Inherited from [`OutputNodeView`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#outputnodeview) |
| [`outputNode`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#outputnode-3) | `variable` | Inherited from [`OutputNodeView`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#outputnodeview) |
| [`graph`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#graph-17) | `variable` | Inherited from [`OutputNodeView`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#outputnodeview) |
| [`inputPortElements`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#inputportelements) | `variable` | Inherited from [`OutputNodeView`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#outputnodeview) |
| [`DrawPreviewToolbar`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#drawpreviewtoolbar-1) | `function` | Inherited from [`OutputNodeView`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#outputnodeview) |
| [`CreateSettingsView`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#createsettingsview-2) | `function` | Inherited from [`OutputNodeView`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#outputnodeview) |
| [`RefreshOutputPortSettings`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#refreshoutputportsettings) | `function` | Inherited from [`OutputNodeView`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#outputnodeview) |
| [`UpdatePortView`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#updateportview-1) | `function` | Inherited from [`OutputNodeView`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#outputnodeview) |
| [`SaveAllTextures`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#savealltextures) | `function` | Inherited from [`OutputNodeView`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#outputnodeview) |
| [`InitializeDebug`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#initializedebug-3) | `function` | Inherited from [`OutputNodeView`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#outputnodeview) |
| [`UpdatePreviewImage`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#updatepreviewimage) | `function` | Inherited from [`OutputNodeView`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#outputnodeview) |
...
## Inherited from [`OutputNodeView`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#outputnodeview)

| Kind | Name | Description |
|------|------|-------------|
| `property` | [`showPreviewTextureEnum`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#showpreviewtextureenum-1)  |  |
| `function` | [`Enable`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#enable-137) `virtual` `inline` |  |
| `function` | [`RefreshPorts`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#refreshports-1) `virtual` `inline` |  |
| `function` | [`BuildOutputNodeSettings`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#buildoutputnodesettings-1) `virtual` `inline` |  |
| `function` | [`BuildContextualMenu`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#buildcontextualmenu-9) `inline` |  |
| `variable` | [`outputNode`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#outputnode-3)  |  |
| `variable` | [`graph`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#graph-17)  |  |
| `variable` | [`inputPortElements`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#inputportelements)  |  |
| `function` | [`DrawPreviewToolbar`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#drawpreviewtoolbar-1) `virtual` `inline` |  |
| `function` | [`CreateSettingsView`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#createsettingsview-2) `virtual` `inline` |  |
| `function` | [`RefreshOutputPortSettings`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#refreshoutputportsettings) `inline` |  |
| `function` | [`UpdatePortView`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#updateportview-1) `inline` |  |
| `function` | [`SaveAllTextures`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#savealltextures) `inline` |  |
| `function` | [`InitializeDebug`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#initializedebug-3) `inline` |  |
| `function` | [`UpdatePreviewImage`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#updatepreviewimage) `inline` |  |
...
|--------|------|-------------|
| `override bool` | [`showPreviewTextureEnum`](#showpreviewtextureenum)  |  |

---

{#showpreviewtextureenum}

### showPreviewTextureEnum

```cpp
override bool showPreviewTextureEnum
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ExternalOutputNodeView.cs:21

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-105) `virtual` `inline` |  |
| `override void` | [`BuildOutputNodeSettings`](#buildoutputnodesettings) `virtual` `inline` |  |
| `override void` | [`OnRemoved`](#onremoved-3) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ExternalOutputNodeView.cs:23
...
```cpp
virtual inline override void BuildOutputNodeSettings()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ExternalOutputNodeView.cs:36

#### Reimplements

- [`BuildOutputNodeSettings`](api-AhahGames-GenesisNoise-Views-OutputNodeView.md#buildoutputnodesettings-1)
...
```cpp
virtual inline override void OnRemoved()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ExternalOutputNodeView.cs:194

#### Reimplements

- [`OnRemoved`](api-GraphProcessor-BaseNodeView.md#onremoved-1)

## Private Attributes

| Return | Name | Description |
|--------|------|-------------|
| `List<(Button save, Button update)>` | [`buttons`](#buttons)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ExternalOutputNodeView.cs:19

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`UpdateButtons`](#updatebuttons) `inline` |  |
| `void` | [`SaveExternal`](#saveexternal) `inline` |  |
| `void` | [`UpdateExternal`](#updateexternal) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ExternalOutputNodeView.cs:158
...
```cpp
inline void SaveExternal()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ExternalOutputNodeView.cs:182
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/ExternalOutputNodeView.cs:188
