{#heightmapfrequenciesmappernode}

# HeightMapFrequenciesMapperNode

```cpp
class HeightMapFrequenciesMapperNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Adjustments/HeightMapFrequenciesMapperNode.cs:19
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-257) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-233) | `property` | Declared here |
| [`ShaderName`](#shadername-194) | `property` | Declared here |
| [`DisplayMaterialInspector`](#displaymaterialinspector-73) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-96) | `property` | Declared here |
| [`filteredOutProperties`](#filteredoutproperties-78) | `property` | Declared here |
| [`defaultSettings`](#defaultsettings-12) | `property` | Declared here |
| [`supportedDimensions`](#supporteddimensions-13) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-257)  |  |
| `override string` | [`NodeGroup`](#nodegroup-233)  |  |
| `override string` | [`ShaderName`](#shadername-194)  |  |
| `override bool` | [`DisplayMaterialInspector`](#displaymaterialinspector-73)  |  |
| `override float` | [`nodeWidth`](#nodewidth-96)  |  |
| `override IEnumerable< string >` | [`filteredOutProperties`](#filteredoutproperties-78)  |  |
| `override GenesisNoiseSettings` | [`defaultSettings`](#defaultsettings-12)  |  |
| `override List< OutputDimension >` | [`supportedDimensions`](#supporteddimensions-13)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Adjustments/HeightMapFrequenciesMapperNode.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Adjustments/HeightMapFrequenciesMapperNode.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Adjustments/HeightMapFrequenciesMapperNode.cs:23

---

{#displaymaterialinspector-73}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Adjustments/HeightMapFrequenciesMapperNode.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Adjustments/HeightMapFrequenciesMapperNode.cs:25

---

{#filteredoutproperties-78}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Adjustments/HeightMapFrequenciesMapperNode.cs:27
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Adjustments/HeightMapFrequenciesMapperNode.cs:29

---

{#supporteddimensions-13}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/Adjustments/HeightMapFrequenciesMapperNode.cs:31
