...
```cpp
class SwitchNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/SwitchNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-60) | `property` | Declared here |
| [`Enable`](#enable-158) | `function` | Declared here |
| [`Disable`](#disable-76) | `function` | Declared here |
| [`caseCountField`](#casecountfield-1) | `variable` | Declared here |
| [`OnCaseCountChanged`](#oncasecountchanged-1) | `function` | Declared here |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/SwitchNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-158) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-76) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/SwitchNodeView.cs:16
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/SwitchNodeView.cs:30
...
| Return | Name | Description |
|--------|------|-------------|
| `IntegerField` | [`caseCountField`](#casecountfield-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/SwitchNodeView.cs:14

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`OnCaseCountChanged`](#oncasecountchanged-1) `inline` |  |

---

{#oncasecountchanged-1}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/SwitchNodeView.cs:38
