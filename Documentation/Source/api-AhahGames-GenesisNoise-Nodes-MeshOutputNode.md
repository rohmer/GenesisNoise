...
```cpp
class MeshOutputNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:19
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-331) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-304) | `property` | Declared here |
| [`hasSettings`](#hassettings-15) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-42) | `property` | Declared here |
| [`isRenamable`](#isrenamable-3) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-123) | `property` | Declared here |
| [`previewTexture`](#previewtexture-26) | `property` | Declared here |
| [`ResolvedOutputName`](#resolvedoutputname) | `property` | Declared here |
| [`input`](#input-19) | `variable` | Declared here |
| [`output`](#output-51) | `variable` | Declared here |
| [`outputMesh`](#outputmesh) | `variable` | Declared here |
| [`CreateBlueprintInstance`](#createblueprintinstance) | `function` | Declared here |
| [`Enable`](#enable-52) | `function` | Declared here |
| [`Disable`](#disable-29) | `function` | Declared here |
| [`ProcessNode`](#processnode-75) | `function` | Declared here |
| [`outputName`](#outputname-1) | `variable` | Declared here |
| [`preview`](#preview-7) | `variable` | Declared here |
| [`OnInputEdgesChanged`](#oninputedgeschanged) | `function` | Declared here |
| [`ValidateInputMessages`](#validateinputmessages) | `function` | Declared here |
| [`EnsureOutputMesh`](#ensureoutputmesh) | `function` | Declared here |
| [`EnsureOutputObject`](#ensureoutputobject) | `function` | Declared here |
| [`CopyRendererMaterials`](#copyrenderermaterials) | `function` | Declared here |
| [`CopyMesh`](#copymesh) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-331)  |  |
| `override string` | [`NodeGroup`](#nodegroup-304)  |  |
| `override bool` | [`hasSettings`](#hassettings-15)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-42)  |  |
| `override bool` | [`isRenamable`](#isrenamable-3)  |  |
| `override float` | [`nodeWidth`](#nodewidth-123)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-26)  |  |
| `string` | [`ResolvedOutputName`](#resolvedoutputname)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:36
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:37
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:38

---

{#showdefaultinspector-42}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:39
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:40
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:41
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:42
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:44

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `GameObject` | [`input`](#input-19)  |  |
| `GameObject` | [`output`](#output-51)  |  |
| `Mesh` | [`outputMesh`](#outputmesh)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:25
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:31

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `GameObject` | [`CreateBlueprintInstance`](#createblueprintinstance) `inline` |  |
...
```cpp
inline GameObject CreateBlueprintInstance()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:117

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-52) `virtual` `inline` | Called when the node is enabled. |
| `override void` | [`Disable`](#disable-29) `virtual` `inline` | Called when the node is disabled. |
| `override bool` | [`ProcessNode`](#processnode-75) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:45
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:53
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:90
...
| Return | Name | Description |
|--------|------|-------------|
| `string` | [`outputName`](#outputname-1)  |  |
| `Texture2D` | [`preview`](#preview-7)  |  |
...
```cpp
string outputName = "Mesh"
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:28
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:34

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`OnInputEdgesChanged`](#oninputedgeschanged) `inline` |  |
| `bool` | [`ValidateInputMessages`](#validateinputmessages) `inline` |  |
| `void` | [`EnsureOutputMesh`](#ensureoutputmesh) `inline` |  |
| `void` | [`EnsureOutputObject`](#ensureoutputobject) `inline` |  |
...
```cpp
inline void OnInputEdgesChanged(SerializableEdge edge)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:64
...
```cpp
inline bool ValidateInputMessages()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:70
...
```cpp
inline void EnsureOutputMesh()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:140
...
```cpp
inline void EnsureOutputObject(GameObject source)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:161

## Private Static Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`CopyRendererMaterials`](#copyrenderermaterials) `static` `inline` |  |
| `void` | [`CopyMesh`](#copymesh) `static` `inline` |  |

---

{#copyrenderermaterials}
...
```cpp
static inline void CopyRendererMaterials(GameObject source, GameObject target)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:178
...
```cpp
static inline void CopyMesh(Mesh source, Mesh target)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshOutputNode.cs:189
