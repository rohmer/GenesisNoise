...
```cpp
class ExpTextureNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/ExpTexture.cs:15
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-179) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-158) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-23) | `property` | Declared here |
| [`hasPreview`](#haspreview-27) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-65) | `property` | Declared here |
| [`inputA`](#inputa-15) | `variable` | Declared here |
| [`output`](#output-33) | `variable` | Declared here |
| [`Enable`](#enable-28) | `function` | Declared here |
| [`ProcessNode`](#processnode-43) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-179)  |  |
| `override string` | [`NodeGroup`](#nodegroup-158)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-23)  |  |
| `override bool` | [`hasPreview`](#haspreview-27)  |  |
| `override float` | [`nodeWidth`](#nodewidth-65)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/ExpTexture.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/ExpTexture.cs:23

---

{#showdefaultinspector-23}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/ExpTexture.cs:25
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/ExpTexture.cs:26
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/ExpTexture.cs:27

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `RenderTexture` | [`inputA`](#inputa-15)  |  |
| `RenderTexture` | [`output`](#output-33)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/ExpTexture.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/ExpTexture.cs:21

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-28) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-43) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/ExpTexture.cs:28
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/ExpTexture.cs:34
