...
```cpp
class OutputNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/OutputNodeView.cs:19
...
> **Subclassed by:** [`AhahGames.GenesisNoise.Views.ExternalOutputNodeView`](api-AhahGames-GenesisNoise-Views-ExternalOutputNodeView.md#externaloutputnodeview)

## List of all members

| Name | Kind | Owner |
|------|------|-------|
| [`showPreviewTextureEnum`](#showpreviewtextureenum-1) | `property` | Declared here |
| [`Enable`](#enable-137) | `function` | Declared here |
| [`RefreshPorts`](#refreshports-1) | `function` | Declared here |
| [`BuildOutputNodeSettings`](#buildoutputnodesettings-1) | `function` | Declared here |
| [`BuildContextualMenu`](#buildcontextualmenu-9) | `function` | Declared here |
| [`outputNode`](#outputnode-3) | `variable` | Declared here |
| [`graph`](#graph-17) | `variable` | Declared here |
| [`inputPortElements`](#inputportelements) | `variable` | Declared here |
| [`DrawPreviewToolbar`](#drawpreviewtoolbar-1) | `function` | Declared here |
| [`CreateSettingsView`](#createsettingsview-2) | `function` | Declared here |
| [`RefreshOutputPortSettings`](#refreshoutputportsettings) | `function` | Declared here |
| [`UpdatePortView`](#updateportview-1) | `function` | Declared here |
| [`SaveAllTextures`](#savealltextures) | `function` | Declared here |
| [`InitializeDebug`](#initializedebug-3) | `function` | Declared here |
| [`UpdatePreviewImage`](#updatepreviewimage) | `function` | Declared here |
...
|--------|------|-------------|
| `bool` | [`showPreviewTextureEnum`](#showpreviewtextureenum-1)  |  |

---

{#showpreviewtextureenum-1}

### showPreviewTextureEnum

```cpp
bool showPreviewTextureEnum
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/OutputNodeView.cs:26

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-137) `virtual` `inline` |  |
| `override bool` | [`RefreshPorts`](#refreshports-1) `virtual` `inline` |  |
| `void` | [`BuildOutputNodeSettings`](#buildoutputnodesettings-1) `virtual` `inline` |  |
| `override void` | [`BuildContextualMenu`](#buildcontextualmenu-9) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/OutputNodeView.cs:28
...
```cpp
virtual inline override bool RefreshPorts()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/OutputNodeView.cs:109

#### Reimplements

- [`RefreshPorts`](api-GraphProcessor-BaseNodeView.md#refreshports)

---

{#buildoutputnodesettings-1}
...
```cpp
virtual inline void BuildOutputNodeSettings()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/OutputNodeView.cs:172

#### Reimplemented by

- [`BuildOutputNodeSettings`](api-AhahGames-GenesisNoise-Views-ExternalOutputNodeView.md#buildoutputnodesettings)

---

{#buildcontextualmenu-9}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/OutputNodeView.cs:203

## Protected Attributes

| Return | Name | Description |
|--------|------|-------------|
| `OutputNode` | [`outputNode`](#outputnode-3)  |  |
| `GenesisGraph` | [`graph`](#graph-17)  |  |
| `Dictionary< string, OutputTextureView >` | [`inputPortElements`](#inputportelements)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/OutputNodeView.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/OutputNodeView.cs:22
...
```cpp
Dictionary< string, OutputTextureView > inputPortElements = new()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/OutputNodeView.cs:24

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`DrawPreviewToolbar`](#drawpreviewtoolbar-1) `virtual` `inline` |  |
| `override VisualElement` | [`CreateSettingsView`](#createsettingsview-2) `virtual` `inline` |  |

---

{#drawpreviewtoolbar-1}
...
```cpp
virtual inline override void DrawPreviewToolbar(Texture texture)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/OutputNodeView.cs:116

#### Reimplements

- [`DrawPreviewToolbar`](api-AhahGames-GenesisNoise-Views-GenesisNodeView.md#drawpreviewtoolbar)

---

{#createsettingsview-2}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/OutputNodeView.cs:131
...
| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RefreshOutputPortSettings`](#refreshoutputportsettings) `inline` |  |
| `void` | [`UpdatePortView`](#updateportview-1) `inline` |  |
| `void` | [`SaveAllTextures`](#savealltextures) `inline` |  |
| `void` | [`InitializeDebug`](#initializedebug-3) `inline` |  |
| `void` | [`UpdatePreviewImage`](#updatepreviewimage) `inline` |  |
...
```cpp
inline void RefreshOutputPortSettings()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/OutputNodeView.cs:75
...
```cpp
inline void UpdatePortView()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/OutputNodeView.cs:81
...
```cpp
inline void SaveAllTextures()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/OutputNodeView.cs:197
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/OutputNodeView.cs:208
...
```cpp
inline void UpdatePreviewImage()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/OutputNodeView.cs:230
