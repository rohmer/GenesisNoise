...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/AmbientOcclusionNode.cs:18
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-22) | `property` | Declared here |
| [`ShaderName`](#shadername-6) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-10) | `property` | Declared here |
| [`DisplayMaterialInspector`](#displaymaterialinspector-4) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-3) | `property` | Declared here |
| [`filteredOutProperties`](#filteredoutproperties-4) | `property` | Declared here |
| [`defaultSettings`](#defaultsettings) | `property` | Declared here |
| [`supportedDimensions`](#supporteddimensions-1) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-22)  |  |
| `override string` | [`ShaderName`](#shadername-6)  |  |
| `override string` | [`NodeGroup`](#nodegroup-10)  |  |
| `override bool` | [`DisplayMaterialInspector`](#displaymaterialinspector-4)  |  |
| `override float` | [`nodeWidth`](#nodewidth-3)  |  |
| `override IEnumerable< string >` | [`filteredOutProperties`](#filteredoutproperties-4)  |  |
| `override GenesisNoiseSettings` | [`defaultSettings`](#defaultsettings)  |  |
| `override List< OutputDimension >` | [`supportedDimensions`](#supporteddimensions-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/AmbientOcclusionNode.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/AmbientOcclusionNode.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/AmbientOcclusionNode.cs:22

---

{#displaymaterialinspector-4}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/AmbientOcclusionNode.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/AmbientOcclusionNode.cs:24

---

{#filteredoutproperties-4}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/AmbientOcclusionNode.cs:26
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/AmbientOcclusionNode.cs:28
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/AmbientOcclusionNode.cs:30
