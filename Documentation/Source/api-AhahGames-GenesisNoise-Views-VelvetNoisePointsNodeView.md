{#velvetnoisepointsnodeview}

# VelvetNoisePointsNodeView

```cpp
class VelvetNoisePointsNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/VelvetNoisePointsNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-91) | `property` | Declared here |
| [`Enable`](#enable-191) | `function` | Declared here |
| [`Disable`](#disable-78) | `function` | Declared here |
| [`countField`](#countfield-10) | `variable` | Declared here |
| [`coordinatesField`](#coordinatesfield-9) | `variable` | Declared here |
| [`RefreshOutputs`](#refreshoutputs-19) | `function` | Declared here |
...
|--------|------|-------------|
| `VelvetNoisePointsNode` | [`node`](#node-91)  |  |
...
```cpp
VelvetNoisePointsNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/VelvetNoisePointsNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-191) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-78) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/VelvetNoisePointsNodeView.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/VelvetNoisePointsNodeView.cs:38
...
| Return | Name | Description |
|--------|------|-------------|
| `IntegerField` | [`countField`](#countfield-10)  |  |
| `TextField` | [`coordinatesField`](#coordinatesfield-9)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/VelvetNoisePointsNodeView.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/VelvetNoisePointsNodeView.cs:15

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RefreshOutputs`](#refreshoutputs-19) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/VelvetNoisePointsNodeView.cs:44
