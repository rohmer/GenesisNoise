{#lloydrelaxedpointsnodeview}

# LloydRelaxedPointsNodeView

```cpp
class LloydRelaxedPointsNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/LloydRelaxedPointsNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-29) | `property` | Declared here |
| [`Enable`](#enable-124) | `function` | Declared here |
| [`Disable`](#disable-60) | `function` | Declared here |
| [`countField`](#countfield-4) | `variable` | Declared here |
| [`coordinatesField`](#coordinatesfield-3) | `variable` | Declared here |
| [`RefreshOutputs`](#refreshoutputs-3) | `function` | Declared here |
...
|--------|------|-------------|
| `LloydRelaxedPointsNode` | [`node`](#node-29)  |  |
...
```cpp
LloydRelaxedPointsNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/LloydRelaxedPointsNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-124) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-60) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/LloydRelaxedPointsNodeView.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/LloydRelaxedPointsNodeView.cs:38
...
| Return | Name | Description |
|--------|------|-------------|
| `IntegerField` | [`countField`](#countfield-4)  |  |
| `TextField` | [`coordinatesField`](#coordinatesfield-3)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/LloydRelaxedPointsNodeView.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/LloydRelaxedPointsNodeView.cs:15

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RefreshOutputs`](#refreshoutputs-3) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/LloydRelaxedPointsNodeView.cs:44
