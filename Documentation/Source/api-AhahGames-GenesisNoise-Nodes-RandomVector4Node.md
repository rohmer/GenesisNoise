...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector4Node.cs:12

> **Inherits:** [`AhahGames.GenesisNoise.Nodes.ConstantNode`](api-AhahGames-GenesisNoise-Nodes-ConstantNode.md#constantnode)

## List of all members

| Name | Kind | Owner |
|------|------|-------|
| [`nodeWidth`](#nodewidth-153) | `property` | Declared here |
| [`name`](#name-419) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-388) | `property` | Declared here |
| [`output`](#output-76) | `variable` | Declared here |
| [`XMin`](#xmin-2) | `variable` | Declared here |
| [`XMax`](#xmax-2) | `variable` | Declared here |
| [`YMin`](#ymin-2) | `variable` | Declared here |
| [`YMax`](#ymax-2) | `variable` | Declared here |
| [`ZMin`](#zmin-1) | `variable` | Declared here |
| [`ZMax`](#zmax-1) | `variable` | Declared here |
| [`WMin`](#wmin) | `variable` | Declared here |
| [`WMax`](#wmax) | `variable` | Declared here |
| [`Process`](#process-16) | `function` | Declared here |
| [`ProcessNode`](#processnode-106) | `function` | Declared here |
| [`NodeGroup`](api-AhahGames-GenesisNoise-Nodes-ConstantNode.md#nodegroup-93) | `property` | Inherited from [`ConstantNode`](api-AhahGames-GenesisNoise-Nodes-ConstantNode.md#constantnode) |
| [`processingTime`](api-AhahGames-GenesisNoise-Nodes-ConstantNode.md#processingtime) | `property` | Inherited from [`ConstantNode`](api-AhahGames-GenesisNoise-Nodes-ConstantNode.md#constantnode) |
| [`nodeWidth`](api-AhahGames-GenesisNoise-Nodes-ConstantNode.md#nodewidth-48) | `property` | Inherited from [`ConstantNode`](api-AhahGames-GenesisNoise-Nodes-ConstantNode.md#constantnode) |
| [`hasSettings`](api-AhahGames-GenesisNoise-Nodes-ConstantNode.md#hassettings-4) | `property` | Inherited from [`ConstantNode`](api-AhahGames-GenesisNoise-Nodes-ConstantNode.md#constantnode) |
| [`canUseUpstreamCaching`](api-AhahGames-GenesisNoise-Nodes-ConstantNode.md#canuseupstreamcaching-1) | `property` | Inherited from [`ConstantNode`](api-AhahGames-GenesisNoise-Nodes-ConstantNode.md#constantnode) |
| [`ProcessNode`](api-AhahGames-GenesisNoise-Nodes-ConstantNode.md#processnode-29) | `function` | Inherited from [`ConstantNode`](api-AhahGames-GenesisNoise-Nodes-ConstantNode.md#constantnode) |
...
## Inherited from [`ConstantNode`](api-AhahGames-GenesisNoise-Nodes-ConstantNode.md#constantnode)

| Kind | Name | Description |
|------|------|-------------|
| `property` | [`NodeGroup`](api-AhahGames-GenesisNoise-Nodes-ConstantNode.md#nodegroup-93)  |  |
| `property` | [`processingTime`](api-AhahGames-GenesisNoise-Nodes-ConstantNode.md#processingtime)  | Gets the width of the node. |
| `property` | [`nodeWidth`](api-AhahGames-GenesisNoise-Nodes-ConstantNode.md#nodewidth-48)  |  |
| `property` | [`hasSettings`](api-AhahGames-GenesisNoise-Nodes-ConstantNode.md#hassettings-4)  |  |
| `property` | [`canUseUpstreamCaching`](api-AhahGames-GenesisNoise-Nodes-ConstantNode.md#canuseupstreamcaching-1)  |  |
| `function` | [`ProcessNode`](api-AhahGames-GenesisNoise-Nodes-ConstantNode.md#processnode-29) `virtual` `inline` |  |
...
|--------|------|-------------|
| `override float` | [`nodeWidth`](#nodewidth-153)  |  |
| `override string` | [`name`](#name-419)  |  |
| `override string` | [`NodeGroup`](#nodegroup-388)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector4Node.cs:34
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector4Node.cs:35
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector4Node.cs:36

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `Vector4` | [`output`](#output-76)  |  |
| `float` | [`XMin`](#xmin-2)  |  |
| `float` | [`XMax`](#xmax-2)  |  |
| `float` | [`YMin`](#ymin-2)  |  |
| `float` | [`YMax`](#ymax-2)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector4Node.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector4Node.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector4Node.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector4Node.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector4Node.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector4Node.cs:26
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector4Node.cs:28
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector4Node.cs:30
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector4Node.cs:32

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Process`](#process-16) `virtual` `inline` | Override this method to implement custom processing. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector4Node.cs:38
...
| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-106) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomVector4Node.cs:47
