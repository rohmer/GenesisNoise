...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/DebugNode.cs:16
...
| Name | Kind | Owner |
|------|------|-------|
| [`NodeGroup`](#nodegroup-115) | `property` | Declared here |
| [`name`](#name-134) | `property` | Declared here |
| [`hasPreview`](#haspreview-23) | `property` | Declared here |
| [`previewTexture`](#previewtexture-6) | `property` | Declared here |
| [`processingTime`](#processingtime-1) | `property` | Declared here |
| [`Output`](#output-28) | `variable` | Declared here |
| [`value`](#value-32) | `variable` | Declared here |
| [`Update`](#update-3) | `function` | Declared here |
| [`ProcessNode`](#processnode-36) | `function` | Declared here |
| [`Input`](#input-9) | `variable` | Declared here |
| [`OutputPortBehavior`](#outputportbehavior-1) | `function` | Declared here |
| [`IsTextureInputConnected`](#istextureinputconnected) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`NodeGroup`](#nodegroup-115)  |  |
| `override string` | [`name`](#name-134)  |  |
| `override bool` | [`hasPreview`](#haspreview-23)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-6)  |  |
| `override float` | [`processingTime`](#processingtime-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/DebugNode.cs:27
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/DebugNode.cs:28
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/DebugNode.cs:73
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/DebugNode.cs:75
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/DebugNode.cs:91

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `object` | [`Output`](#output-28)  |  |
| `string` | [`value`](#value-32)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/DebugNode.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/DebugNode.cs:25

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`Update`](#update-3) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/DebugNode.cs:93

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-36) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/DebugNode.cs:58
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/DebugNode.cs:18

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `IEnumerable< PortData >` | [`OutputPortBehavior`](#outputportbehavior-1) `inline` |  |
| `bool` | [`IsTextureInputConnected`](#istextureinputconnected) `inline` |  |

---

{#outputportbehavior-1}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/DebugNode.cs:34

---

{#istextureinputconnected}
...
```cpp
inline bool IsTextureInputConnected()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/DebugNode.cs:77
