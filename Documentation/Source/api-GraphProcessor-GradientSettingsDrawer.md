{#gradientsettingsdrawer}

# GradientSettingsDrawer

```cpp
class GradientSettingsDrawer
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Utils/ExposedParameterDrawer.cs:529
...
| Name | Kind | Owner |
|------|------|-------|
| [`CreatePropertyGUI`](#createpropertygui-9) | `function` | Declared here |
...
|--------|------|-------------|
| `override VisualElement` | [`CreatePropertyGUI`](#createpropertygui-9) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Utils/ExposedParameterDrawer.cs:531
