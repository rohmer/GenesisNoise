{#hdrplitmaterialnodeview}

# HDRPLitMaterialNodeView

```cpp
class HDRPLitMaterialNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/HDRP/HDRPLitMaterialNodeView.cs:18
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-23) | `property` | Declared here |
| [`Enable`](#enable-116) | `function` | Declared here |
| [`workflow`](#workflow) | `variable` | Declared here |
| [`surfaceType`](#surfacetype-1) | `variable` | Declared here |
| [`shadows`](#shadows) | `variable` | Declared here |
| [`clipping`](#clipping) | `variable` | Declared here |
| [`eColor`](#ecolor) | `variable` | Declared here |
...
```cpp
HDRPLitMaterial node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/HDRP/HDRPLitMaterialNodeView.cs:20

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-116) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/HDRP/HDRPLitMaterialNodeView.cs:26
...
| Return | Name | Description |
|--------|------|-------------|
| `EnumField` | [`workflow`](#workflow)  |  |
| `EnumField` | [`surfaceType`](#surfacetype-1)  |  |
| `Toggle` | [`shadows`](#shadows)  |  |
| `Toggle` | [`clipping`](#clipping)  |  |
| `ColorField` | [`eColor`](#ecolor)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/HDRP/HDRPLitMaterialNodeView.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/HDRP/HDRPLitMaterialNodeView.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/HDRP/HDRPLitMaterialNodeView.cs:24
