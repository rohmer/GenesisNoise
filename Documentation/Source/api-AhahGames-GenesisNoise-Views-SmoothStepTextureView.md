{#smoothsteptextureview}

# SmoothStepTextureView

```cpp
class SmoothStepTextureView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Textures/TextureSmoothStepView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-57) | `property` | Declared here |
| [`Enable`](#enable-155) | `function` | Declared here |
| [`min`](#min-65) | `variable` | Declared here |
| [`max`](#max-65) | `variable` | Declared here |
| [`UpdateLabel`](#updatelabel-12) | `function` | Declared here |
...
|--------|------|-------------|
| `SmoothStepTexture` | [`node`](#node-57)  |  |
...
```cpp
SmoothStepTexture node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Textures/TextureSmoothStepView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-155) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Textures/TextureSmoothStepView.cs:15
...
| Return | Name | Description |
|--------|------|-------------|
| `FloatField` | [`min`](#min-65)  |  |
| `FloatField` | [`max`](#max-65)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Textures/TextureSmoothStepView.cs:13
...
| Return | Name | Description |
|--------|------|-------------|
| `void` | [`UpdateLabel`](#updatelabel-12) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Textures/TextureSmoothStepView.cs:44
