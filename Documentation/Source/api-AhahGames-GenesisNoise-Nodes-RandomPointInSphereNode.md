...
```cpp
class RandomPointInSphereNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInSphereNode.cs:14
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-415) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-384) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-149) | `property` | Declared here |
| [`output`](#output-72) | `variable` | Declared here |
| [`pt1`](#pt1-3) | `variable` | Declared here |
| [`radius`](#radius-1) | `variable` | Declared here |
| [`Process`](#process-13) | `function` | Declared here |
| [`ProcessNode`](#processnode-102) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-415)  |  |
| `override string` | [`NodeGroup`](#nodegroup-384)  |  |
| `override float` | [`nodeWidth`](#nodewidth-149)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInSphereNode.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInSphereNode.cs:25
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInSphereNode.cs:26

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `Vector3` | [`output`](#output-72)  |  |
| `Vector3` | [`pt1`](#pt1-3)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInSphereNode.cs:17
...
```cpp
Vector3 pt1 = new(0, 0, 0)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInSphereNode.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInSphereNode.cs:22

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Process`](#process-13) `virtual` `inline` | Override this method to implement custom processing. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInSphereNode.cs:28
...
| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-102) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInSphereNode.cs:33
