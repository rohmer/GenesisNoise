...
```cpp
class EnumSwitchNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:17
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-175) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-154) | `property` | Declared here |
| [`hasPreview`](#haspreview-26) | `property` | Declared here |
| [`hasSettings`](#hassettings-6) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-22) | `property` | Declared here |
| [`CaseCount`](#casecount) | `property` | Declared here |
| [`selection`](#selection) | `variable` | Declared here |
| [`defaultInput`](#defaultinput) | `variable` | Declared here |
| [`caseInputs`](#caseinputs) | `variable` | Declared here |
| [`output`](#output-31) | `variable` | Declared here |
| [`OnNodeCreated`](#onnodecreated-1) | `function` | Declared here |
| [`SetCaseCount`](#setcasecount) | `function` | Declared here |
| [`GetCaseLabel`](#getcaselabel) | `function` | Declared here |
| [`SetCaseLabel`](#setcaselabel) | `function` | Declared here |
| [`DefaultInputPortType`](#defaultinputporttype) | `function` | Declared here |
| [`CaseInputPortType`](#caseinputporttype) | `function` | Declared here |
| [`OutputPortType`](#outputporttype-4) | `function` | Declared here |
| [`PullCaseInputs`](#pullcaseinputs) | `function` | Declared here |
| [`SyncCasesFromConnectedEnumParameter`](#synccasesfromconnectedenumparameter) | `function` | Declared here |
| [`Enable`](#enable-27) | `function` | Declared here |
| [`Disable`](#disable-14) | `function` | Declared here |
| [`ProcessNode`](#processnode-41) | `function` | Declared here |
| [`caseCount`](#casecount-1) | `variable` | Declared here |
| [`caseLabels`](#caselabels) | `variable` | Declared here |
| [`inputType`](#inputtype-6) | `variable` | Declared here |
| [`OnEdgesChanged`](#onedgeschanged) | `function` | Declared here |
| [`ResolveCaseIndex`](#resolvecaseindex) | `function` | Declared here |
| [`TryGetConnectedEnumParameter`](#trygetconnectedenumparameter) | `function` | Declared here |
| [`GetDisplayLabel`](#getdisplaylabel) | `function` | Declared here |
| [`CreateValuePortData`](#createvalueportdata) | `function` | Declared here |
| [`ResolveValueInputType`](#resolvevalueinputtype) | `function` | Declared here |
| [`defaultCaseCount`](#defaultcasecount) | `variable` | Declared here |
| [`minimumCaseCount`](#minimumcasecount) | `variable` | Declared here |
| [`TryGetConnectedPortType`](#trygetconnectedporttype) | `function` | Declared here |
| [`GetCaseIdentifier`](#getcaseidentifier) | `function` | Declared here |
| [`TryGetCaseIndex`](#trygetcaseindex) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-175)  |  |
| `override string` | [`NodeGroup`](#nodegroup-154)  |  |
| `override bool` | [`hasPreview`](#haspreview-26)  |  |
| `override bool` | [`hasSettings`](#hassettings-6)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-22)  |  |
| `int` | [`CaseCount`](#casecount)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:43
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:44
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:45
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:46

---

{#showdefaultinspector-22}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:47
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:49
...
| `object` | [`defaultInput`](#defaultinput)  |  |
| `List< object >` | [`caseInputs`](#caseinputs)  |  |
| `object` | [`output`](#output-31)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:26
...
```cpp
List< object > caseInputs = new() { null, null, null }
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:29
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:32

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`OnNodeCreated`](#onnodecreated-1) `virtual` `inline` | Called only when the node is created, not when instantiated. |
| `void` | [`SetCaseCount`](#setcasecount) `inline` |  |
| `string` | [`GetCaseLabel`](#getcaselabel) `inline` |  |
| `void` | [`SetCaseLabel`](#setcaselabel) `inline` |  |
| `IEnumerable< PortData >` | [`DefaultInputPortType`](#defaultinputporttype) `inline` |  |
| `IEnumerable< PortData >` | [`CaseInputPortType`](#caseinputporttype) `inline` |  |
| `IEnumerable< PortData >` | [`OutputPortType`](#outputporttype-4) `inline` |  |
| `void` | [`PullCaseInputs`](#pullcaseinputs) `inline` |  |
| `bool` | [`SyncCasesFromConnectedEnumParameter`](#synccasesfromconnectedenumparameter) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:51
...
```cpp
inline void SetCaseCount(int value)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:82
...
```cpp
inline string GetCaseLabel(int index)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:88
...
```cpp
inline void SetCaseLabel(int index, string label)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:94

---

{#defaultinputporttype}
...
```cpp
inline IEnumerable< PortData > DefaultInputPortType(List< SerializableEdge > edges)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:104
...
```cpp
inline IEnumerable< PortData > CaseInputPortType(List< SerializableEdge > edges)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:110
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:128
...
```cpp
inline void PullCaseInputs(List< SerializableEdge > edges, NodePort inputPort)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:140

---

{#synccasesfromconnectedenumparameter}
...
```cpp
inline bool SyncCasesFromConnectedEnumParameter()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:203

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-27) `virtual` `inline` | Called when the node is enabled. |
| `override void` | [`Disable`](#disable-14) `virtual` `inline` | Called when the node is disabled. |
| `override bool` | [`ProcessNode`](#processnode-41) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:57
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:66
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:153
...
| Return | Name | Description |
|--------|------|-------------|
| `int` | [`caseCount`](#casecount-1)  |  |
| `List< string >` | [`caseLabels`](#caselabels)  |  |
| `SerializableType` | [`inputType`](#inputtype-6)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:35
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:38
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:41

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`OnEdgesChanged`](#onedgeschanged) `inline` |  |
| `int` | [`ResolveCaseIndex`](#resolvecaseindex) `inline` |  |
| `bool` | [`TryGetConnectedEnumParameter`](#trygetconnectedenumparameter) `inline` |  |
| `string` | [`GetDisplayLabel`](#getdisplaylabel) `inline` |  |
| `PortData` | [`CreateValuePortData`](#createvalueportdata) `inline` |  |
| `Type` | [`ResolveValueInputType`](#resolvevalueinputtype) `inline` |  |
...
```cpp
inline void OnEdgesChanged(SerializableEdge edge)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:73
...
```cpp
inline int ResolveCaseIndex(object selectionValue)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:188

---

{#trygetconnectedenumparameter}
...
```cpp
inline bool TryGetConnectedEnumParameter(out EnumPatternParameter enumParameter)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:229
...
```cpp
inline string GetDisplayLabel(int index)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:254
...
```cpp
inline PortData CreateValuePortData(string displayName, string identifier, List< SerializableEdge > edges)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:260

---

{#resolvevalueinputtype}
...
```cpp
inline Type ResolveValueInputType(List< SerializableEdge > edges)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:273

## Private Static Attributes

| Return | Name | Description |
|--------|------|-------------|
| `const int` | [`defaultCaseCount`](#defaultcasecount) `static` |  |
| `const int` | [`minimumCaseCount`](#minimumcasecount) `static` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:20

## Private Static Methods

| Return | Name | Description |
|--------|------|-------------|
| `bool` | [`TryGetConnectedPortType`](#trygetconnectedporttype) `static` `inline` |  |
| `string` | [`GetCaseIdentifier`](#getcaseidentifier) `static` `inline` |  |
| `bool` | [`TryGetCaseIndex`](#trygetcaseindex) `static` `inline` |  |

---

{#trygetconnectedporttype}
...
```cpp
static inline bool TryGetConnectedPortType(List< SerializableEdge > edges, out Type resolvedType)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:293
...
```cpp
static inline string GetCaseIdentifier(int index)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:306
...
```cpp
static inline bool TryGetCaseIndex(string identifier, out int caseIndex)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/EnumSwitchNode.cs:308
