{#noisedistanceheightnodeview}

# NoiseDistanceHeightNodeView

```cpp
class NoiseDistanceHeightNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/NoiseDistanceHeightNodeView.cs:9
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-38) | `property` | Declared here |
| [`Enable`](#enable-134) | `function` | Declared here |
| [`iterations`](#iterations-4) | `variable` | Declared here |
| [`maxHeight`](#maxheight-3) | `variable` | Declared here |
| [`maxDistance`](#maxdistance) | `variable` | Declared here |
| [`falloffPower`](#falloffpower-1) | `variable` | Declared here |
| [`noiseFactor`](#noisefactor) | `variable` | Declared here |
| [`button`](#button-1) | `variable` | Declared here |
...
|--------|------|-------------|
| `Assets.Packages.com.ahahgames.genesisnoise.Runtime.Nodes.Terrain.Height.DistanceNoiseHeightNode` | [`node`](#node-38)  |  |
...
```cpp
Assets.Packages.com.ahahgames.genesisnoise.Runtime.Nodes.Terrain.Height.DistanceNoiseHeightNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/NoiseDistanceHeightNodeView.cs:11

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-134) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/NoiseDistanceHeightNodeView.cs:19
...
| Return | Name | Description |
|--------|------|-------------|
| `SliderInt` | [`iterations`](#iterations-4)  |  |
| `Slider` | [`maxHeight`](#maxheight-3)  |  |
| `Slider` | [`maxDistance`](#maxdistance)  |  |
| `Slider` | [`falloffPower`](#falloffpower-1)  |  |
| `Slider` | [`noiseFactor`](#noisefactor)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/NoiseDistanceHeightNodeView.cs:12
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/NoiseDistanceHeightNodeView.cs:13
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/NoiseDistanceHeightNodeView.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/NoiseDistanceHeightNodeView.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/NoiseDistanceHeightNodeView.cs:16
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/NoiseDistanceHeightNodeView.cs:17
