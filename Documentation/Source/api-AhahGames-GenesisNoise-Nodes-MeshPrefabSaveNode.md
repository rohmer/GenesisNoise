...
```cpp
class MeshPrefabSaveNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshPrefabSaveNode.cs:22
...
| Name | Kind | Owner |
|------|------|-------|
| [`hasPreview`](#haspreview-57) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-305) | `property` | Declared here |
| [`name`](#name-332) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-43) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-124) | `property` | Declared here |
| [`previewTexture`](#previewtexture-27) | `property` | Declared here |
| [`loopInput`](#loopinput-5) | `variable` | Declared here |
| [`loopOutput`](#loopoutput-5) | `variable` | Declared here |
| [`input`](#input-20) | `variable` | Declared here |
| [`output`](#output-52) | `variable` | Declared here |
| [`prefab`](#prefab) | `variable` | Declared here |
| [`Enable`](#enable-53) | `function` | Declared here |
| [`ProcessNode`](#processnode-76) | `function` | Declared here |
| [`preview`](#preview-8) | `variable` | Declared here |
| [`GetSafePrefabName`](#getsafeprefabname) | `function` | Declared here |
...
|--------|------|-------------|
| `override bool` | [`hasPreview`](#haspreview-57)  |  |
| `override string` | [`NodeGroup`](#nodegroup-305)  |  |
| `override string` | [`name`](#name-332)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-43)  |  |
| `override float` | [`nodeWidth`](#nodewidth-124)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-27)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshPrefabSaveNode.cs:46
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshPrefabSaveNode.cs:47
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshPrefabSaveNode.cs:48

---

{#showdefaultinspector-43}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshPrefabSaveNode.cs:49
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshPrefabSaveNode.cs:50
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshPrefabSaveNode.cs:51

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `object` | [`loopInput`](#loopinput-5)  |  |
| `object` | [`loopOutput`](#loopoutput-5)  |  |
| `GameObject` | [`input`](#input-20)  |  |
| `GameObject` | [`output`](#output-52)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshPrefabSaveNode.cs:25
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshPrefabSaveNode.cs:28
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshPrefabSaveNode.cs:31
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshPrefabSaveNode.cs:34
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshPrefabSaveNode.cs:37

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-53) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-76) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshPrefabSaveNode.cs:53
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshPrefabSaveNode.cs:59
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshPrefabSaveNode.cs:44

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `string` | [`GetSafePrefabName`](#getsafeprefabname) `inline` |  |
...
```cpp
inline string GetSafePrefabName()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshPrefabSaveNode.cs:153
