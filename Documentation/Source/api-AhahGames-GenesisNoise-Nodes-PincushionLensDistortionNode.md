{#pincushionlensdistortionnode}

# PincushionLensDistortionNode

```cpp
class PincushionLensDistortionNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/PincushionLensDistortionNode.cs:12
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-389) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-359) | `property` | Declared here |
| [`ShaderName`](#shadername-293) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-389)  |  |
| `override string` | [`NodeGroup`](#nodegroup-359)  |  |
| `override string` | [`ShaderName`](#shadername-293)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/PincushionLensDistortionNode.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/PincushionLensDistortionNode.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/PincushionLensDistortionNode.cs:16
