...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Views/RelayNodeView.cs:9
...
| Name | Kind | Owner |
|------|------|-------|
| [`relay`](#relay) | `property` | Declared here |
| [`input`](#input-1) | `property` | Declared here |
| [`output`](#output-1) | `property` | Declared here |
| [`Enable`](#enable-1) | `function` | Declared here |
| [`BuildContextualMenu`](#buildcontextualmenu) | `function` | Declared here |
| [`SetPosition`](#setposition) | `function` | Declared here |
| [`OnRemoved`](#onremoved) | `function` | Declared here |
| [`TogglePackInput`](#togglepackinput) | `function` | Declared here |
| [`ToggleUnpackOutput`](#toggleunpackoutput) | `function` | Declared here |
| [`PackInputStatus`](#packinputstatus) | `function` | Declared here |
| [`UnpackOutputStatus`](#unpackoutputstatus) | `function` | Declared here |
| [`UpdateSize`](#updatesize) | `function` | Declared here |
...
| `VisualElement` | [`input`](#input-1)  |  |
| `VisualElement` | [`output`](#output-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Views/RelayNodeView.cs:11
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Views/RelayNodeView.cs:12
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Views/RelayNodeView.cs:13

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-1) `virtual` `inline` |  |
| `override void` | [`BuildContextualMenu`](#buildcontextualmenu) `inline` |  |
| `override void` | [`SetPosition`](#setposition) `inline` |  |
| `override void` | [`OnRemoved`](#onremoved) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Views/RelayNodeView.cs:15

#### Reimplements

- [`Enable`](api-GraphProcessor-BaseNodeView.md#enable-6)
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Views/RelayNodeView.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Views/RelayNodeView.cs:72
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Views/RelayNodeView.cs:103
...
| Return | Name | Description |
|--------|------|-------------|
| `void` | [`TogglePackInput`](#togglepackinput) `inline` |  |
| `void` | [`ToggleUnpackOutput`](#toggleunpackoutput) `inline` |  |
| `DropdownMenuAction.Status` | [`PackInputStatus`](#packinputstatus) `inline` |  |
| `DropdownMenuAction.Status` | [`UnpackOutputStatus`](#unpackoutputstatus) `inline` |  |
| `void` | [`UpdateSize`](#updatesize) `inline` |  |
...
```cpp
inline void TogglePackInput(DropdownMenuAction action)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Views/RelayNodeView.cs:32
...
```cpp
inline void ToggleUnpackOutput(DropdownMenuAction action)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Views/RelayNodeView.cs:41
...
```cpp
inline DropdownMenuAction.Status PackInputStatus(DropdownMenuAction action)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Views/RelayNodeView.cs:50
...
```cpp
inline DropdownMenuAction.Status UnpackOutputStatus(DropdownMenuAction action)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Views/RelayNodeView.cs:61
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/NodeGraphProcessor/Editor/Views/RelayNodeView.cs:78
