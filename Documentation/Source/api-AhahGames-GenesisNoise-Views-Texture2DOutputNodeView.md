{#texture2doutputnodeview}

# Texture2DOutputNodeView

```cpp
class Texture2DOutputNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Output/Texture2DOutputNodeView.cs:18
...
| Name | Kind | Owner |
|------|------|-------|
| [`Enable`](#enable-168) | `function` | Declared here |
| [`BuildOutputNodeSettings`](#buildoutputnodesettings-2) | `function` | Declared here |
| [`outputNode`](#outputnode-4) | `variable` | Declared here |
| [`graph`](#graph-18) | `variable` | Declared here |
| [`buttons`](#buttons-1) | `variable` | Declared here |
| [`UpdateExternal`](#updateexternal-1) | `function` | Declared here |
| [`UpdateButtons`](#updatebuttons-1) | `function` | Declared here |
| [`SaveExternal`](#saveexternal-1) | `function` | Declared here |
| [`SaveExternal`](#saveexternal-2) | `function` | Declared here |
| [`GetDefaultSaveName`](#getdefaultsavename-1) | `function` | Declared here |
| [`GetDefaultSaveDirectory`](#getdefaultsavedirectory-1) | `function` | Declared here |
| [`CreateExportTexture`](#createexporttexture) | `function` | Declared here |
| [`GetExtension`](#getextension) | `function` | Declared here |
...
|--------|------|-------------|
| `override void` | [`Enable`](#enable-168) `virtual` `inline` |  |
| `void` | [`BuildOutputNodeSettings`](#buildoutputnodesettings-2) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Output/Texture2DOutputNodeView.cs:24
...
```cpp
inline void BuildOutputNodeSettings()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Output/Texture2DOutputNodeView.cs:39

## Protected Attributes

| Return | Name | Description |
|--------|------|-------------|
| `Texture2DOutputNode` | [`outputNode`](#outputnode-4)  |  |
| `GenesisGraph` | [`graph`](#graph-18)  |  |
...
```cpp
Texture2DOutputNode outputNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Output/Texture2DOutputNodeView.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Output/Texture2DOutputNodeView.cs:21

## Private Attributes

| Return | Name | Description |
|--------|------|-------------|
| `List<(Button save, Button update)>` | [`buttons`](#buttons-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Output/Texture2DOutputNodeView.cs:22

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`UpdateExternal`](#updateexternal-1) `inline` |  |
| `void` | [`UpdateButtons`](#updatebuttons-1) `inline` |  |
| `void` | [`SaveExternal`](#saveexternal-1) `inline` |  |
| `void` | [`SaveExternal`](#saveexternal-2) `inline` |  |
| `string` | [`GetDefaultSaveName`](#getdefaultsavename-1) `inline` |  |
| `string` | [`GetDefaultSaveDirectory`](#getdefaultsavedirectory-1) `inline` |  |
| `Texture2D` | [`CreateExportTexture`](#createexporttexture) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Output/Texture2DOutputNodeView.cs:100
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Output/Texture2DOutputNodeView.cs:104
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Output/Texture2DOutputNodeView.cs:127
...
```cpp
inline void SaveExternal(bool saveAs)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Output/Texture2DOutputNodeView.cs:132

---

{#getdefaultsavename-1}
...
```cpp
inline string GetDefaultSaveName()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Output/Texture2DOutputNodeView.cs:231

---

{#getdefaultsavedirectory-1}
...
```cpp
inline string GetDefaultSaveDirectory()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Output/Texture2DOutputNodeView.cs:243
...
```cpp
inline Texture2D CreateExportTexture(Texture2D source)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Output/Texture2DOutputNodeView.cs:255

## Private Static Methods

| Return | Name | Description |
|--------|------|-------------|
| `string` | [`GetExtension`](#getextension) `static` `inline` |  |
...
```cpp
static inline string GetExtension(ExternalFileType fileType)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Output/Texture2DOutputNodeView.cs:290
