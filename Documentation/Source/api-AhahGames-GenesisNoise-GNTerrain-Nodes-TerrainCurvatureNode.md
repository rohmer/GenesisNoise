...
```cpp
class TerrainCurvatureNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainCurvatureNode.cs:16
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-600) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-83) | `property` | Declared here |
| [`hasPreview`](#haspreview-96) | `property` | Declared here |
| [`hasSettings`](#hassettings-27) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-212) | `property` | Declared here |
| [`previewTexture`](#previewtexture-58) | `property` | Declared here |
| [`TerrainInput`](#terraininput-1) | `variable` | Declared here |
| [`CurvatureMap`](#curvaturemap) | `variable` | Declared here |
| [`Enable`](#enable-193) | `function` | Declared here |
| [`ProcessNode`](#processnode-146) | `function` | Declared here |
| [`Disable`](#disable-80) | `function` | Declared here |
| [`preview`](#preview-18) | `variable` | Declared here |
| [`previewRequestVersion`](#previewrequestversion-5) | `variable` | Declared here |
| [`shader`](#shader-8) | `variable` | Declared here |
| [`kernel`](#kernel-2) | `variable` | Declared here |
| [`SanitizeParameters`](#sanitizeparameters) | `function` | Declared here |
| [`RequestPreview`](#requestpreview-6) | `function` | Declared here |
| [`ThreadGroupSize`](#threadgroupsize-5) | `variable` | Declared here |
| [`PreviewResolution`](#previewresolution-1) | `variable` | Declared here |
| [`LoadTerrainComputeShader`](#loadterraincomputeshader-1) | `function` | Declared here |
| [`ClearTexture`](#cleartexture-2) | `function` | Declared here |
| [`DestroyPreview`](#destroypreview-4) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-600)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-83)  |  |
| `override bool` | [`hasPreview`](#haspreview-96)  |  |
| `override bool` | [`hasSettings`](#hassettings-27)  |  |
| `override float` | [`nodeWidth`](#nodewidth-212)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-58)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainCurvatureNode.cs:38

---

{#showdefaultinspector-83}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainCurvatureNode.cs:39
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainCurvatureNode.cs:40
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainCurvatureNode.cs:41
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainCurvatureNode.cs:42
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainCurvatureNode.cs:43

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `HeightField` | [`TerrainInput`](#terraininput-1)  |  |
| `RenderTexture` | [`CurvatureMap`](#curvaturemap)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainCurvatureNode.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainCurvatureNode.cs:22

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-193) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-146) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-80) `virtual` `inline` | Called when the node is disabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainCurvatureNode.cs:45
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainCurvatureNode.cs:51
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainCurvatureNode.cs:176
...
| Return | Name | Description |
|--------|------|-------------|
| `Texture2D` | [`preview`](#preview-18)  |  |
| `int` | [`previewRequestVersion`](#previewrequestversion-5)  |  |
| `ComputeShader` | [`shader`](#shader-8)  |  |
| `int` | [`kernel`](#kernel-2)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainCurvatureNode.cs:30

---

{#previewrequestversion-5}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainCurvatureNode.cs:31
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainCurvatureNode.cs:32
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainCurvatureNode.cs:33

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`SanitizeParameters`](#sanitizeparameters) `inline` |  |
| `void` | [`RequestPreview`](#requestpreview-6) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainCurvatureNode.cs:138
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainCurvatureNode.cs:155

## Private Static Attributes

| Return | Name | Description |
|--------|------|-------------|
| `const int` | [`ThreadGroupSize`](#threadgroupsize-5) `static` |  |
| `const int` | [`PreviewResolution`](#previewresolution-1) `static` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainCurvatureNode.cs:35
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainCurvatureNode.cs:36

## Private Static Methods

| Return | Name | Description |
|--------|------|-------------|
| `ComputeShader` | [`LoadTerrainComputeShader`](#loadterraincomputeshader-1) `static` `inline` |  |
| `void` | [`ClearTexture`](#cleartexture-2) `static` `inline` |  |
| `void` | [`DestroyPreview`](#destroypreview-4) `static` `inline` |  |

---

{#loadterraincomputeshader-1}

### LoadTerrainComputeShader

`static` `inline`

```cpp
static inline ComputeShader LoadTerrainComputeShader(string shaderName)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainCurvatureNode.cs:104
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainCurvatureNode.cs:147
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainCurvatureNode.cs:185
