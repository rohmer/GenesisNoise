...
```cpp
class LogATextureNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/LogATexture.cs:17
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-309) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-283) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-35) | `property` | Declared here |
| [`hasPreview`](#haspreview-49) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-114) | `property` | Declared here |
| [`inputA`](#inputa-17) | `variable` | Declared here |
| [`output`](#output-44) | `variable` | Declared here |
| [`Enable`](#enable-45) | `function` | Declared here |
| [`ProcessNode`](#processnode-66) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-309)  |  |
| `override string` | [`NodeGroup`](#nodegroup-283)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-35)  |  |
| `override bool` | [`hasPreview`](#haspreview-49)  |  |
| `override float` | [`nodeWidth`](#nodewidth-114)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/LogATexture.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/LogATexture.cs:25

---

{#showdefaultinspector-35}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/LogATexture.cs:27
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/LogATexture.cs:28
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/LogATexture.cs:29

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `RenderTexture` | [`inputA`](#inputa-17)  |  |
| `RenderTexture` | [`output`](#output-44)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/LogATexture.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/LogATexture.cs:23

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-45) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-66) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/LogATexture.cs:30
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/LogATexture.cs:36
