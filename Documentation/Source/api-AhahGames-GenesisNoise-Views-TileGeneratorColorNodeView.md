{#tilegeneratorcolornodeview}

# TileGeneratorColorNodeView

```cpp
class TileGeneratorColorNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Tiling/TileGeneratorColorNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`tileGeneratorNode`](#tilegeneratornode) | `property` | Declared here |
| [`MaterialGUI`](#materialgui-4) | `function` | Declared here |
...
|--------|------|-------------|
| `TileGeneratorColorNode` | [`tileGeneratorNode`](#tilegeneratornode)  |  |
...
```cpp
TileGeneratorColorNode tileGeneratorNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Tiling/TileGeneratorColorNodeView.cs:12

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`MaterialGUI`](#materialgui-4) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Tiling/TileGeneratorColorNodeView.cs:14
