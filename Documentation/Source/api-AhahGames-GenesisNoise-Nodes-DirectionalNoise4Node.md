{#directionalnoise4node}

# DirectionalNoise4Node

```cpp
class DirectionalNoise4Node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/DirectionalNoise4Node.cs:17
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-146) | `property` | Declared here |
| [`ShaderName`](#shadername-103) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-127) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-146)  |  |
| `override string` | [`ShaderName`](#shadername-103)  |  |
| `override string` | [`NodeGroup`](#nodegroup-127)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/DirectionalNoise4Node.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/DirectionalNoise4Node.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/DirectionalNoise4Node.cs:21
