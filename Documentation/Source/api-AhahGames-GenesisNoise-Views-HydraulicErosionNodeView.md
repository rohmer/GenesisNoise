{#hydraulicerosionnodeview}

# HydraulicErosionNodeView

```cpp
class HydraulicErosionNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/HydraulicErosionNodeView.cs:17
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-26) | `property` | Declared here |
| [`Enable`](#enable-119) | `function` | Declared here |
| [`iterations`](#iterations-1) | `variable` | Declared here |
| [`deltaTime`](#deltatime) | `variable` | Declared here |
| [`rainAmount`](#rainamount) | `variable` | Declared here |
| [`evaporation`](#evaporation) | `variable` | Declared here |
| [`gravity`](#gravity) | `variable` | Declared here |
| [`pipeArea`](#pipearea) | `variable` | Declared here |
| [`pipeLength`](#pipelength) | `variable` | Declared here |
| [`sedimentCapacity`](#sedimentcapacity) | `variable` | Declared here |
| [`minSedimentCapacity`](#minsedimentcapacity) | `variable` | Declared here |
| [`erosionRate`](#erosionrate) | `variable` | Declared here |
| [`depositionRate`](#depositionrate) | `variable` | Declared here |
| [`dissolveRate`](#dissolverate) | `variable` | Declared here |
| [`cellSize`](#cellsize) | `variable` | Declared here |
...
|--------|------|-------------|
| `HydraulicErosionNode` | [`node`](#node-26)  |  |
...
```cpp
HydraulicErosionNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/HydraulicErosionNodeView.cs:19

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-119) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/HydraulicErosionNodeView.cs:24
...
| Return | Name | Description |
|--------|------|-------------|
| `SliderInt` | [`iterations`](#iterations-1)  |  |
| `Slider` | [`deltaTime`](#deltatime)  |  |
| `Slider` | [`rainAmount`](#rainamount)  |  |
| `Slider` | [`evaporation`](#evaporation)  |  |
| `Slider` | [`gravity`](#gravity)  |  |
| `Slider` | [`pipeArea`](#pipearea)  |  |
| `Slider` | [`pipeLength`](#pipelength)  |  |
| `Slider` | [`sedimentCapacity`](#sedimentcapacity)  |  |
| `Slider` | [`minSedimentCapacity`](#minsedimentcapacity)  |  |
| `Slider` | [`erosionRate`](#erosionrate)  |  |
| `Slider` | [`depositionRate`](#depositionrate)  |  |
| `Slider` | [`dissolveRate`](#dissolverate)  |  |
| `Slider` | [`cellSize`](#cellsize)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/HydraulicErosionNodeView.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/HydraulicErosionNodeView.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/HydraulicErosionNodeView.cs:22
