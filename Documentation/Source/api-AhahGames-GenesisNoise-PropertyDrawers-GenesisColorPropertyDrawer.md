{#genesiscolorpropertydrawer}

# GenesisColorPropertyDrawer

```cpp
class GenesisColorPropertyDrawer
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisColorPropertyDrawer.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`DrawerGUI`](#drawergui-5) | `function` | Declared here |
...
|--------|------|-------------|
| `override void` | [`DrawerGUI`](#drawergui-5) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisColorPropertyDrawer.cs:12
