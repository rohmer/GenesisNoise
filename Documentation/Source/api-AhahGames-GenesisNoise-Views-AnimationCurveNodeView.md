{#animationcurvenodeview}

# AnimationCurveNodeView

```cpp
class AnimationCurveNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Constant/AnimationCurveNodeView.cs:12
...
| Name | Kind | Owner |
|------|------|-------|
| [`acNode`](#acnode) | `property` | Declared here |
| [`Enable`](#enable-91) | `function` | Declared here |
| [`curveField`](#curvefield-1) | `variable` | Declared here |
| [`NodeTarget_onProcessed`](#nodetarget_onprocessed) | `function` | Declared here |
| [`UpdateLabel`](#updatelabel-2) | `function` | Declared here |
...
|--------|------|-------------|
| `AnimationCurveNode` | [`acNode`](#acnode)  |  |
...
```cpp
AnimationCurveNode acNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Constant/AnimationCurveNodeView.cs:14

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-91) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Constant/AnimationCurveNodeView.cs:17
...
| Return | Name | Description |
|--------|------|-------------|
| `CurveField` | [`curveField`](#curvefield-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Constant/AnimationCurveNodeView.cs:15

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`NodeTarget_onProcessed`](#nodetarget_onprocessed) `inline` |  |
| `void` | [`UpdateLabel`](#updatelabel-2) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Constant/AnimationCurveNodeView.cs:37
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Constant/AnimationCurveNodeView.cs:42
