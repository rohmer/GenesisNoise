{#pinknoisepointsnodeview}

# PinkNoisePointsNodeView

```cpp
class PinkNoisePointsNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/PinkNoisePointsNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-42) | `property` | Declared here |
| [`Enable`](#enable-138) | `function` | Declared here |
| [`Disable`](#disable-64) | `function` | Declared here |
| [`countField`](#countfield-7) | `variable` | Declared here |
| [`coordinatesField`](#coordinatesfield-6) | `variable` | Declared here |
| [`RefreshOutputs`](#refreshoutputs-6) | `function` | Declared here |
...
|--------|------|-------------|
| `PinkNoisePointsNode` | [`node`](#node-42)  |  |
...
```cpp
PinkNoisePointsNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/PinkNoisePointsNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-138) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-64) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/PinkNoisePointsNodeView.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/PinkNoisePointsNodeView.cs:38
...
| Return | Name | Description |
|--------|------|-------------|
| `IntegerField` | [`countField`](#countfield-7)  |  |
| `TextField` | [`coordinatesField`](#coordinatesfield-6)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/PinkNoisePointsNodeView.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/PinkNoisePointsNodeView.cs:15

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RefreshOutputs`](#refreshoutputs-6) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/PinkNoisePointsNodeView.cs:44
