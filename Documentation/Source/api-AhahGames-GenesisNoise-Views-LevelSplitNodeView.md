...
```cpp
class LevelSplitNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/LevelSplitNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`levelSplitNode`](#levelsplitnode-1) | `property` | Declared here |
| [`Enable`](#enable-123) | `function` | Declared here |
...
|--------|------|-------------|
| `LevelSplitNode` | [`levelSplitNode`](#levelsplitnode-1)  |  |
...
```cpp
LevelSplitNode levelSplitNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/LevelSplitNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-123) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/LevelSplitNodeView.cs:14
