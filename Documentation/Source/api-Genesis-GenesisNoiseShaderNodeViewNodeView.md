{#genesisnoiseshadernodeviewnodeview}

# GenesisNoiseShaderNodeViewNodeView

```cpp
class GenesisNoiseShaderNodeViewNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Examples/Nodes/Shader Node - Custom View/GenesisNoiseShaderNodeView.cs:15
...
[NodeCustomEditor](api-GraphProcessor-NodeCustomEditor.md#nodecustomeditor) defines what node type this editor is for.

This class name is a bit of a mess, the standard across [GenesisNoise](api-GenesisNoise.md#genesisnoise) is for the node class to end in Node and the view class to end in View (With the preceeding node class added)
...
| [`node`](#node) | `variable` | Declared here |
...
|--------|------|-------------|
| `override void` | [`Enable`](#enable) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Examples/Nodes/Shader Node - Custom View/GenesisNoiseShaderNodeView.cs:22
...
| Return | Name | Description |
|--------|------|-------------|
| `GenesisNoiseExampleCustomViewNode` | [`node`](#node)  | The node that this view is for, this is set in the Enable method below. You can use this to access the node's properties and methods. |
...
```cpp
GenesisNoiseExampleCustomViewNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Examples/Nodes/Shader Node - Custom View/GenesisNoiseShaderNodeView.cs:20

The node that this view is for, this is set in the Enable method below. You can use this to access the node's properties and methods.
