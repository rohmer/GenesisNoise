...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/CurveNode.cs:23
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-131) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-112) | `property` | Declared here |
| [`ShaderName`](#shadername-89) | `property` | Declared here |
| [`filteredOutProperties`](#filteredoutproperties-42) | `property` | Declared here |
| [`curve`](#curve) | `variable` | Declared here |
| [`Enable`](#enable-24) | `function` | Declared here |
| [`ProcessNode`](#processnode-35) | `function` | Declared here |
| [`Disable`](#disable-11) | `function` | Declared here |
| [`curveTexture`](#curvetexture) | `variable` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-131)  |  |
| `override string` | [`NodeGroup`](#nodegroup-112)  |  |
| `override string` | [`ShaderName`](#shadername-89)  |  |
| `override IEnumerable< string >` | [`filteredOutProperties`](#filteredoutproperties-42)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/CurveNode.cs:25
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/CurveNode.cs:26
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/CurveNode.cs:27

---

{#filteredoutproperties-42}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/CurveNode.cs:35
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/CurveNode.cs:30

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-24) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-35) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-11) `virtual` `inline` | Called when the node is disabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/CurveNode.cs:46
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/CurveNode.cs:72
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/CurveNode.cs:104
...
| Return | Name | Description |
|--------|------|-------------|
| `Texture2D` | [`curveTexture`](#curvetexture)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Filters/CurveNode.cs:33
