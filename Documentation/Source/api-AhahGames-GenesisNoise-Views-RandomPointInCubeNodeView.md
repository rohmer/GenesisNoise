{#randompointincubenodeview}

# RandomPointInCubeNodeView

```cpp
class RandomPointInCubeNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomPointInCubeNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-51) | `property` | Declared here |
| [`Enable`](#enable-148) | `function` | Declared here |
| [`Disable`](#disable-70) | `function` | Declared here |
| [`p1`](#p1-2) | `variable` | Declared here |
| [`p2`](#p2-1) | `variable` | Declared here |
| [`RefreshOutputs`](#refreshoutputs-13) | `function` | Declared here |
...
|--------|------|-------------|
| `RandomPointInCubeNode` | [`node`](#node-51)  |  |
...
```cpp
RandomPointInCubeNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomPointInCubeNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-148) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-70) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomPointInCubeNodeView.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomPointInCubeNodeView.cs:46
...
| Return | Name | Description |
|--------|------|-------------|
| `Vector3Field` | [`p1`](#p1-2)  |  |
| `Vector3Field` | [`p2`](#p2-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomPointInCubeNodeView.cs:13
...
| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RefreshOutputs`](#refreshoutputs-13) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomPointInCubeNodeView.cs:52
