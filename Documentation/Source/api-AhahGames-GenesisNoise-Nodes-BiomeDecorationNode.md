...
```cpp
class BiomeDecorationNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/Decorations/BiomeDecorationNode.cs:13
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-51) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-8) | `property` | Declared here |
| [`hasPreview`](#haspreview-11) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-17) | `property` | Declared here |
| [`Enable`](#enable-16) | `function` | Declared here |
| [`Disable`](#disable-4) | `function` | Declared here |
| [`ProcessNode`](#processnode-16) | `function` | Declared here |
| [`connectedPrefabInputs`](#connectedprefabinputs) | `variable` | Declared here |
| [`PullPrefabInputs`](#pullprefabinputs) | `function` | Declared here |
| [`PushDecoration`](#pushdecoration) | `function` | Declared here |
| [`OnPrefabEdgeConnected`](#onprefabedgeconnected) | `function` | Declared here |
| [`OnPrefabEdgeDisconnected`](#onprefabedgedisconnected) | `function` | Declared here |
| [`IsPrefabInputEdge`](#isprefabinputedge) | `function` | Declared here |
| [`SyncPrefabInputs`](#syncprefabinputs) | `function` | Declared here |
| [`SyncDecoration`](#syncdecoration) | `function` | Declared here |
| [`ResolvePrefab`](#resolveprefab) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-51)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-8)  |  |
| `override bool` | [`hasPreview`](#haspreview-11)  |  |
| `override float` | [`nodeWidth`](#nodewidth-17)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/Decorations/BiomeDecorationNode.cs:27

---

{#showdefaultinspector-8}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/Decorations/BiomeDecorationNode.cs:28
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/Decorations/BiomeDecorationNode.cs:29
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/Decorations/BiomeDecorationNode.cs:30

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-16) `virtual` `inline` | Called when the node is enabled. |
| `override void` | [`Disable`](#disable-4) `virtual` `inline` | Called when the node is disabled. |
| `override bool` | [`ProcessNode`](#processnode-16) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/Decorations/BiomeDecorationNode.cs:31
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/Decorations/BiomeDecorationNode.cs:39
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/Decorations/BiomeDecorationNode.cs:60
...
| Return | Name | Description |
|--------|------|-------------|
| `readonly List< GameObject >` | [`connectedPrefabInputs`](#connectedprefabinputs)  |  |

---

{#connectedprefabinputs}

### connectedPrefabInputs

```cpp
readonly List< GameObject > connectedPrefabInputs = new()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/Decorations/BiomeDecorationNode.cs:21

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`PullPrefabInputs`](#pullprefabinputs) `inline` |  |
| `void` | [`PushDecoration`](#pushdecoration) `inline` |  |
| `void` | [`OnPrefabEdgeConnected`](#onprefabedgeconnected) `inline` |  |
| `void` | [`OnPrefabEdgeDisconnected`](#onprefabedgedisconnected) `inline` |  |
| `bool` | [`IsPrefabInputEdge`](#isprefabinputedge) `inline` |  |
| `bool` | [`SyncPrefabInputs`](#syncprefabinputs) `inline` |  |
| `void` | [`SyncDecoration`](#syncdecoration) `inline` |  |
...
```cpp
inline void PullPrefabInputs(List< SerializableEdge > inputEdges)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/Decorations/BiomeDecorationNode.cs:48
...
```cpp
inline void PushDecoration(List< SerializableEdge > outputEdges, NodePort outputPort)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/Decorations/BiomeDecorationNode.cs:53

---

{#onprefabedgeconnected}
...
```cpp
inline void OnPrefabEdgeConnected(SerializableEdge edge)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/Decorations/BiomeDecorationNode.cs:96

---

{#onprefabedgedisconnected}
...
```cpp
inline void OnPrefabEdgeDisconnected(SerializableEdge edge)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/Decorations/BiomeDecorationNode.cs:102
...
```cpp
inline bool IsPrefabInputEdge(SerializableEdge edge)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/Decorations/BiomeDecorationNode.cs:113
...
```cpp
inline bool SyncPrefabInputs(List< SerializableEdge > inputEdges)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/Decorations/BiomeDecorationNode.cs:118
...
```cpp
inline void SyncDecoration()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/Decorations/BiomeDecorationNode.cs:171

## Private Static Methods

| Return | Name | Description |
|--------|------|-------------|
| `GameObject` | [`ResolvePrefab`](#resolveprefab) `static` `inline` |  |
...
```cpp
static inline GameObject ResolvePrefab(SerializableEdge edge)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/Decorations/BiomeDecorationNode.cs:160
