{#floodfilltoshapenode}

# FloodFillToShapeNode

```cpp
class FloodFillToShapeNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/FloodFillToShapeNode.cs:22
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-200) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-178) | `property` | Declared here |
| [`ShaderName`](#shadername-149) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-200)  |  |
| `override string` | [`NodeGroup`](#nodegroup-178)  |  |
| `override string` | [`ShaderName`](#shadername-149)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/FloodFillToShapeNode.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/FloodFillToShapeNode.cs:25
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/FloodFillToShapeNode.cs:26
