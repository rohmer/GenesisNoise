...
```cpp
class BiomeManagerNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:18
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-52) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-9) | `property` | Declared here |
| [`hasPreview`](#haspreview-12) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-18) | `property` | Declared here |
| [`previewTexture`](#previewtexture-1) | `property` | Declared here |
| [`ProcessNode`](#processnode-17) | `function` | Declared here |
| [`Disable`](#disable-6) | `function` | Declared here |
| [`previewMap`](#previewmap) | `variable` | Declared here |
| [`coverageMap`](#coveragemap) | `variable` | Declared here |
| [`defaultScratch`](#defaultscratch) | `variable` | Declared here |
| [`preview`](#preview) | `variable` | Declared here |
| [`previewRequestVersion`](#previewrequestversion) | `variable` | Declared here |
| [`size`](#size-4) | `variable` | Declared here |
| [`splatShader`](#splatshader) | `variable` | Declared here |
| [`previewShader`](#previewshader) | `variable` | Declared here |
| [`splatKernel`](#splatkernel) | `variable` | Declared here |
| [`coverageKernel`](#coveragekernel) | `variable` | Declared here |
| [`defaultKernel`](#defaultkernel) | `variable` | Declared here |
| [`previewKernel`](#previewkernel) | `variable` | Declared here |
| [`PullInputs`](#pullinputs) | `function` | Declared here |
| [`GenerateSplatMaps`](#generatesplatmaps) | `function` | Declared here |
| [`InitializeShaders`](#initializeshaders) | `function` | Declared here |
| [`GeneratePackedSplatMap`](#generatepackedsplatmap) | `function` | Declared here |
| [`ApplyDefaultBiome`](#applydefaultbiome) | `function` | Declared here |
| [`GeneratePreview`](#generatepreview) | `function` | Declared here |
| [`GetDefaultBiomeIndex`](#getdefaultbiomeindex) | `function` | Declared here |
| [`GetPreviewColor`](#getpreviewcolor) | `function` | Declared here |
| [`GetLandOverrideChannels`](#getlandoverridechannels) | `function` | Declared here |
| [`EnsureTextureList`](#ensuretexturelist) | `function` | Declared here |
| [`RequestPreview`](#requestpreview) | `function` | Declared here |
| [`ThreadGroupSize`](#threadgroupsize) | `variable` | Declared here |
| [`PreviewResolution`](#previewresolution) | `variable` | Declared here |
| [`ColorTolerance`](#colortolerance) | `variable` | Declared here |
| [`PreviewColors`](#previewcolors) | `variable` | Declared here |
| [`GetLandChannel`](#getlandchannel) | `function` | Declared here |
| [`GetOneBasedBandMin`](#getonebasedbandmin) | `function` | Declared here |
| [`GetOneBasedBandMax`](#getonebasedbandmax) | `function` | Declared here |
| [`EnsureTexture`](#ensuretexture) | `function` | Declared here |
| [`Dispatch`](#dispatch) | `function` | Declared here |
| [`GetTerrainSize`](#getterrainsize) | `function` | Declared here |
| [`LoadTerrainComputeShader`](#loadterraincomputeshader) | `function` | Declared here |
| [`ReleaseTextureList`](#releasetexturelist) | `function` | Declared here |
| [`DestroyPreview`](#destroypreview) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-52)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-9)  |  |
| `override bool` | [`hasPreview`](#haspreview-12)  |  |
| `override float` | [`nodeWidth`](#nodewidth-18)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:79

---

{#showdefaultinspector-9}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:80
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:81
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:82
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:83

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-17) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-6) `virtual` `inline` | Called when the node is disabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:98
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:500
...
| Return | Name | Description |
|--------|------|-------------|
| `RenderTexture` | [`previewMap`](#previewmap)  |  |
| `RenderTexture` | [`coverageMap`](#coveragemap)  |  |
| `RenderTexture` | [`defaultScratch`](#defaultscratch)  |  |
| `Texture2D` | [`preview`](#preview)  |  |
| `int` | [`previewRequestVersion`](#previewrequestversion)  |  |
| `int` | [`size`](#size-4)  |  |
| `ComputeShader` | [`splatShader`](#splatshader)  |  |
| `ComputeShader` | [`previewShader`](#previewshader)  |  |
| `int` | [`splatKernel`](#splatkernel)  |  |
| `int` | [`coverageKernel`](#coveragekernel)  |  |
| `int` | [`defaultKernel`](#defaultkernel)  |  |
| `int` | [`previewKernel`](#previewkernel)  |  |
...
```cpp
RenderTexture previewMap
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:35
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:36
...
```cpp
RenderTexture defaultScratch
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:37
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:38
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:39
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:40
...
```cpp
ComputeShader splatShader
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:42
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:43
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:44
...
```cpp
int coverageKernel = -1
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:45
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:46
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:47

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`PullInputs`](#pullinputs) `inline` |  |
| `void` | [`GenerateSplatMaps`](#generatesplatmaps) `inline` |  |
| `bool` | [`InitializeShaders`](#initializeshaders) `inline` |  |
| `void` | [`GeneratePackedSplatMap`](#generatepackedsplatmap) `inline` |  |
| `void` | [`ApplyDefaultBiome`](#applydefaultbiome) `inline` |  |
| `void` | [`GeneratePreview`](#generatepreview) `inline` |  |
| `int` | [`GetDefaultBiomeIndex`](#getdefaultbiomeindex) `inline` |  |
| `Color` | [`GetPreviewColor`](#getpreviewcolor) `inline` |  |
| `Vector4` | [`GetLandOverrideChannels`](#getlandoverridechannels) `inline` |  |
| `void` | [`EnsureTextureList`](#ensuretexturelist) `inline` |  |
| `void` | [`RequestPreview`](#requestpreview) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:86
...
```cpp
inline void GenerateSplatMaps()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:118
...
```cpp
inline bool InitializeShaders()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:157

---

{#generatepackedsplatmap}
...
```cpp
inline void GeneratePackedSplatMap(int mapIndex, Texture landMap, Texture moisture, Texture slope, float heightMapMaximum, Vector4 landOverrideChannels, int defaultBiomeIndex)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:183
...
```cpp
inline void ApplyDefaultBiome(int defaultBiomeIndex)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:249
...
```cpp
inline void GeneratePreview()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:285

---

{#getdefaultbiomeindex}
...
```cpp
inline int GetDefaultBiomeIndex()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:303
...
```cpp
inline Color GetPreviewColor(int biomeIndex)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:314

---

{#getlandoverridechannels}
...
```cpp
inline Vector4 GetLandOverrideChannels()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:334
...
```cpp
inline void EnsureTextureList(List< RenderTexture > textures, int requiredCount)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:373
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:479

## Private Static Attributes

| Return | Name | Description |
|--------|------|-------------|
| `const int` | [`ThreadGroupSize`](#threadgroupsize) `static` |  |
| `const int` | [`PreviewResolution`](#previewresolution) `static` |  |
| `const float` | [`ColorTolerance`](#colortolerance) `static` |  |
| `readonly Color[]` | [`PreviewColors`](#previewcolors) `static` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:49
...
```cpp
const int PreviewResolution = 400
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:50
...
```cpp
const float ColorTolerance = 2.0f / 255.0f
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:51
...
```cpp
readonly Color[] PreviewColors                                     =
{
    new Color(0.18f, 0.52f, 0.30f, 1.0f),
    new Color(0.78f, 0.66f, 0.25f, 1.0f),
    new Color(0.25f, 0.48f, 0.76f, 1.0f),
    new Color(0.70f, 0.34f, 0.28f, 1.0f),
    new Color(0.42f, 0.30f, 0.62f, 1.0f),
    new Color(0.28f, 0.66f, 0.64f, 1.0f),
    new Color(0.68f, 0.45f, 0.18f, 1.0f),
    new Color(0.55f, 0.60f, 0.24f, 1.0f),
    Color.aliceBlue,
    Color.azure,
    Color.bisque,
    Color.blueViolet,
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:53

## Private Static Methods

| Return | Name | Description |
|--------|------|-------------|
| `int` | [`GetLandChannel`](#getlandchannel) `static` `inline` |  |
| `float` | [`GetOneBasedBandMin`](#getonebasedbandmin) `static` `inline` |  |
| `float` | [`GetOneBasedBandMax`](#getonebasedbandmax) `static` `inline` |  |
| `void` | [`EnsureTexture`](#ensuretexture) `static` `inline` |  |
| `void` | [`Dispatch`](#dispatch) `static` `inline` |  |
| `int` | [`GetTerrainSize`](#getterrainsize) `static` `inline` |  |
| `ComputeShader` | [`LoadTerrainComputeShader`](#loadterraincomputeshader) `static` `inline` |  |
| `void` | [`ReleaseTextureList`](#releasetexturelist) `static` `inline` |  |
| `void` | [`DestroyPreview`](#destroypreview) `static` `inline` |  |
...
```cpp
static inline int GetLandChannel(Biome biome)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:350
...
```cpp
static inline float GetOneBasedBandMin(int value, int bandCount)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:363
...
```cpp
static inline float GetOneBasedBandMax(int value, int bandCount)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:368
...
```cpp
static inline void EnsureTexture(ref RenderTexture texture, int width, int height)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:394
...
```cpp
static inline void Dispatch(ComputeShader shader, int kernel, int width, int height)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:406
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:415
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:429
...
```cpp
static inline void ReleaseTextureList(List< RenderTexture > textures)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:515
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/BiomeManagerNode.cs:526
