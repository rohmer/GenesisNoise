{#nonuniformrotationnode}

# NonUniformRotationNode

```cpp
class NonUniformRotationNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/NonUniformTransformNode.cs:16
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-363) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-335) | `property` | Declared here |
| [`ShaderName`](#shadername-269) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-363)  |  |
| `override string` | [`NodeGroup`](#nodegroup-335)  |  |
| `override string` | [`ShaderName`](#shadername-269)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/NonUniformTransformNode.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/NonUniformTransformNode.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/NonUniformTransformNode.cs:20
