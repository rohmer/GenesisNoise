{#genesisblurmatrixdrawer}

# GenesisBlurMatrixDrawer

```cpp
class GenesisBlurMatrixDrawer
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisBlurMatrixDrawer.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`DrawerGUI`](#drawergui-2) | `function` | Declared here |
| [`BlurMatrixDrawer`](#blurmatrixdrawer) | `enum` | Declared here |
...
|--------|------|-------------|
| `override void` | [`DrawerGUI`](#drawergui-2) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisBlurMatrixDrawer.cs:30
...
| Name | Description |
|------|-------------|
| [`BlurMatrixDrawer`](#blurmatrixdrawer)  |  |
...
```cpp
enum BlurMatrixDrawer
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisBlurMatrixDrawer.cs:12
