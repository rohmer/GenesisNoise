{#smartmaskbuildernode}

# SmartMaskBuilderNode

```cpp
class SmartMaskBuilderNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/SmartMaskBuilderNode.cs:14

> **Inherits:** [`AhahGames.GenesisNoise.Nodes.SmartMaskEffectNodeBase`](api-AhahGames-GenesisNoise-Nodes-SmartMaskEffectNodeBase.md#smartmaskeffectnodebase)

## List of all members

| Name | Kind | Owner |
|------|------|-------|
| [`Mode`](#mode-24) | `property` | Declared here |
| [`name`](#name-466) | `property` | Declared here |
| [`ShaderName`](#shadername-345) | `property` | Declared here |
| [`Mode`](api-AhahGames-GenesisNoise-Nodes-SmartMaskEffectNodeBase.md#mode-25) | `property` | Inherited from [`SmartMaskEffectNodeBase`](api-AhahGames-GenesisNoise-Nodes-SmartMaskEffectNodeBase.md#smartmaskeffectnodebase) |
| [`NodeGroup`](api-AhahGames-GenesisNoise-Nodes-SmartMaskEffectNodeBase.md#nodegroup-432) | `property` | Inherited from [`SmartMaskEffectNodeBase`](api-AhahGames-GenesisNoise-Nodes-SmartMaskEffectNodeBase.md#smartmaskeffectnodebase) |
| [`filteredOutProperties`](api-AhahGames-GenesisNoise-Nodes-SmartMaskEffectNodeBase.md#filteredoutproperties-116) | `property` | Inherited from [`SmartMaskEffectNodeBase`](api-AhahGames-GenesisNoise-Nodes-SmartMaskEffectNodeBase.md#smartmaskeffectnodebase) |
| [`ProcessNode`](api-AhahGames-GenesisNoise-Nodes-SmartMaskEffectNodeBase.md#processnode-116) | `function` | Inherited from [`SmartMaskEffectNodeBase`](api-AhahGames-GenesisNoise-Nodes-SmartMaskEffectNodeBase.md#smartmaskeffectnodebase) |
...
## Inherited from [`SmartMaskEffectNodeBase`](api-AhahGames-GenesisNoise-Nodes-SmartMaskEffectNodeBase.md#smartmaskeffectnodebase)

| Kind | Name | Description |
|------|------|-------------|
| `property` | [`Mode`](api-AhahGames-GenesisNoise-Nodes-SmartMaskEffectNodeBase.md#mode-25)  |  |
| `property` | [`NodeGroup`](api-AhahGames-GenesisNoise-Nodes-SmartMaskEffectNodeBase.md#nodegroup-432)  |  |
| `property` | [`filteredOutProperties`](api-AhahGames-GenesisNoise-Nodes-SmartMaskEffectNodeBase.md#filteredoutproperties-116)  |  |
| `function` | [`ProcessNode`](api-AhahGames-GenesisNoise-Nodes-SmartMaskEffectNodeBase.md#processnode-116) `virtual` `inline` |  |
...
|--------|------|-------------|
| `override int` | [`Mode`](#mode-24)  |  |
| `override string` | [`name`](#name-466)  |  |
| `override string` | [`ShaderName`](#shadername-345)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/SmartMaskBuilderNode.cs:16
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/SmartMaskBuilderNode.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/SmartMaskBuilderNode.cs:19
