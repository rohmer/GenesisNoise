{#genesisfibonaccidrawer}

# GenesisFibonacciDrawer

```cpp
class GenesisFibonacciDrawer
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisFibonacciDrawer.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`DrawerGUI`](#drawergui-6) | `function` | Declared here |
| [`Fibonacci`](#fibonacci) | `enum` | Declared here |
...
|--------|------|-------------|
| `override void` | [`DrawerGUI`](#drawergui-6) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisFibonacciDrawer.cs:34
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisFibonacciDrawer.cs:12
