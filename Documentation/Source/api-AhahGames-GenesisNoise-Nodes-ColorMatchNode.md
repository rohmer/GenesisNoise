...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/ColorMatchNode.cs:15
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-107) | `property` | Declared here |
| [`ShaderName`](#shadername-72) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-88) | `property` | Declared here |
| [`DisplayMaterialInspector`](#displaymaterialinspector-34) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-44) | `property` | Declared here |
| [`filteredOutProperties`](#filteredoutproperties-33) | `property` | Declared here |
| [`referenceColor`](#referencecolor) | `variable` | Declared here |
| [`ProcessNode`](#processnode-27) | `function` | Declared here |
| [`ReferenceColorProperty`](#referencecolorproperty) | `variable` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-107)  |  |
| `override string` | [`ShaderName`](#shadername-72)  |  |
| `override string` | [`NodeGroup`](#nodegroup-88)  |  |
| `override bool` | [`DisplayMaterialInspector`](#displaymaterialinspector-34)  |  |
| `override float` | [`nodeWidth`](#nodewidth-44)  |  |
| `override IEnumerable< string >` | [`filteredOutProperties`](#filteredoutproperties-33)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/ColorMatchNode.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/ColorMatchNode.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/ColorMatchNode.cs:24

---

{#displaymaterialinspector-34}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/ColorMatchNode.cs:25
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/ColorMatchNode.cs:26

---

{#filteredoutproperties-33}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/ColorMatchNode.cs:28

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `Color` | [`referenceColor`](#referencecolor)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/ColorMatchNode.cs:18

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-27) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/ColorMatchNode.cs:30
...
| Return | Name | Description |
|--------|------|-------------|
| `const string` | [`ReferenceColorProperty`](#referencecolorproperty) `static` |  |

---

{#referencecolorproperty}
...
```cpp
const string ReferenceColorProperty = "_ReferenceColor"
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/ColorMatchNode.cs:20
