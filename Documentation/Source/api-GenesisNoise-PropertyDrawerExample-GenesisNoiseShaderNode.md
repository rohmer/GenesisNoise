{#genesisnoiseshadernode}

# GenesisNoiseShaderNode

```cpp
class GenesisNoiseShaderNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Examples/Nodes/Shader Node - Custom Property Drawer/GenesisNoiseExamplePropertyDrawer.cs:11
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-597) | `property` | Declared here |
| [`ShaderName`](#shadername-429) | `property` | Declared here |
| [`DisplayMaterialInspector`](#displaymaterialinspector-200) | `property` | Declared here |
| [`filteredOutProperties`](#filteredoutproperties-139) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-597)  | The name of the node, which will be displayed in the node graph. You can change this to whatever you want. |
| `override string` | [`ShaderName`](#shadername-429)  | The name of the shader, this will be the same as the first line of your shader file. For example: Shader "Hidden/Genesis/MyCustomShader". |
| `override bool` | [`DisplayMaterialInspector`](#displaymaterialinspector-200)  | If true, the node will display the material inspector for the shader. If false, the node will not display the material inspector. You may want to not show the default if you are planning on writing a custom view for this node. |
| `override IEnumerable< string >` | [`filteredOutProperties`](#filteredoutproperties-139)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Examples/Nodes/Shader Node - Custom Property Drawer/GenesisNoiseExamplePropertyDrawer.cs:16
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Examples/Nodes/Shader Node - Custom Property Drawer/GenesisNoiseExamplePropertyDrawer.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Examples/Nodes/Shader Node - Custom Property Drawer/GenesisNoiseExamplePropertyDrawer.cs:29
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Examples/Nodes/Shader Node - Custom Property Drawer/GenesisNoiseExamplePropertyDrawer.cs:32
