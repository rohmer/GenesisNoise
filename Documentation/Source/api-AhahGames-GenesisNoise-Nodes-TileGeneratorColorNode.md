{#tilegeneratorcolornode}

# TileGeneratorColorNode

```cpp
class TileGeneratorColorNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorColorNode.cs:17
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-524) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-481) | `property` | Declared here |
| [`ShaderName`](#shadername-382) | `property` | Declared here |
| [`DisplayMaterialInspector`](#displaymaterialinspector-172) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-182) | `property` | Declared here |
| [`filteredOutProperties`](#filteredoutproperties-128) | `property` | Declared here |
| [`defaultSettings`](#defaultsettings-33) | `property` | Declared here |
| [`supportedDimensions`](#supporteddimensions-31) | `property` | Declared here |
| [`pattern`](#pattern) | `variable` | Declared here |
| [`ProcessNode`](#processnode-137) | `function` | Declared here |
| [`PatternProperty`](#patternproperty) | `variable` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-524)  |  |
| `override string` | [`NodeGroup`](#nodegroup-481)  |  |
| `override string` | [`ShaderName`](#shadername-382)  |  |
| `override bool` | [`DisplayMaterialInspector`](#displaymaterialinspector-172)  |  |
| `override float` | [`nodeWidth`](#nodewidth-182)  |  |
| `override IEnumerable< string >` | [`filteredOutProperties`](#filteredoutproperties-128)  |  |
| `override GenesisNoiseSettings` | [`defaultSettings`](#defaultsettings-33)  |  |
| `override List< OutputDimension >` | [`supportedDimensions`](#supporteddimensions-31)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorColorNode.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorColorNode.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorColorNode.cs:25

---

{#displaymaterialinspector-172}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorColorNode.cs:26
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorColorNode.cs:27

---

{#filteredoutproperties-128}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorColorNode.cs:29
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorColorNode.cs:31

---

{#supporteddimensions-31}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorColorNode.cs:33

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `TileGeneratorGrayscalePattern` | [`pattern`](#pattern)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorColorNode.cs:19

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-137) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorColorNode.cs:38
...
| Return | Name | Description |
|--------|------|-------------|
| `const string` | [`PatternProperty`](#patternproperty) `static` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorColorNode.cs:21
