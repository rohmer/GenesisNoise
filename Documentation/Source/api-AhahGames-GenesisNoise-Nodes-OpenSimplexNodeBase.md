...
```cpp
class OpenSimplexNodeBase
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/OpenSimplexNodes.cs:11

> **Inherits:** [`FixedNoiseNode`](api-FixedNoiseNode.md#fixednoisenode)
> **Subclassed by:** [`AhahGames.GenesisNoise.Nodes.OpenSimplex2Node`](api-AhahGames-GenesisNoise-Nodes-OpenSimplex2Node.md#opensimplex2node), [`AhahGames.GenesisNoise.Nodes.OpenSimplex2SNode`](api-AhahGames-GenesisNoise-Nodes-OpenSimplex2SNode.md#opensimplex2snode)

## List of all members

| Name | Kind | Owner |
|------|------|-------|
| [`Variant`](#variant-2) | `property` | Declared here |
| [`filteredOutProperties`](#filteredoutproperties-97) | `property` | Declared here |
| [`ProcessNode`](#processnode-90) | `function` | Declared here |
...
|--------|------|-------------|
| `int` | [`Variant`](#variant-2)  |  |
| `override IEnumerable< string >` | [`filteredOutProperties`](#filteredoutproperties-97)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/OpenSimplexNodes.cs:13

---

{#filteredoutproperties-97}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/OpenSimplexNodes.cs:15

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-90) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/OpenSimplexNodes.cs:17
