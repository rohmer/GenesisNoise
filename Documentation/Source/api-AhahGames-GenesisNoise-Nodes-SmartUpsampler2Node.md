...
```cpp
class SmartUpsampler2Node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/SmartUpsampler2Node.cs:12
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-468) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-434) | `property` | Declared here |
| [`ShaderName`](#shadername-347) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-468)  |  |
| `override string` | [`NodeGroup`](#nodegroup-434)  |  |
| `override string` | [`ShaderName`](#shadername-347)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/SmartUpsampler2Node.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/SmartUpsampler2Node.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/SmartUpsampler2Node.cs:16
