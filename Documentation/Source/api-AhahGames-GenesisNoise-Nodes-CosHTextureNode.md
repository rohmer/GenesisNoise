...
```cpp
class CosHTextureNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/CosHTexture.cs:15
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-117) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-98) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-18) | `property` | Declared here |
| [`hasPreview`](#haspreview-22) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-51) | `property` | Declared here |
| [`inputA`](#inputa-11) | `variable` | Declared here |
| [`output`](#output-26) | `variable` | Declared here |
| [`Enable`](#enable-23) | `function` | Declared here |
| [`ProcessNode`](#processnode-33) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-117)  |  |
| `override string` | [`NodeGroup`](#nodegroup-98)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-18)  |  |
| `override bool` | [`hasPreview`](#haspreview-22)  |  |
| `override float` | [`nodeWidth`](#nodewidth-51)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/CosHTexture.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/CosHTexture.cs:23

---

{#showdefaultinspector-18}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/CosHTexture.cs:25
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/CosHTexture.cs:26
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/CosHTexture.cs:27

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `RenderTexture` | [`inputA`](#inputa-11)  |  |
| `RenderTexture` | [`output`](#output-26)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/CosHTexture.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/CosHTexture.cs:21

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-23) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-33) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/CosHTexture.cs:28
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Textures/CosHTexture.cs:34
