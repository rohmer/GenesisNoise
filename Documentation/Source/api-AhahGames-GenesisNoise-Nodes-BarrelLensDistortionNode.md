{#barrellensdistortionnode}

# BarrelLensDistortionNode

```cpp
class BarrelLensDistortionNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/BarrelLensDistortionNode.cs:12
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-46) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-34) | `property` | Declared here |
| [`ShaderName`](#shadername-22) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-46)  |  |
| `override string` | [`NodeGroup`](#nodegroup-34)  |  |
| `override string` | [`ShaderName`](#shadername-22)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/BarrelLensDistortionNode.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/BarrelLensDistortionNode.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/BarrelLensDistortionNode.cs:16
