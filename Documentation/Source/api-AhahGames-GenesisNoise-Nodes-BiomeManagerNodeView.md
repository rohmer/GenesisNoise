{#biomemanagernodeview}

# BiomeManagerNodeView

```cpp
class BiomeManagerNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeManagerNodeView.cs:12
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-8) | `property` | Declared here |
| [`Enable`](#enable-18) | `function` | Declared here |
| [`shader`](#shader) | `variable` | Declared here |
...
```cpp
BiomeManagerNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeManagerNodeView.cs:14

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-18) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeManagerNodeView.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/BiomeManagerNodeView.cs:16
