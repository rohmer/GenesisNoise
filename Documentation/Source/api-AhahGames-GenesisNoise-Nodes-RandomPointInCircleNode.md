...
```cpp
class RandomPointInCircleNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInCircleNode.cs:14
...
| Name | Kind | Owner |
|------|------|-------|
| [`nodeWidth`](#nodewidth-147) | `property` | Declared here |
| [`name`](#name-413) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-382) | `property` | Declared here |
| [`output`](#output-70) | `variable` | Declared here |
| [`pt1`](#pt1-1) | `variable` | Declared here |
| [`radius`](#radius) | `variable` | Declared here |
| [`Process`](#process-11) | `function` | Declared here |
| [`ProcessNode`](#processnode-100) | `function` | Declared here |
...
|--------|------|-------------|
| `override float` | [`nodeWidth`](#nodewidth-147)  |  |
| `override string` | [`name`](#name-413)  |  |
| `override string` | [`NodeGroup`](#nodegroup-382)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInCircleNode.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInCircleNode.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInCircleNode.cs:25

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `Vector2` | [`output`](#output-70)  |  |
| `Vector2` | [`pt1`](#pt1-1)  |  |
| `float` | [`radius`](#radius)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInCircleNode.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInCircleNode.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInCircleNode.cs:22

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Process`](#process-11) `virtual` `inline` | Override this method to implement custom processing. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInCircleNode.cs:26
...
| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-100) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInCircleNode.cs:31
