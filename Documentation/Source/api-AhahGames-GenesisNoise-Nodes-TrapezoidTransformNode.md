{#trapezoidtransformnode}

# TrapezoidTransformNode

```cpp
class TrapezoidTransformNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/TrapezoidTransformNode.cs:25
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-544) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-499) | `property` | Declared here |
| [`ShaderName`](#shadername-391) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-544)  |  |
| `override string` | [`NodeGroup`](#nodegroup-499)  |  |
| `override string` | [`ShaderName`](#shadername-391)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/TrapezoidTransformNode.cs:27
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/TrapezoidTransformNode.cs:28
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/TrapezoidTransformNode.cs:29
