{#terraingaussianblurnode}

# TerrainGaussianBlurNode

```cpp
class TerrainGaussianBlurNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Modifier/TerrainGaussianBlurNode.cs:13
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-511) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-71) | `property` | Declared here |
| [`hasPreview`](#haspreview-82) | `property` | Declared here |
| [`hasSettings`](#hassettings-19) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-175) | `property` | Declared here |
| [`previewTexture`](#previewtexture-43) | `property` | Declared here |
| [`inputHeightField`](#inputheightfield) | `variable` | Declared here |
| [`outputHeightField`](#outputheightfield) | `variable` | Declared here |
| [`ProcessNode`](#processnode-129) | `function` | Declared here |
| [`Disable`](#disable-43) | `function` | Declared here |
| [`preview`](#preview-10) | `variable` | Declared here |
| [`previewRequestVersion`](#previewrequestversion-2) | `variable` | Declared here |
| [`shader`](#shader-3) | `variable` | Declared here |
| [`kernel`](#kernel) | `variable` | Declared here |
| [`RequestPreview`](#requestpreview-2) | `function` | Declared here |
| [`ThreadGroupSize`](#threadgroupsize-1) | `variable` | Declared here |
| [`DestroyPreview`](#destroypreview-2) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-511)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-71)  |  |
| `override bool` | [`hasPreview`](#haspreview-82)  |  |
| `override bool` | [`hasSettings`](#hassettings-19)  |  |
| `override float` | [`nodeWidth`](#nodewidth-175)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-43)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Modifier/TerrainGaussianBlurNode.cs:25

---

{#showdefaultinspector-71}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Modifier/TerrainGaussianBlurNode.cs:26
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Modifier/TerrainGaussianBlurNode.cs:27
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Modifier/TerrainGaussianBlurNode.cs:28
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Modifier/TerrainGaussianBlurNode.cs:29
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Modifier/TerrainGaussianBlurNode.cs:30

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `HeightField` | [`inputHeightField`](#inputheightfield)  |  |
| `HeightField` | [`outputHeightField`](#outputheightfield)  |  |
...
```cpp
HeightField inputHeightField
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Modifier/TerrainGaussianBlurNode.cs:16
...
```cpp
HeightField outputHeightField
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Modifier/TerrainGaussianBlurNode.cs:19

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-129) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-43) `virtual` `inline` | Called when the node is disabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Modifier/TerrainGaussianBlurNode.cs:37
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Modifier/TerrainGaussianBlurNode.cs:103
...
| Return | Name | Description |
|--------|------|-------------|
| `Texture2D` | [`preview`](#preview-10)  |  |
| `int` | [`previewRequestVersion`](#previewrequestversion-2)  |  |
| `ComputeShader` | [`shader`](#shader-3)  |  |
| `int` | [`kernel`](#kernel)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Modifier/TerrainGaussianBlurNode.cs:32

---

{#previewrequestversion-2}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Modifier/TerrainGaussianBlurNode.cs:33
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Modifier/TerrainGaussianBlurNode.cs:34
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Modifier/TerrainGaussianBlurNode.cs:35

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RequestPreview`](#requestpreview-2) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Modifier/TerrainGaussianBlurNode.cs:82

## Private Static Attributes

| Return | Name | Description |
|--------|------|-------------|
| `const int` | [`ThreadGroupSize`](#threadgroupsize-1) `static` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Modifier/TerrainGaussianBlurNode.cs:23

## Private Static Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`DestroyPreview`](#destroypreview-2) `static` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Modifier/TerrainGaussianBlurNode.cs:113
