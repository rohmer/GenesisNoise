{#directionalnoise2node}

# DirectionalNoise2Node

```cpp
class DirectionalNoise2Node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/DirectionalNoise2Node.cs:17
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-144) | `property` | Declared here |
| [`ShaderName`](#shadername-101) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-125) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-144)  |  |
| `override string` | [`ShaderName`](#shadername-101)  |  |
| `override string` | [`NodeGroup`](#nodegroup-125)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/DirectionalNoise2Node.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/DirectionalNoise2Node.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/DirectionalNoise2Node.cs:21
