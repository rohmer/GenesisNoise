...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/WhileEnd.cs:12

> **Inherits:** [`AhahGames.GenesisNoise.Nodes.ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend)

## List of all members

| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-586) | `property` | Declared here |
| [`name`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#name-203) | `property` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`NodeGroup`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#nodegroup-181) | `property` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`hasPreview`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#haspreview-29) | `property` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`hasSettings`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#hassettings-9) | `property` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`showDefaultInspector`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#showdefaultinspector-25) | `property` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`input`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#input-12) | `variable` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`output`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#output-36) | `variable` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`mode`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#mode-13) | `variable` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`InputPortType`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#inputporttype-4) | `function` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`OutputPortType`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#outputporttype-6) | `function` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`PrepareNewIteration`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#preparenewiteration) | `function` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`PrepareLoopEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#prepareloopend-1) | `function` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`FinalIteration`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#finaliteration-1) | `function` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`Enable`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#enable-31) | `function` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`ProcessNode`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#processnode-47) | `function` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`Disable`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#disable-15) | `function` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`AggregationMode`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#aggregationmode) | `enum` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`loopStart`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#loopstart) | `variable` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`loopStartGUID`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#loopstartguid-1) | `variable` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`doubleBufferForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#doublebufferforend) | `variable` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`inputMeshes`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#inputmeshes) | `variable` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`RegisterLoopStart`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#registerloopstart-1) | `function` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`UnregisterLoopStart`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#unregisterloopstart-1) | `function` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`EdgeConnectionCallback`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#edgeconnectioncallback-1) | `function` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`FeedbackInputToStartNode`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#feedbackinputtostartnode) | `function` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
| [`RemoveTransientGeneratedObjects`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#removetransientgeneratedobjects) | `function` | Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend) |
...
| [`PrepareLoopEnd`](api-AhahGames-GenesisNoise-Nodes.md#prepareloopend-2) | `function` | Inherited from [`ILoopEnd`](api-AhahGames-GenesisNoise-Nodes-ILoopEnd.md#iloopend) |
| [`FinalIteration`](api-AhahGames-GenesisNoise-Nodes.md#finaliteration-2) | `function` | Inherited from [`ILoopEnd`](api-AhahGames-GenesisNoise-Nodes-ILoopEnd.md#iloopend) |

## Inherited from [`ForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#forend)

| Kind | Name | Description |
|------|------|-------------|
| `property` | [`name`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#name-203)  |  |
| `property` | [`NodeGroup`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#nodegroup-181)  |  |
| `property` | [`hasPreview`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#haspreview-29)  |  |
| `property` | [`hasSettings`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#hassettings-9)  |  |
| `property` | [`showDefaultInspector`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#showdefaultinspector-25)  |  |
| `variable` | [`input`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#input-12)  |  |
| `variable` | [`output`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#output-36)  |  |
| `variable` | [`mode`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#mode-13)  |  |
| `function` | [`InputPortType`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#inputporttype-4) `inline` |  |
| `function` | [`OutputPortType`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#outputporttype-6) `inline` |  |
| `function` | [`PrepareNewIteration`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#preparenewiteration) `inline` |  |
| `function` | [`PrepareLoopEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#prepareloopend-1) `inline` | Function executed the first time a Loop end is encountered. I.e. at the end of the first loop iteration. |
| `function` | [`FinalIteration`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#finaliteration-1) `inline` |  |
| `function` | [`Enable`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#enable-31) `virtual` `inline` | Called when the node is enabled. |
| `function` | [`ProcessNode`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#processnode-47) `virtual` `inline` |  |
| `function` | [`Disable`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#disable-15) `virtual` `inline` | Called when the node is disabled. |
| `enum` | [`AggregationMode`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#aggregationmode)  |  |
| `variable` | [`loopStart`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#loopstart)  |  |
| `variable` | [`loopStartGUID`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#loopstartguid-1)  |  |
| `variable` | [`doubleBufferForEnd`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#doublebufferforend)  |  |
| `variable` | [`inputMeshes`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#inputmeshes)  |  |
| `function` | [`RegisterLoopStart`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#registerloopstart-1) `inline` |  |
| `function` | [`UnregisterLoopStart`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#unregisterloopstart-1) `inline` |  |
| `function` | [`EdgeConnectionCallback`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#edgeconnectioncallback-1) `inline` |  |
| `function` | [`FeedbackInputToStartNode`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#feedbackinputtostartnode) `inline` |  |
| `function` | [`RemoveTransientGeneratedObjects`](api-AhahGames-GenesisNoise-Nodes-ForEnd.md#removetransientgeneratedobjects) `inline` |  |
...
## Inherited from [`ILoopEnd`](api-AhahGames-GenesisNoise-Nodes-ILoopEnd.md#iloopend)

| Kind | Name | Description |
|------|------|-------------|
| `function` | [`PrepareLoopEnd`](api-AhahGames-GenesisNoise-Nodes.md#prepareloopend-2)  | Function executed the first time a Loop end is encountered. I.e. at the end of the first loop iteration. |
| `function` | [`FinalIteration`](api-AhahGames-GenesisNoise-Nodes.md#finaliteration-2)  |  |

## Properties

| Return | Name | Description |
|--------|------|-------------|
| `override string` | [`name`](#name-586)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/WhileEnd.cs:14
