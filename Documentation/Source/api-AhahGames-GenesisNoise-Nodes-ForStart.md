...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForStart.cs:16
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-204) | `property` | Declared here |
| [`hasPreview`](#haspreview-30) | `property` | Declared here |
| [`hasSettings`](#hassettings-10) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-26) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-67) | `property` | Declared here |
| [`CurrentLoopValue`](#currentloopvalue-1) | `property` | Declared here |
| [`input`](#input-13) | `variable` | Declared here |
| [`inputCount`](#inputcount) | `variable` | Declared here |
| [`output`](#output-37) | `variable` | Declared here |
| [`index`](#index-1) | `variable` | Declared here |
| [`outputCount`](#outputcount-1) | `variable` | Declared here |
| [`InputPortType`](#inputporttype-5) | `function` | Declared here |
| [`OutputPortType`](#outputporttype-7) | `function` | Declared here |
| [`GatherNodesInLoop`](#gathernodesinloop) | `function` | Declared here |
| [`IsLastIteration`](#islastiteration-1) | `function` | Declared here |
| [`GetLoopValueType`](#getloopvaluetype-1) | `function` | Declared here |
| [`PrepareLoopStart`](#prepareloopstart-1) | `function` | Declared here |
| [`ProcessNode`](#processnode-48) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-204)  |  |
| `override bool` | [`hasPreview`](#haspreview-30)  |  |
| `override bool` | [`hasSettings`](#hassettings-10)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-26)  |  |
| `override float` | [`nodeWidth`](#nodewidth-67)  |  |
| `object` | [`CurrentLoopValue`](#currentloopvalue-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForStart.cs:37
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForStart.cs:39
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForStart.cs:40

---

{#showdefaultinspector-26}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForStart.cs:41
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForStart.cs:42
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForStart.cs:44
...
| Return | Name | Description |
|--------|------|-------------|
| `object` | [`input`](#input-13)  |  |
| `int` | [`inputCount`](#inputcount)  |  |
| `object` | [`output`](#output-37)  |  |
| `int` | [`index`](#index-1)  |  |
| `int` | [`outputCount`](#outputcount-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForStart.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForStart.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForStart.cs:25
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForStart.cs:29
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForStart.cs:32

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `IEnumerable< PortData >` | [`InputPortType`](#inputporttype-5) `inline` |  |
| `IEnumerable< PortData >` | [`OutputPortType`](#outputporttype-7) `inline` |  |
| `HashSet< BaseNode >` | [`GatherNodesInLoop`](#gathernodesinloop) `inline` |  |
| `bool` | [`IsLastIteration`](#islastiteration-1) `inline` |  |
| `Type` | [`GetLoopValueType`](#getloopvaluetype-1) `inline` |  |
| `void` | [`PrepareLoopStart`](#prepareloopstart-1) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForStart.cs:51
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForStart.cs:57
...
```cpp
inline HashSet< BaseNode > GatherNodesInLoop()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForStart.cs:68
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForStart.cs:102
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForStart.cs:104
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForStart.cs:106
...
| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-48) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/ForStart.cs:96
