...
```cpp
class TerrainSlopeNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainSlopeNode.cs:16
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-602) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-85) | `property` | Declared here |
| [`hasPreview`](#haspreview-98) | `property` | Declared here |
| [`hasSettings`](#hassettings-29) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-214) | `property` | Declared here |
| [`previewTexture`](#previewtexture-60) | `property` | Declared here |
| [`TerrainInput`](#terraininput-3) | `variable` | Declared here |
| [`SlopeMap`](#slopemap-1) | `variable` | Declared here |
| [`Enable`](#enable-195) | `function` | Declared here |
| [`ProcessNode`](#processnode-148) | `function` | Declared here |
| [`Disable`](#disable-82) | `function` | Declared here |
| [`preview`](#preview-20) | `variable` | Declared here |
| [`previewRequestVersion`](#previewrequestversion-7) | `variable` | Declared here |
| [`shader`](#shader-10) | `variable` | Declared here |
| [`kernel`](#kernel-4) | `variable` | Declared here |
| [`RequestPreview`](#requestpreview-8) | `function` | Declared here |
| [`ThreadGroupSize`](#threadgroupsize-7) | `variable` | Declared here |
| [`DestroyPreview`](#destroypreview-6) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-602)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-85)  |  |
| `override bool` | [`hasPreview`](#haspreview-98)  |  |
| `override bool` | [`hasSettings`](#hassettings-29)  |  |
| `override float` | [`nodeWidth`](#nodewidth-214)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-60)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainSlopeNode.cs:36

---

{#showdefaultinspector-85}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainSlopeNode.cs:37
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainSlopeNode.cs:38
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainSlopeNode.cs:39
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainSlopeNode.cs:40
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainSlopeNode.cs:41

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `HeightField` | [`TerrainInput`](#terraininput-3)  |  |
| `RenderTexture` | [`SlopeMap`](#slopemap-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainSlopeNode.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainSlopeNode.cs:22

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-195) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-148) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-82) `virtual` `inline` | Called when the node is disabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainSlopeNode.cs:43
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainSlopeNode.cs:49
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainSlopeNode.cs:110
...
| Return | Name | Description |
|--------|------|-------------|
| `Texture2D` | [`preview`](#preview-20)  |  |
| `int` | [`previewRequestVersion`](#previewrequestversion-7)  |  |
| `ComputeShader` | [`shader`](#shader-10)  |  |
| `int` | [`kernel`](#kernel-4)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainSlopeNode.cs:29

---

{#previewrequestversion-7}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainSlopeNode.cs:30
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainSlopeNode.cs:31
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainSlopeNode.cs:32

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RequestPreview`](#requestpreview-8) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainSlopeNode.cs:89

## Private Static Attributes

| Return | Name | Description |
|--------|------|-------------|
| `const int` | [`ThreadGroupSize`](#threadgroupsize-7) `static` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainSlopeNode.cs:34

## Private Static Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`DestroyPreview`](#destroypreview-6) `static` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Data/TerrainSlopeNode.cs:119
