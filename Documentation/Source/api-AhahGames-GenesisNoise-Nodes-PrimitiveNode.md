...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:17

> **Inherits:** [`AhahGames.GenesisNoise.Nodes.GenesisNode`](api-AhahGames-GenesisNoise-Nodes-GenesisNode.md#genesisnode), [`AhahGames.GenesisNoise.Nodes.INeedLoopRunReset`](api-AhahGames-GenesisNoise-Nodes-INeedLoopRunReset.md#ineedlooprunreset), [`AhahGames.GenesisNoise.Nodes.IGeneratedMeshObjectCleanup`](api-AhahGames-GenesisNoise-Nodes-IGeneratedMeshObjectCleanup.md#igeneratedmeshobjectcleanup)

## List of all members

| Name | Kind | Owner |
|------|------|-------|
| [`hasPreview`](#haspreview-65) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-371) | `property` | Declared here |
| [`name`](#name-402) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-56) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-140) | `property` | Declared here |
| [`previewTexture`](#previewtexture-38) | `property` | Declared here |
| [`loopInput`](#loopinput-10) | `variable` | Declared here |
| [`output`](#output-65) | `variable` | Declared here |
| [`primitiveType`](#primitivetype-6) | `variable` | Declared here |
| [`primitiveName`](#primitivename) | `variable` | Declared here |
| [`PrepareNewLoopRun`](#preparenewlooprun-7) | `function` | Declared here |
| [`SetPrimitive`](#setprimitive) | `function` | Declared here |
| [`RemoveTransientGeneratedObjects`](#removetransientgeneratedobjects-2) | `function` | Declared here |
| [`Enable`](#enable-64) | `function` | Declared here |
| [`ProcessNode`](#processnode-96) | `function` | Declared here |
| [`ePrimitiveType`](#eprimitivetype) | `enum` | Declared here |
| [`loopOutputs`](#loopoutputs) | `variable` | Declared here |
| [`loopRunPrepared`](#looprunprepared) | `variable` | Declared here |
| [`primitiveSourceMesh`](#primitivesourcemesh) | `variable` | Declared here |
| [`PrepareLoopPrimitiveRun`](#prepareloopprimitiverun) | `function` | Declared here |
| [`EnsurePrimitive`](#ensureprimitive) | `function` | Declared here |
| [`CreatePrimitiveObject`](#createprimitiveobject) | `function` | Declared here |
| [`RestorePrimitiveSource`](#restoreprimitivesource) | `function` | Declared here |
| [`GetPrimitiveObjectName`](#getprimitiveobjectname) | `function` | Declared here |
| [`ClearLoopOutputs`](#clearloopoutputs) | `function` | Declared here |
| [`MarkGeneratedObject`](#markgeneratedobject) | `function` | Declared here |
| [`ClearMarkedGeneratedObjects`](#clearmarkedgeneratedobjects) | `function` | Declared here |
| [`UpdatePreview`](#updatepreview-3) | `function` | Declared here |
| [`IsLoopMode`](#isloopmode-6) | `function` | Declared here |
| [`IsFinalOutput`](#isfinaloutput) | `function` | Declared here |
...
| [`RemoveTransientGeneratedObjects`](api-AhahGames-GenesisNoise-Nodes.md#removetransientgeneratedobjects-1) | `function` | Inherited from [`IGeneratedMeshObjectCleanup`](api-AhahGames-GenesisNoise-Nodes-IGeneratedMeshObjectCleanup.md#igeneratedmeshobjectcleanup) |
...
## Inherited from [`IGeneratedMeshObjectCleanup`](api-AhahGames-GenesisNoise-Nodes-IGeneratedMeshObjectCleanup.md#igeneratedmeshobjectcleanup)

| Kind | Name | Description |
|------|------|-------------|
| `function` | [`RemoveTransientGeneratedObjects`](api-AhahGames-GenesisNoise-Nodes.md#removetransientgeneratedobjects-1)  |  |

## Properties

| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`hasPreview`](#haspreview-65)  |  |
| `override string` | [`NodeGroup`](#nodegroup-371)  |  |
| `override string` | [`name`](#name-402)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-56)  |  |
| `override float` | [`nodeWidth`](#nodewidth-140)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-38)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:42
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:43
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:44

---

{#showdefaultinspector-56}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:45
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:46
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:53

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `object` | [`loopInput`](#loopinput-10)  |  |
| `GameObject` | [`output`](#output-65)  |  |
| `ePrimitiveType` | [`primitiveType`](#primitivetype-6)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:28
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:39
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:40

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`PrepareNewLoopRun`](#preparenewlooprun-7) `inline` |  |
| `void` | [`SetPrimitive`](#setprimitive) `inline` |  |
| `void` | [`RemoveTransientGeneratedObjects`](#removetransientgeneratedobjects-2) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:83
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:112

---

{#removetransientgeneratedobjects-2}

### RemoveTransientGeneratedObjects

`inline`

```cpp
inline void RemoveTransientGeneratedObjects(GameObject finalOutput)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:201

#### Reimplements

- [`RemoveTransientGeneratedObjects`](api-AhahGames-GenesisNoise-Nodes.md#removetransientgeneratedobjects-1)

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-64) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-96) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:54
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:61
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:30
...
| Return | Name | Description |
|--------|------|-------------|
| `readonly List< GameObject >` | [`loopOutputs`](#loopoutputs)  |  |
| `bool` | [`loopRunPrepared`](#looprunprepared)  |  |
| `Mesh` | [`primitiveSourceMesh`](#primitivesourcemesh)  |  |
...
```cpp
readonly List< GameObject > loopOutputs = new()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:48
...
```cpp
bool loopRunPrepared
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:49
...
```cpp
Mesh primitiveSourceMesh
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:50

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`PrepareLoopPrimitiveRun`](#prepareloopprimitiverun) `inline` |  |
| `void` | [`EnsurePrimitive`](#ensureprimitive) `inline` |  |
| `GameObject` | [`CreatePrimitiveObject`](#createprimitiveobject) `inline` |  |
| `void` | [`RestorePrimitiveSource`](#restoreprimitivesource) `inline` |  |
| `string` | [`GetPrimitiveObjectName`](#getprimitiveobjectname) `inline` |  |
| `void` | [`ClearLoopOutputs`](#clearloopoutputs) `inline` |  |
| `void` | [`MarkGeneratedObject`](#markgeneratedobject) `inline` |  |
| `void` | [`ClearMarkedGeneratedObjects`](#clearmarkedgeneratedobjects) `inline` |  |
| `void` | [`UpdatePreview`](#updatepreview-3) `inline` |  |
| `bool` | [`IsLoopMode`](#isloopmode-6) `inline` |  |

---

{#prepareloopprimitiverun}
...
```cpp
inline void PrepareLoopPrimitiveRun()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:91
...
```cpp
inline void EnsurePrimitive()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:104
...
```cpp
inline GameObject CreatePrimitiveObject(string nameSuffix)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:123

---

{#restoreprimitivesource}
...
```cpp
inline void RestorePrimitiveSource(GameObject primitive)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:160

---

{#getprimitiveobjectname}
...
```cpp
inline string GetPrimitiveObjectName(string nameSuffix)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:184
...
```cpp
inline void ClearLoopOutputs()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:190
...
```cpp
inline void MarkGeneratedObject(GameObject generatedObject)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:230

---

{#clearmarkedgeneratedobjects}
...
```cpp
inline void ClearMarkedGeneratedObjects(GameObject finalOutput)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:242
...
```cpp
inline void UpdatePreview(GameObject primitive)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:268
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:274

## Private Static Methods

| Return | Name | Description |
|--------|------|-------------|
| `bool` | [`IsFinalOutput`](#isfinaloutput) `static` `inline` |  |
...
```cpp
static inline bool IsFinalOutput(GameObject generatedObject, GameObject finalOutput)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/PrimitiveNode.cs:255
