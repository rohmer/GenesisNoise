{#hdrplayeredlitmaterial}

# HDRPLayeredLitMaterial

```cpp
class HDRPLayeredLitMaterial
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:11
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-250) | `property` | Declared here |
| [`hasPreview`](#haspreview-33) | `property` | Declared here |
| [`previewTexture`](#previewtexture-14) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-226) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-90) | `property` | Declared here |
| [`MaterialOutput`](#materialoutput-1) | `property` | Declared here |
| [`asset`](#asset-2) | `variable` | Declared here |
| [`primitiveType`](#primitivetype-1) | `variable` | Declared here |
| [`baseColor0`](#basecolor0) | `variable` | Declared here |
| [`baseColor1`](#basecolor1) | `variable` | Declared here |
| [`baseColor2`](#basecolor2) | `variable` | Declared here |
| [`baseColor3`](#basecolor3) | `variable` | Declared here |
| [`metallicAmount`](#metallicamount) | `variable` | Declared here |
| [`smoothnessAmount`](#smoothnessamount) | `variable` | Declared here |
| [`layerCount`](#layercount) | `variable` | Declared here |
| [`Render`](#render-1) | `function` | Declared here |
| [`Enable`](#enable-35) | `function` | Declared here |
| [`baseMap0`](#basemap0) | `variable` | Declared here |
| [`baseMap1`](#basemap1) | `variable` | Declared here |
| [`baseMap2`](#basemap2) | `variable` | Declared here |
| [`baseMap3`](#basemap3) | `variable` | Declared here |
| [`OutputMaterial`](#outputmaterial-1) | `variable` | Declared here |
| [`preview`](#preview-2) | `variable` | Declared here |
| [`ApplyLayeredProperties`](#applylayeredproperties) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-250)  |  |
| `override bool` | [`hasPreview`](#haspreview-33)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-14)  |  |
| `override string` | [`NodeGroup`](#nodegroup-226)  |  |
| `override float` | [`nodeWidth`](#nodewidth-90)  |  |
| `Material` | [`MaterialOutput`](#materialoutput-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:25
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:26
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:29

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `Material` | [`asset`](#asset-2)  |  |
| `PrimitiveType` | [`primitiveType`](#primitivetype-1)  |  |
| `Color` | [`baseColor0`](#basecolor0)  |  |
| `Color` | [`baseColor1`](#basecolor1)  |  |
| `Color` | [`baseColor2`](#basecolor2)  |  |
| `Color` | [`baseColor3`](#basecolor3)  |  |
| `float` | [`metallicAmount`](#metallicamount)  |  |
| `float` | [`smoothnessAmount`](#smoothnessamount)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:28
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:31
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:32
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:33
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:34
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:35
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:36
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:37
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:38

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`Render`](#render-1) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:74

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-35) `virtual` `inline` | Called when the node is enabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:40
...
| Return | Name | Description |
|--------|------|-------------|
| `Texture` | [`baseMap0`](#basemap0)  |  |
| `Texture` | [`baseMap1`](#basemap1)  |  |
| `Texture` | [`baseMap2`](#basemap2)  |  |
| `Texture` | [`baseMap3`](#basemap3)  |  |
| `Material` | [`OutputMaterial`](#outputmaterial-1)  |  |
| `Texture2D` | [`preview`](#preview-2)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:13
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:16
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:21

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`ApplyLayeredProperties`](#applylayeredproperties) `inline` |  |

---

{#applylayeredproperties}
...
```cpp
inline void ApplyLayeredProperties(Material mat, string shaderName)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Material/HDRP/HDRPLayeredLitMaterial.cs:47
