{#terrainslopenodeview}

# TerrainSlopeNodeView

```cpp
class TerrainSlopeNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainSlopeNodeView.cs:13
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-65) | `property` | Declared here |
| [`Enable`](#enable-163) | `function` | Declared here |
| [`heightScale`](#heightscale-3) | `variable` | Declared here |
| [`cellSize`](#cellsize-1) | `variable` | Declared here |
| [`maxSlope`](#maxslope-2) | `variable` | Declared here |
| [`sampleRadius`](#sampleradius-1) | `variable` | Declared here |
...
```cpp
TerrainSlopeNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainSlopeNodeView.cs:15

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-163) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainSlopeNodeView.cs:22
...
| Return | Name | Description |
|--------|------|-------------|
| `Slider` | [`heightScale`](#heightscale-3)  |  |
| `Slider` | [`cellSize`](#cellsize-1)  |  |
| `Slider` | [`maxSlope`](#maxslope-2)  |  |
| `SliderInt` | [`sampleRadius`](#sampleradius-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainSlopeNodeView.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainSlopeNodeView.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainSlopeNodeView.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainSlopeNodeView.cs:20
