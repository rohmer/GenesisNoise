{#hdrplittessellationmaterialnodeview}

# HDRPLitTessellationMaterialNodeView

```cpp
class HDRPLitTessellationMaterialNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/HDRP/HDRPLitTessellationMaterialNodeView.cs:14
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-24) | `property` | Declared here |
| [`Enable`](#enable-117) | `function` | Declared here |
...
|--------|------|-------------|
| `HDRPLitTessellationMaterial` | [`node`](#node-24)  |  |
...
```cpp
HDRPLitTessellationMaterial node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/HDRP/HDRPLitTessellationMaterialNodeView.cs:16

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-117) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/HDRP/HDRPLitTessellationMaterialNodeView.cs:18
