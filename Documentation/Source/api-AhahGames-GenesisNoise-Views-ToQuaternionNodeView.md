{#toquaternionnodeview}

# ToQuaternionNodeView

```cpp
class ToQuaternionNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Cast/ToQuaternionNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-74) | `property` | Declared here |
| [`Enable`](#enable-174) | `function` | Declared here |
| [`field`](#field-3) | `variable` | Declared here |
| [`UpdateLabel`](#updatelabel-19) | `function` | Declared here |
...
```cpp
ToQuaternionNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Cast/ToQuaternionNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-174) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Cast/ToQuaternionNodeView.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Cast/ToQuaternionNodeView.cs:13

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`UpdateLabel`](#updatelabel-19) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Cast/ToQuaternionNodeView.cs:33
