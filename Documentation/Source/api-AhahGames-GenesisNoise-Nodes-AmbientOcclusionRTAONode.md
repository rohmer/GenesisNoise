{#ambientocclusionrtaonode}

# AmbientOcclusionRTAONode

```cpp
class AmbientOcclusionRTAONode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/AmbientOcclusionRTAONode.cs:15
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-23) | `property` | Declared here |
| [`ShaderName`](#shadername-7) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-11) | `property` | Declared here |
| [`DisplayMaterialInspector`](#displaymaterialinspector-5) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-4) | `property` | Declared here |
| [`filteredOutProperties`](#filteredoutproperties-5) | `property` | Declared here |
| [`defaultSettings`](#defaultsettings-1) | `property` | Declared here |
| [`supportedDimensions`](#supporteddimensions-2) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-23)  |  |
| `override string` | [`ShaderName`](#shadername-7)  |  |
| `override string` | [`NodeGroup`](#nodegroup-11)  |  |
| `override bool` | [`DisplayMaterialInspector`](#displaymaterialinspector-5)  |  |
| `override float` | [`nodeWidth`](#nodewidth-4)  |  |
| `override IEnumerable< string >` | [`filteredOutProperties`](#filteredoutproperties-5)  |  |
| `override GenesisNoiseSettings` | [`defaultSettings`](#defaultsettings-1)  |  |
| `override List< OutputDimension >` | [`supportedDimensions`](#supporteddimensions-2)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/AmbientOcclusionRTAONode.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/AmbientOcclusionRTAONode.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/AmbientOcclusionRTAONode.cs:19

---

{#displaymaterialinspector-5}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/AmbientOcclusionRTAONode.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/AmbientOcclusionRTAONode.cs:21

---

{#filteredoutproperties-5}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/AmbientOcclusionRTAONode.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/AmbientOcclusionRTAONode.cs:25
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/AmbientOcclusionRTAONode.cs:27
