{#meshsmoothingnodeview}

# MeshSmoothingNodeView

```cpp
class MeshSmoothingNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshSmoothingNodeView.cs:11
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-36) | `property` | Declared here |
| [`Enable`](#enable-131) | `function` | Declared here |
| [`iterations`](#iterations-3) | `variable` | Declared here |
| [`strength`](#strength-1) | `variable` | Declared here |
| [`preserveBorders`](#preserveborders-1) | `variable` | Declared here |
| [`removePointedVertices`](#removepointedvertices-1) | `variable` | Declared here |
| [`pointedVertexThreshold`](#pointedvertexthreshold) | `variable` | Declared here |
| [`recalculateNormals`](#recalculatenormals-3) | `variable` | Declared here |
...
|--------|------|-------------|
| `MeshSmoothingNode` | [`node`](#node-36)  |  |
...
```cpp
MeshSmoothingNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshSmoothingNodeView.cs:13

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-131) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshSmoothingNodeView.cs:22

## Private Attributes

| Return | Name | Description |
|--------|------|-------------|
| `SliderInt` | [`iterations`](#iterations-3)  |  |
| `Slider` | [`strength`](#strength-1)  |  |
| `Toggle` | [`preserveBorders`](#preserveborders-1)  |  |
| `Toggle` | [`removePointedVertices`](#removepointedvertices-1)  |  |
| `Slider` | [`pointedVertexThreshold`](#pointedvertexthreshold)  |  |
| `Toggle` | [`recalculateNormals`](#recalculatenormals-3)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshSmoothingNodeView.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshSmoothingNodeView.cs:16
...
```cpp
Toggle preserveBorders
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshSmoothingNodeView.cs:17

---

{#removepointedvertices-1}

### removePointedVertices

```cpp
Toggle removePointedVertices
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshSmoothingNodeView.cs:18

---

{#pointedvertexthreshold}

### pointedVertexThreshold

```cpp
Slider pointedVertexThreshold
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshSmoothingNodeView.cs:19

---

{#recalculatenormals-3}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshSmoothingNodeView.cs:20
