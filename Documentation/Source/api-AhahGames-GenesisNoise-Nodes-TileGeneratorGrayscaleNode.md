{#tilegeneratorgrayscalenode}

# TileGeneratorGrayscaleNode

```cpp
class TileGeneratorGrayscaleNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorGrayscaleNode.cs:39
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-525) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-482) | `property` | Declared here |
| [`ShaderName`](#shadername-383) | `property` | Declared here |
| [`DisplayMaterialInspector`](#displaymaterialinspector-173) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-183) | `property` | Declared here |
| [`filteredOutProperties`](#filteredoutproperties-129) | `property` | Declared here |
| [`defaultSettings`](#defaultsettings-34) | `property` | Declared here |
| [`supportedDimensions`](#supporteddimensions-32) | `property` | Declared here |
| [`pattern`](#pattern-1) | `variable` | Declared here |
| [`ProcessNode`](#processnode-138) | `function` | Declared here |
| [`PatternProperty`](#patternproperty-1) | `variable` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-525)  |  |
| `override string` | [`NodeGroup`](#nodegroup-482)  |  |
| `override string` | [`ShaderName`](#shadername-383)  |  |
| `override bool` | [`DisplayMaterialInspector`](#displaymaterialinspector-173)  |  |
| `override float` | [`nodeWidth`](#nodewidth-183)  |  |
| `override IEnumerable< string >` | [`filteredOutProperties`](#filteredoutproperties-129)  |  |
| `override GenesisNoiseSettings` | [`defaultSettings`](#defaultsettings-34)  |  |
| `override List< OutputDimension >` | [`supportedDimensions`](#supporteddimensions-32)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorGrayscaleNode.cs:70
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorGrayscaleNode.cs:71
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorGrayscaleNode.cs:72

---

{#displaymaterialinspector-173}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorGrayscaleNode.cs:73
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorGrayscaleNode.cs:74

---

{#filteredoutproperties-129}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorGrayscaleNode.cs:76
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorGrayscaleNode.cs:78

---

{#supporteddimensions-32}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorGrayscaleNode.cs:80

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `TileGeneratorGrayscalePattern` | [`pattern`](#pattern-1)  |  |
...
```cpp
TileGeneratorGrayscalePattern pattern = TileGeneratorGrayscalePattern.Square
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorGrayscaleNode.cs:41

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-138) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorGrayscaleNode.cs:85
...
| Return | Name | Description |
|--------|------|-------------|
| `const string` | [`PatternProperty`](#patternproperty-1) `static` |  |
...
```cpp
const string PatternProperty = "_PatternType"
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Tiling/TileGeneratorGrayscaleNode.cs:43
