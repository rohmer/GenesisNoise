{#genesischannelmaskdrawer}

# GenesisChannelMaskDrawer

```cpp
class GenesisChannelMaskDrawer
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisChannelMaskDrawer.cs:7
...
| Name | Kind | Owner |
|------|------|-------|
| [`DrawerGUI`](#drawergui-4) | `function` | Declared here |
| [`displayedOptions`](#displayedoptions) | `variable` | Declared here |
...
|--------|------|-------------|
| `override void` | [`DrawerGUI`](#drawergui-4) `inline` |  |
...
```cpp
inline override void DrawerGUI(Rect position, MaterialProperty prop, string label, MaterialEditor editor, Graph.GenesisGraph graph, Views.GenesisNodeView nodeView)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisChannelMaskDrawer.cs:9

## Private Static Attributes

| Return | Name | Description |
|--------|------|-------------|
| `string[]` | [`displayedOptions`](#displayedoptions) `static` |  |
...
```cpp
string[] displayedOptions = { "Red", "Green", "Blue", "Alpha" }
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/PropertyDrawers/GenesisChannelMaskDrawer.cs:24
