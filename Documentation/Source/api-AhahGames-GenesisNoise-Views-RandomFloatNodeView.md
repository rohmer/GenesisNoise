...
```cpp
class RandomFloatNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomFloatNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-47) | `property` | Declared here |
| [`Enable`](#enable-144) | `function` | Declared here |
| [`Disable`](#disable-66) | `function` | Declared here |
| [`min`](#min-63) | `variable` | Declared here |
| [`max`](#max-63) | `variable` | Declared here |
| [`RefreshOutputs`](#refreshoutputs-9) | `function` | Declared here |
...
```cpp
RandomFloatNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomFloatNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-144) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-66) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomFloatNodeView.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomFloatNodeView.cs:44
...
| Return | Name | Description |
|--------|------|-------------|
| `FloatField` | [`min`](#min-63)  |  |
| `FloatField` | [`max`](#max-63)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomFloatNodeView.cs:13
...
| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RefreshOutputs`](#refreshoutputs-9) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomFloatNodeView.cs:50
