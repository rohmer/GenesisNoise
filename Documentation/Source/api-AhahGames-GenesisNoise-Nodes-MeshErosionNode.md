...
```cpp
class MeshErosionNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:19
...
| Name | Kind | Owner |
|------|------|-------|
| [`hasPreview`](#haspreview-53) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-300) | `property` | Declared here |
| [`name`](#name-327) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-38) | `property` | Declared here |
| [`canUseUpstreamCaching`](#canuseupstreamcaching-3) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-119) | `property` | Declared here |
| [`previewTexture`](#previewtexture-22) | `property` | Declared here |
| [`loopInput`](#loopinput-1) | `variable` | Declared here |
| [`loopOutput`](#loopoutput-1) | `variable` | Declared here |
| [`input`](#input-15) | `variable` | Declared here |
| [`output`](#output-47) | `variable` | Declared here |
| [`PrepareNewLoopRun`](#preparenewlooprun-1) | `function` | Declared here |
| [`Enable`](#enable-48) | `function` | Declared here |
| [`Disable`](#disable-25) | `function` | Declared here |
| [`ProcessNode`](#processnode-71) | `function` | Declared here |
| [`meshStates`](#meshstates) | `variable` | Declared here |
| [`TryGetInputMesh`](#trygetinputmesh) | `function` | Declared here |
| [`ResolveCurrentInputMesh`](#resolvecurrentinputmesh) | `function` | Declared here |
| [`RestoreOriginalMesh`](#restoreoriginalmesh) | `function` | Declared here |
| [`ApplyOutputMesh`](#applyoutputmesh) | `function` | Declared here |
| [`UpdatePreview`](#updatepreview-1) | `function` | Declared here |
| [`ClearGeneratedMeshes`](#cleargeneratedmeshes) | `function` | Declared here |
| [`IsLoopMode`](#isloopmode) | `function` | Declared here |
| [`ReadMeshData`](#readmeshdata) | `function` | Declared here |
| [`CpuErosionTimeoutMs`](#cpuerosiontimeoutms) | `variable` | Declared here |
| [`RefreshCollider`](#refreshcollider) | `function` | Declared here |
| [`ErodeMeshData`](#erodemeshdata) | `function` | Declared here |
| [`BuildAdjacency`](#buildadjacency) | `function` | Declared here |
| [`AddNeighbor`](#addneighbor) | `function` | Declared here |
| [`CountEdge`](#countedge) | `function` | Declared here |
| [`BuildUnityMesh`](#buildunitymesh) | `function` | Declared here |
...
|--------|------|-------------|
| `override bool` | [`hasPreview`](#haspreview-53)  |  |
| `override string` | [`NodeGroup`](#nodegroup-300)  |  |
| `override string` | [`name`](#name-327)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-38)  |  |
| `override bool` | [`canUseUpstreamCaching`](#canuseupstreamcaching-3)  |  |
| `override float` | [`nodeWidth`](#nodewidth-119)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-22)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:43
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:44
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:45

---

{#showdefaultinspector-38}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:46

---

{#canuseupstreamcaching-3}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:47
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:48
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:51

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `object` | [`loopInput`](#loopinput-1)  |  |
| `object` | [`loopOutput`](#loopoutput-1)  |  |
| `GameObject` | [`input`](#input-15)  |  |
| `GameObject` | [`output`](#output-47)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:26
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:29
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:32

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`PrepareNewLoopRun`](#preparenewlooprun-1) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:65
...
| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-48) `virtual` `inline` | Called when the node is enabled. |
| `override void` | [`Disable`](#disable-25) `virtual` `inline` | Called when the node is disabled. |
| `override bool` | [`ProcessNode`](#processnode-71) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:53
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:59
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:71
...
| Return | Name | Description |
|--------|------|-------------|
| `readonly Dictionary< GameObject, MeshState >` | [`meshStates`](#meshstates)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:41

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `bool` | [`TryGetInputMesh`](#trygetinputmesh) `inline` |  |
| `Mesh` | [`ResolveCurrentInputMesh`](#resolvecurrentinputmesh) `inline` |  |
| `void` | [`RestoreOriginalMesh`](#restoreoriginalmesh) `inline` |  |
| `void` | [`ApplyOutputMesh`](#applyoutputmesh) `inline` |  |
| `void` | [`UpdatePreview`](#updatepreview-1) `inline` |  |
| `void` | [`ClearGeneratedMeshes`](#cleargeneratedmeshes) `inline` |  |
| `bool` | [`IsLoopMode`](#isloopmode) `inline` |  |
| `MeshBuildData` | [`ReadMeshData`](#readmeshdata) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:179
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:217
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:243
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:254
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:271
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:277
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:288
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:330

## Private Static Attributes

| Return | Name | Description |
|--------|------|-------------|
| `const int` | [`CpuErosionTimeoutMs`](#cpuerosiontimeoutms) `static` |  |
...
```cpp
const int CpuErosionTimeoutMs = 1000
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:21

## Private Static Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RefreshCollider`](#refreshcollider) `static` `inline` |  |
| `MeshBuildData` | [`ErodeMeshData`](#erodemeshdata) `static` `inline` |  |
| `List< int >[]` | [`BuildAdjacency`](#buildadjacency) `static` `inline` |  |
| `void` | [`AddNeighbor`](#addneighbor) `static` `inline` |  |
| `void` | [`CountEdge`](#countedge) `static` `inline` |  |
| `Mesh` | [`BuildUnityMesh`](#buildunitymesh) `static` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:294
...
```cpp
static inline MeshBuildData ErodeMeshData(MeshBuildData sourceData, int iterations, float erosionStrength, float depositionStrength, float talusHeight, bool preserveBorders, CancellationToken cancellationToken)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:354
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:430
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:468
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:484
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/MeshErosionNode.cs:494
