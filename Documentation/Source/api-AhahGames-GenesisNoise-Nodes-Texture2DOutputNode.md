...
```cpp
class Texture2DOutputNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Output/Texture2DOutputNode.cs:31
...
| Name | Kind | Owner |
|------|------|-------|
| [`IsColorOutput`](#iscoloroutput) | `property` | Declared here |
| [`previewTexture`](#previewtexture-45) | `property` | Declared here |
| [`name`](#name-515) | `property` | Declared here |
| [`defaultPreviewSRGB`](#defaultpreviewsrgb-2) | `property` | Declared here |
| [`asset`](#asset-7) | `variable` | Declared here |
| [`wrapMode`](#wrapmode-1) | `variable` | Declared here |
| [`filterMode`](#filtermode-1) | `variable` | Declared here |
| [`hasMipMaps`](#hasmipmaps-2) | `variable` | Declared here |
| [`Enable`](#enable-81) | `function` | Declared here |
| [`ProcessNode`](#processnode-133) | `function` | Declared here |
| [`Disable`](#disable-45) | `function` | Declared here |
| [`pendingSource`](#pendingsource) | `variable` | Declared here |
| [`pendingReadback`](#pendingreadback) | `variable` | Declared here |
| [`readbackVersion`](#readbackversion) | `variable` | Declared here |
| [`genesisGraph`](#genesisgraph-2) | `variable` | Declared here |
| [`OnCommandBufferExecuted`](#oncommandbufferexecuted) | `function` | Declared here |
| [`NotifySettingsChanged`](#notifysettingschanged) | `function` | Declared here |
| [`ReplaceOutput`](#replaceoutput) | `function` | Declared here |
| [`DestroyTexture`](#destroytexture-2) | `function` | Declared here |
...
|--------|------|-------------|
| `bool` | [`IsColorOutput`](#iscoloroutput)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-45)  |  |
| `override string` | [`name`](#name-515)  |  |
| `override bool` | [`defaultPreviewSRGB`](#defaultpreviewsrgb-2)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Output/Texture2DOutputNode.cs:45
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Output/Texture2DOutputNode.cs:55
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Output/Texture2DOutputNode.cs:56

---

{#defaultpreviewsrgb-2}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Output/Texture2DOutputNode.cs:57

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `Texture` | [`asset`](#asset-7)  |  |
| `TextureWrapMode` | [`wrapMode`](#wrapmode-1)  |  |
| `FilterMode` | [`filterMode`](#filtermode-1)  |  |
| `bool` | [`hasMipMaps`](#hasmipmaps-2)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Output/Texture2DOutputNode.cs:39
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Output/Texture2DOutputNode.cs:42
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Output/Texture2DOutputNode.cs:43
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Output/Texture2DOutputNode.cs:48

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-81) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-133) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-45) `virtual` `inline` | Called when the node is disabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Output/Texture2DOutputNode.cs:59
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Output/Texture2DOutputNode.cs:69
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Output/Texture2DOutputNode.cs:127
...
| Return | Name | Description |
|--------|------|-------------|
| `RenderTexture` | [`pendingSource`](#pendingsource)  |  |
| `bool` | [`pendingReadback`](#pendingreadback)  |  |
| `int` | [`readbackVersion`](#readbackversion)  |  |
| `GenesisGraph` | [`genesisGraph`](#genesisgraph-2)  |  |
...
```cpp
RenderTexture pendingSource
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Output/Texture2DOutputNode.cs:50
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Output/Texture2DOutputNode.cs:51
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Output/Texture2DOutputNode.cs:52
...
```cpp
GenesisGraph genesisGraph
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Output/Texture2DOutputNode.cs:53

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`OnCommandBufferExecuted`](#oncommandbufferexecuted) `inline` |  |
| `void` | [`NotifySettingsChanged`](#notifysettingschanged) `inline` |  |
| `void` | [`ReplaceOutput`](#replaceoutput) `inline` |  |

---

{#oncommandbufferexecuted}
...
```cpp
inline void OnCommandBufferExecuted()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Output/Texture2DOutputNode.cs:87
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Output/Texture2DOutputNode.cs:115
...
```cpp
inline void ReplaceOutput(Texture2D replacement)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Output/Texture2DOutputNode.cs:120

## Private Static Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`DestroyTexture`](#destroytexture-2) `static` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Output/Texture2DOutputNode.cs:142
