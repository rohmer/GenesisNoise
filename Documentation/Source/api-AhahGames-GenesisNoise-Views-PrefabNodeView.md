...
```cpp
class PrefabNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/PrefabNodeView.cs:13
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-44) | `property` | Declared here |
| [`Enable`](#enable-141) | `function` | Declared here |
| [`prefabField`](#prefabfield) | `variable` | Declared here |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/PrefabNodeView.cs:15

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-141) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/PrefabNodeView.cs:19

## Private Attributes

| Return | Name | Description |
|--------|------|-------------|
| `ObjectField` | [`prefabField`](#prefabfield)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/PrefabNodeView.cs:17
