{#noiseweightedrandompointsnodeview}

# NoiseWeightedRandomPointsNodeView

```cpp
class NoiseWeightedRandomPointsNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/NoiseWeightedRandomPointsNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-40) | `property` | Declared here |
| [`Enable`](#enable-136) | `function` | Declared here |
| [`Disable`](#disable-63) | `function` | Declared here |
| [`countField`](#countfield-6) | `variable` | Declared here |
| [`coordinatesField`](#coordinatesfield-5) | `variable` | Declared here |
| [`RefreshOutputs`](#refreshoutputs-5) | `function` | Declared here |
...
|--------|------|-------------|
| `NoiseWeightedRandomPointsNode` | [`node`](#node-40)  |  |
...
```cpp
NoiseWeightedRandomPointsNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/NoiseWeightedRandomPointsNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-136) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-63) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/NoiseWeightedRandomPointsNodeView.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/NoiseWeightedRandomPointsNodeView.cs:38
...
| Return | Name | Description |
|--------|------|-------------|
| `IntegerField` | [`countField`](#countfield-6)  |  |
| `TextField` | [`coordinatesField`](#coordinatesfield-5)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/NoiseWeightedRandomPointsNodeView.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/NoiseWeightedRandomPointsNodeView.cs:15

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RefreshOutputs`](#refreshoutputs-5) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/NoiseWeightedRandomPointsNodeView.cs:44
