{#lloydrelaxedpointsnode}

# LloydRelaxedPointsNode

```cpp
class LloydRelaxedPointsNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:34
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-307) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-281) | `property` | Declared here |
| [`previewTexture`](#previewtexture-21) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-33) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-112) | `property` | Declared here |
| [`defaultPreviewChannels`](#defaultpreviewchannels-5) | `property` | Declared here |
| [`supportedDimensions`](#supporteddimensions-15) | `property` | Declared here |
| [`defaultSettings`](#defaultsettings-14) | `property` | Declared here |
| [`densityInput`](#densityinput) | `variable` | Declared here |
| [`seed`](#seed-3) | `variable` | Declared here |
| [`numberOfPoints`](#numberofpoints-2) | `variable` | Declared here |
| [`relaxationIterations`](#relaxationiterations) | `variable` | Declared here |
| [`relaxationResolution`](#relaxationresolution) | `variable` | Declared here |
| [`jitter`](#jitter) | `variable` | Declared here |
| [`pointRadiusPixels`](#pointradiuspixels-3) | `variable` | Declared here |
| [`backgroundColor`](#backgroundcolor-5) | `variable` | Declared here |
| [`pointColor`](#pointcolor-3) | `variable` | Declared here |
| [`output`](#output-42) | `variable` | Declared here |
| [`points`](#points-5) | `variable` | Declared here |
| [`pointCount`](#pointcount-3) | `variable` | Declared here |
| [`GetCoordinatesText`](#getcoordinatestext-3) | `function` | Declared here |
| [`ProcessNode`](#processnode-64) | `function` | Declared here |
| [`Disable`](#disable-24) | `function` | Declared here |
| [`lastWidth`](#lastwidth-3) | `variable` | Declared here |
| [`lastHeight`](#lastheight-3) | `variable` | Declared here |
| [`lastSeed`](#lastseed-3) | `variable` | Declared here |
| [`lastNumberOfPoints`](#lastnumberofpoints-2) | `variable` | Declared here |
| [`lastRelaxationIterations`](#lastrelaxationiterations) | `variable` | Declared here |
| [`lastRelaxationResolution`](#lastrelaxationresolution) | `variable` | Declared here |
| [`lastPointRadiusPixels`](#lastpointradiuspixels-3) | `variable` | Declared here |
| [`lastJitter`](#lastjitter) | `variable` | Declared here |
| [`lastBackgroundColor`](#lastbackgroundcolor-3) | `variable` | Declared here |
| [`lastPointColor`](#lastpointcolor-3) | `variable` | Declared here |
| [`readableDensity`](#readabledensity) | `variable` | Declared here |
| [`pixelBuffer`](#pixelbuffer-3) | `variable` | Declared here |
| [`GeneratePoints`](#generatepoints-3) | `function` | Declared here |
| [`CreateInitialPoints`](#createinitialpoints) | `function` | Declared here |
| [`RelaxPointSet`](#relaxpointset) | `function` | Declared here |
| [`FindNearestPointIndex`](#findnearestpointindex) | `function` | Declared here |
| [`UpdateReadableDensity`](#updatereadabledensity) | `function` | Declared here |
| [`BuildTexture`](#buildtexture-3) | `function` | Declared here |
| [`EnsureOutputTexture`](#ensureoutputtexture-3) | `function` | Declared here |
| [`NeedsRebuild`](#needsrebuild-3) | `function` | Declared here |
| [`CacheSettings`](#cachesettings-3) | `function` | Declared here |
| [`epsilon`](#epsilon-5) | `variable` | Declared here |
| [`NextFloat`](#nextfloat-3) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-307)  |  |
| `override string` | [`NodeGroup`](#nodegroup-281)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-21)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-33)  |  |
| `override float` | [`nodeWidth`](#nodewidth-112)  |  |
| `override PreviewChannels` | [`defaultPreviewChannels`](#defaultpreviewchannels-5)  |  |
| `override List< OutputDimension >` | [`supportedDimensions`](#supporteddimensions-15)  |  |
| `override GenesisNoiseSettings` | [`defaultSettings`](#defaultsettings-14)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:107
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:108
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:109

---

{#showdefaultinspector-33}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:110
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:111

---

{#defaultpreviewchannels-5}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:112

---

{#supporteddimensions-15}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:113
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:114

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `Texture` | [`densityInput`](#densityinput)  |  |
| `int` | [`seed`](#seed-3)  |  |
| `int` | [`numberOfPoints`](#numberofpoints-2)  |  |
| `int` | [`relaxationIterations`](#relaxationiterations)  |  |
| `int` | [`relaxationResolution`](#relaxationresolution)  |  |
| `float` | [`jitter`](#jitter)  |  |
| `int` | [`pointRadiusPixels`](#pointradiuspixels-3)  |  |
| `Color` | [`backgroundColor`](#backgroundcolor-5)  |  |
| `Color` | [`pointColor`](#pointcolor-3)  |  |
| `Texture2D` | [`output`](#output-42)  |  |
| `List< Vector2 >` | [`points`](#points-5)  |  |
| `int` | [`pointCount`](#pointcount-3)  |  |
...
```cpp
Texture densityInput
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:39
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:42
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:45
...
```cpp
int relaxationIterations = 8
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:48
...
```cpp
int relaxationResolution = 128
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:51
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:54
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:57
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:60
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:63
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:66
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:69
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:72

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `string` | [`GetCoordinatesText`](#getcoordinatestext-3) `inline` |  |

---

{#getcoordinatestext-3}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:131

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-64) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-24) `virtual` `inline` | Called when the node is disabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:116
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:420
...
| Return | Name | Description |
|--------|------|-------------|
| `int` | [`lastWidth`](#lastwidth-3)  |  |
| `int` | [`lastHeight`](#lastheight-3)  |  |
| `int` | [`lastSeed`](#lastseed-3)  |  |
| `int` | [`lastNumberOfPoints`](#lastnumberofpoints-2)  |  |
| `int` | [`lastRelaxationIterations`](#lastrelaxationiterations)  |  |
| `int` | [`lastRelaxationResolution`](#lastrelaxationresolution)  |  |
| `int` | [`lastPointRadiusPixels`](#lastpointradiuspixels-3)  |  |
| `float` | [`lastJitter`](#lastjitter)  |  |
| `Color` | [`lastBackgroundColor`](#lastbackgroundcolor-3)  |  |
| `Color` | [`lastPointColor`](#lastpointcolor-3)  |  |
| `Texture2D` | [`readableDensity`](#readabledensity)  |  |
| `Color32[]` | [`pixelBuffer`](#pixelbuffer-3)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:75
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:78
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:81

---

{#lastnumberofpoints-2}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:84

---

{#lastrelaxationiterations}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:87

---

{#lastrelaxationresolution}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:90

---

{#lastpointradiuspixels-3}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:93
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:96

---

{#lastbackgroundcolor-3}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:99
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:102
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:104
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:105

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`GeneratePoints`](#generatepoints-3) `inline` |  |
| `void` | [`CreateInitialPoints`](#createinitialpoints) `inline` |  |
| `void` | [`RelaxPointSet`](#relaxpointset) `inline` |  |
| `int` | [`FindNearestPointIndex`](#findnearestpointindex) `inline` |  |
| `bool` | [`UpdateReadableDensity`](#updatereadabledensity) `inline` |  |
| `void` | [`BuildTexture`](#buildtexture-3) `inline` |  |
| `void` | [`EnsureOutputTexture`](#ensureoutputtexture-3) `inline` |  |
| `bool` | [`NeedsRebuild`](#needsrebuild-3) `inline` |  |
| `void` | [`CacheSettings`](#cachesettings-3) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:154
...
```cpp
inline void CreateInitialPoints(System.Random random, int safePointCount, List< Vector2 > destination)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:173
...
```cpp
inline void RelaxPointSet(int resolution, Color[] densityPixels)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:211
...
```cpp
inline int FindNearestPointIndex(Vector2 sample)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:250

---

{#updatereadabledensity}
...
```cpp
inline bool UpdateReadableDensity(Texture source, int resolution)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:268
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:304

---

{#ensureoutputtexture-3}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:351
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:372
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:401

## Private Static Attributes

| Return | Name | Description |
|--------|------|-------------|
| `const float` | [`epsilon`](#epsilon-5) `static` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:36

## Private Static Methods

| Return | Name | Description |
|--------|------|-------------|
| `float` | [`NextFloat`](#nextfloat-3) `static` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/PointGenerator/LloydRelaxedPointsNode.cs:415
