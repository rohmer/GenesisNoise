{#nonsquaretransformnode}

# NonSquareTransformNode

```cpp
class NonSquareTransformNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/NonSquareTransformNode.cs:21
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-360) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-332) | `property` | Declared here |
| [`ShaderName`](#shadername-266) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-360)  |  |
| `override string` | [`NodeGroup`](#nodegroup-332)  |  |
| `override string` | [`ShaderName`](#shadername-266)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/NonSquareTransformNode.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/NonSquareTransformNode.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/NonSquareTransformNode.cs:25
