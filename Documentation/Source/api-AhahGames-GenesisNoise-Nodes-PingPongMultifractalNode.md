{#pingpongmultifractalnode}

# PingPongMultifractalNode

```cpp
class PingPongMultifractalNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/TerrainMultifractalNodes.cs:74

> **Inherits:** [`AhahGames.GenesisNoise.Nodes.TerrainMultifractalNodeBase`](api-AhahGames-GenesisNoise-Nodes-TerrainMultifractalNodeBase.md#terrainmultifractalnodebase)

## List of all members

| Name | Kind | Owner |
|------|------|-------|
| [`Mode`](#mode-20) | `property` | Declared here |
| [`name`](#name-390) | `property` | Declared here |
| [`ShaderName`](#shadername-294) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-360) | `property` | Declared here |
| [`Mode`](api-AhahGames-GenesisNoise-Nodes-TerrainMultifractalNodeBase.md#mode-26) | `property` | Inherited from [`TerrainMultifractalNodeBase`](api-AhahGames-GenesisNoise-Nodes-TerrainMultifractalNodeBase.md#terrainmultifractalnodebase) |
| [`filteredOutProperties`](api-AhahGames-GenesisNoise-Nodes-TerrainMultifractalNodeBase.md#filteredoutproperties-126) | `property` | Inherited from [`TerrainMultifractalNodeBase`](api-AhahGames-GenesisNoise-Nodes-TerrainMultifractalNodeBase.md#terrainmultifractalnodebase) |
| [`ProcessNode`](api-AhahGames-GenesisNoise-Nodes-TerrainMultifractalNodeBase.md#processnode-131) | `function` | Inherited from [`TerrainMultifractalNodeBase`](api-AhahGames-GenesisNoise-Nodes-TerrainMultifractalNodeBase.md#terrainmultifractalnodebase) |
...
## Inherited from [`TerrainMultifractalNodeBase`](api-AhahGames-GenesisNoise-Nodes-TerrainMultifractalNodeBase.md#terrainmultifractalnodebase)

| Kind | Name | Description |
|------|------|-------------|
| `property` | [`Mode`](api-AhahGames-GenesisNoise-Nodes-TerrainMultifractalNodeBase.md#mode-26)  |  |
| `property` | [`filteredOutProperties`](api-AhahGames-GenesisNoise-Nodes-TerrainMultifractalNodeBase.md#filteredoutproperties-126)  |  |
| `function` | [`ProcessNode`](api-AhahGames-GenesisNoise-Nodes-TerrainMultifractalNodeBase.md#processnode-131) `virtual` `inline` |  |
...
|--------|------|-------------|
| `override int` | [`Mode`](#mode-20)  |  |
| `override string` | [`name`](#name-390)  |  |
| `override string` | [`ShaderName`](#shadername-294)  |  |
| `override string` | [`NodeGroup`](#nodegroup-360)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/TerrainMultifractalNodes.cs:76
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/TerrainMultifractalNodes.cs:78
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/TerrainMultifractalNodes.cs:79
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/TerrainMultifractalNodes.cs:80
