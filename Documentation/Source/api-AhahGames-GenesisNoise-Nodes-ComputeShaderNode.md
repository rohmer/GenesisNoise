...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ComputeShaderNode.cs:14

> **Inherits:** [`AhahGames.GenesisNoise.Nodes.GenesisNode`](api-AhahGames-GenesisNoise-Nodes-GenesisNode.md#genesisnode)
> **Subclassed by:** [`AhahGames.GenesisNoise.Nodes.Distance`](api-AhahGames-GenesisNoise-Nodes-Distance.md#distance-6), [`AhahGames.GenesisNoise.Nodes.Levels`](api-AhahGames-GenesisNoise-Nodes-Levels.md#levels), [`AhahGames.GenesisNoise.Nodes.MeshToUDF`](api-AhahGames-GenesisNoise-Nodes-MeshToUDF.md#meshtoudf), [`AhahGames.GenesisNoise.Nodes.Scatter`](api-AhahGames-GenesisNoise-Nodes-Scatter.md#scatter), [`AhahGames.GenesisNoise.Nodes.VoronoiFromPointsComputeNode`](api-AhahGames-GenesisNoise-Nodes-VoronoiFromPointsComputeNode.md#voronoifrompointscomputenode)

## List of all members

| Name | Kind | Owner |
|------|------|-------|
| [`previewTexture`](#previewtexture-5) | `property` | Declared here |
| [`name`](#name-112) | `property` | Declared here |
| [`previewTexturePropertyName`](#previewtexturepropertyname) | `property` | Declared here |
| [`computeShaderResourcePath`](#computeshaderresourcepath) | `property` | Declared here |
| [`showOpenButton`](#showopenbutton) | `property` | Declared here |
| [`tempRenderTextureHasMipmaps`](#temprendertexturehasmipmaps) | `property` | Declared here |
| [`tempRenderTextureHasDepthBuffer`](#temprendertexturehasdepthbuffer) | `property` | Declared here |
| [`canProcess`](#canprocess-1) | `property` | Declared here |
| [`computeShader`](#computeshader) | `variable` | Declared here |
| [`ComputeIsValid`](#computeisvalid) | `function` | Declared here |
| [`tempRenderTexture`](#temprendertexture) | `variable` | Declared here |
| [`Enable`](#enable-21) | `function` | Declared here |
| [`LoadComputeShader`](#loadcomputeshader) | `function` | Declared here |
| [`DispatchCompute`](#dispatchcompute) | `function` | Declared here |
| [`DispatchCompute`](#dispatchcompute-1) | `function` | Declared here |
| [`DispatchComputePreview`](#dispatchcomputepreview) | `function` | Declared here |
| [`DispatchComputePreview`](#dispatchcomputepreview-1) | `function` | Declared here |
| [`ClearBuffer`](#clearbuffer-1) | `function` | Declared here |
| [`Disable`](#disable-10) | `function` | Declared here |
| [`UpdateTempRT`](#updatetemprt) | `function` | Declared here |
| [`previewResolutionId`](#previewresolutionid) | `variable` | Declared here |
...
|--------|------|-------------|
| `override Texture` | [`previewTexture`](#previewtexture-5)  |  |
| `override string` | [`name`](#name-112)  |  |
| `string` | [`previewTexturePropertyName`](#previewtexturepropertyname)  |  |
| `string` | [`computeShaderResourcePath`](#computeshaderresourcepath)  |  |
| `bool` | [`showOpenButton`](#showopenbutton)  |  |
| `bool` | [`tempRenderTextureHasMipmaps`](#temprendertexturehasmipmaps)  |  |
| `bool` | [`tempRenderTextureHasDepthBuffer`](#temprendertexturehasdepthbuffer)  |  |
| `override bool` | [`canProcess`](#canprocess-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ComputeShaderNode.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ComputeShaderNode.cs:30
...
```cpp
string previewTexturePropertyName
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ComputeShaderNode.cs:32
...
```cpp
string computeShaderResourcePath
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ComputeShaderNode.cs:33
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ComputeShaderNode.cs:35
...
```cpp
bool tempRenderTextureHasMipmaps
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ComputeShaderNode.cs:37
...
```cpp
bool tempRenderTextureHasDepthBuffer
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ComputeShaderNode.cs:38
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ComputeShaderNode.cs:83
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ComputeShaderNode.cs:17

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `bool` | [`ComputeIsValid`](#computeisvalid) `inline` |  |
...
```cpp
inline bool ComputeIsValid()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ComputeShaderNode.cs:91

## Protected Attributes

| Return | Name | Description |
|--------|------|-------------|
| `CustomRenderTexture` | [`tempRenderTexture`](#temprendertexture)  |  |
...
```cpp
CustomRenderTexture tempRenderTexture
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ComputeShaderNode.cs:26

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-21) `virtual` `inline` | Called when the node is enabled. |
| `ComputeShader` | [`LoadComputeShader`](#loadcomputeshader) `inline` |  |
| `void` | [`DispatchCompute`](#dispatchcompute) `inline` |  |
| `void` | [`DispatchCompute`](#dispatchcompute-1) `inline` |  |
| `void` | [`DispatchComputePreview`](#dispatchcomputepreview) `inline` |  |
| `void` | [`DispatchComputePreview`](#dispatchcomputepreview-1) `inline` |  |
| `void` | [`ClearBuffer`](#clearbuffer-1) `inline` |  |
| `override void` | [`Disable`](#disable-10) `virtual` `inline` | Called when the node is disabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ComputeShaderNode.cs:40
...
```cpp
inline ComputeShader LoadComputeShader(string name)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ComputeShaderNode.cs:57
...
```cpp
inline void DispatchCompute(CommandBuffer cmd, int kernelIndex, int width, int height = 1, int depth = 1)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ComputeShaderNode.cs:120
...
```cpp
inline void DispatchCompute(CommandBuffer cmd, ComputeShader compute, int kernelIndex, int width, int height = 1, int depth = 1)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ComputeShaderNode.cs:123

---

{#dispatchcomputepreview}
...
```cpp
inline void DispatchComputePreview(CommandBuffer cmd, int previewKernel)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ComputeShaderNode.cs:138

---

{#dispatchcomputepreview-1}
...
```cpp
inline void DispatchComputePreview(CommandBuffer cmd, ComputeShader compute, int previewKernel)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ComputeShaderNode.cs:141
...
```cpp
inline void ClearBuffer(CommandBuffer cmd, ComputeBuffer buffer, int sizeInByte = -1, int offset = 0)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ComputeShaderNode.cs:158
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ComputeShaderNode.cs:161
...
| Return | Name | Description |
|--------|------|-------------|
| `void` | [`UpdateTempRT`](#updatetemprt) `inline` |  |
...
```cpp
inline void UpdateTempRT()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ComputeShaderNode.cs:85

## Private Static Attributes

| Return | Name | Description |
|--------|------|-------------|
| `readonly int` | [`previewResolutionId`](#previewresolutionid) `static` |  |
...
```cpp
readonly int previewResolutionId = Shader.PropertyToID("_PreviewResolution")
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/ComputeShaderNode.cs:19
