...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomFloatNode.cs:14
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-409) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-378) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-144) | `property` | Declared here |
| [`output`](#output-67) | `variable` | Declared here |
| [`min`](#min-61) | `variable` | Declared here |
| [`max`](#max-61) | `variable` | Declared here |
| [`Process`](#process-8) | `function` | Declared here |
| [`ProcessNode`](#processnode-97) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-409)  |  |
| `override string` | [`NodeGroup`](#nodegroup-378)  |  |
| `override float` | [`nodeWidth`](#nodewidth-144)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomFloatNode.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomFloatNode.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomFloatNode.cs:24

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `float` | [`output`](#output-67)  |  |
| `float` | [`min`](#min-61)  |  |
| `float` | [`max`](#max-61)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomFloatNode.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomFloatNode.cs:20
...
| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Process`](#process-8) `virtual` `inline` | Override this method to implement custom processing. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomFloatNode.cs:26
...
| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-97) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomFloatNode.cs:31
