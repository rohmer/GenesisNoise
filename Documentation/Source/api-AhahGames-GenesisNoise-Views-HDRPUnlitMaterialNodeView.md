{#hdrpunlitmaterialnodeview}

# HDRPUnlitMaterialNodeView

```cpp
class HDRPUnlitMaterialNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/HDRP/HDRPUnlitMaterialNodeView.cs:14
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-25) | `property` | Declared here |
| [`Enable`](#enable-118) | `function` | Declared here |
...
|--------|------|-------------|
| `HDRPUnlitMaterial` | [`node`](#node-25)  |  |
...
```cpp
HDRPUnlitMaterial node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/HDRP/HDRPUnlitMaterialNodeView.cs:16

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-118) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Material/HDRP/HDRPUnlitMaterialNodeView.cs:18
