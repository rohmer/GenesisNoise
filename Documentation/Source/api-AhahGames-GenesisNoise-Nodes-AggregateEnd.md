...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:19
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-21) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-9) | `property` | Declared here |
| [`hasPreview`](#haspreview-3) | `property` | Declared here |
| [`hasSettings`](#hassettings-1) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-3) | `property` | Declared here |
| [`input`](#input-5) | `variable` | Declared here |
| [`output`](#output-8) | `variable` | Declared here |
| [`iterationCount`](#iterationcount) | `variable` | Declared here |
| [`mode`](#mode-6) | `variable` | Declared here |
| [`InputPortType`](#inputporttype) | `function` | Declared here |
| [`OutputPortType`](#outputporttype) | `function` | Declared here |
| [`PrepareLoopEnd`](#prepareloopend) | `function` | Declared here |
| [`FinalIteration`](#finaliteration) | `function` | Declared here |
| [`ZeroIteration`](#zeroiteration) | `function` | Declared here |
| [`Enable`](#enable-11) | `function` | Declared here |
| [`ProcessNode`](#processnode-8) | `function` | Declared here |
| [`Disable`](#disable-3) | `function` | Declared here |
| [`AggregateMode`](#aggregatemode) | `enum` | Declared here |
| [`loopStartNode`](#loopstartnode) | `variable` | Declared here |
| [`loopStartGUID`](#loopstartguid) | `variable` | Declared here |
| [`inputType`](#inputtype-2) | `variable` | Declared here |
| [`values`](#values-1) | `variable` | Declared here |
| [`RegisterLoopStart`](#registerloopstart) | `function` | Declared here |
| [`UnregisterLoopStart`](#unregisterloopstart) | `function` | Declared here |
| [`EdgeConnectionCallback`](#edgeconnectioncallback) | `function` | Declared here |
| [`BuildAggregateOutput`](#buildaggregateoutput) | `function` | Declared here |
| [`ResolveInputType`](#resolveinputtype) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-21)  |  |
| `override string` | [`NodeGroup`](#nodegroup-9)  |  |
| `override bool` | [`hasPreview`](#haspreview-3)  |  |
| `override bool` | [`hasSettings`](#hassettings-1)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-3)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:51
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:52
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:53
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:54

---

{#showdefaultinspector-3}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:55

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `object` | [`input`](#input-5)  |  |
| `object` | [`output`](#output-8)  |  |
| `int` | [`iterationCount`](#iterationcount)  |  |
| `AggregateMode` | [`mode`](#mode-6)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:30
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:33
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:36
...
```cpp
AggregateMode mode = AggregateMode.CollectValues
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:38

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `IEnumerable< PortData >` | [`InputPortType`](#inputporttype) `inline` |  |
| `IEnumerable< PortData >` | [`OutputPortType`](#outputporttype) `inline` |  |
| `void` | [`PrepareLoopEnd`](#prepareloopend) `inline` | Function executed the first time a Loop end is encountered. I.e. at the end of the first loop iteration. |
| `void` | [`FinalIteration`](#finaliteration) `inline` |  |
| `void` | [`ZeroIteration`](#zeroiteration) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:114
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:128
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:147
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:154
...
```cpp
inline void ZeroIteration(ILoopStart loopStartNode)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:159

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-11) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-8) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-3) `virtual` `inline` | Called when the node is disabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:57
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:139
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:172
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:21
...
| Return | Name | Description |
|--------|------|-------------|
| `BaseNode` | [`loopStartNode`](#loopstartnode)  |  |
| `string` | [`loopStartGUID`](#loopstartguid)  |  |
| `SerializableType` | [`inputType`](#inputtype-2)  |  |
| `readonly List< object >` | [`values`](#values-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:41
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:44
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:47
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:49

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RegisterLoopStart`](#registerloopstart) `inline` |  |
| `void` | [`UnregisterLoopStart`](#unregisterloopstart) `inline` |  |
| `void` | [`EdgeConnectionCallback`](#edgeconnectioncallback) `inline` |  |
| `object` | [`BuildAggregateOutput`](#buildaggregateoutput) `inline` |  |
| `Type` | [`ResolveInputType`](#resolveinputtype) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:65
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:77
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:86
...
```cpp
inline object BuildAggregateOutput()
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:178
...
```cpp
inline Type ResolveInputType(List< SerializableEdge > edges)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/FlowControl/AggregateEnd.cs:190
