...
```cpp
class SubdivideMeshNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:18
...
| Name | Kind | Owner |
|------|------|-------|
| [`hasPreview`](#haspreview-76) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-460) | `property` | Declared here |
| [`name`](#name-495) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-65) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-170) | `property` | Declared here |
| [`previewTexture`](#previewtexture-42) | `property` | Declared here |
| [`input`](#input-24) | `variable` | Declared here |
| [`output`](#output-88) | `variable` | Declared here |
| [`Enable`](#enable-73) | `function` | Declared here |
| [`ProcessNode`](#processnode-120) | `function` | Declared here |
| [`Disable`](#disable-42) | `function` | Declared here |
| [`meshStates`](#meshstates-5) | `variable` | Declared here |
| [`TryGetInputMesh`](#trygetinputmesh-5) | `function` | Declared here |
| [`ResolveCurrentInputMesh`](#resolvecurrentinputmesh-5) | `function` | Declared here |
| [`ClearGeneratedMeshes`](#cleargeneratedmeshes-6) | `function` | Declared here |
| [`ReadMeshData`](#readmeshdata-5) | `function` | Declared here |
| [`CpuSubdivideTimeoutMs`](#cpusubdividetimeoutms) | `variable` | Declared here |
| [`GpuSubdivideMinTriangleCount`](#gpusubdividemintrianglecount) | `variable` | Declared here |
| [`SubdivideComputeResourcePath`](#subdividecomputeresourcepath) | `variable` | Declared here |
| [`inputVerticesId`](#inputverticesid) | `variable` | Declared here |
| [`inputUVId`](#inputuvid) | `variable` | Declared here |
| [`inputUV2Id`](#inputuv2id) | `variable` | Declared here |
| [`inputColorsId`](#inputcolorsid) | `variable` | Declared here |
| [`inputIndicesId`](#inputindicesid) | `variable` | Declared here |
| [`outputVerticesId`](#outputverticesid) | `variable` | Declared here |
| [`outputUVId`](#outputuvid) | `variable` | Declared here |
| [`outputUV2Id`](#outputuv2id) | `variable` | Declared here |
| [`outputColorsId`](#outputcolorsid) | `variable` | Declared here |
| [`outputIndicesId`](#outputindicesid) | `variable` | Declared here |
| [`triangleCountId`](#trianglecountid) | `variable` | Declared here |
| [`hasUVId`](#hasuvid) | `variable` | Declared here |
| [`hasUV2Id`](#hasuv2id) | `variable` | Declared here |
| [`hasColorsId`](#hascolorsid) | `variable` | Declared here |
| [`subdivideComputeShader`](#subdividecomputeshader) | `variable` | Declared here |
| [`subdivideComputeKernel`](#subdividecomputekernel) | `variable` | Declared here |
| [`SubdivideMeshData`](#subdividemeshdata) | `function` | Declared here |
| [`SubdivideMeshDataOnce`](#subdividemeshdataonce) | `function` | Declared here |
| [`BuildOrUpdateUnityMesh`](#buildorupdateunitymesh-1) | `function` | Declared here |
| [`IsValidVertexIndex`](#isvalidvertexindex) | `function` | Declared here |
| [`CanUseGpuSubdivide`](#canusegpusubdivide) | `function` | Declared here |
| [`TrySubdivideWithCompute`](#trysubdividewithcompute) | `function` | Declared here |
| [`TryGetSubdivideCompute`](#trygetsubdividecompute) | `function` | Declared here |
| [`HasMatchingSourceSignature`](#hasmatchingsourcesignature) | `function` | Declared here |
| [`UpdateSourceSignature`](#updatesourcesignature) | `function` | Declared here |
| [`ResetSourceSignature`](#resetsourcesignature) | `function` | Declared here |
| [`GetMidpoint`](#getmidpoint) | `function` | Declared here |
...
|--------|------|-------------|
| `override bool` | [`hasPreview`](#haspreview-76)  |  |
| `override string` | [`NodeGroup`](#nodegroup-460)  |  |
| `override string` | [`name`](#name-495)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-65)  |  |
| `override float` | [`nodeWidth`](#nodewidth-170)  |  |
| `override Texture` | [`previewTexture`](#previewtexture-42)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:61
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:62
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:63

---

{#showdefaultinspector-65}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:64
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:65
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:68

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `GameObject` | [`input`](#input-24)  |  |
| `GameObject` | [`output`](#output-88)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:52
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:55

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-73) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-120) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-42) `virtual` `inline` | Called when the node is disabled. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:70
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:76
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:85
...
| Return | Name | Description |
|--------|------|-------------|
| `readonly Dictionary< GameObject, MeshState >` | [`meshStates`](#meshstates-5)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:59

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `bool` | [`TryGetInputMesh`](#trygetinputmesh-5) `inline` |  |
| `Mesh` | [`ResolveCurrentInputMesh`](#resolvecurrentinputmesh-5) `inline` |  |
| `void` | [`ClearGeneratedMeshes`](#cleargeneratedmeshes-6) `inline` |  |
| `MeshBuildData` | [`ReadMeshData`](#readmeshdata-5) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:202

---

{#resolvecurrentinputmesh-5}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:246

---

{#cleargeneratedmeshes-6}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:272
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:283

## Private Static Attributes

| Return | Name | Description |
|--------|------|-------------|
| `const int` | [`CpuSubdivideTimeoutMs`](#cpusubdividetimeoutms) `static` |  |
| `const int` | [`GpuSubdivideMinTriangleCount`](#gpusubdividemintrianglecount) `static` |  |
| `const string` | [`SubdivideComputeResourcePath`](#subdividecomputeresourcepath) `static` |  |
| `readonly int` | [`inputVerticesId`](#inputverticesid) `static` |  |
| `readonly int` | [`inputUVId`](#inputuvid) `static` |  |
| `readonly int` | [`inputUV2Id`](#inputuv2id) `static` |  |
| `readonly int` | [`inputColorsId`](#inputcolorsid) `static` |  |
| `readonly int` | [`inputIndicesId`](#inputindicesid) `static` |  |
| `readonly int` | [`outputVerticesId`](#outputverticesid) `static` |  |
| `readonly int` | [`outputUVId`](#outputuvid) `static` |  |
| `readonly int` | [`outputUV2Id`](#outputuv2id) `static` |  |
| `readonly int` | [`outputColorsId`](#outputcolorsid) `static` |  |
| `readonly int` | [`outputIndicesId`](#outputindicesid) `static` |  |
| `readonly int` | [`triangleCountId`](#trianglecountid) `static` |  |
| `readonly int` | [`hasUVId`](#hasuvid) `static` |  |
| `readonly int` | [`hasUV2Id`](#hasuv2id) `static` |  |
| `readonly int` | [`hasColorsId`](#hascolorsid) `static` |  |
| `ComputeShader` | [`subdivideComputeShader`](#subdividecomputeshader) `static` |  |
| `int` | [`subdivideComputeKernel`](#subdividecomputekernel) `static` |  |

---

{#cpusubdividetimeoutms}
...
```cpp
const int CpuSubdivideTimeoutMs = 10000
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:20

---

{#gpusubdividemintrianglecount}
...
```cpp
const int GpuSubdivideMinTriangleCount = 2048
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:21

---

{#subdividecomputeresourcepath}
...
```cpp
const string SubdivideComputeResourcePath = "GenesisNoise/SubdivideMesh"
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:22
...
```cpp
readonly int inputVerticesId = Shader.PropertyToID("_InputVertices")
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:24
...
```cpp
readonly int inputUVId = Shader.PropertyToID("_InputUV")
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:25
...
```cpp
readonly int inputUV2Id = Shader.PropertyToID("_InputUV2")
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:26
...
```cpp
readonly int inputColorsId = Shader.PropertyToID("_InputColors")
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:27
...
```cpp
readonly int inputIndicesId = Shader.PropertyToID("_InputIndices")
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:28
...
```cpp
readonly int outputVerticesId = Shader.PropertyToID("_OutputVertices")
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:29
...
```cpp
readonly int outputUVId = Shader.PropertyToID("_OutputUV")
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:30
...
```cpp
readonly int outputUV2Id = Shader.PropertyToID("_OutputUV2")
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:31
...
```cpp
readonly int outputColorsId = Shader.PropertyToID("_OutputColors")
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:32
...
```cpp
readonly int outputIndicesId = Shader.PropertyToID("_OutputIndices")
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:33
...
```cpp
readonly int triangleCountId = Shader.PropertyToID("_TriangleCount")
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:34
...
```cpp
readonly int hasUVId = Shader.PropertyToID("_HasUV")
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:35
...
```cpp
readonly int hasUV2Id = Shader.PropertyToID("_HasUV2")
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:36
...
```cpp
readonly int hasColorsId = Shader.PropertyToID("_HasColors")
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:37

---

{#subdividecomputeshader}
...
```cpp
ComputeShader subdivideComputeShader
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:39

---

{#subdividecomputekernel}
...
```cpp
int subdivideComputeKernel = -1
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:40

## Private Static Methods

| Return | Name | Description |
|--------|------|-------------|
| `MeshBuildData` | [`SubdivideMeshData`](#subdividemeshdata) `static` `inline` |  |
| `MeshBuildData` | [`SubdivideMeshDataOnce`](#subdividemeshdataonce) `static` `inline` | Uniformly subdivides every triangle in the source mesh into 4 smaller triangles. |
| `Mesh` | [`BuildOrUpdateUnityMesh`](#buildorupdateunitymesh-1) `static` `inline` |  |
| `bool` | [`IsValidVertexIndex`](#isvalidvertexindex) `static` `inline` |  |
| `bool` | [`CanUseGpuSubdivide`](#canusegpusubdivide) `static` `inline` |  |
| `bool` | [`TrySubdivideWithCompute`](#trysubdividewithcompute) `static` `inline` |  |
| `bool` | [`TryGetSubdivideCompute`](#trygetsubdividecompute) `static` `inline` |  |
| `bool` | [`HasMatchingSourceSignature`](#hasmatchingsourcesignature) `static` `inline` |  |
| `void` | [`UpdateSourceSignature`](#updatesourcesignature) `static` `inline` |  |
| `void` | [`ResetSourceSignature`](#resetsourcesignature) `static` `inline` |  |
| `int` | [`GetMidpoint`](#getmidpoint) `static` `inline` |  |
...
```cpp
static inline MeshBuildData SubdivideMeshData(MeshBuildData sourceData, int subdivisionCount)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:306

---

{#subdividemeshdataonce}
...
```cpp
static inline MeshBuildData SubdivideMeshDataOnce(MeshBuildData sourceData)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:322

Uniformly subdivides every triangle in the source mesh into 4 smaller triangles.

---

{#buildorupdateunitymesh-1}

### BuildOrUpdateUnityMesh

`static` `inline`

```cpp
static inline Mesh BuildOrUpdateUnityMesh(Mesh sourceMesh, MeshBuildData data, MeshState meshState)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:375
...
```cpp
static inline bool IsValidVertexIndex(int index, int vertexCount)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:407
...
```cpp
static inline bool CanUseGpuSubdivide(MeshBuildData sourceData, int subdivisionCount)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:412

---

{#trysubdividewithcompute}
...
```cpp
static inline bool TrySubdivideWithCompute(MeshBuildData sourceData, out MeshBuildData resultData)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:421

---

{#trygetsubdividecompute}
...
```cpp
static inline bool TryGetSubdivideCompute(out ComputeShader computeShader, out int kernel)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:570

---

{#hasmatchingsourcesignature}
...
```cpp
static inline bool HasMatchingSourceSignature(Mesh mesh, MeshState state)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:599

---

{#updatesourcesignature}
...
```cpp
static inline void UpdateSourceSignature(Mesh mesh, MeshState state)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:617

---

{#resetsourcesignature}
...
```cpp
static inline void ResetSourceSignature(MeshState state)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:631
...
```cpp
static inline int GetMidpoint(int i1, int i2, List< Vector3 > vertices, List< Vector2 > uv, List< Vector2 > uv2, List< Color > colors, Dictionary< long, int > cache)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Mesh/SubdivideNode.cs:642
