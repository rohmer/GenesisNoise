...
```cpp
class ForStartNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/FlowControl/ForStartNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-18) | `property` | Declared here |
| [`Enable`](#enable-108) | `function` | Declared here |
| [`countField`](#countfield-2) | `variable` | Declared here |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/FlowControl/ForStartNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-108) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/FlowControl/ForStartNodeView.cs:16
...
| Return | Name | Description |
|--------|------|-------------|
| `IntegerField` | [`countField`](#countfield-2)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/FlowControl/ForStartNodeView.cs:14
