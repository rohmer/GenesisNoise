...
```cpp
class SubtractNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/SubtractNodeView.cs:9
...
| Name | Kind | Owner |
|------|------|-------|
| [`subtractNode`](#subtractnode) | `property` | Declared here |
| [`Enable`](#enable-2) | `function` | Declared here |
| [`value`](#value) | `variable` | Declared here |
| [`SubtractNodeWiew_onPortDisconnected`](#subtractnodewiew_onportdisconnected) | `function` | Declared here |
| [`SubtractNodeWiew_onPortConnected`](#subtractnodewiew_onportconnected) | `function` | Declared here |
| [`UpdateLabel`](#updatelabel) | `function` | Declared here |
...
|--------|------|-------------|
| `SubtractNode` | [`subtractNode`](#subtractnode)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/SubtractNodeView.cs:11

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-2) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/SubtractNodeView.cs:13
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/SubtractNodeView.cs:12

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`SubtractNodeWiew_onPortDisconnected`](#subtractnodewiew_onportdisconnected) `inline` |  |
| `void` | [`SubtractNodeWiew_onPortConnected`](#subtractnodewiew_onportconnected) `inline` |  |
| `void` | [`UpdateLabel`](#updatelabel) `inline` |  |

---

{#subtractnodewiew_onportdisconnected}
...
```cpp
inline void SubtractNodeWiew_onPortDisconnected(PortView obj)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/SubtractNodeView.cs:34

---

{#subtractnodewiew_onportconnected}
...
```cpp
inline void SubtractNodeWiew_onPortConnected(PortView obj)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/SubtractNodeView.cs:39
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/SubtractNodeView.cs:47
