{#subdividemeshnodeview}

# SubDivideMeshNodeView

```cpp
class SubDivideMeshNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/SubDivideMeshNodeView.cs:11
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-59) | `property` | Declared here |
| [`Enable`](#enable-157) | `function` | Declared here |
| [`subdivisions`](#subdivisions) | `variable` | Declared here |
...
|--------|------|-------------|
| `SubdivideMeshNode` | [`node`](#node-59)  |  |
...
```cpp
SubdivideMeshNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/SubDivideMeshNodeView.cs:13

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-157) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/SubDivideMeshNodeView.cs:17

## Private Attributes

| Return | Name | Description |
|--------|------|-------------|
| `SliderInt` | [`subdivisions`](#subdivisions)  |  |
...
```cpp
SliderInt subdivisions
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/SubDivideMeshNodeView.cs:15
