{#floodfilltobboxsizenode}

# FloodFillToBBoxSizeNode

```cpp
class FloodFillToBBoxSizeNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/FloodFillToBBoxSizeNode.cs:9
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-192) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-170) | `property` | Declared here |
| [`ShaderName`](#shadername-141) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-192)  |  |
| `override string` | [`NodeGroup`](#nodegroup-170)  |  |
| `override string` | [`ShaderName`](#shadername-141)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/FloodFillToBBoxSizeNode.cs:11
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/FloodFillToBBoxSizeNode.cs:12
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Effects/Effects/FloodFillToBBoxSizeNode.cs:13
