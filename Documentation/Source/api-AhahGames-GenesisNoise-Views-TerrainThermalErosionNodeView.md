{#terrainthermalerosionnodeview}

# TerrainThermalErosionNodeView

```cpp
class TerrainThermalErosionNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainThermalErosionNodeView.cs:13
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-66) | `property` | Declared here |
| [`Enable`](#enable-164) | `function` | Declared here |
| [`iterations`](#iterations-5) | `variable` | Declared here |
| [`talus`](#talus) | `variable` | Declared here |
| [`strength`](#strength-2) | `variable` | Declared here |
| [`transferRate`](#transferrate) | `variable` | Declared here |
| [`SetNodeValue`](#setnodevalue) | `function` | Declared here |
...
|--------|------|-------------|
| `TerrainThermalErosionNode` | [`node`](#node-66)  |  |
...
```cpp
TerrainThermalErosionNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainThermalErosionNodeView.cs:15

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-164) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainThermalErosionNodeView.cs:22
...
| Return | Name | Description |
|--------|------|-------------|
| `SliderInt` | [`iterations`](#iterations-5)  |  |
| `Slider` | [`talus`](#talus)  |  |
| `Slider` | [`strength`](#strength-2)  |  |
| `Slider` | [`transferRate`](#transferrate)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainThermalErosionNodeView.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainThermalErosionNodeView.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainThermalErosionNodeView.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainThermalErosionNodeView.cs:20

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`SetNodeValue`](#setnodevalue) `inline` |  |
...
```cpp
inline void SetNodeValue(string undoName, System.Action setter)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainThermalErosionNodeView.cs:59
