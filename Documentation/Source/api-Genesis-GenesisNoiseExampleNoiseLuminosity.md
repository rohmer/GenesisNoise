{#genesisnoiseexamplenoiseluminosity}

# GenesisNoiseExampleNoiseLuminosity

```cpp
class GenesisNoiseExampleNoiseLuminosity
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Examples/Nodes/Shader Node/GenesisNoiseExampleNoiseLuminosity.cs:8
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-1) | `property` | Declared here |
| [`ShaderName`](#shadername-1) | `property` | Declared here |
| [`DisplayMaterialInspector`](#displaymaterialinspector-1) | `property` | Declared here |
| [`filteredOutProperties`](#filteredoutproperties-1) | `property` | Declared here |
| [`supportedDimensions`](#supporteddimensions) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-1)  | The name of the node, which will be displayed in the node graph. You can change this to whatever you want. |
| `override string` | [`ShaderName`](#shadername-1)  | The name of the shader, this will be the same as the first line of your shader file. For example: Shader "Hidden/Genesis/MyCustomShader". |
| `override bool` | [`DisplayMaterialInspector`](#displaymaterialinspector-1)  | In our example we are using the default inspector for the shader, but you can create your own custom inspector by creating a new class that inherits from ShaderNodeInspector and overriding the DisplayMaterialInspector property to return false. Then you can create your own custom inspector for your shader node. |
| `override IEnumerable< string >` | [`filteredOutProperties`](#filteredoutproperties-1)  |  |
| `override List< OutputDimension >` | [`supportedDimensions`](#supporteddimensions)  | For our example we are only going to focus on 2D textures, but you can support any type of output dimension that you want. The list of supported dimensions is defined in the OutputDimension enum. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Examples/Nodes/Shader Node/GenesisNoiseExampleNoiseLuminosity.cs:13

The name of the node, which will be displayed in the node graph. You can change this to whatever you want.
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Examples/Nodes/Shader Node/GenesisNoiseExampleNoiseLuminosity.cs:19

The name of the shader, this will be the same as the first line of your shader file. For example: Shader "Hidden/Genesis/MyCustomShader".

---

{#displaymaterialinspector-1}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Examples/Nodes/Shader Node/GenesisNoiseExampleNoiseLuminosity.cs:24

In our example we are using the default inspector for the shader, but you can create your own custom inspector by creating a new class that inherits from ShaderNodeInspector and overriding the DisplayMaterialInspector property to return false. Then you can create your own custom inspector for your shader node.

---

{#filteredoutproperties-1}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Examples/Nodes/Shader Node/GenesisNoiseExampleNoiseLuminosity.cs:27
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Examples/Nodes/Shader Node/GenesisNoiseExampleNoiseLuminosity.cs:32

For our example we are only going to focus on 2D textures, but you can support any type of output dimension that you want. The list of supported dimensions is defined in the OutputDimension enum.
