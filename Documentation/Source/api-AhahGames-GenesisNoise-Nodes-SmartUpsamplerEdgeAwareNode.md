{#smartupsampleredgeawarenode}

# SmartUpsamplerEdgeAwareNode

```cpp
class SmartUpsamplerEdgeAwareNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/NoiseUpsamplerEdgeAwareNode.cs:16
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-471) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-437) | `property` | Declared here |
| [`ShaderName`](#shadername-350) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-471)  |  |
| `override string` | [`NodeGroup`](#nodegroup-437)  |  |
| `override string` | [`ShaderName`](#shadername-350)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/NoiseUpsamplerEdgeAwareNode.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/NoiseUpsamplerEdgeAwareNode.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/NoiseUpsamplerEdgeAwareNode.cs:20
