{#sparsegaborconvolutionnode}

# SparseGaborConvolutionNode

```cpp
class SparseGaborConvolutionNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/SparseGaborConvolutionNode.cs:15
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-478) | `property` | Declared here |
| [`ShaderName`](#shadername-356) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-444) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-478)  |  |
| `override string` | [`ShaderName`](#shadername-356)  |  |
| `override string` | [`NodeGroup`](#nodegroup-444)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/SparseGaborConvolutionNode.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/SparseGaborConvolutionNode.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Noise/SparseGaborConvolutionNode.cs:19
