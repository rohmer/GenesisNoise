{#cartesiantopolarnode}

# CartesianToPolarNode

```cpp
class CartesianToPolarNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/CartesianToPolarNode.cs:11
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-75) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-57) | `property` | Declared here |
| [`ShaderName`](#shadername-41) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-75)  |  |
| `override string` | [`NodeGroup`](#nodegroup-57)  |  |
| `override string` | [`ShaderName`](#shadername-41)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/CartesianToPolarNode.cs:13
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/CartesianToPolarNode.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Transforms/CartesianToPolarNode.cs:15
