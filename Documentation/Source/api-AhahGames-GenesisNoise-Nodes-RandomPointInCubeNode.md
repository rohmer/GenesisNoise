{#randompointincubenode}

# RandomPointInCubeNode

```cpp
class RandomPointInCubeNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInCubeNode.cs:14
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-414) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-383) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-148) | `property` | Declared here |
| [`output`](#output-71) | `variable` | Declared here |
| [`pt1`](#pt1-2) | `variable` | Declared here |
| [`pt2`](#pt2-1) | `variable` | Declared here |
| [`Process`](#process-12) | `function` | Declared here |
| [`ProcessNode`](#processnode-101) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-414)  |  |
| `override string` | [`NodeGroup`](#nodegroup-383)  |  |
| `override float` | [`nodeWidth`](#nodewidth-148)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInCubeNode.cs:24
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInCubeNode.cs:25
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInCubeNode.cs:26

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `Vector3` | [`output`](#output-71)  |  |
| `Vector3` | [`pt1`](#pt1-2)  |  |
| `Vector3` | [`pt2`](#pt2-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInCubeNode.cs:17
...
```cpp
Vector3 pt1 = new(-1, -1, -1)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInCubeNode.cs:20
...
```cpp
Vector3 pt2 = new(1, 1, 1)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInCubeNode.cs:22

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Process`](#process-12) `virtual` `inline` | Override this method to implement custom processing. |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInCubeNode.cs:27
...
| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-101) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Functions/Random/RandomPointInCubeNode.cs:42
