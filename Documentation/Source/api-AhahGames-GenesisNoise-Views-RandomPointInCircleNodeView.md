{#randompointincirclenodeview}

# RandomPointInCircleNodeView

```cpp
class RandomPointInCircleNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomPointInCircleNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-50) | `property` | Declared here |
| [`Enable`](#enable-147) | `function` | Declared here |
| [`Disable`](#disable-69) | `function` | Declared here |
| [`p1`](#p1-1) | `variable` | Declared here |
| [`radius`](#radius-3) | `variable` | Declared here |
| [`RefreshOutputs`](#refreshoutputs-12) | `function` | Declared here |
...
|--------|------|-------------|
| `RandomPointInCircleNode` | [`node`](#node-50)  |  |
...
```cpp
RandomPointInCircleNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomPointInCircleNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-147) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-69) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomPointInCircleNodeView.cs:16
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomPointInCircleNodeView.cs:48
...
| Return | Name | Description |
|--------|------|-------------|
| `Vector2Field` | [`p1`](#p1-1)  |  |
| `FloatField` | [`radius`](#radius-3)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomPointInCircleNodeView.cs:13
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomPointInCircleNodeView.cs:14

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RefreshOutputs`](#refreshoutputs-12) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Random/RandomPointInCircleNodeView.cs:54
