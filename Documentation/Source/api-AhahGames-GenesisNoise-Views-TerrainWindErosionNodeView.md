{#terrainwinderosionnodeview}

# TerrainWindErosionNodeView

```cpp
class TerrainWindErosionNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindErosionNodeView.cs:13
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-67) | `property` | Declared here |
| [`Enable`](#enable-165) | `function` | Declared here |
| [`iterations`](#iterations-6) | `variable` | Declared here |
| [`windAngle`](#windangle) | `variable` | Declared here |
| [`windStrength`](#windstrength) | `variable` | Declared here |
| [`talus`](#talus-1) | `variable` | Declared here |
| [`abrasion`](#abrasion) | `variable` | Declared here |
| [`deposition`](#deposition) | `variable` | Declared here |
| [`turbulence`](#turbulence) | `variable` | Declared here |
| [`sampleRadius`](#sampleradius-2) | `variable` | Declared here |
...
|--------|------|-------------|
| `TerrainWindErosionNode` | [`node`](#node-67)  |  |
...
```cpp
TerrainWindErosionNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindErosionNodeView.cs:15

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-165) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindErosionNodeView.cs:26
...
| Return | Name | Description |
|--------|------|-------------|
| `SliderInt` | [`iterations`](#iterations-6)  |  |
| `Slider` | [`windAngle`](#windangle)  |  |
| `Slider` | [`windStrength`](#windstrength)  |  |
| `Slider` | [`talus`](#talus-1)  |  |
| `Slider` | [`abrasion`](#abrasion)  |  |
| `Slider` | [`deposition`](#deposition)  |  |
| `Slider` | [`turbulence`](#turbulence)  |  |
| `SliderInt` | [`sampleRadius`](#sampleradius-2)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindErosionNodeView.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindErosionNodeView.cs:18
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindErosionNodeView.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindErosionNodeView.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindErosionNodeView.cs:21
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindErosionNodeView.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindErosionNodeView.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Terrain/TerrainWindErosionNodeView.cs:24
