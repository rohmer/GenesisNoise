...
```cpp
class TerrainTextureNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/TerrainTextureNode.cs:13
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-513) | `property` | Declared here |
| [`showDefaultInspector`](#showdefaultinspector-73) | `property` | Declared here |
| [`hasPreview`](#haspreview-84) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-178) | `property` | Declared here |
| [`Enable`](#enable-79) | `function` | Declared here |
| [`ProcessNode`](#processnode-132) | `function` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-513)  |  |
| `override bool` | [`showDefaultInspector`](#showdefaultinspector-73)  |  |
| `override bool` | [`hasPreview`](#haspreview-84)  |  |
| `override float` | [`nodeWidth`](#nodewidth-178)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/TerrainTextureNode.cs:21

---

{#showdefaultinspector-73}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/TerrainTextureNode.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/TerrainTextureNode.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/TerrainTextureNode.cs:24

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-79) `virtual` `inline` | Called when the node is enabled. |
| `override bool` | [`ProcessNode`](#processnode-132) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/TerrainTextureNode.cs:26
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Terrain/Materials/TerrainTextureNode.cs:34
