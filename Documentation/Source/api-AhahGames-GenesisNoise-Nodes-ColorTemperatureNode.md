...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/ColorTemperatureNode.cs:15
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-111) | `property` | Declared here |
| [`ShaderName`](#shadername-75) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-92) | `property` | Declared here |
| [`DisplayMaterialInspector`](#displaymaterialinspector-37) | `property` | Declared here |
| [`nodeWidth`](#nodewidth-47) | `property` | Declared here |
| [`filteredOutProperties`](#filteredoutproperties-35) | `property` | Declared here |
| [`temperatureColor`](#temperaturecolor) | `variable` | Declared here |
| [`ProcessNode`](#processnode-28) | `function` | Declared here |
| [`ColorProperty`](#colorproperty-1) | `variable` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-111)  |  |
| `override string` | [`ShaderName`](#shadername-75)  |  |
| `override string` | [`NodeGroup`](#nodegroup-92)  |  |
| `override bool` | [`DisplayMaterialInspector`](#displaymaterialinspector-37)  |  |
| `override float` | [`nodeWidth`](#nodewidth-47)  |  |
| `override IEnumerable< string >` | [`filteredOutProperties`](#filteredoutproperties-35)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/ColorTemperatureNode.cs:22
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/ColorTemperatureNode.cs:23
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/ColorTemperatureNode.cs:24

---

{#displaymaterialinspector-37}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/ColorTemperatureNode.cs:25
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/ColorTemperatureNode.cs:26

---

{#filteredoutproperties-35}
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/ColorTemperatureNode.cs:28

## Public Attributes

| Return | Name | Description |
|--------|------|-------------|
| `Color` | [`temperatureColor`](#temperaturecolor)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/ColorTemperatureNode.cs:18

## Protected Methods

| Return | Name | Description |
|--------|------|-------------|
| `override bool` | [`ProcessNode`](#processnode-28) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/ColorTemperatureNode.cs:30
...
| Return | Name | Description |
|--------|------|-------------|
| `const string` | [`ColorProperty`](#colorproperty-1) `static` |  |
...
```cpp
const string ColorProperty = "_TemperatureColor"
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Color/ColorTemperatureNode.cs:20
