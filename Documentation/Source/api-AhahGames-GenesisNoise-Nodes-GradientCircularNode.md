{#gradientcircularnode}

# GradientCircularNode

```cpp
class GradientCircularNode
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Shape/GradientCircularNode.cs:17
...
| Name | Kind | Owner |
|------|------|-------|
| [`name`](#name-226) | `property` | Declared here |
| [`ShaderName`](#shadername-171) | `property` | Declared here |
| [`NodeGroup`](#nodegroup-203) | `property` | Declared here |
...
|--------|------|-------------|
| `override string` | [`name`](#name-226)  |  |
| `override string` | [`ShaderName`](#shadername-171)  |  |
| `override string` | [`NodeGroup`](#nodegroup-203)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Shape/GradientCircularNode.cs:19
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Shape/GradientCircularNode.cs:20
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Runtime/Nodes/Generator/Shape/GradientCircularNode.cs:21
