{#greynoisepointsnodeview}

# GreyNoisePointsNodeView

```cpp
class GreyNoisePointsNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/GreyNoisePointsNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-19) | `property` | Declared here |
| [`Enable`](#enable-112) | `function` | Declared here |
| [`Disable`](#disable-59) | `function` | Declared here |
| [`countField`](#countfield-3) | `variable` | Declared here |
| [`coordinatesField`](#coordinatesfield-2) | `variable` | Declared here |
| [`RefreshOutputs`](#refreshoutputs-2) | `function` | Declared here |
...
|--------|------|-------------|
| `GreyNoisePointsNode` | [`node`](#node-19)  |  |
...
```cpp
GreyNoisePointsNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/GreyNoisePointsNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-112) `virtual` `inline` |  |
| `override void` | [`Disable`](#disable-59) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/GreyNoisePointsNodeView.cs:17
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/GreyNoisePointsNodeView.cs:38
...
| Return | Name | Description |
|--------|------|-------------|
| `IntegerField` | [`countField`](#countfield-3)  |  |
| `TextField` | [`coordinatesField`](#coordinatesfield-2)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/GreyNoisePointsNodeView.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/GreyNoisePointsNodeView.cs:15

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`RefreshOutputs`](#refreshoutputs-2) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/GreyNoisePointsNodeView.cs:44
