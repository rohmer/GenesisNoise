...
```cpp
class MultiplyNodeWiew
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/MultiplyNodeView.cs:10
...
| Name | Kind | Owner |
|------|------|-------|
| [`multiplyNode`](#multiplynode-1) | `property` | Declared here |
| [`Enable`](#enable-133) | `function` | Declared here |
| [`value`](#value-34) | `variable` | Declared here |
| [`MultiplyNodeWiew_onPortDisconnected`](#multiplynodewiew_onportdisconnected) | `function` | Declared here |
| [`MultiplyNodeWiew_onPortConnected`](#multiplynodewiew_onportconnected) | `function` | Declared here |
| [`Process`](#process-29) | `function` | Declared here |
| [`UpdateLabel`](#updatelabel-9) | `function` | Declared here |
...
|--------|------|-------------|
| `MultiplyNode` | [`multiplyNode`](#multiplynode-1)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/MultiplyNodeView.cs:12

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-133) `virtual` `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/MultiplyNodeView.cs:14
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/MultiplyNodeView.cs:13

## Private Methods

| Return | Name | Description |
|--------|------|-------------|
| `void` | [`MultiplyNodeWiew_onPortDisconnected`](#multiplynodewiew_onportdisconnected) `inline` |  |
| `void` | [`MultiplyNodeWiew_onPortConnected`](#multiplynodewiew_onportconnected) `inline` |  |
| `void` | [`Process`](#process-29) `inline` |  |
| `void` | [`UpdateLabel`](#updatelabel-9) `inline` |  |

---

{#multiplynodewiew_onportdisconnected}
...
```cpp
inline void MultiplyNodeWiew_onPortDisconnected(PortView obj)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/MultiplyNodeView.cs:35

---

{#multiplynodewiew_onportconnected}
...
```cpp
inline void MultiplyNodeWiew_onPortConnected(PortView obj)
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/MultiplyNodeView.cs:40
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/MultiplyNodeView.cs:49
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Function/Math/MultiplyNodeView.cs:59
