{#meshnoisedisplacementnodeview}

# MeshNoiseDisplacementNodeView

```cpp
class MeshNoiseDisplacementNodeView
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshNoiseDisplacementNodeView.cs:11
...
| Name | Kind | Owner |
|------|------|-------|
| [`node`](#node-32) | `property` | Declared here |
| [`Enable`](#enable-127) | `function` | Declared here |
| [`strength`](#strength) | `variable` | Declared here |
| [`alongNormals`](#alongnormals) | `variable` | Declared here |
| [`centerNoise`](#centernoise) | `variable` | Declared here |
...
|--------|------|-------------|
| `MeshNoiseDisplacementNode` | [`node`](#node-32)  |  |
...
```cpp
MeshNoiseDisplacementNode node
```

Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshNoiseDisplacementNodeView.cs:13

## Public Methods

| Return | Name | Description |
|--------|------|-------------|
| `override void` | [`Enable`](#enable-127) `inline` |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshNoiseDisplacementNodeView.cs:19
...
| `Toggle` | [`alongNormals`](#alongnormals)  |  |
| `Toggle` | [`centerNoise`](#centernoise)  |  |
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshNoiseDisplacementNodeView.cs:15
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshNoiseDisplacementNodeView.cs:16
...
Defined in E:/Unity/Genesis_NG/Assets/Packages/com.ahahgames.genesisnoise/Editor/Views/Mesh/MeshNoiseDisplacementNodeView.cs:17
